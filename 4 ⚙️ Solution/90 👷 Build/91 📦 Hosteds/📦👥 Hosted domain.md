...
> Part of [Hoster ☁️ helper domain](<../../45 🤲 Helper domains/55 ☁️ Hosters/☁️🤲 Hoster helper.md>)
...
1. **How to set up a Hosted domain?**
    ...
    |#|Step
    |-|-
    |1| [Bind 🔗](<../../30 Data/20 🔗 Binds/🔗 Bind.md>) to a [Hoster ☁️ domain](<../../45 🤲 Helper domains/55 ☁️ Hosters/☁️🤲 Hoster helper.md>)
...
1. **What domain files are cloned locally?**
    ...
    | 🔆 [Locators](<📦📄 Hosted files/🔆📄 Locators file.md>) | YAML | Map of [Locators 🔆](<../../25 Locators/15 🔆 Locators/🔆 Locator.md>) to [Talkers 😃](<../../../9 😃 Talkers/10 📘 Talker specs/10 😃 Talker.md>)
    | 😃 [Talkers](<📦📄 Hosted files/😃📂 Talkers folder.md>) | Folder | List of [Talker 😃](<../../../9 😃 Talkers/10 📘 Talker specs/10 😃 Talker.md>) scripts 
    | [📜 Manifest](<📦📄 Hosted files/📜📂 Manifest folder.md>) | Folder | Public [domain Manifest 📜](<../../40 👥 Domains/👥📜 Domain Manifests/📜 Manifest.md>) parts
    | [🪣 Pools](<📦📄 Hosted files/🪣📄 Pools file.md>) | YAML | Resource index for [Talker `MAP`](<../../../9 😃 Talkers/30 🗃️ Talker data/61 🪣 MAP item.md>)
...
1. **What are the API methods?**
    ...
    | Method | Purpose
    |-|-
    [😃🐌 Handle](<📦🅰️ Hosted methods/😃🐌📦 Handle.md>) | Evaluates [{Functions}](<../../../9 😃 Talkers/30 🗃️ Talker data/12 🐍 {Function}.md>) in [Talkers 😃](<../../../9 😃 Talkers/10 📘 Talker specs/10 😃 Talker.md>)
...
1. **What is required from domain owners?**
    ...
    | Dependency | Purpose
    |-|-
    | [🧑‍🦰 Wallet](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) | To authenticate and [Chat 💬](<../../35 Chats/12 💬 Chats/💬 Chat.md>) with the [Hoster ☁️ ](<../../45 🤲 Helper domains/55 ☁️ Hosters/☁️🤲 Hoster helper.md>)
