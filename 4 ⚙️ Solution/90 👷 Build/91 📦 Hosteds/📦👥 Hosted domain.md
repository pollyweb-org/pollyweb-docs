...
1. **How to set up a Hosted domain?**
    ...
    |2| [Clone](<../01 🛠️ Syncers/🔃⏩ Syncer flows/10 🔃⏩🗃️ Clone.md>) the files to a local folder
    |3| Spin up an HTTP backend endpoint
    |4| Edit the files and [sync](<../01 🛠️ Syncers/🔃⏩ Syncer flows/20 🔃⏩🗃️ Sync.md>) the changes
...
1. **What is required from domain owners?**
    ...
    | Dependency | Purpose
    |-|-
    | [🧑‍🦰 Wallet](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) | To authenticate and [Chat 💬](<../../35 Chats/💬 Chats/💬 Chat.md>) with the [Hoster ☁️ ](<../../45 🤲 Helper domains/55 ☁️ Hosters/☁️🤲 Hoster helper.md>)
