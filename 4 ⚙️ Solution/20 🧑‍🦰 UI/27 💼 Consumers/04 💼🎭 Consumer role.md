...
1. **How do Consumers verify a Token's signature?**
    ...
    - Other [domains 👥](<../../40 👥 Domains/41 📨 Comms/00 👥 Domain.md>) can use the [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) key to verify the signature on the [Token 🎫](<../25 🎫 Tokens/01 🎫 Token.md>).
...
1. **How are consumers prevented from collecting too much user data?**
    ...
    * That configuration would result in the following [Chat 💬](<../12 💬 Chats/01 💬 Chat.md>) excerpt. 
        ...
        | [Domain](<../../40 👥 Domains/41 📨 Comms/00 👥 Domain.md>) | [Prompt](<../../../9 😃 Talkers/10 📘 Talker specs/20 🤔 Prompt.md>) | [User](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>)
        |-|-|-|
