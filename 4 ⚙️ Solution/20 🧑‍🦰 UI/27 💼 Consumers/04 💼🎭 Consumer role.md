...
13. **How can users be protected from consumers collecting too much PII?**
    ...
    * [Broker 🤵 domains](<../03 🤵 Brokers/03 🤵 Broker domain.md>) inform users of every context change, identifying the data that may be collected, then block any data request from the Consumer that does not comply with that context - e.g., [Order pizza 🍕](<../../../3 🤝 Use Cases/02 🍽️ Eat & Drink/04 🍕 Order pizza/01 🍕 Customer @ Home 🏠/01 🏠 Order pizza.md>), [Hotel check-in 🛎️](<../../../3 🤝 Use Cases/03 🧳 Travel/08 🧳 Stay at hotels 🏨/03 🏨 Guest @ Reception 🛎️/04 🛎️ Check-in.md>).
