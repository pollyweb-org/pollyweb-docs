...
|-|-|-|-
| Header | `From`    | string | [Vault 🗄️](<../../../../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>) of the [Bind 🔗](<../../../../30 Data/🔗 Binds/🔗 Bind.md>)
|| `To`      | string | [Broker 🤵](<../../🤵🤲 Broker helper.md>) of the [Bind 🔗](<../../../../30 Data/🔗 Binds/🔗 Bind.md>)
|| `Subject` | string | `Engage@Broker`
| Body | `BindID`  | uuid   | [Bind 🔗](<../../../../30 Data/🔗 Binds/🔗 Bind.md>) of [`.HOST/BIND/SELF` 🧩](<../../../../../7 🧩 Codes/$/🧩 VAULT code.md>)
| | `Locator`| string | [Locator 🔆](<../../../../25 Locators/15 🔆 Locators/🔆 Locator.md>) for [`Hello@Host`](<../../../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🅰️ Host methods/🤵🐌🤗 Hello.md>)
