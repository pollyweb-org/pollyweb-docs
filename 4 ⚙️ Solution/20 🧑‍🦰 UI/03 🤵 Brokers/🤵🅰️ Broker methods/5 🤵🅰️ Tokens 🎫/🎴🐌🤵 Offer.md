...
* An [Issuer 🎴 domain](<../../../../41 🎭 Domain Roles/40 🎴 Issuers/🎴🎭 Issuer role.md>) issues a [Token 🎫](<../../../../30 Data/🎫 Tokens/🎫 Token.md>) 
...
1. **Why are the schema and timestamp properties for?**
    ...
    `Translate` | [Broker 🤵 domains](<../../🤵🤲 Broker helper.md>) need to translate the [Schema Code 🧩](<../../../../30 Data/🧩 Schema Codes/🧩 Schema Code.md>)  into for users in their [Wallet 🧑‍🦰 app](<../../../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) language.
