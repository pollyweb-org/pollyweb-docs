...
1. **How do Brokers protect users from Hosts?**
    ...
    * For a [Host 🤗 domain](<../12 💬 Chats/04 🤗🎭 Host role.md>) to identity a user across sessions, the user needs to explicitly accept a [Bind 🔗](<../../25 Data/24 🗄️ Vaults/01 🔗 Bind.md>) from the [Host's Vault 🗄️ role](<../../41 🎭 Domain Roles/80 🗄️ Vault/$ 🗄️🎭 Vault role.md>) or a [Token 🎫](<../25 🎫 Tokens/01 🎫 Token.md>) from the [Host's Issuer 🎴 role](<../25 🎫 Tokens/02 🎴🎭 Issuer role.md>).
...
1. **What API methods does a Broker expose?**
    ...
    || [🗄️🐌 Bindable](<../../../6 🅰️ APIs/15 🤵🅰️ Broker/40 🤵🅰️ Binds 🔗/20 🗄️🐌🤵 Bindable.md>) | [Vaults 🗄️](<../../41 🎭 Domain Roles/80 🗄️ Vault/$ 🗄️🎭 Vault role.md>) offer to bind [Schema Codes 🧩](<../../25 Data/24 🗄️ Vaults/02 🧩 Schema Code.md>)
