...
2. **How do Brokers protect users from Hosts?**
...
3. **Who migrates users between phones - Brokers or Notifiers?**
...
4. **How do users migrate a Wallet to another phone?**
...
5. **How do users change between Wallet providers?**
...
6. **What if an attacker intercepts a user's recovery QR Token?**
...
7. **After destroying a migration QR, how can users migrate?**
...
8. **After losing a phone, how do users recover a wallet on a new phone?**
...
9.  **What if an attacker has the user's old phone and rejects the transfer?**
...
10. **Why aren't Brokers and Notifiers the same domain?**
...
11. **How can Wallet startups connect to a Broker?**
...
12. **How do Brokers ensure Wallets are NLWeb compliant?**
