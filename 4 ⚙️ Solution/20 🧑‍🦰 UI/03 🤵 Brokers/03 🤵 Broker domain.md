...
1. **What API methods does a Broker expose?**
    ...
    | | [🤗🐌 Prompt](<../../../6 🅰️ APIs/15 🤵🅰️ Broker/30 🤵🅰️ Chats 💬/03 🤗🐌🤵 Prompt.md>) |   [Prompt 🤔](<../../../9 😃 Talkers/50 🤔 Prompts/1 📘 Prompt specs/01 🤔 Prompt.md>) intent from [Host 🤗 domain](<../12 💬 Chats/04 🤗🎭 Host role.md>) 
