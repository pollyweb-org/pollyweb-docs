...
1. **What API methods does a Broker expose?**
    ...
    | [`💼 Share`](<../27 💼 Consumers/04 💼🎭 Consumer role.md>) | [💼🐌 Query](<../../../6 🅰️ APIs/15 🤵🅰️ Broker/60 🤵🅰️ Share/61 💼🐌🤵 Query.md>) | Return user [Binds 🔗](<../../25 Data/24 🗄️ Vaults/01 🔗 Bind.md>) and [Tokens 🎫](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/25 🎫 Tokens/01 🎫 Token.md>)
