...
1. **How do Brokers protect users from Hosts?**
    ...
    * For a [Host 🤗 domain](<../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) to identity a user across sessions, the user needs to explicitly accept a [Bind 🔗](<../../30 🧩 Data/2 🔗 Binds/🔗 Bind.md>) from the [Host's Vault 🗄️ role](<../../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>) or a [Token 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) from the [Host's Issuer 🎴 role](<../../41 🎭 Domain Roles/40 🎴 Issuers/🎴🎭 Issuer role.md>).
...
1. **What API methods does a Broker expose?**
    ...
    || [🗄️🐌 Bindable](<🤵🅰️ Broker methods/4 🤵🅰️ Binds 🔗/🗄️🐌🤵 Bindable.md>) | [Vaults 🗄️](<../../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>) offer to bind [Schema Codes 🧩](<../../30 🧩 Data/1 🧩 Schema Codes/🧩 Schema Code.md>)
    ...
    || [🎴🐌 Offer](<🤵🅰️ Broker methods/5 🤵🅰️ Tokens 🎫/🎴🐌🤵 Offer.md>) | [Issuers 🎴](<../../41 🎭 Domain Roles/40 🎴 Issuers/🎴🎭 Issuer role.md>) offer an issued [Token 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) 
    ...
    | [`💼 Share`](<../../41 🎭 Domain Roles/27 💼 Consumers/💼🎭 Consumer role.md>) | [💼🐌 Query](<🤵🅰️ Broker methods/6 🤵🅰️ Share/💼🐌🤵 Query.md>) | Return user [Binds 🔗](<../../30 🧩 Data/2 🔗 Binds/🔗 Bind.md>) and [Tokens 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>)
