...
2. **What's the BIND syntax?**
   ...
   ```
    ...
    | Argument| Purpose
    |-|-
    | `<code-n>` | Array of bindable [Schema Codes 🧩](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/24 🗄️ Vaults/02 🧩 Schema Code.md>)
    | `<binds>`  |
...
3. **What does a Chat look like?**
    ...
    | 🗄️ [Vault](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) | ✅ [Done! Your wallet is bound.](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/13 🤔 Prompts/13 ✅ SUCCESS prompt.md>)
       ...
       * Example: `iata.org/SSR/WCHR`, `iata.org/...`
       ...
       | Command | Purpose
       |-|-
       | ℹ️ [INFO](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/13 🤔 Prompts/11 ℹ️ INFO prompt.md>) | To show the first message.
       |  | 
       | ⤵️ [IF](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/14 😃 Talkers/21 ⤵️ IF flow.md>) | To verify the result.
       | ✅ [SUCCESS](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/13 🤔 Prompts/13 ✅ SUCCESS prompt.md>) | To report success.
       | ❌ [FAILURE](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/13 🤔 Prompts/14 ❌ FAILURE prompt.md>) | To report nothing was bound.    