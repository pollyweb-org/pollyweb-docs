...
1. **What is a Token?**
    ...
    * issued and signed by an [Issuer 🎴 domain](<../../41 🎭 Domain Roles/40 🎴 Issuers/02 🎴🎭 Issuer role.md>), 
...
1. **How do Tokens work?**
    ...
    |#|Category|Step
    |-|-|-
    |1| `Issue`| An [Issuer 🎴 domain](<../../41 🎭 Domain Roles/40 🎴 Issuers/02 🎴🎭 Issuer role.md>) issues a [Token 🎫](<01 🎫 Token.md>) the the user stores offline in the [Wallet 🧑‍🦰 app](<../01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>).
...
1. **Can Tokens be read in Chats without the use consent?**
    ...
    - Exceptionally, if the [Schema Code 🧩](<../../25 Data/24 🗄️ Vaults/02 🧩 Schema Code.md>) of the [Token 🎫](<01 🎫 Token.md>) is marked as SELF, then the user's [Broker 🤵 domain](<../03 🤵 Brokers/$ 🤵 Broker domain.md>) silently share the [Token 🎫](<01 🎫 Token.md>) with the [Token's Issuer 🎴 domain](<../../41 🎭 Domain Roles/40 🎴 Issuers/02 🎴🎭 Issuer role.md>).
...
1. **Why do SELF Tokens exist?**
    ...
    [SELF Tokens 🎫](<01 🎫 Token.md>) are typically issued as a pass to be presented back to the [Token's Issuer 🎴 domain](<../../41 🎭 Domain Roles/40 🎴 Issuers/02 🎴🎭 Issuer role.md>) in a later moment in time, aiming for the least possible friction in the future - e.g.:
...
1. **Can users share Tokens in Wallets without internet?**
    ...
    Not via [Wallet 🧑‍🦰 apps](<../01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>), no, because Wallets need Internet connectivity to share the [Token 🎫](<01 🎫 Token.md>) with other domains. 
...
1. **Can users print Tokens in paper?**
    ...
    Yes. 
    - Offline [Tokens 🎫](<01 🎫 Token.md>) allow users to remove the dependency on the device's battery, or technical issues with the [Wallet 🧑‍🦰 app](<../01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>) resulting from low or no internet connectivity;
...
1. **What data is contained in a Token?**
    ...
    | `Domain` | string | The [Issuer 🎴 domain](<../../41 🎭 Domain Roles/40 🎴 Issuers/02 🎴🎭 Issuer role.md>) name
    | `TokenID` | uuid |  The resource key in the [Issuer 🎴](<../../41 🎭 Domain Roles/40 🎴 Issuers/02 🎴🎭 Issuer role.md>)
