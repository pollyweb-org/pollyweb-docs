...
1. **How do Tokens work?**
    ...
    |2| `In-Chat`| While in a [Chat 💬](<../12 💬 Chats/01 💬 Chat.md>) with a [Consumer 💼 host domain](<../../41 🎭 Domain Roles/27 💼 Consumers/$ 💼🎭 Consumer role.md>), the user shares the [Token 🎫](<01 🎫 Token.md>).
