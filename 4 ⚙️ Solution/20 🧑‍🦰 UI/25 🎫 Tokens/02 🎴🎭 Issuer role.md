...
4. **What if the user presents a QR Token printed on paper?**
    ...
    * instead, the QR presented by [Wallet 🧑‍🦰 apps](<../01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) contain only a [Locator 🔆](<../04 🔆 Locators/01 🔆 Locator.md>) with the ID of the [Token 🎫](<01 🎫 Token.md>) and the [Broker 🤵 domain](<../03 🤵 Brokers/03 🤵 Broker domain.md>) that holds the content and the status of the [Token 🎫](<01 🎫 Token.md>).
