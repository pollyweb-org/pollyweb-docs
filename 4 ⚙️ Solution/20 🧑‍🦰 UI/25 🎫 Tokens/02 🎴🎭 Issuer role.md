...
2. **How do Issuers work?**
    ...
    | # | Step 
    |-|-
    |1| A user engages in a [Chat 💬](<../23 💬 Chats/01 💬 Chat.md>) with a [Host 🤗 domain](<../23 💬 Chats/04 🤗🎭 Host role.md>) with an [Issuer 🎴 role](<02 🎴🎭 Issuer role.md>).
...
3. **Can an Issuer domain suspend or revoke a Token?**
    ...
    * [Broker 🤵 domains](<../03 🤵 Brokers/03 🤵 Broker domain.md>) only share active [Tokens 🎫](<01 🎫 Token.md>) when [Consumer 💼 domains](<../../30 🫥 Agents/01 📦 Storage/01 📦🫥 Storage agent.md>) ask for them in a [Chat 💬](<../23 💬 Chats/01 💬 Chat.md>).
...
4. **What if the user presents a QR Token printed on paper?**
    ...
    * instead, the QR presented by [Wallet 🧑‍🦰 apps](<../01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) contain only a [Locator 🔆](<../22 🔆 Locators/01 🔆 Locator.md>) with the ID of the [Token 🎫](<01 🎫 Token.md>) and the [Broker 🤵 domain](<../03 🤵 Brokers/03 🤵 Broker domain.md>) that holds the content and the status of the [Token 🎫](<01 🎫 Token.md>).
...
5. **Why not check revocation directly with Issuers?**
    ...
    * Furthermore, because [Broker 🤵 domains](<../03 🤵 Brokers/03 🤵 Broker domain.md>) simplify the process by only sharing active [Tokens 🎫](<01 🎫 Token.md>) when [Consumer 💼 domains](<../../30 🫥 Agents/01 📦 Storage/01 📦🫥 Storage agent.md>) send sharing requests in a [Chat 💬](<../23 💬 Chats/01 💬 Chat.md>), this allows [Consumer 💼 domains](<../../30 🫥 Agents/01 📦 Storage/01 📦🫥 Storage agent.md>) to only need to verify the status of [Tokens 🎫](<01 🎫 Token.md>) presented in an offline fashion (e.g., a printed QR on a paper).
