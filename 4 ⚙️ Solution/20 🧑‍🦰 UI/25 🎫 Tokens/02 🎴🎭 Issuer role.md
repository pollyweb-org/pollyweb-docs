...
1. **Can an Issuer domain suspend or revoke a Token?**
    ...
    * [Broker 🤵 domains](<../03 🤵 Brokers/$ 🤵 Broker domain.md>) only share active [Tokens 🎫](<01 🎫 Token.md>) when [Consumer 💼 domains](<../../30 🫥 Agents/80 📦 Storage/$ 📦🫥 Storage agent.md>) ask for them in a [Chat 💬](<../12 💬 Chats/01 💬 Chat.md>).
...
1. **What if the user presents a QR Token printed on paper?**
    ...
    * instead, the QR presented by [Wallet 🧑‍🦰 apps](<../01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>) contain only a [Locator 🔆](<../11 🔆 Locators/01 🔆 Locator.md>) with the ID of the [Token 🎫](<01 🎫 Token.md>) and the [Broker 🤵 domain](<../03 🤵 Brokers/$ 🤵 Broker domain.md>) that holds the content and the status of the [Token 🎫](<01 🎫 Token.md>).
