...
1. **Can an Issuer domain suspend or revoke a Token?**
    ...
    * [Broker 🤵 domains](<../03 🤵 Brokers/03 🤵 Broker domain.md>) only share active [Tokens 🎫](<01 🎫 Token.md>) when [Consumer 💼 domains](<../../30 🫥 Agents/01 📦 Storage/$ 📦🫥 Storage agent.md>) ask for them in a [Chat 💬](<../12 💬 Chats/01 💬 Chat.md>).
...
1. **Why not check revocation directly with Issuers?**
    ...
    * Instead, in NLWeb, [Broker 🤵 domains](<../03 🤵 Brokers/03 🤵 Broker domain.md>) protect the privacy of users by answering the online [Token 🎫](<01 🎫 Token.md>) status queries by [Consumer 💼 domains](<../../30 🫥 Agents/01 📦 Storage/$ 📦🫥 Storage agent.md>), based on the [Token 🎫](<01 🎫 Token.md>) status update events sent asynchronously by [Issuer 🎴 domains](<02 🎴🎭 Issuer role.md>).
    
    * Furthermore, because [Broker 🤵 domains](<../03 🤵 Brokers/03 🤵 Broker domain.md>) simplify the process by only sharing active [Tokens 🎫](<01 🎫 Token.md>) when [Consumer 💼 domains](<../../30 🫥 Agents/01 📦 Storage/$ 📦🫥 Storage agent.md>) send sharing requests in a [Chat 💬](<../12 💬 Chats/01 💬 Chat.md>), this allows [Consumer 💼 domains](<../../30 🫥 Agents/01 📦 Storage/$ 📦🫥 Storage agent.md>) to only need to verify the status of [Tokens 🎫](<01 🎫 Token.md>) presented in an offline fashion (e.g., a printed QR on a paper).
