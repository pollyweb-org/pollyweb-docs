...
1. **What are the message types supported in chats?**
    ...
    - 💼 *Share*: [Consumer 💼](<../27 💼 Consumers/04 💼🎭 Consumer role.md>) domains request users to share data from a specific [schema](<../24 🗄️ Vaults/02 🧩 Schema Code.md>) or to share a [Token 🎫](<../27 🎫 Tokens/01 🎫 Token.md>).
