...
1. **How do Wallet apps scan an NLWeb QR?**
    ...
    * When a user scans the QR with an NLWeb Wallet app, the Wallet reads the [Locator 🔆](<01 🔆 Locator.md>) from the URL and opens a chat with the Locator's [Host 🤗](<../05 💬 Chats/04 🤗🎭 Host role.md>).
...
1. **What's NLWeb view on entitlement QR codes?**
    ...
    - i.e., apart from rare exceptions where two [Wallets 🧑‍🦰](<../01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) are co-operating, users are not required present a QR.
...
1. **What's NLWeb view on pin codes for entitlement?**
    ...
    - NLWeb does provide [Chat 💬 prompts](<../05 💬 Chats/01 💬 Chat.md>) to render OTPs and face scans;
