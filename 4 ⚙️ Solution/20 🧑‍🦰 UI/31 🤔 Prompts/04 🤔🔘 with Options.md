...
1. **Can prompt options be deferred?**
    ...
    * [Prompt options](<04 🤔🔘 with Options.md>) can be differed with [non-blocking status Prompts 🤔](<08 ⚠️ Status behavior.md>);
        ...
        * e.g., [`INFO`](<../../../9 😃 Talkers/Prompts/20 Status prompts/21 ℹ️ INFO prompt.md>), [`TEMP`](<../../../9 😃 Talkers/Prompts/20 Status prompts/25 ⏳ TEMP prompt.md>), [`SUCCESS`](<../../../9 😃 Talkers/Prompts/20 Status prompts/23 ✅ SUCCESS prompt.md>), and [`FAILURE`](<24 ❌ FAILURE prompt.md>).
...
1. **What are the prompts with options?**
    ...
    |[`Inputs`](<11 ✏️ Input behavior.md>) | [`1️⃣ ONE`](<../../../9 😃 Talkers/Prompts/30 Input prompts/53 1️⃣ ONE prompt.md>) [`🔢 MANY`](<../../../9 😃 Talkers/Prompts/30 Input prompts/54 🔠 MANY prompt.md>)  [`🔠 TEXT`](<../../../9 😃 Talkers/Prompts/30 Input prompts/32 🔠 TEXT prompt.md>) 
...
1. **What's the format for a [Talker 😃](<../../../9 😃 Talkers/01 😃 Talker.md>)?**
    ...
    |-|-|-
    | `<PROMPT>` | A [Prompt 🤔](<01 🤔 Prompt.md>) format. | [`INFO`](<../../../9 😃 Talkers/Prompts/20 Status prompts/21 ℹ️ INFO prompt.md>) [`TEMP`](<../../../9 😃 Talkers/Prompts/20 Status prompts/25 ⏳ TEMP prompt.md>)
...
1. **What's an example in a [Chat 💬](<../12 💬 Chats/01 💬 Chat.md>)?**
    ...
    |-|-
    | 1️⃣ [`ONE`](<../../../9 😃 Talkers/Prompts/30 Input prompts/53 1️⃣ ONE prompt.md>) | To show the options.
    | 🔀 [`CASE`](<../../../9 😃 Talkers/Flow/22 🔀 CASE flow.md>) | To check the selected option.
    | ℹ️ [`INFO`](<../../../9 😃 Talkers/Prompts/20 Status prompts/21 ℹ️ INFO prompt.md>) | To show the result.
