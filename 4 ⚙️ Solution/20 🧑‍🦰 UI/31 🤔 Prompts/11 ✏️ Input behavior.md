...
1. **What are blocking inputs?**
    ...
    * e.g., date, number, radio, checklist;
    ...
    ||Section | Details
    |-|- | -
    ||[⏭️ Input nullability](<../../../9 😃 Talkers/Prompts/25 Input defintions/12 ✏️⏭️ Input nullability.md>) | Allow inputs to be optional.
    ||[📋 Input validation](<../../../9 😃 Talkers/Prompts/25 Input defintions/13 ✏️📋 Input validation.md>) | Client versus Server side validation.
    ||[😶 Input emojis](<../../../9 😃 Talkers/Prompts/25 Input defintions/14 ✏️😶 Input emojis.md>) | Changing the default emojis.
...
1. **What are the blocking formats available?**
    ...
    | [🔠&nbsp;TEXT](<../../../9 😃 Talkers/Prompts/30 Input prompts/32 🔠 TEXT prompt.md>) | Asks for a text input
    ...
    | [🔑&nbsp;OTP](<../../../9 😃 Talkers/Prompts/30 Input prompts/57 🔑 OTP prompt.md>) | Asks for 6 digits
    ...
    | [⭐&nbsp;RATE](<../../../9 😃 Talkers/Prompts/30 Input prompts/46 ⭐ RATE prompt.md>) | 1 to 5 stars
    ...
    | [🔆&nbsp;SCAN](<../../../9 😃 Talkers/Prompts/30 Input prompts/72 🔆 SCAN prompt.md>) | Asks to touch/scan a [QR/NFC Locator 🔆](<../11 🔆 Locators/01 🔆 Locator.md>)
    | [🦋&nbsp;TOUCH](<../../../9 😃 Talkers/Prompts/30 Input prompts/73 🦋 TOUCH prompt.md>) | Asks to touch/scan a [QR/NFC Ephemeral 🦋 device](<../../60 🧰 Edge/62 🦋 Ephemerals/03 🦋🔌 Ephemeral device.md>)
    ...
    | [👤&nbsp;IDENTIFY](<../../../9 😃 Talkers/Prompts/30 Input prompts/71 👤 IDENTIFY prompt.md>) | Asks the user's [Identity 🆔 agent](<../../30 🫥 Agents/05 🆔 Identities/01 🆔🫥 Identity agent.md>) to verify the user
...
1. **How can Hosts protect users from input fatigue?**
    ...
    * e.g., ask to share the code `nlweb.org/BOOKING/CONTACTS` instead of asking for the name, then the phone number, then the email address, and so on.
    ...
    When [Prompts 🤔](<01 🤔 Prompt.md>) are inevitable, avoid [`TEXT`](<../../../9 😃 Talkers/Prompts/30 Input prompts/32 🔠 TEXT prompt.md>) prompts; 
