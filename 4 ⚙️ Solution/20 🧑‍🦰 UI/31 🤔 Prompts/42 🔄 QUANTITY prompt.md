...
1. **How to default quantities in a [Chat 💬](<../12 💬 Chats/01 💬 Chat.md>)?**
    ...
    Use the [`ONE`](<../../../9 😃 Talkers/Prompts/53 1️⃣ ONE prompt.md>) prompt.
...
1. **How does Precision work?**
    ...
    * and ask confirmation to the user if the value differs.
    ...
    | [Command ⌘](<../../../9 😃 Talkers/Flow/10 ⌘ Command.md>) | Purpose
    |-|-
    | ℹ️ [`INFO`](<../../../9 😃 Talkers/Prompts/21 ℹ️ INFO prompt.md>) | To show the message.
    | 🔁 [`REPEAT`](<../../../9 😃 Talkers/Flow/23 🔁 REPEAT flow.md>) | To repeat the input cycle forever.
...
1. **What's contained in the QUANTITY placeholder?**
    ...
    | [`$p.$`](<../../../9 😃 Talkers/Data/12 🐍 {Function}.md>) | The value of `$p.Pretty` | `1,234.57`
    | `$p` | The [default value](<../../../9 😃 Talkers/Data/12 🐍 {Function}.md>) `$p.$` | `1,234.57`
