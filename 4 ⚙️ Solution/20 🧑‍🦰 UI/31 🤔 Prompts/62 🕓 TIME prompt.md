...
1. **What's the format of a [Talker 😃](<../../../9 😃 Talkers/01 😃 Talker.md>)?**
...
1. **How to provide default time options in a [Chat 💬](<../12 💬 Chats/01 💬 Chat.md>)?**
    ...
    Mix with [ONE 1️⃣ prompts](<../../../9 😃 Talkers/Prompts/53 1️⃣ ONE prompt.md>), like in the following [Chat 💬](<../12 💬 Chats/01 💬 Chat.md>).

    | Domain | [Prompt 🤔](<01 🤔 Prompt.md>) | User
    | - | - | - |
    | [🤗 Host](<../12 💬 Chats/04 🤗🎭 Host role.md>) | 😃 [What time tomorrow?](<../../../9 😃 Talkers/Prompts/53 1️⃣ ONE prompt.md>) <br/> - [ 10:00 ] <br/> - [ 10:30 ] <br/> - [ Another ] time | > Another
