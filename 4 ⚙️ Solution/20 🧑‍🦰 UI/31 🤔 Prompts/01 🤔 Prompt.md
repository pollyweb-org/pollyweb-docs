...
1. **What input formats can Hosts ask Wallets to render?**
    ...
    * The supported [Prompt 🤔](<01 🤔 Prompt.md>) formats are as follow.
    ...
    |[`Inputs`](<11 ✏️ Input behavior.md>)| [`🔢 INT`](<44 🔢 DIGITS prompt.md>) [`🔄 QUANTITY`](<42 🔄 QUANTITY prompt.md>) [`💰 AMOUNT`](<45 💰 AMOUNT prompt.md>) [`🔑 OTP`](<57 🔑 OTP prompt.md>) [`⭐ RATE`](<56 ⭐ RATE prompt.md>) 
