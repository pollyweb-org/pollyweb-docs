...
1. **What is a non-blocking SUCCESS?**
    ...
    A `SUCCESS` 
    * is like an [INFO ℹ️ prompt](<../../../9 😃 Talkers/Prompts/21 ℹ️ INFO prompt.md>) 
...
1. **How do SUCCESS emojis work?**
    ...
    |Emoji | Usage | Details
    |-|-|-
    |✅ | `Host` | Similar to ℹ️ on [INFO ℹ️](<../../../9 😃 Talkers/Prompts/21 ℹ️ INFO prompt.md>)
    |☑️ | `Agent` | Similar to ⓘ on [INFO ℹ️](<../../../9 😃 Talkers/Prompts/21 ℹ️ INFO prompt.md>)
