...
6. **What domain files are cloned locally?**
    ...
    | 🔆 [Locators](<../11 🔆 Locators/01 🔆 Locator.md>) | YAML | Mapping of [Locators 🔆](<../11 🔆 Locators/01 🔆 Locator.md>) to [Talkers 😃](<03 😃 Talker.md>)
    | 😃 [Talkers](<03 😃 Talker.md>) | Folder | Tree of [💬 Chat](<01 💬 Chat.md>) scripts by [Locator 🔆](<../11 🔆 Locators/01 🔆 Locator.md>)
...
1. **What does the Locators file looks like?**
    ...
    The `🔆 Locators.yaml` file contains the mapping of [Locator 🔆 resources](<../11 🔆 Locators/01 🔆 Locator.md>) to [Talkers 😃](<03 😃 Talker.md>).
