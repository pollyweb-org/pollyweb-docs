...
1. **How do Host domains work?**
    ...
    |#|Category|Step
    |-|-|-
    |1| `Hello`| The [user's Broker 🤵 domain](<../03 🤵 Brokers/03 🤵 Broker domain.md>) checks-in into a [Host 🤗 domain](<04 🤗🎭 Host role.md>), passing it context parameters, [Binds 🔗](<../../25 Data/24 🗄️ Vaults/01 🔗 Bind.md>), and [Tokens 🎫](<../25 🎫 Tokens/01 🎫 Token.md>).
...
1. **What incentives do Hosts have to close sessions?**
    ...
    - See the [Advertiser 👀 helper domains](<../../45 Helpers/12 👀 Advertisers/$ 👀👥 Advertiser helper.md>) for details.
...
1. **What proxy services are involved in the flow?**
    ...
    [Messages 📨](<../../40 👥 Domains/41 📨 Messages/01 📨 Domain Message.md>) sent from [Host 🤗 domains](<04 🤗🎭 Host role.md>) first reach the user's [Broker 🤵 domain](<../03 🤵 Brokers/03 🤵 Broker domain.md>) via HTTPS POST:
...
1. **What flows are initiated by Host domains?**
    ...
    | [👋 `Goodbye`](<../../../5 ⏩ Flows/50 🤗⏩ Hosts/07 🤗⏩🧑‍🦰 Goodbye 👋.md>) | Triggers the [advertising 👀](<../../45 Helpers/12 👀 Advertisers/$ 👀👥 Advertiser helper.md>) flow
...
1. **What API methods are exposed by a Host domain?**
    ...
    [⭐ Reviewer](<../../30 🫥 Agents/10 🔎 Finders/01 ⭐🫥 Reviewer vault.md>) | [`Rated`](<../../../6 🅰️ APIs/50 🤗🅰️ Host/09 ⭐🐌🤗 Rated.md>) | The [Chat 💬](<01 💬 Chat.md>) received user reviews
