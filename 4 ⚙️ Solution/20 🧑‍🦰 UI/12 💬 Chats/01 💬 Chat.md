...
1. **How are the intervening parties in a chat?**
    ...
    |[🤵 Broker](<../03 🤵 Brokers/03 🤵 Broker domain.md>) | Intermediates the conversation, receiving the Host's messages and forwarding them to the [Notifier 📣 domain](<../02 📣 Notifiers/$ 📣 Notifier domain.md>).
    |[📣 Notifier](<../02 📣 Notifiers/$ 📣 Notifier domain.md>) | Implements the mobile push notifications, receiving the messages from the [Broker 🤵 domain](<../03 🤵 Brokers/03 🤵 Broker domain.md>) and forwarding them to the [Wallet 🧑‍🦰 app](<../01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>).
