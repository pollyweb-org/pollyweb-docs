...
1. **How does a user open a new chat window with a domain?**
    ...
    |[🤔 Prompt](<../../../9 😃 Talkers/10 📘 Talker specs/02 🤔 Prompt.md>)| In a [Chat 💬](<01 💬 Chat.md>) window, the [Host 🤗 domain](<04 🤗🎭 Host role.md>) provides one or more options for the user to select from, and the user selects one - this opens a new [Chat 💬](<01 💬 Chat.md>) window.
...
1. **What are the message types supported in chats?**
    ...
    | Component | Behavior
    |-|-
    | [🤔 Prompt](<../../../9 😃 Talkers/10 📘 Talker specs/02 🤔 Prompt.md>) | [Host 🤗 domains](<04 🤗🎭 Host role.md>) send a question or information to the user.
