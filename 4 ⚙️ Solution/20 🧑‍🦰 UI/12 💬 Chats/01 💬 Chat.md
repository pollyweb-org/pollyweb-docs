...
1. **What are the message types supported in chats?**
    ...
    | 🗄️ *Bind* | [Vault 🗄️ domains](<../../41 🎭 Domain Roles/80 🗄️ Vault/03 🗄️🎭 Vault role.md>)  request the user to [Bind🔗](<../../25 Data/24 🗄️ Vaults/01 🔗 Bind.md>) to them.
    | 💼 *Share* | [Consumer 💼 domains](<../../41 🎭 Domain Roles/27 💼 Consumers/04 💼🎭 Consumer role.md>)  request the user to share data from a specific [Schema Code 🧩](<../../25 Data/24 🗄️ Vaults/02 🧩 Schema Code.md>) or to share a [Token 🎫](<../25 🎫 Tokens/01 🎫 Token.md>).
