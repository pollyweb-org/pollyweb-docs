...
1. **How are the intervening parties in a chat?**
    ...
    |-|-
    |[🤗 Host](<04 🤗🎭 Host role.md>) | Leads the [Chat 💬](<$ 💬 Chat.md>), always asking first.
...
1. **How does a user open a new chat window with a domain?**
    ...
    To open a new [Chat 💬](<$ 💬 Chat.md>) window with a [Host 🤗 domain](<04 🤗🎭 Host role.md>), a user needs the [Host's Locator 🔆](<../11 🔆 Locators/$ 🔆 Locator.md>) contained in one of the following technology forms.
    ...
    |[🤔 Prompt](<../../../9 😃 Talkers/10 📘 Talker specs/20 🤔 Prompt.md>)| In a [Chat 💬](<$ 💬 Chat.md>) window, the [Host 🤗 domain](<04 🤗🎭 Host role.md>) provides one or more options for the user to select from, and the user selects one - this opens a new [Chat 💬](<$ 💬 Chat.md>) window.
