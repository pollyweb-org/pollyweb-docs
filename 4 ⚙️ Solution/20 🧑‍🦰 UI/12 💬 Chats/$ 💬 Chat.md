...
1. **What are the message types supported in chats?**
    ...
    | 🗄️ *Bind* | [Vault 🗄️ domains](<../../41 🎭 Domain Roles/80 🗄️ Vaults/$ 🗄️🎭 Vault role.md>)  request the user to [Bind🔗](<../../25 Data/24 🔗 Binds/01 🔗 Bind.md>) to them.
    | 💼 *Share* | [Consumer 💼 domains](<../../41 🎭 Domain Roles/27 💼 Consumers/$ 💼🎭 Consumer role.md>)  request the user to share data from a specific [Schema Code 🧩](<../../25 Data/Schema Codes/02 🧩 Schema Code.md>) or to share a [Token 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>).
