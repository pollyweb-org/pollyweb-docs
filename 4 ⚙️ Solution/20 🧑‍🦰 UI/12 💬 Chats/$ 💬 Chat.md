...
1. **What are the message types supported in chats?**
    ...
    | 💼 *Share* | [Consumer 💼 domains](<../../41 🎭 Domain Roles/27 💼 Consumers/$ 💼🎭 Consumer role.md>)  request the user to share data from a specific [Schema Code 🧩](<../../25 Data/10 🧩 Schema Codes/02 🧩 Schema Code.md>) or to share a [Token 🎫](<../../25 Data/30 🎫 Tokens/$ 🎫 Token.md>).
