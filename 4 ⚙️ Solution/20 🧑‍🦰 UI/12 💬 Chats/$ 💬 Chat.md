...
1. **How are the intervening parties in a chat?**
    ...
    |[🤵 Broker](<../../45 🤲 Helper domains/24 🤵 Brokers/🤵🤲 Broker helper.md>) | Intermediates the conversation, receiving the Host's messages and forwarding them to the [Notifier 📣 domain](<../02 📣 Notifiers/📣 Notifier domain.md>).
    |[📣 Notifier](<../02 📣 Notifiers/📣 Notifier domain.md>) | Implements the mobile push notifications, receiving the messages from the [Broker 🤵 domain](<../../45 🤲 Helper domains/24 🤵 Brokers/🤵🤲 Broker helper.md>) and forwarding them to the [Wallet 🧑‍🦰 app](<../01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>).
...
1. **How does a user open a new chat window with a domain?**
    ...
    |[🔆 NFC tag](<../../30 🧩 Data/15 🔆 Locators/04 🧑‍🦰🔆 Wallet NFC tap.md>)| Users tap the NFC tag with their device, regardless of having the [Wallet 🧑‍🦰 app](<../01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) open - this opens a chat window on the Wallet.
    |[🌐 Link](<../../30 🧩 Data/15 🔆 Locators/02 🧑‍🦰🌐 Wallet URLs.md>)| Users click the link/button on the traditional web browser of their device - this opens a chat window on the [Wallet 🧑‍🦰 app](<../01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>).
...
1. **What if the user doesn't have the domain's Locator?**
    ...
    If a user doesn't know exactly where to find a [Locator 🔆](<../../30 🧩 Data/15 🔆 Locators/$ 🔆 Locator.md>), they can use the [Finder 🔎 domain](<../../50 🫥 Agents/40 🔎 Finders/🔎🫥 Finder agent.md>) to search for it;
...
1. **What are the message types supported in chats?**
    ...
    | 💳 *Pay* | [Seller 💵 domains](<../../41 🎭 Domain Roles/70 💵 Sellers/💵🎭 Seller role.md>)  request the user's [Payer 💳 agent](<../../50 🫥 Agents/60 💳 Payers/03 💳🎭 Payer role.md>) to pay an amount.
...
1. **How can users contribute to a domain's reputation?**
    ...
    * [Wallet 🧑‍🦰 apps](<../01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) share this feedback collaboratively with other Wallets via [Reviewer ⭐ domains](<../../50 🫥 Agents/73 ⭐ Reviewers/⭐🫥 Reviewer agent.md>). 
