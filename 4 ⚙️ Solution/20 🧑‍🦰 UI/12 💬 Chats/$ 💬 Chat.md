...
1. **What are the message types supported in chats?**
    ...
    | 💼 *Share* | [Consumer 💼 domains](<../../41 🎭 Domain Roles/27 💼 Consumers/$ 💼🎭 Consumer role.md>)  request the user to share data from a specific [Schema Code 🧩](<../../25 Data/24 🗄️ Vaults/02 🧩 Schema Code.md>) or to share a [Token 🎫](<../25 🎫 Tokens/$ 🎫 Token.md>).
...
1. **How can Hosts leverage reference data, like countries?**
    ...
    [Hosts 🤗 domains](<../../41 🎭 Domain Roles/30 🤗 Hosts/$ 🤗🎭 Host role.md>) can use data sets exposed by [Dataset 🪣 helper domains](<07 🪣🎭 Dataset role.md>).
