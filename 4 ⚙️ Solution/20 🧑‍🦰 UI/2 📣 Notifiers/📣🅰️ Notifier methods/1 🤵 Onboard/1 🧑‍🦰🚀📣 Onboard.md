...
* Used in [Onboard 🧑‍🦰👉🤵](<../../../1 🧑‍🦰 Wallets/🧑‍🦰💬 Wallet chats/in 🏠 Home/🧑‍🦰💬🤵 Onboard.md>) to register the channel between the [Notifier 📣 domain](<../../📣👥 Notifier domain.md>) and the [Wallet 🧑‍🦰 apps](<../../../1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) (e.g., sockets). 
