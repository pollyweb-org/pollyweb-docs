...
1. **What are examples of Schema Codes?**
    ...
    | [`unicode.org/FLAG` 🧩](<../../../8 📜 Manifests/👥 any-igo.org/📜 unicode.any-igo.org.md>) | Flags for country [Prompts 🤔](<../13 🤔 Prompts/01 🤔 Prompt.md>)
    | [`locale.org/TERRITORY` 🧩](<../../../8 📜 Manifests/👥 any-igo.org/📜 locale.any-igo.org.md>) | Country names for [Prompts 🤔](<../13 🤔 Prompts/01 🤔 Prompt.md>)
