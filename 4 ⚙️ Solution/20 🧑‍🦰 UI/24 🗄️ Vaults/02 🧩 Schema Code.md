...
1. **What does it mean when a YAML content starts with 🤝?**
    ...
    * e.g., `🤝:` [`.MANIFEST/CODE`](<../../40 👥 Domains/44 📜 Manifests/11 🧩 CODE code.md>)
...
1. **How do define a Schema in a Manifest?**
    ...
    | Schema | Description
    |-|-
    | [`.MANIFEST/CODE` 🧩](<../../40 👥 Domains/44 📜 Manifests/11 🧩 CODE code.md>) | CODE properties
    | [`.MANIFEST/CODE/SCHEMA` 🧩](<../../40 👥 Domains/44 📜 Manifests/12 🧩 SCHEMA code.md>) | CODE/SCHEMA properties
    | [`.MANIFEST/DELEGATE` 🧩](<../../40 👥 Domains/44 📜 Manifests/13 🧩 DELEGATE code.md>) | Delegation to other [Authorities 🏛️](<../../40 👥 Domains/43 👍 Trusts/02 🏛️🛠️ Authority helper.md>)
...
1. **Are NLWeb Schema definitions compatible with JSON Schema?**
    ...
    - Details are available at [`nlweb.org/MANIFEST/CODE/SCHEMA` 🧩](<../../40 👥 Domains/44 📜 Manifests/12 🧩 SCHEMA code.md>).
...
1. **Can a Schema inherit from another Schema?**
    ...
    * Using the `Inherits` property
        * defined in [`.MANIFEST/CODE/SCHEMA` 🧩](<../../40 👥 Domains/44 📜 Manifests/12 🧩 SCHEMA code.md>).
...
1. **Can a Schema reference a specific property of another Schema?**
    ...
    Yes.
    * See [`.MANIFEST/TRUST` 🧩](<../../40 👥 Domains/44 📜 Manifests/17 🧩 TRUST code.md>)
