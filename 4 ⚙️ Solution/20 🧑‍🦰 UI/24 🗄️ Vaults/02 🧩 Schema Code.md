...
1. **How do define a Schema in a Manifest?**
    ...
    | [`.MANIFEST/CODE/SCHEMA` 🧩](<../../40 👥 Domains/44 📜 Manifests/12 🧩 SCHEMA schema.md>) | CODE/SCHEMA properties
...
1. **Are NLWeb Schema definitions compatible with JSON Schema?**
    ...
    - Details are available at [`nlweb.org/MANIFEST/CODE/SCHEMA` 🧩](<../../40 👥 Domains/44 📜 Manifests/12 🧩 SCHEMA schema.md>).
...
1. **Can a Schema inherit from another Schema?**
    ...
    * Using the `Inherits` property
        * defined in [`.MANIFEST/CODE/SCHEMA` 🧩](<../../40 👥 Domains/44 📜 Manifests/12 🧩 SCHEMA schema.md>).
...
1. **Can a Schema reference another Schema?**
    ...
    * as defined in [`.MANIFEST/CODE/SCHEMA` 🧩](<../../40 👥 Domains/44 📜 Manifests/12 🧩 SCHEMA schema.md>).
