...
1. **What are examples of Agent roles?**
    ...
    |-|-|-
    | [Concierge 🛎️](<../../30 🫥 Agents/06 🛎️ Concierges/01 🛎️🫥 Concierge agent.md>) | TaskRabbit | Orchestrates tasks with 3rd parties (e.g., deliveries, repairs).
    ...
    | [Navigator 🧭](<../../30 🫥 Agents/07 🧭 Navigators/05 🧭🫥 Navigator agent.md>) | G.Maps | Helps users going from point A to B.
    | [Payer 💳](<../../30 🫥 Agents/04 💳 Payers/02 💳🎭 Payer role.md>) | Paypal | Performs payments to [Collector 🏦 domains](<../../30 🫥 Agents/01 📦 Storage/03 🏦🛠️ Collector helper.md>).
    ...
    | [Scheduler 🗓️](<../../30 🫥 Agents/38 🕓 User Timeline/04 🗓️🗄️ Scheduler agent.md>) | Outlook | Monitors and manages the user's agenda.
