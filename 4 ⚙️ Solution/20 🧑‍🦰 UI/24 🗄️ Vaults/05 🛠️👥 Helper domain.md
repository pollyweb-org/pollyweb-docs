...
2. **What are examples of Helper domains?**
    ...
    | [🤵 Broker](<../03 🤵 Brokers/03 🤵 Broker domain.md>) | WhatsApp | Orchestrates [Chats](<../05 💬 Chats/01 💬 Chat.md>) between [Wallet 🧑‍🦰 apps](<../01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) and [Host 🤗 domains](<../05 💬 Chats/04 🤗🎭 Host role.md>).
    ...
    | [🖨️ Printer](<../../70 🌳 Ambient/71 💠 Brand Things/08 🖨️🏭 Printer helper.md>) | - | Prints [NFC/QR Locators 🔆](<../04 🔆 Locators/01 🔆 Locator.md>) on behalf of [Brand 🍏](<../../70 🌳 Ambient/71 💠 Brand Things/07 🍏🎭 Brand role.md>) and [Host 🤗](<../05 💬 Chats/04 🤗🎭 Host role.md>) domains.
    | [🛰️ Relayer](<../../60 🧰 Edge/61 🔌 Pluggables/04 🛰️🛠️ Relayer helper.md>)
    | [🪄 Wand](<../../70 🌳 Ambient/71 💠 Brand Things/09 🪄🛠️ Wand helper.md>) | - | Manages [Chats 💬](<../05 💬 Chats/01 💬 Chat.md>) for [Things 💠](<../../70 🌳 Ambient/71 💠 Brand Things/01 💠 Thing.md>) on behalf of [Brand 🍏 domains](<../../70 🌳 Ambient/71 💠 Brand Things/07 🍏🎭 Brand role.md>).
