...
2. **What are examples of Helper domains?**
    ...
    | [🖨️ Printer](<../../70 🌳 Ambient/71 💠 Brand Things/08 🖨️🏭 Printer helper.md>) | - | Prints [NFC/QR Locators 🔆](<../04 🔆 Locators/01 🔆 Locator.md>) on behalf of [Brand 🍏](<../../70 🌳 Ambient/71 💠 Brand Things/07 🍏🎭 Brand role.md>) and [Host 🤗](<../12 💬 Chats/04 🤗🎭 Host role.md>) domains.
