...
1. **What roles do Helpers implement?**
    ...
    | [🗄️ Vault](<../24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) | To store user profiles with [`.HOST/PROFILE` 🧩](<../../../7 🧩 Codes/HOST/🧩 HostBindSelf.md>)
...
1. **What does the registration Chat look like?**
    ...
    | 🤵 [Broker](<../03 🤵 Brokers/03 🤵 Broker domain.md>) | 🫥 [Bind?](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/30 👉🔗 Binds/02 🧑‍🦰👉🗄️ Bind 🔗.md>) [Yes, No, +]<br/>- [Host Profile 🧩](<../../../7 🧩 Codes/HOST/🧩 HostBindSelf.md>) | > Yes 
