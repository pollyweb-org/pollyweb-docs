...
1. **How do users change between Wallet providers?**
    ...
    If both the old and the new [Wallet 🧑‍🦰 app](<🧑‍🦰🛠️ Wallet app.md>) providers use the same [Broker 🤵 domain](<../Brokers 🤵/🤵🤲 Broker helper.md>), 
...
1. **What if an attacker intercepts a user's recovery QR Token?**
    ...
    When a migration QR is used on a new [Wallet 🧑‍🦰 app](<🧑‍🦰🛠️ Wallet app.md>), the [Broker 🤵 domain](<../Brokers 🤵/🤵🤲 Broker helper.md>) notifies the old Wallet, allowing legitimate owners to block the attack and destroy the QR. 
...
1. **What workflows can users execute in a Wallet app?**
    ...
    | | [👉 Translate](<🧑‍🦰💬 Wallet in App 🏠/...in App 🏠/💬🤵 Translate.md>)  | Change the language of the [Wallet 🧑‍🦰](<🧑‍🦰🛠️ Wallet app.md>)
    | 🔆 Locators |[👉 Host QR](<🧑‍🦰💬 Wallet in App 🏠/...in App 🏠/🔆🤗 Tap host locator.md>)  | Scan a [Host 🤗 NFC/QR](<../../41 🎭 Domain Roles/Hosts 🤗/🤗🎭 Host role.md>)   to open a [Chat 💬](<../../35 💬 Chats/💬 Chats/💬 Chat.md>)
    ||[👉 Printer QR](<🧑‍🦰💬 Wallet in App 🏠/...in App 🏠/🔆🖨️ Tap alias locator.md>)  | Scan a [Printer 🖨️ NFC/QR](<../../45 🤲 Helper domains/Printers 🖨️/🖨️🤲 Printer helper.md>) to open a [Chat 💬](<../../35 💬 Chats/💬 Chats/💬 Chat.md>)
    |💬 Chats|[👉 Chats](<🧑‍🦰💬 Wallet in App 🏠/...in App 🏠/💬🤵 List Chats 💬.md>) | List the user's [Chats 💬](<../../35 💬 Chats/💬 Chats/💬 Chat.md>) 
    ||[👉 Home](<🧑‍🦰💬 Wallet in App 🏠/...in Chats 💬/💬🤵 Host home.md>) | Show the [Host's 🤗 ](<../../41 🎭 Domain Roles/Hosts 🤗/🤗🎭 Host role.md>) menu in a [Chat 💬](<../../35 💬 Chats/💬 Chats/💬 Chat.md>)
    ||[👉 Abandon](<🧑‍🦰💬 Wallet in App 🏠/...in Chats 💬/💬🤵 Abandon 💬.md>) | Unilaterally abandon a [Chat 💬](<../../35 💬 Chats/💬 Chats/💬 Chat.md>)
    | 🔗 Binds | [👉 Binds ](<🧑‍🦰💬 Wallet in App 🏠/...in App 🏠/💬🤵 List Binds 🔗.md>) | List the user's [Binds 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>)
    ...
    |🎫 Tokens| [👉 Tokens](<🧑‍🦰💬 Wallet in App 🏠/...in App 🏠/💬🤵 List Tokens 🎫.md>)| List the user's [Tokens 🎫](<../../30 🧩 Data/Tokens 🎫/🎫 Token.md>)
    ...
    || [👉 Share](<🧑‍🦰💬 Wallet in Prompts 🤔/👉💼 Share Token 🎫.md>) | Share a [Token 🎫](<../../30 🧩 Data/Tokens 🎫/🎫 Token.md>) with a [Consumer 💼](<../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>)
    || [👉 Verify ID](<🧑‍🦰💬 Wallet in Prompts 🤔/👉💼 Share Token+ID.md>) | Share and [verify the user Identity 🆔](<../../50 🫥 Agent domains/Identities 🆔/🆔⏩ Identity flows/3 🆔⏩🎫 Verify Tokens.md>)
