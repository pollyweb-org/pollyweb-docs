...
|#| Step | Purpose
|-|-|-
|1| [💼🐌🤵 `Query@Broker`](<../../../Brokers 🤵/🤵🅰️ Broker methods/6 ...for Share 💼/Query/💼🐌🤵 Query.md>) | Ask for user data in specific [Schema Codes 🧩](<../../../../30 🧩 Data/Codes 🧩/🧩 Schema Code.md>)
...
|5| [🤵🐌📣 `Share@Notifier`](<../../../Notifiers 📣/📣🅰️ Notifier methods/4 🎫 Tokens/2 🤵🐌📣 Share.md>) | Proxy the share order to the [Wallet 🧑‍🦰 app](<../../🧑‍🦰🛠️ Wallet app.md>)
