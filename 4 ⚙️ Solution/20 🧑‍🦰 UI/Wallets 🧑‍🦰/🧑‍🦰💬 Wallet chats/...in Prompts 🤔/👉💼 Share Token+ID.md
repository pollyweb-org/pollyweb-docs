...
|3|[💼🐌🤵 `Invite@Broker`](<../../../Brokers 🤵/🤵🅰️ Broker methods/6 ...for Share 💼/💼🐌🤵 Invite.md>)|Invite the [Identity 🆔](<../../../../50 🫥 Agent domains/Identities 🆔/🆔🫥 Identity agent.md>) to the [Chat 💬](<../../../../35 💬 Chats/💬 Chats/💬 Chat.md>)
...
1. **What does the Invite@Broker call look like?**
    ...
    Consider the following example payload to  [`Invite@Broker`](<../../../Brokers 🤵/🤵🅰️ Broker methods/6 ...for Share 💼/💼🐌🤵 Invite.md>).
