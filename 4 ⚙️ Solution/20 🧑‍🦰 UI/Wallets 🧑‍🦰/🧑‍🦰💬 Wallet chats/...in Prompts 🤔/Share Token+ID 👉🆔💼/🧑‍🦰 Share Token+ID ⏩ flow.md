...
1. **Why do we need to get the user's approval?**
    ...
    Users expect to have only their own [Vaults 🗄️ domains](<../../../../../41 🎭 Domain Roles/Vaults 🗄️/🗄️🎭 Vault role.md>) on the [Chat 💬](<../../../../../35 💬 Chats/Chats 💬/💬 Chat.md>), apart from the [Host 🤗 domain](<../../../../../41 🎭 Domain Roles/Hosts 🤗/🤗 Host role/🤗🎭 Host role.md>) and the [Broker 🤵 domain](<../../../../Brokers 🤵/🤵🤲 Broker helper.md>).
