...
1. **What workflows can users execute in a Wallet app?**
    ...
    | 🔗 Binds |  [👉 Bind](<../🧑‍🦰💬 Wallet chats/...in Prompts 🤔/Bind 👉🗄️🔗/🧑‍🦰 Bind Vault ⏩ flow.md>) | [Bind 🔗](<../../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) the [Wallet 🧑‍🦰](<🧑‍🦰 Wallet 🛠️ app.md>) to a [Vault 🗄️](<../../../41 🎭 Domain Roles/Vaults 🗄️/🗄️🎭 Vault role.md>)
