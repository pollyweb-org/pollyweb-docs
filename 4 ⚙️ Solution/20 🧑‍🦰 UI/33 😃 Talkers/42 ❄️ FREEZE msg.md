...
1. **What is a FREEZE command?**
    ...
    * that freezes all previous [non-blocking Prompts 🤔](<../31 🤔 Prompts/08 🤔⚠️ with Status behavior.md>)
...
1. **What's an example for FREEZE?**
    ...
    | 👍 [`CONFIRM`](<../31 🤔 Prompts/19 👍 CONFIRM prompt.md>) | Pause to allow changing previous inputs.
