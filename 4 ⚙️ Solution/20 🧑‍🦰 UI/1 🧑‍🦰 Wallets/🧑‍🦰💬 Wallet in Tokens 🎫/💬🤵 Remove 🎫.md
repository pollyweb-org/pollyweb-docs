...
| # | API | Description
|-|-|-
| 1 | [🧑‍🦰🐌🤗 `Home@Host`](<../../../41 🎭 Domain Roles/Hosts 🤗/🤗🅰️ Host methods/🤵🐌🤗 Home.md>) | The user calls the [Broker 🤵](<../../Brokers 🤵/🤵🤲 Broker helper.md>) from the [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>)
...
| 4 | [🤵🐌📣 `Remove@Notifier`](<../../2 📣 Notifiers/📣🅰️ Notifier methods/4 🎫 Tokens/3 🤵🐌📣 Remove.md>) | The [Broker 🤵](<../../Brokers 🤵/🤵🤲 Broker helper.md>) tells the [Wallet 🧑‍🦰](<../🧑‍🦰🛠️ Wallet app.md>) to remove it
||
