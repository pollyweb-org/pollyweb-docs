...
The associated [Talker 😃](<../../../35 💬 Chats/😃 Talkers/😃 Talker.md>) uses the [`OFFER`](<../../../35 💬 Chats/😃 Talkers/😃📨 Talker msgs/OFFER 🎫 msg.md>) command.
...
|2| [🎴🐌🤵 `Offer@Broker`](<../../3 🤵 Brokers/🤵🅰️ Broker methods/5 🤵🅰️ Tokens 🎫/🎴🐌🤵 Offer.md>) | In the [Chat 💬](<../../../35 💬 Chats/💬 Chats/💬 Chat.md>), [Issuers 🎴](<../../../41 🎭 Domain Roles/Issuers 🎴/🎴🎭 Issuer role.md>) offer a [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>)
...
| 5 | [🤵🐌📣 `Save@Notifier`](<../../2 📣 Notifiers/📣🅰️ Notifier methods/4 🎫 Tokens/1 🤵🐌📣 Save.md>) | [Brokers 🤵](<../../3 🤵 Brokers/🤵🤲 Broker helper.md>) send the [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>) ID
...
1. **Why the extra step to download the Token?**
    ...
    `Privacy` [Tokens 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>) are not proxied via the [Broker 🤵 domain](<../../3 🤵 Brokers/🤵🤲 Broker helper.md>) to protect user's privacy.    
    ...
    * Accepted [Tokens 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>) are stored locally, and only the path is sent to the [Broker 🤵 domain](<../../3 🤵 Brokers/🤵🤲 Broker helper.md>).
