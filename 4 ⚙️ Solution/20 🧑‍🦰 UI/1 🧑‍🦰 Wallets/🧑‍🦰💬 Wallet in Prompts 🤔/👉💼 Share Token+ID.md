...
1. **Why do we need to get the user's approval?**
    ...
    * If the [Identity 🆔 vault](<../../../50 🫥 Agent domains/Identities 🆔/🆔🫥 Identity agent.md>) referenced by the [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>) is listed as a user [Bind 🔗](<../../../30 🧩 Data/2 🔗 Binds/🔗 Bind.md>), then no approval is required.
