...
1. **What workflows can users execute in a Wallet app?**
    ...
    |🎫 Tokens| [👉 Tokens](<🧑‍🦰💬 Wallet in App 🏠/🧑‍🦰💬🤵 List Tokens 🎫.md>)| List the user's [Tokens 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>)
    || [👉 Save](<🧑‍🦰💬 Wallet in Prompts 🤔/🧑‍🦰👉🎴 Save token.md>) | Save a [Token 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) in the [Wallet 🧑‍🦰](<🧑‍🦰🛠️ Wallet app.md>)
    || [👉 Remove](<🧑‍🦰💬 Wallet in Tokens 🎫/🧑‍🦰💬🤵 Remove 🎫.md>) | Remove a [Token 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) from the [Wallet 🧑‍🦰](<🧑‍🦰🛠️ Wallet app.md>)
    || [👉 Share](<🧑‍🦰💬 Wallet in Prompts 🤔/🧑‍🦰👉💼 Share Token 🎫.md>) | Share a [Token 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) with a [Consumer 💼](<../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>)
