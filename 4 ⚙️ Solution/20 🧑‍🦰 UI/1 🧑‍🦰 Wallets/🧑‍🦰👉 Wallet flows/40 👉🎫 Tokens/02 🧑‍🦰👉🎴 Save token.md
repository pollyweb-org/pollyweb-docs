...
| 6 | [🧑‍🦰🚀🎴 `Issued@Issuer`](<../../../../41 🎭 Domain Roles/Issuers 🎴/🎴🅰️ Issuer methods/🧑‍🦰🚀🎴 Issued.md>) | [Wallets 🧑‍🦰](<../../🧑‍🦰 Wallet app.md>) download it and save it
...
1. **Why the extra step to download the Token?**
    ...
    * Instead, [Wallet 🧑‍🦰 apps](<../../🧑‍🦰 Wallet app.md>) download the [Token 🎫](<../../../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) directly from [Issuer 🎴 domain](<../../../../41 🎭 Domain Roles/Issuers 🎴/🎴🎭 Issuer role.md>).
