...
|[`OnPopLocalize` 🔔 handler](<../../../🤵🔆 Broker locators/PopWallet 🔆/Wallet » Localize/🤵 PopWalletLocalize 🔆 handler.md>)| Sets the language on [`Broker.Wallets`](<../🪣 Wallets/🤵 Broker.Wallets 🪣 table.md>)
