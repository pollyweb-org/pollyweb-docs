...
* [`OnSchemaLocalized` 🔔 handler](<../../Schemas 🧩 table/🪣🔔 Localized/🤵 OnSchemaLocalized 🔔 handler.md>)
...
|[`OnFrontendAltered` 🔔 handler](<../../Frontend 📱 table/🪣🔔 Altered/🤵 OnFrontendAltered 🔔 handler.md>)| Calls the [`Updated@Notifier` 🐌 msg](<../../../../Notifiers 📣/📣📨 Notifier msgs/Wallets 🧑‍🦰 Updated 🤵🐌📣/📣 Updated 🐌 msg.md>)
