...
|[`OnTokenLocalized` 📃 handler](<../🪣🧱 31 Localized 🔔 event/🤵 OnTokenLocalized 🔔 handler.md>) | Localizes a single item in [`Broker.Tokens`](<../🪣 Tokens/🤵 Broker.Tokens 🪣 table.md>)
|[`OnTokenAltered` 📃 handler](<../🪣🧱 21 Altered 🔔 event/🤵 OnTokenAltered 🔔 handler.md>)| [Script 📃](<../../../../../35 💬 Chats/Scripts 📃/Script 📃.md>) that updates the Frontend table
