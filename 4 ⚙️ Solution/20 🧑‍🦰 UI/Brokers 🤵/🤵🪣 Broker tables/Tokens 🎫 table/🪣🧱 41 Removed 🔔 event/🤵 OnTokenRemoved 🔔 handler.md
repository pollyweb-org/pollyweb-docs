...
> Part of the [`Broker.Tokens.Remove` ⏩ flow](<../🪣🧱 40 Remove ⏩ flow/🤵 Broker.Tokens.Remove ⏩ flow.md>)
...
- SEND:
    ...
    Body:
        Issuer: $Token.Issuer.Require
        Path: $Token.Path.Require
```
...
| [Messages 📨](<../../../../../30 🧩 Data/Messages 📨/📨 Message/📨 Message.md>) | [`Removed@Issuer` 📨 msg](<../../../../../41 🎭 Domain Roles/Issuers 🎴/🎴📨 Issuer msgs/Removed 🤵🐌🎴/🎴 Removed 🐌 msg.md>) <br/> [`Remove@Notifier` 📨 msg](<../../../../Notifiers 📣/📣📨 Notifier msgs/Tokens 🎫 Remove 🤵🐌📣/📣 Remove 🐌 msg.md>)
|