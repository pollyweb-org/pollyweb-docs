...
|[`OnPopLocalize` 🔔 handler](<../../../🤵🔆 Broker locators/PopWallet 🔆/Wallet » Localize/🤵 PopWalletLocalize 🔆 handler.md>)| Localizes the [`Broker.Wallets` 🪣 table](<../../Wallets 🧑‍🦰 table/🪣 Wallets/🤵 Broker.Wallets 🪣 table.md>)
