...
> Assumes `$wallet` and `$locator` placeholders from the [`Assess` 📃 script](<../../Assess 🔆/.📎 Assets/Assess 📃 handler.md>).

> Continues from the [`Assess` 📃 script](<../../Assess 🔆/.📎 Assets/Assess 📃 handler.md>)
...
> Continues on [`UpdateChats` 📃 script](<../../Update Chats 💬/.📎 Assets/Update Chats 📃 script.md>)
...
| [Scripts 📃](<../../../../../35 💬 Chats/😃 Talkers/😃⚙️ Talker cmds/...commands ⌘/Script 📃/📃 Script.md>) |[`UpdateChats`](<../../Update Chats 💬/.📎 Assets/Update Chats 📃 script.md>)
