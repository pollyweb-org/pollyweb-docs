...
| # | API | Description |
|-|-|-
| 1 | [👥🚀🕸 `Translate@Graph`](<../../../../45 🤲 Helper domains/Graphs 🕸/🕸🅰️ Graph methods/👥🚀🕸 Translate/🕸 Translate 🚀 request.md>) | The [Broker 🤵](<../../🤵 Broker helper/🤵 Broker 🤲 helper.md>) translates into the user's language
