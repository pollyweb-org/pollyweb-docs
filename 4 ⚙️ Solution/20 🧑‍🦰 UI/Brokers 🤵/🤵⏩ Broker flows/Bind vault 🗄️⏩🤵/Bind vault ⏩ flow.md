...
| # | API | Description |
|-|-|-
| 1 | [👥🚀🕸 `Translate@Graph`](<../../../../45 🤲 Helper domains/Graphs 🕸/🕸🅰️ Graph methods/👥🚀🕸 Translate.md>) | The [Broker 🤵](<../../🤵 Broker helper/🤵 Broker 🤲 helper.md>) translates into the user's language
...
| 4 | [🤵⏩🧑‍🦰 Update Binds 🔗](<../Update Binds 🤵⏩🔗/🤵 Update Binds ⏩ flow.md>) | [Brokers 🤵](<../../🤵 Broker helper/🤵 Broker 🤲 helper.md>) asks [Wallets 🧑‍🦰](<../../../Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰🛠️ Wallet app.md>) to update the [Binds 🔗](<../../../../30 🧩 Data/Binds 🔗/🔗 Bind.md>)
||