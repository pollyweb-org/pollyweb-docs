...
1. **What API methods does a Broker expose?**
    ...
    | | [🧑‍🦰🐌 Pop](<../🤵📨 Broker msgs/Wallets 🧑‍🦰 Pop 🧑‍🦰🐌🤵/🤵 Pop 🐌 msg.md>) | Summons the [Broker 🤵](<🤵 Broker 🤲 helper.md>) for help 
    ...
    | | [🧑‍🦰🚀 Chats](<../🤵📨 Broker msgs/Wallets 🧑‍🦰 Frontend 🧑‍🦰🚀🤵/🤵 Frontend 🚀 call.md>) | Fetch [Chats 💬](<../../../35 💬 Chats/Chats 💬/💬 Chat.md>) from the [Broker 🤵](<🤵 Broker 🤲 helper.md>)
    ...
    | |[🔎🐌 Presented](<../🤵📨 Broker msgs/Chats 💬 Presented 🔎🐌🤵/🤵 Presented 🐌 msg.md>) | A [Finder 🔎 domain](<../../../50 🫥 Agent domains/Finders 🔎/🔎 Finder agent/🔎 Finder 🫥 agent.md>) finished the intro
