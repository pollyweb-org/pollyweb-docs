...
1. **What API methods does a Broker expose?**
    ...
    | |[🔎🐌 Introduced](<../🤵🅰️ Broker methods/Chats 💬 Introduced 🔎🐌🤵/🤵 Introduced 🐌 msg.md>) | A [Finder 🔎 domain](<../../../50 🫥 Agent domains/Finders 🔎/🔎 Finder agent/🔎🫥 Finder agent.md>) finished the intro
