...
1. **How do Brokers work?**
    ...
    |4| `Bye`    | The [user's Broker 🤵 domain](<🤵 Broker 🤲 helper.md>) forwards the [Messages 📨](<../../../30 🧩 Data/Messages 📨/📨 Message/📨 Message.md>) to the [user's Notifier 📣 domain](<../../Notifiers 📣/📣 Notifier domain/📣 Notifier 👥 domain.md>), to be pushed to the [Wallet 🧑‍🦰 app](<../../Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>).
...
1. **Who migrates users between phones - Brokers or Notifiers?**
    ...
    Given that [Wallet 🧑‍🦰 apps](<../../Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>) and [Notifier 📣 domains](<../../Notifiers 📣/📣 Notifier domain/📣 Notifier 👥 domain.md>) contain only minimum-to-no data, the migration of a user between and old and a new phone needs to be done by [Broker 🤵 domains](<🤵 Broker 🤲 helper.md>).
...
1. **Why aren't Brokers and Notifiers the same domain?**
    ...
    * These startups can then focus on the [Wallet 🧑‍🦰 app](<../../Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>) and [Notifier 📣 domain](<../../Notifiers 📣/📣 Notifier domain/📣 Notifier 👥 domain.md>) to create great frontend user experiences.
...
1. **How do Brokers ensure Wallets are NLWeb compliant?**
    ...
    [Broker 🤵 domains](<🤵 Broker 🤲 helper.md>) are responsible for testing the compliance of [Wallet 🧑‍🦰 apps](<../../Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>) and [Notifier 📣 domains](<../../Notifiers 📣/📣 Notifier domain/📣 Notifier 👥 domain.md>) by performing a set of automated tests before allowing new Wallet versions to be used.
...
1. **What API methods does a Broker expose?**
    ...
    |-|-|-
    |[`🧑‍🦰 Setup`](<../../Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>)| [📣🚀 Onboard](<../🤵🅰️ Broker methods/Wallets 🧑‍🦰 Onboard 📣🚀🤵/🤵 Onboard 🚀 request.md>) | Onboard a [Wallet 🧑‍🦰 app](<../../Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>)
    |  | [🧑‍🦰🐌 Translate](<../🤵🅰️ Broker methods/Wallets 🧑‍🦰 Language 🧑‍🦰🐌🤵/🤵 Language 🐌 msg.md>) | Change the language of a [Wallet 🧑‍🦰](<../../Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>)
    ...
    |[`🔗 Binds`](<../../../30 🧩 Data/Binds 🔗/🔗 Bind.md>)| [🧑‍🦰🚀 Binds](<../🤵🅰️ Broker methods/Binds 🔗 Binds 🧑‍🦰🚀🤵/🤵 Binds 🚀 request.md>) | List the [Binds 🔗](<../../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) of a [Wallet 🧑‍🦰 app](<../../Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>)
    ...
    | [`🎫 Tokens`](<../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) | [🧑‍🦰🚀 Tokens](<../🤵🅰️ Broker methods/Tokens 🎫 Tokens 🧑‍🦰🚀🤵/🤵 Tokens 🚀 request.md>) | List of [Tokens 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) of a [Wallet 🧑‍🦰 app](<../../Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>)
    ...
    || [🧑‍🦰🐌 Saved](<../🤵🅰️ Broker methods/Tokens 🎫 Saved 🧑‍🦰🐌🤵/🤵 Saved 🐌 msg.md>) | A [Wallet 🧑‍🦰](<../../Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>) saved a [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) locally
