...
|| `Language` |text| For the [`.Translate`](<../../../../37 Scripts 📃/📃 Functions 🐍/🐍 System 🔩 functions/Translate ⓕ.md>) function | [`Language@`](<../Wallets 🧑‍🦰 Localize 🧑‍🦰🐌🤵/🤵 Language 🐌 msg.md>) | [`Prompt@`](<../Chats 💬 Prompt 🤗🐌🤵/🤵 Prompt 🐌 msg.md>)
