...
|| `Timezone`|text| For [`.Now`](<../../../../37 Scripts 📃/📃 Functions 🐍/🐍 System 🔩 functions/time/Now ⓕ.md>) and [`.Today`](<../../../../37 Scripts 📃/📃 Functions 🐍/🐍 System 🔩 functions/time/Today ⓕ.md>)  
|| `Language` |text| For the [`.Translate`](<../../../../37 Scripts 📃/📃 Holders 🧠/Text 📚 holders/Translate ⓕ.md>) function | [`Language@`](<../Wallets 🧑‍🦰 Language 🧑‍🦰🐌🤵/🤵 Language 🐌 msg.md>) | [`Prompt@`](<../Chats 💬 Prompt 🤗🐌🤵/🤵 Prompt 🐌 msg.md>)
