...
1. **Why are the schema and timestamp properties for?**
    ...
    `Share`| When [Broker 🤵 domains](<../../../🤵🤲 Broker helper.md>) answer a [Query@Broker](<../../...for Share 💼/Query 💼🐌🤵/Query 🐌 msg.md>) call, they need to filter only the active [Tokens 🎫](<../../../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>) of a certain [Schema 🧩](<../../../../../30 🧩 Data/Codes 🧩/🧩 Schema Code.md>)  within a version interval to be shared.
    |
