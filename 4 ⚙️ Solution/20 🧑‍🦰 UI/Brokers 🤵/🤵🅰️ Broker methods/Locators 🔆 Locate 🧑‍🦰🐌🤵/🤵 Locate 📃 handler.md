...
[Scripts 📃](<../../../../35 💬 Chats/Scripts 📃/Script 📃.md>) | [`Resolve Alias` 📃 script](<📃 Resolve Alias/🤵 Resolve Alias 📃 script.md>)  <br/> [`Call Introduce` 📃 script](<📃 Call Present/🤵 Call Present 📃 script.md>) <br/> [`Save Chat` 📃 script](<📃 Save Chat/🤵 Save Chat 📃 script.md>)
| 