...
> Implemented by [`Pop@Broker` 📃 script](<../../🤵📃 Broker scripts/...handlers/🤵📃 Pop 💬.md>)
...
| Body | `Hook` | uuid | `Hook` for [`Converse@Notifier`](<../../../Notifiers 📣/📣🅰️ Notifier methods/2 💬 Chats/1 🤵🐌📣 Converse.md>)
