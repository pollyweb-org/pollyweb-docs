...
> Implemented by [`Binds` 📃 script](<../../🤵📃 Broker scripts/...handlers/🤵📃 Binds 🔗.md>)

> Used in:
* [`Translate` 💬 chat](<../../../Wallets 🧑‍🦰/🧑‍🦰💬 Wallet in App 🏠/...in App 🏠/💬🤵 Translate.md>)
* [`List binds` 💬 chat](<../../../Wallets 🧑‍🦰/🧑‍🦰💬 Wallet in App 🏠/...in App 🏠/💬🤵 List Binds 🔗.md>)
