...
1. **Why are `Format` and `Emoji` the only Prompt properties provided?**
    ...
    For privacy reasons, [Broker 🤵 domains](<../../🤵🤲 Broker helper.md>) are not allowed to see the contents of [Prompts 🤔](<../../../../35 💬 Chats/Prompts 🤔/🤔 Prompt.md>) sent from [Host 🤗 domains](<../../../../41 🎭 Domain Roles/Hosts 🤗/🤗 Host role/🤗🎭 Host role.md>) to [Wallet 🧑‍🦰 apps](<../../../Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>).
