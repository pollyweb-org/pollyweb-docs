...
1. **What API methods does a Broker expose?**
    ...
    | | [🧑‍🦰🚀 Chats](<🤵🅰️ Broker methods/3 ...for Chats 💬/Chats 🧑‍🦰🚀🤵/Chats 🚀 request.md>) | Fetch [Chats 💬](<../../35 💬 Chats/💬 Chats/💬 Chat.md>) from the [Broker 🤵](<🤵🤲 Broker helper.md>)
    ...
    | |[🔎🐌 Introduced](<🤵🅰️ Broker methods/3 ...for Chats 💬/Introduced 🔎🐌🤵/Introduced 🐌 msg.md>) | A [Finder 🔎 domain](<../../50 🫥 Agent domains/Finders 🔎/🔎🫥 Finder agent.md>) finished the intro
    | |[🤗🐌 Goodbye](<🤵🅰️ Broker methods/3 ...for Chats 💬/Goodbye 🤗🐌🤵/Goodbye 🐌 msg.md>) | A [Host 🤗 domain](<../../41 🎭 Domain Roles/Hosts 🤗/🤗🎭 Host role.md>) ended the [Chat 💬](<../../35 💬 Chats/💬 Chats/💬 Chat.md>)
    | | [👀🐌 Promote](<🤵🅰️ Broker methods/2 ...for Locators 🔆/Promote/👀🐌🤵 Promote.md>) |  Check-in into the selected [Locator 🔆](<../../25 🔆 Locators/Locators 🔆/🔆 Locator.md>)
    | | [🧑‍🦰🐌 Join](<🤵🅰️ Broker methods/3 ...for Chats 💬/Join 🧑‍🦰🐌🤵/Join 🐌 msg.md>) | Ask for the [Broker 🤵](<🤵🤲 Broker helper.md>) to join a [Chat 💬](<../../35 💬 Chats/💬 Chats/💬 Chat.md>) 
    ...
    || [🗄️🐌 Bindable](<🤵🅰️ Broker methods/4 ...for Binds 🔗/Bindable 🗄️🐌🤵/🗄️🐌🤵 Bindable.md>) | [Vaults 🗄️](<../../41 🎭 Domain Roles/Vaults 🗄️/🗄️🎭 Vault role.md>) offer to bind [Schema Codes 🧩](<../../30 🧩 Data/Codes 🧩/🧩 Schema Code.md>)
