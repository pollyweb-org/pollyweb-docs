...
1. **What API methods does a Broker expose?**
    ...
    |[`🔗 Binds`](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>)| [🧑‍🦰🚀 Binds](<🤵🅰️ Broker methods/4 ...for Binds 🔗/Binds 🧑‍🦰🚀🤵/Binds 🚀 request.md>) | List the [Binds 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) of a [Wallet 🧑‍🦰 app](<../Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>)
