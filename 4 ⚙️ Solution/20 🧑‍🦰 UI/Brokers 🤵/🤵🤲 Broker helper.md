...
1. **What API methods does a Broker expose?**
    ...
    | |[🔎🐌 Introduced](<🤵🅰️ Broker methods/3 ...for Chats 💬/Introduced 🔎🐌🤵/Introduced 🅰️ method.md>) | A [Finder 🔎 domain](<../../50 🫥 Agent domains/Finders 🔎/🔎🫥 Finder agent.md>) finished the intro
    | |[🤗🐌 Goodbye](<🤵🅰️ Broker methods/3 ...for Chats 💬/Goodbye 🤗🐌🤵/Goodbye 🅰️ method.md>) | A [Host 🤗 domain](<../../41 🎭 Domain Roles/Hosts 🤗/🤗🎭 Host role.md>) ended the [Chat 💬](<../../35 💬 Chats/💬 Chats/💬 Chat.md>)
    ...
    | | [🧑‍🦰🐌 Join](<🤵🅰️ Broker methods/3 ...for Chats 💬/Join 🧑‍🦰🐌🤵/Join 🅰️ method.md>) | Ask for the [Broker 🤵](<🤵🤲 Broker helper.md>) to join a [Chat 💬](<../../35 💬 Chats/💬 Chats/💬 Chat.md>) 
