...
1. **What API methods does a Broker expose?**
    ...
    | |[🔎🐌 Introduced](<🤵🅰️ Broker methods/3 ...for Chats 💬/Introduced/🔎🐌🤵 Introduced.md>) | A [Finder 🔎 domain](<../../50 🫥 Agent domains/Finders 🔎/🔎🫥 Finder agent.md>) finished the intro
    | |[🤗🐌 Goodbye](<🤵🅰️ Broker methods/3 ...for Chats 💬/Goodbye/🤗🐌🤵 Goodbye.md>) | A [Host 🤗 domain](<../../41 🎭 Domain Roles/Hosts 🤗/🤗🎭 Host role.md>) ended the [Chat 💬](<../../35 💬 Chats/💬 Chats/💬 Chat.md>)
    | | [👀🐌 Promote](<🤵🅰️ Broker methods/2 ...for Locators 🔆/👀🐌🤵 Promote.md>) |  Check-in into the selected [Locator 🔆](<../../25 🔆 Locators/Locators 🔆/🔆 Locator.md>)
    | | [🧑‍🦰🐌 Join](<🤵🅰️ Broker methods/3 ...for Chats 💬/Join/🧑‍🦰🐌🤵 Join.md>) | Ask for the [Broker 🤵](<🤵🤲 Broker helper.md>) to join a [Chat 💬](<../../35 💬 Chats/💬 Chats/💬 Chat.md>) 
