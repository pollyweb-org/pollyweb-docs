...
1. **What is required from domain owners?**
    ...
    | Dependency | Purpose
    |-|-
    | [🧑‍🦰 Wallet](<../01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) | To authenticate and [Chat 💬](<../12 💬 Chats/01 💬 Chat.md>) with the [Hoster ☁️ ](<05 ☁️🛠️ Hoster helper.md>)
    | [💳 Payer](<../../30 🫥 Agents/04 💳 Payers/04 💳🫥 Payer agent.md>) | To pay for usage and subscription plans.
    | [🆔 Identity](<../../30 🫥 Agents/05 🆔 Identities/01 🆔🫥 Identity agent.md>) | To authenticate the domain user.
    | [🗂️ Folder](<../26 🗂️ Folders/01 🗂️ Folder editor.md>) | To manage the settings of the hosted [domain 👥](<../../40 👥 Domains/44 📜 Manifests/00 👥 Domain.md>).
...
1. **What domain files are cloned locally?**
    ...
    | 🔆 [Locators](<../11 🔆 Locators/01 🔆 Locator.md>) | YAML | Mapping of [Locators 🔆](<../11 🔆 Locators/01 🔆 Locator.md>) to [Talkers 😃](<../../../9 😃 Talkers/10 📘 Talker specs/01 😃 Talker.md>)
    | 😃 [Talkers](<../../../9 😃 Talkers/10 📘 Talker specs/01 😃 Talker.md>) | Folder | Tree of [💬 Chat](<../12 💬 Chats/01 💬 Chat.md>) scripts by [Locator 🔆](<../11 🔆 Locators/01 🔆 Locator.md>)
...
1. **What does the Locators file looks like?**
    ...
    The `🔆 Locators.yaml` file contains the mapping of [Locator 🔆 resources](<../11 🔆 Locators/01 🔆 Locator.md>) to [Talkers 😃](<../../../9 😃 Talkers/10 📘 Talker specs/01 😃 Talker.md>).
    ...
    * Note: only the `resource` part of each [Locator 🔆](<../11 🔆 Locators/01 🔆 Locator.md>) is required.
    ...
    The [Talker 😃](<../../../9 😃 Talkers/10 📘 Talker specs/01 😃 Talker.md>) files reside under the `Talkers/` folder.
...
1. **What are the API methods?**
    ...
    | Method | Purpose
    |-|-
    [🧑‍💻🚀👥 Evaluate](<../../../6 🅰️ APIs/51 🧑‍💻🅰️ Hosted/01 ☁️🚀🧑‍💻 Evaluate.md>) | Evaluates [{Functions}](<../../../9 😃 Talkers/30 💾 Talker data/12 🐍 {Function}.md>) in [Talkers 😃](<../../../9 😃 Talkers/10 📘 Talker specs/01 😃 Talker.md>)
    |