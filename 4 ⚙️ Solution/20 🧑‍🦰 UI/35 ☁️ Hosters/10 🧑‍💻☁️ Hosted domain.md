...
1. **What domain files are cloned locally?**
    ...
    | 🔆 [Locators](<../11 🔆 Locators/01 🔆 Locator.md>) | YAML | Mapping of [Locators 🔆](<../11 🔆 Locators/01 🔆 Locator.md>) to [Talkers 😃](<../../../9 😃 Talkers/01 😃 Talker.md>)
    | 😃 [Talkers](<../../../9 😃 Talkers/01 😃 Talker.md>) | Folder | Tree of [💬 Chat](<../12 💬 Chats/01 💬 Chat.md>) scripts by [Locator 🔆](<../11 🔆 Locators/01 🔆 Locator.md>)
...
1. **What does the Locators file looks like?**
    ...
    The `🔆 Locators.yaml` file contains the mapping of [Locator 🔆 resources](<../11 🔆 Locators/01 🔆 Locator.md>) to [Talkers 😃](<../../../9 😃 Talkers/01 😃 Talker.md>).
    ...
    * Note: only the `resource` part of each [Locator 🔆](<../11 🔆 Locators/01 🔆 Locator.md>) is required.
    ...
    The [Talker 😃](<../../../9 😃 Talkers/01 😃 Talker.md>) files reside under the `Talkers/` folder.
...
1. **What are the API methods?**
    ...
    | Method | Purpose
    |-|-
    [🧑‍💻🚀👥 Evaluate](<../../../6 🅰️ APIs/51 🧑‍💻🅰️ Hosted/01 ☁️🚀🧑‍💻 Evaluate.md>) | Evaluates [{Functions}](<../../../9 😃 Talkers/03 Talker Data/12 🐍 {Function}.md>) in [Talkers 😃](<../../../9 😃 Talkers/01 😃 Talker.md>)
    |