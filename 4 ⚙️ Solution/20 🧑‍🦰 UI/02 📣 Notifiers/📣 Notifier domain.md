...
1. **How do Notifier domains work?**
    ...
    |#|Step
    |-|-
    |1| A [Host 🤗 domain](<../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) sends a [Prompt 🤔 ](<../../35 Chats/20 🤔 Prompts/20 🤔 Prompt.md>) identifier to a [Broker 🤵 domain](<../../45 🤲 Helper domains/24 🤵 Brokers/🤵🤲 Broker helper.md>) in the context of a [Chat 💬](<../../35 Chats/12 💬 Chats/$ 💬 Chat.md>), which is then proxied through the [Notifier 📣 domain](<📣 Notifier domain.md>) and pushed to the [Wallet 🧑‍🦰 app](<../01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>).
    |2| The [Wallet 🧑‍🦰 app](<../01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) pulls the content of the [Prompt 🤔 ](<../../35 Chats/20 🤔 Prompts/20 🤔 Prompt.md>) using the identifier.
    |3| The user replies to the [Prompt 🤔 ](<../../35 Chats/20 🤔 Prompts/20 🤔 Prompt.md>) and the [Wallet 🧑‍🦰 app](<../01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) sends the answer to the [Host 🤗 domain](<../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>).
