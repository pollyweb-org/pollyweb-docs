...
1. **How do Notifier domains work?**
    ...
    |#|Step
    |-|-
    |1| A [Host 🤗 domain](<../12 💬 Chats/04 🤗🎭 Host role.md>) sends a [Prompt 🤔 ](<../../../9 😃 Talkers/10 📘 Talker specs/2 🤔 Prompt.md>) identifier to a [Broker 🤵 domain](<../03 🤵 Brokers/03 🤵 Broker domain.md>) in the context of a [Chat 💬](<../12 💬 Chats/01 💬 Chat.md>), which is then proxied through the [Notifier 📣 domain](<02 📣 Notifier domain.md>) and pushed to the [Wallet 🧑‍🦰 app](<../01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>).
    |2| The [Wallet 🧑‍🦰 app](<../01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) pulls the content of the [Prompt 🤔 ](<../../../9 😃 Talkers/10 📘 Talker specs/2 🤔 Prompt.md>) using the identifier.
    |3| The user replies to the [Prompt 🤔 ](<../../../9 😃 Talkers/10 📘 Talker specs/2 🤔 Prompt.md>) and the [Wallet 🧑‍🦰 app](<../01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) sends the answer to the [Host 🤗 domain](<../12 💬 Chats/04 🤗🎭 Host role.md>).
