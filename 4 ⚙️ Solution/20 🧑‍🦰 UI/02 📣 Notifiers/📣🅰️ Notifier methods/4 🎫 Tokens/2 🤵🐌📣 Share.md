...
> Sends [Tokens 🎫](<../../../../30 Data/🎫 Tokens/🎫 Token.md>) to a [Consumer 💼 domain](<../../../../41 🎭 Domain Roles/27 💼 Consumers/💼🎭 Consumer role.md>).
...
|| `ChatID` | string | [Chat 💬](<../../../../35 Chats/💬 Chats/💬 Chat.md>) ID from [`Query@Broker`](<../../../03 🤵 Brokers/🤵🅰️ Broker methods/6 🤵🅰️ Share/💼🐌🤵 Query.md>)
|| `Consumer` | string | [Consumer 💼](<../../../../41 🎭 Domain Roles/27 💼 Consumers/💼🎭 Consumer role.md>) from [ `Query@Broker`](<../../../03 🤵 Brokers/🤵🅰️ Broker methods/6 🤵🅰️ Share/💼🐌🤵 Query.md>)
| | `Tokens`  | string[] | Paths from [`Saved@Broker`](<../../../03 🤵 Brokers/🤵🅰️ Broker methods/5 🤵🅰️ Tokens 🎫/🧑‍🦰🐌🤵 Saved.md>)
|