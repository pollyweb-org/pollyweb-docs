...
|-|-|-|-
|Header|`From`|string | [Broker 🤵](<../../../Brokers 🤵/🤵🤲 Broker helper.md>) from [`Assess@Broker`](<../../../Brokers 🤵/🤵🅰️ Broker methods/2 ...for Locators 🔆/🧑‍🦰🐌🤵 Assess.md>)
...
|Body  |`Wallet` |uuid  | [Wallet 🧑‍🦰](<../../../Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>) from [`Assess@`](<../../../Brokers 🤵/🤵🅰️ Broker methods/2 ...for Locators 🔆/🧑‍🦰🐌🤵 Assess.md>) [`Pop@Broker`](<../../../Brokers 🤵/🤵📃 Broker scripts/...handlers/🤵📃 Pop 💬 handler.md>)
|       | `Hook`| uuid | `Hook` from [`Assess@`](<../../../Brokers 🤵/🤵🅰️ Broker methods/2 ...for Locators 🔆/🧑‍🦰🐌🤵 Assess.md>) [`Pop@Broker`](<../../../Brokers 🤵/🤵📃 Broker scripts/...handlers/🤵📃 Pop 💬 handler.md>)
