...
1. **What can a user do with a Wallet?**
    ...
    - 💬 [Chats](<../../35 Chats/12 💬 Chats/💬 Chat.md>): list, filter, search, view, and interact.
    ...
    - ✨ [Scan](<../../25 Locators/15 🔆 Locators/🔆⏩ Locator flows/🧑‍🦰✨ Wallet QR scan.md>) a QR [Locator 🔆](<../../25 Locators/15 🔆 Locators/🔆 Locator.md>) to open a [Chat 💬](<../../35 Chats/12 💬 Chats/💬 Chat.md>).
    - 🔆 [Tap](<../../25 Locators/15 🔆 Locators/🔆⏩ Locator flows/🧑‍🦰🔆 Wallet NFC tap.md>) an NFC [Locator 🔆](<../../25 Locators/15 🔆 Locators/🔆 Locator.md>) to open a [Chat 💬](<../../35 Chats/12 💬 Chats/💬 Chat.md>).
...
1. **What data exists in the device at any given time?**
    ...
    - 📣 The Wallet ID provided by the [Broker 🤵 domain](<../../45 🤲 Helper domains/24 🤵 Brokers/🤵🤲 Broker helper.md>) via the [Notifier 📣 domain](<../02 📣 Notifiers/📣 Notifier domain.md>);
...
1. **How do users change between Wallet providers?**
    ...
    If both the old and the new [Wallet 🧑‍🦰 app](<🧑‍🦰 Wallet app.md>) providers use the same [Broker 🤵 domain](<../../45 🤲 Helper domains/24 🤵 Brokers/🤵🤲 Broker helper.md>), 
    * then changing between Wallet providers in the same phone is very similar to migrating a Wallet to another phone. 
    
    If they use different [Broker 🤵 domains](<../../45 🤲 Helper domains/24 🤵 Brokers/🤵🤲 Broker helper.md>), 
    * then these Brokers will need to implement some sort of portability. 
     
    For simplicity, let's assume they use the same [Broker 🤵 domain](<../../45 🤲 Helper domains/24 🤵 Brokers/🤵🤲 Broker helper.md>).
...
1. **What if an attacker intercepts a user's recovery QR Token?**
    ...
    When a migration QR is used on a new [Wallet 🧑‍🦰 app](<🧑‍🦰 Wallet app.md>), the [Broker 🤵 domain](<../../45 🤲 Helper domains/24 🤵 Brokers/🤵🤲 Broker helper.md>) notifies the old Wallet, allowing legitimate owners to block the attack and destroy the QR. 
    
    * For situations where legitimate owners are not aware of notifications, migrations have a small grace period where [Broker 🤵 domains](<../../45 🤲 Helper domains/24 🤵 Brokers/🤵🤲 Broker helper.md>) inactivate both Wallets until the old Wallet accepts the transfer or the grace period expires.
...
1. **What workflows can users execute in a Wallet app?**
    ...
    |-|-|-
    | 🤵 Set up | [👉 Onboard](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/10 👉🤵 Set-up/11 🧑‍🦰👉🤵 Onboard.md>)  | Register the [Wallet 🧑‍🦰](<🧑‍🦰 Wallet app.md>) on a [Broker 🤵](<../../45 🤲 Helper domains/24 🤵 Brokers/🤵🤲 Broker helper.md>)
    | | [👉 Translate](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/10 👉🤵 Set-up/12 🧑‍🦰👉🤵 Translate.md>)  | Change the language of the [Wallet 🧑‍🦰](<🧑‍🦰 Wallet app.md>)
    | 🔆 Locators |[👉 Host QR](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/15 👉🔆 Locators/01 🧑‍🦰👉🤗 Scan host QR.md>)  | Scan a [Host 🤗 NFC/QR](<../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>)   to open a [Chat 💬](<../../35 Chats/12 💬 Chats/💬 Chat.md>)
    ||[👉 Printer QR](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/15 👉🔆 Locators/02 🧑‍🦰👉🤗 Scan printer QR.md>)  | Scan a [Printer 🖨️ NFC/QR](<../../45 🤲 Helper domains/75 🖨️ Printers/🖨️🤲 Printer helper.md>) to open a [Chat 💬](<../../35 Chats/12 💬 Chats/💬 Chat.md>)
    |💬 Chats|[👉 Chats](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/20 👉💬 Chats/01 🧑‍🦰👉🤵 List chats.md>) | List the user's [Chats 💬](<../../35 Chats/12 💬 Chats/💬 Chat.md>) 
    ||[👉 Home](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/20 👉💬 Chats/02 🧑‍🦰👉🤵 Host home.md>) | Show the [Host's 🤗 ](<../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) menu in a [Chat 💬](<../../35 Chats/12 💬 Chats/💬 Chat.md>)
    ||[👉 Abandon](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/20 👉💬 Chats/03 🧑‍🦰👉🤵 Abandon chat.md>) | Unilaterally abandon a [Chat 💬](<../../35 Chats/12 💬 Chats/💬 Chat.md>)
