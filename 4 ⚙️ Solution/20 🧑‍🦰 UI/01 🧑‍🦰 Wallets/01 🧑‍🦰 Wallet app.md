...
1. **What workflows can users execute in a Wallet app?**
    ...
    ||[👉 Printer QR](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/15 👉🔆 Locators/02 🧑‍🦰👉🤗 Scan printer QR.md>)  | Scan a [Printer 🖨️ NFC/QR](<../../45 Helpers/60 🖨️ Printers/$ 🖨️🏭 Printer helper.md>) to open a [Chat 💬](<../12 💬 Chats/01 💬 Chat.md>)
