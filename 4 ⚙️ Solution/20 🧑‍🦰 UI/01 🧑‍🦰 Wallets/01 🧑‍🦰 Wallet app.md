...
1. **What can a user do with a Wallet?**
    ...
    - 🔗 [Binds](<../../25 Data/24 🗄️ Vaults/01 🔗 Bind.md>): list, view, unbind, and chat with the bound [Vault 🗄️ domain](<../../25 Data/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>). 
...
1. **What workflows can users execute in a Wallet app?**
    ...
    || [👉 Bind](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/30 👉🔗 Binds/02 🧑‍🦰👉🗄️ Bind 🔗.md>) | [Bind 🔗](<../../25 Data/24 🗄️ Vaults/01 🔗 Bind.md>) the [Wallet 🧑‍🦰](<01 🧑‍🦰 Wallet app.md>) to a [Vault 🗄️](<../../25 Data/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>)
    || [👉 Unbind](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/30 👉🔗 Binds/03 🧑‍🦰👉🗄️ Unbind.md>) | Remove a [Bind 🔗](<../../25 Data/24 🗄️ Vaults/01 🔗 Bind.md>) from a [Vault 🗄️](<../../25 Data/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>)
    ||[👉 Share](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/30 👉🔗 Binds/04 🧑‍🦰👉💼 Share Bind 🔗.md>) | Shares a [Bind 🔗](<../../25 Data/24 🗄️ Vaults/01 🔗 Bind.md>) with a [Consumer 💼](<../../25 Data/27 💼 Consumers/04 💼🎭 Consumer role.md>)
    ...
    || [👉 Share](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/40 👉🎫 Tokens/04 🧑‍🦰👉💼 Share Token 🎫.md>) | Share a [Token 🎫](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/25 🎫 Tokens/01 🎫 Token.md>) with a [Consumer 💼](<../../25 Data/27 💼 Consumers/04 💼🎭 Consumer role.md>)
