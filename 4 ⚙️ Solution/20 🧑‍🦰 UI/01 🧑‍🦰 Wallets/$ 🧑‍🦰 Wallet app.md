...
1. **What data exists in the device at any given time?**
    ...
    - 📣 The Wallet ID provided by the [Broker 🤵 domain](<../03 🤵 Brokers/03 🤵 Broker domain.md>) via the [Notifier 📣 domain](<../02 📣 Notifiers/$ 📣 Notifier domain.md>);
...
1. **How do users migrate a Wallet to another phone?**
    ...
    * The [Broker 🤵 domain](<../03 🤵 Brokers/03 🤵 Broker domain.md>) will invoke the [Identity 🆔 domain](<../../30 🫥 Agents/45 🆔 Identities/01 🆔🫥 Identity agent.md>) on the new phone to perform an identity authentication (e.g., face scan), and then will automatically decommission the old Wallet.
...
1. **How do users change between Wallet providers?**
    ...
    If both the old and the new [Wallet 🧑‍🦰 app](<../01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>) providers use the same [Broker 🤵 domain](<../03 🤵 Brokers/03 🤵 Broker domain.md>), 
...
1. **What if an attacker intercepts a user's recovery QR Token?**
    ...
    When a migration QR is used on a new [Wallet 🧑‍🦰 app](<../01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>), the [Broker 🤵 domain](<../03 🤵 Brokers/03 🤵 Broker domain.md>) notifies the old Wallet, allowing legitimate owners to block the attack and destroy the QR. 
...
1. **What workflows can users execute in a Wallet app?**
    ...
    |-|-|-
    | 🤵 Set up | [👉 Onboard](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/10 👉🤵 Set-up/11 🧑‍🦰👉🤵 Onboard.md>)  | Register the [Wallet 🧑‍🦰](<$ 🧑‍🦰 Wallet app.md>) on a [Broker 🤵](<../03 🤵 Brokers/03 🤵 Broker domain.md>)
