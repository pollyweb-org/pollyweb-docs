...
1. **What can a user do with a Wallet?**
    ...
    - 🔗 [Binds](<../../25 Data/24 🔗 Binds/01 🔗 Bind.md>): list, view, unbind, and chat with the bound [Vault 🗄️ domain](<../../41 🎭 Domain Roles/80 🗄️ Vaults/$ 🗄️🎭 Vault role.md>). 
    - 🎫 [Tokens](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>): view, and chat with the [Issuer 🎴 domain](<../../41 🎭 Domain Roles/40 🎴 Issuers/$ 🎴🎭 Issuer role.md>).
...
1. **What data exists in the device at any given time?**
    ...
    - 🎫 Downloaded [Tokens 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) from [Issuer 🎴 domains](<../../41 🎭 Domain Roles/40 🎴 Issuers/$ 🎴🎭 Issuer role.md>).
...
1. **How do users migrate a Wallet to another phone?**
    ...
    To migrate a [Wallet 🧑‍🦰 app](<../01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>) to another phone, a user first needs to bind an [Identity 🆔 agent domain](<../../30 🫥 Agents/45 🆔 Identities/01 🆔🫥 Identity agent.md>) on the old phone, and then generate a migration QR [Token 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>).
    ...
    * The [Broker 🤵 domain](<../03 🤵 Brokers/$ 🤵 Broker domain.md>) will invoke the [Identity 🆔 domain](<../../30 🫥 Agents/45 🆔 Identities/01 🆔🫥 Identity agent.md>) on the new phone to perform an identity authentication (e.g., face scan), and then will automatically decommission the old Wallet.
...
1. **How do users change between Wallet providers?**
    ...
    If both the old and the new [Wallet 🧑‍🦰 app](<../01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>) providers use the same [Broker 🤵 domain](<../03 🤵 Brokers/$ 🤵 Broker domain.md>), 
    * then changing between Wallet providers in the same phone is very similar to migrating a Wallet to another phone. 
    
    If they use different [Broker 🤵 domains](<../03 🤵 Brokers/$ 🤵 Broker domain.md>), 
    * then these Brokers will need to implement some sort of portability. 
     
    For simplicity, let's assume they use the same [Broker 🤵 domain](<../03 🤵 Brokers/$ 🤵 Broker domain.md>).
...
1. **What if an attacker intercepts a user's recovery QR Token?**
    ...
    When a migration QR is used on a new [Wallet 🧑‍🦰 app](<../01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>), the [Broker 🤵 domain](<../03 🤵 Brokers/$ 🤵 Broker domain.md>) notifies the old Wallet, allowing legitimate owners to block the attack and destroy the QR. 
    
    * For situations where legitimate owners are not aware of notifications, migrations have a small grace period where [Broker 🤵 domains](<../03 🤵 Brokers/$ 🤵 Broker domain.md>) inactivate both Wallets until the old Wallet accepts the transfer or the grace period expires.
...
1. **What workflows can users execute in a Wallet app?**
    ...
    | 🔗 Binds | [👉 Binds ](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/30 👉🔗 Binds/01 🧑‍🦰👉🤵 List binds.md>) | List the user's [Binds 🔗](<../../25 Data/24 🔗 Binds/01 🔗 Bind.md>)
    || [👉 Bind](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/30 👉🔗 Binds/02 🧑‍🦰👉🗄️ Bind 🔗.md>) | [Bind 🔗](<../../25 Data/24 🔗 Binds/01 🔗 Bind.md>) the [Wallet 🧑‍🦰](<$ 🧑‍🦰 Wallet app.md>) to a [Vault 🗄️](<../../41 🎭 Domain Roles/80 🗄️ Vaults/$ 🗄️🎭 Vault role.md>)
    || [👉 Unbind](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/30 👉🔗 Binds/03 🧑‍🦰👉🗄️ Unbind.md>) | Remove a [Bind 🔗](<../../25 Data/24 🔗 Binds/01 🔗 Bind.md>) from a [Vault 🗄️](<../../41 🎭 Domain Roles/80 🗄️ Vaults/$ 🗄️🎭 Vault role.md>)
    ||[👉 Share](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/30 👉🔗 Binds/04 🧑‍🦰👉💼 Share Bind 🔗.md>) | Shares a [Bind 🔗](<../../25 Data/24 🔗 Binds/01 🔗 Bind.md>) with a [Consumer 💼](<../../41 🎭 Domain Roles/27 💼 Consumers/$ 💼🎭 Consumer role.md>)
    |🎫 Tokens| [👉 Tokens](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/40 👉🎫 Tokens/01 🧑‍🦰👉🤵 List tokens.md>)| List the user's [Tokens 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>)
    || [👉 Save](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/40 👉🎫 Tokens/02 🧑‍🦰👉🎴 Save token.md>) | Save a [Token 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) in the [Wallet 🧑‍🦰](<$ 🧑‍🦰 Wallet app.md>)
    || [👉 Remove](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/40 👉🎫 Tokens/03 🧑‍🦰👉🤵 Remove token.md>) | Remove a [Token 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) from the [Wallet 🧑‍🦰](<$ 🧑‍🦰 Wallet app.md>)
    || [👉 Share](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/40 👉🎫 Tokens/04 🧑‍🦰👉💼 Share Token 🎫.md>) | Share a [Token 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) with a [Consumer 💼](<../../41 🎭 Domain Roles/27 💼 Consumers/$ 💼🎭 Consumer role.md>)
