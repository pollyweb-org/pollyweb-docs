...
1. **How can users interact with Locators?**
    ...
    | [💬 Chat prompts](<../12 💬 Chats/$ 💬 Chat.md>) | Select a [Host 🤗 domain](<../../41 🎭 Domain Roles/30 🤗 Hosts/$ 🤗🎭 Host role.md>) option - e.g., [Finder 🔎](<../../50 🫥 Agents/40 🔎 Finders/02 🔎🫥 Finder vault.md>), [Advertiser 👀](<../../45 🛠️ Helper domains/12 👀 Advertisers/$ 👀👥 Advertiser helper.md>)
