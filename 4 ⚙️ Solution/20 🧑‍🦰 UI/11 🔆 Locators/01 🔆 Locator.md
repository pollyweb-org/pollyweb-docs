...
1. **How can users interact with Locators?**
    ...
    | [🖨️ Printer domains](<../../45 Helpers/10 Printers/08 🖨️🏭 Printer helper.md>) | Tap/scan a static NFC/QR issue by any [Printer 🖨️ domain](<../../45 Helpers/10 Printers/08 🖨️🏭 Printer helper.md>)
