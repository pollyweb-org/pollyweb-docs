...
1. **How can users interact with Locators?**
    ...
    | [💬 Chat prompts](<../12 💬 Chats/01 💬 Chat.md>) | Select a [Host 🤗 domain](<../12 💬 Chats/04 🤗🎭 Host role.md>) option - e.g., [Finder 🔎](<../../30 🫥 Agents/40 🔎 Finders/02 🔎🫥 Finder vault.md>), [Advertiser 👀](<../../45 🛠️ Helper domains/12 👀 Advertisers/$ 👀👥 Advertiser helper.md>)
...
1. **How can users detect business impersonation attacks?**
    ...
    - If it opens their [Wallet 🧑‍🦰 app](<../01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>), then they'll know that all messages will safely go through a trustworthy [Broker 🤵 domain](<../03 🤵 Brokers/03 🤵 Broker domain.md>).
