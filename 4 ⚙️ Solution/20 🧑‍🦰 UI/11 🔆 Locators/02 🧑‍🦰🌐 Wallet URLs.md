...
1. **What happens to NFC/QR Locators if `nlweb.org` goes down?**
    ...
    * Users using their [Wallet 🧑‍🦰 apps](<../01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>) as the default NFC/QR reader won't notice any difference, because the [Wallet 🧑‍🦰](<../01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>) will parse the destination [Host 🤗](<../../41 🎭 Domain Roles/30 🤗 Hosts/04 🤗🎭 Host role.md>) from the URL.
