...
1. **How do Wallet apps scan an NLWeb QR?**
    ...
    * When a user scans the QR with an NLWeb Wallet app, the Wallet reads the [Locator 🔆](<01 🔆 Locator.md>) from the URL and opens a chat with the Locator's [Host 🤗](<../23 💬 Chats/04 🤗🎭 Host role.md>).
