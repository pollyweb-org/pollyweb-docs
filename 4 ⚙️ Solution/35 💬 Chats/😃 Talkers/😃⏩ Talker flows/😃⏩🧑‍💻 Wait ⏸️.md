...
|4| [⏸️ `WAIT` flow command](<../😃⚙️ Talker cmds/...commands/WAIT ⏸️.md>) | [Talkers 😃](<../😃 Talker role.md>) go to sleep until signaled 
...
|6| [🧑‍💻🐌😃 `Put@Hoster`](<../😃🅰️ Talker methods/🧑‍💻🐌😃 Place.md>) | [Hosteds 📦](<../../../55 👷 Build domains/Hosteds 📦/📦👥 Hosted domain.md>) wake up the [⏸️ `WAIT` flow](<../😃⚙️ Talker cmds/...commands/WAIT ⏸️.md>)
| 