...
1. **What's the SHARE syntax?**
    ...
    | Argument| Purpose
    |-|-
    | `<code-n>`  | [Schema Codes 🧩](<../../../../../30 🧩 Data/Codes 🧩/🧩 Schema Code.md>) for [`Query@Broker`](<../../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🅰️ Broker methods/...for Share 💼/Query/💼🐌🤵 Query.md>) <br/>For readability, a dot replaces `nlweb.dom/`
