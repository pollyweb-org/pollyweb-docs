...
1. **What's the syntax for `INVITE`?**
    ...
    | Argument| Purpose 
    |-|-
    | `<invitee>` | The invitee [domain 👥](<../../../../../40 👥 Domains/👥 Domain.md>) for [`Invite@Broker`](<../../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🅰️ Broker methods/...for Share 💼/Invite 💼🐌🤵/Invite 🐌 msg.md>) 
    | `<code>` | The [Schema Codes 🧩](<../../../../../30 🧩 Data/Codes 🧩/🧩 Schema Code.md>) to query for data
    | `{params}` | Parameters dictionary for [`Invite@Broker`](<../../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🅰️ Broker methods/...for Share 💼/Invite 💼🐌🤵/Invite 🐌 msg.md>) 
