...
1. **What's the syntax?**
    ...
    | `<failure>` | [Script 📃](<../../...commands ⌘/📃 Script.md>) or [Command ⌘](<../../...commands ⌘/⌘ Command.md>) to run on failure
    | `<success>` | [Script 📃](<../../...commands ⌘/📃 Script.md>) or [Command ⌘](<../../...commands ⌘/⌘ Command.md>) to run on success
...
1. **How to open a locker door remotely?**
    ...
    Commands: [`FAILURE`](<../../../../🤔 Prompts/🤔📢 Prompt status/FAILURE ❌/FAILURE ❌ prompt.md>) [`INFO`](<../../../../🤔 Prompts/🤔📢 Prompt status/INFO ℹ️/INFO ℹ️ prompt.md>) [`LOG`](<../../...control ▶️/LOG 🪵/LOG 🪵 flow.md>) [`RELAY`](<RELAY 🛰️ msg.md>) [`SUCCESS`](<../../../../🤔 Prompts/🤔📢 Prompt status/SUCCESS ✅/SUCCESS ✅ prompt.md>) [`TEMP`](<../../../../🤔 Prompts/🤔📢 Prompt status/TEMP ⏳/TEMP ⏳ prompt.md>)
