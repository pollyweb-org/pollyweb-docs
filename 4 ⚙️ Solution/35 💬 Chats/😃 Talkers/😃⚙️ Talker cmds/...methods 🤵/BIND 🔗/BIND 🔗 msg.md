...
1. **What's the BIND syntax?**
    ...
    | Argument| Purpose 
    |-|-
    | `<schema>` | [Schema 🧩](<../../../../../30 🧩 Data/Codes 🧩/🧩 Schema Code.md>) from [`Bindable@Broker`](<../../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🅰️ Broker methods/4 ...for Binds 🔗/Bindable 🐌/🗄️🐌🤵 Bindable.md>) 
    ...
    | Argument| Purpose
    |-|-
    | `<schema-n>` | Array of [Schema Codes 🧩](<../../../../../30 🧩 Data/Codes 🧩/🧩 Schema Code.md>) sent on [`Bindable@Broker`](<../../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🅰️ Broker methods/4 ...for Binds 🔗/Bindable 🐌/🗄️🐌🤵 Bindable.md>)
   ...
   ```
    ...
    | Argument| Purpose
    |-|-
    | `{bindable}` | [{Function}](<../../...functions 🐍/{Function} 🐍.md>) to get the [Codes 🧩](<../../../../../30 🧩 Data/Codes 🧩/🧩 Schema Code.md>) for [Bindable @ Broker](<../../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🅰️ Broker methods/4 ...for Binds 🔗/Bindable 🐌/🗄️🐌🤵 Bindable.md>).
