...
1. **What is a .Diff command?**
    ...
    * that outputs the the difference between [Placeholders 🧠](<../...placeholders 🧠/$Placeholder 🧠.md>).
...
1. **What's the .Diff output for time?**
    ...
    For the [Script 📃](<../...commands ⌘/Script 📃/📃 Script.md>) above, here's the `$diff`  [Placeholder 🧠](<../...placeholders 🧠/$Placeholder 🧠.md>).
