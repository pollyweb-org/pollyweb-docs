...
1. **What's the read syntax?**
    ...
    | `OnMissing` | [Command ⌘](<../...commands/⌘ Command.md>) or [Script 📃](<../for control/📃 Script.md>) | `MyScript`
...
1. **How to read a specific item property?**
    ...
    The following [Script 📃](<../for control/📃 Script.md>) renders `ℹ️ 2.A` in the [Chat 💬](<../../../💬 Chats/💬 Chat.md>).
