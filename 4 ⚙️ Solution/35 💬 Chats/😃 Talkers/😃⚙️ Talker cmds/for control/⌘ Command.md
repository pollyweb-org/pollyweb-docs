...
1. **What are Flow commands?**
    ...
    Command | Purpose
    |-|-
    | ⏯️️ [`CASE`](<CASE ⏯️.md>) | Runs a [Command ⌘](<⌘ Command.md>) or [Script 📃](<📃 Script.md>) matching a [{Function}](<../...functions/{Function} 🐍.md>).
    ...
    | ⬇️ [`EVAL`](<../for data/EVAL ⬇️ flow.md>) | Evaluates a [{Function}](<../...functions/{Function} 🐍.md>) into a placeholder.
    | ⤵️ [`IF`](<IF ⤵️.md>) | Runs a [Command ⌘](<⌘ Command.md>) or [Script 📃](<📃 Script.md>) based on a [{Function}](<../...functions/{Function} 🐍.md>).
