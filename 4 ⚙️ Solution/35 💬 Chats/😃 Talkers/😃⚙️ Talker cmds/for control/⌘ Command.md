...
1. **What are Flow commands?**
    ...
    Command | Purpose
    |-|-
    | ⏯️ [`CASE`](<CASE ⏯️.md>) | Runs a [Command ⌘](<⌘ Command.md>) or [Procedure ⚙️](<▶️ Script.md>) matching a [{Function}](<../for data/{Function} 🐍.md>).
    ...
    | ⤵️ [`IF`](<IF ⤵️.md>) | Runs a [Command ⌘](<⌘ Command.md>) or [Procedure ⚙️](<▶️ Script.md>) based on a [{Function}](<../for data/{Function} 🐍.md>).
    | 🪵 [`LOG`](<../for data/LOG 🪵 flow.md>) | Logs messages into the system handler.
    | 🔁 [`REPEAT`](<REPEAT 🔁.md>) | Repeats the current [Procedure ⚙️](<▶️ Script.md>) with a confirmation.
    | ↩️ [`RETURN`](<RETURN ↩️.md>) | Returns from a [Procedure ⚙️](<▶️ Script.md>) with a result.
    | ▶️ [`RUN`](<RUN ▶️.md>) | Runs a [Procedure ⚙️](<▶️ Script.md>) and puts the result in a placeholder.
