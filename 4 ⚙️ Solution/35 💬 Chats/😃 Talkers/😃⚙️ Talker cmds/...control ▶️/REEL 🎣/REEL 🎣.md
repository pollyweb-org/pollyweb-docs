...
1. **What's an example of REEL?**
    ...
    |-|-
    | ⏬ [`GET`](<../../...datasets 🪣/GET/GET ⏬ item.md>) | Get the [`Hook` 🪣](<../../../😃🪣 Talker tables/😃🪣 Hooks 🪝 table.md>) from [`Bindable@Broker`](<../../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🅰️ Broker methods/...for Binds 🔗/Bindable 🗄️🐌🤵/🗄️🐌🤵 Bindable.md>)  
