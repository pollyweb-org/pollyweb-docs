...
> Referenced by the [😃⏩🧑‍💻 Wait ⏸️](<../../../😃⏩ Talker flows/Wait 😃⏩🧑‍💻/😃 Wait ⏩ flow.md>) flow
...
1. **How to wait in a queue?**
    ...
    | [Command ⌘](<../../...commands ⌘/Command ⌘/Command ⌘.md>) | Purpose
    |-|-
    | ⏯️️ [`CASE`](<../CASE ⏯️/CASE ⏯️.md>) | To show the human-friendly message.
    | ⬇️ [`EVAL`](<../../...placeholders 🧠/EVAL ⬇️ flow.md>) | to assess the backend queue length.
...
1. **How to signal a WAIT placeholder?**
    ...
    The full interaction is described in the [😃⏩🧑‍💻 Wait ⏸️](<../../../😃⏩ Talker flows/Wait 😃⏩🧑‍💻/😃 Wait ⏩ flow.md>) flow 
