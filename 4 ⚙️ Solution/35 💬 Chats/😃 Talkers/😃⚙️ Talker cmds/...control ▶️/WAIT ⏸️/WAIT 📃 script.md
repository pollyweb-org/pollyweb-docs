...
> Implements the [`WAIT`](<WAIT ⏸️.md>) command.
...
Needs||
|-|-
[Commands ⌘](<../../...commands ⌘/Command ⌘/Command ⌘.md>) | [`ASSERT`](<../../...placeholders 🧠/ASSERT 🚦/ASSERT 🚦.md>) [`EVAL`](<../../...placeholders 🧠/EVAL ⬇️ flow.md>) [`SAVE`](<../../...datasets 🪣/SAVE 💾/💾 SAVE ⌘ cmd.md>)
