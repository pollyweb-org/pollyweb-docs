...
> Example: [Pop Vault 🔆](<../../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵📃 Broker scripts/...procedures/🤵📃 Pop Vault 🗄️ script.md>)
...
1. **What is the syntax of the PARALLEL command?**
    ...
    | `<command-n>`   | [Command ⌘](<../../...commands ⌘/Command ⌘/Command ⌘.md>) to execute | [`SAVE`](<../../...datasets 🪣/SAVE/SAVE 💾 item.md>)
