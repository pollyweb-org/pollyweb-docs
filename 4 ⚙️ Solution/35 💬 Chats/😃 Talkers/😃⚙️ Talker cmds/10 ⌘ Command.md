...
1. **What are Message commands?**
    ...
    |Command|Purpose
    |-|-
    | 🔗 [`BIND`](<../😃📨 Talker msgs/44 🔗 BIND msg.md>) | Calls the [Bind Vault @ Wallet ⏩](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰💬 Wallet chats/in Prompts 🤔/🧑‍🦰👉🗄️ Bind 🔗.md>) flow.
    | 🎫 [`OFFER`](<../😃📨 Talker msgs/49 🎫 OFFER msg.md>) | Calls the [Save Token @ Wallet ⏩](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰💬 Wallet chats/in Prompts 🤔/🧑‍🦰👉🎴 Save token.md>) flow.
