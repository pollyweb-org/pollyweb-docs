...
1. **What's the syntax of an update SAVE?**
    ...
    |-|-|-
    | `$item` | [Placeholder 🧠](<../...placeholders/$Placeholder 🧠.md>) loaded with [`GET`](<../...items/GET ⏬ item.md>)
...
1. **How up update an item?**
    ...
    Commands: [`EVAL`](<EVAL ⬇️ flow.md>) [`GET`](<../...items/GET ⏬ item.md>) [`SAVE`](<SAVE 💾 item.md>)
...
1. **What if the item doesn't exist?**
    ...
    Set the `Default` property of [`GET`](<../...items/GET ⏬ item.md>).
