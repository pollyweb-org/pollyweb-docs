...
1. **How to invoke a Script?**
    ...
    |⤵️ [`IF`](<../...control ▶️/IF/IF ⤵️.md>) | Runs [Scripts 📃](<📃 Script.md>) for `True` and `False` evaluations.
    | ⏯️️ [`CASE`](<../...control ▶️/CASE/CASE ⏯️.md>) | Runs [Scripts 📃](<📃 Script.md>) for matching evaluations.
