...
1. **What's the syntax?**
    ...
    | `<failure>` | [Script ▶️](<../for control/📃 Script.md>) or [Command ⌘](<../for control/⌘ Command.md>) to run on failure
    | `<success>` | [Script ▶️](<../for control/📃 Script.md>) or [Command ⌘](<../for control/⌘ Command.md>) to run on success
