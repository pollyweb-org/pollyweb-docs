...
1. **What's the syntax?**
    ...
    | `<failure>` | [Script 📃](<../for control/📃 Script.md>) or [Command ⌘](<../...commands/⌘ Command.md>) to run on failure
    | `<success>` | [Script 📃](<../for control/📃 Script.md>) or [Command ⌘](<../...commands/⌘ Command.md>) to run on success
