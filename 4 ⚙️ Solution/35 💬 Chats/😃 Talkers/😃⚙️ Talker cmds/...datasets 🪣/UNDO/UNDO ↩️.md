...
1. **How to use an UNDO?**
    ...
    Commands: [`CASE`](<../../...control ▶️/CASE ⏯️/CASE ⏯️.md>) [`DELETE`](<../DELETE/DELETE 🗑️ item.md>) [`SUCCESS`](<../../../../🤔 Prompts/🤔📢 Prompt status/SUCCESS ✅/SUCCESS ✅ prompt.md>)
...
1. **What's a use case for soft deletes?**
    ...
    See [Pop Token 🔆](<../../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🅰️ Broker methods/3 ...for Chats 💬/Pop 🧑‍🦰🐌🤵/.📎 Assets/Pop Token 🎫 script.md>).
