...
> Implemented by the [`.UNDO` 📃 script](<../../😃📃 Talker scripts/...for datasets 🪣/😃📃 .UNDO script.md>)
...
1. **How to use an UNDO?**
    ...
    Commands: [`CASE`](<../...control ▶️/CASE/CASE ⏯️.md>) [`DELETE`](<DELETE 🗑️ item.md>) [`SUCCESS`](<../../../🤔 Prompts/🤔📢 Prompt status/SUCCESS ✅ prompt.md>)
