...
* Writes a value to a [$Placeholder 🧠](<../😃⚙️ Talker cmds/for data/$Placeholder 🧠.md>).
* [$Placeholder 🧠](<../😃⚙️ Talker cmds/for data/$Placeholder 🧠.md>) names must to start with a letter.
