...
1. **What's the syntax of REEL for Async Messages?**
    ...
    | `{response}` | [Command ⌘](<../../...commands ⌘/Command ⌘/⌘ Command.md>) output to a [Holder 🧠](<../../../Talkers 😃/😃⚙️ Talker cmds/...holders 🧠/$Holder 🧠.md>)
...
1. **What's an example of REEL?**
    ...
    Consider the [`BIND` flow command](<../../../Talkers 😃/😃⚙️ Talker cmds/...methods 🤵/BIND 🔗/🔗 BIND ⌘ cmd.md>).
    ...
    Commands: [`BIND`](<../../../Talkers 😃/😃⚙️ Talker cmds/...methods 🤵/BIND 🔗/🔗 BIND ⌘ cmd.md>) [`IF`](<../IF ⤵️/⤵️ IF ⌘ cmd.md>)
    ...
    |-|-
    | 🧲 [`GET`](<../../../Talkers 😃/😃⚙️ Talker cmds/...datasets 🪣/GET 🧲/🧲 GET ⌘ cmd.md>) | Get the [`Hook` 🪣](<../../../Talkers 😃/😃🪣 Talker tables/😃🪣 TalkerHooks 🪝 table.md>) from [`Bindable@Broker`](<../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🅰️ Broker methods/Binds 🔗 Bindable 🗄️🐌🤵/🤵 Bindable 🐌 msg.md>)  
