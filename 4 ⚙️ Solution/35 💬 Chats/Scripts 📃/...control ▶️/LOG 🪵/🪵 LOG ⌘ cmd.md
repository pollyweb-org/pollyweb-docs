...
1. **What is a LOG command?**
    ...
    * that sends an event 
    * to the log handler of a [Talker 😃](<../../../Talkers 😃/😃 Talker role.md>).
...
1. **What are example use cases?**
    ...
    * Handling the result of a [`RELAY`](<../../../Talkers 😃/😃⚙️ Talker cmds/...methods 🤵/RELAY 🛰️/🛰️ RELAY ⌘ cmd.md>) command.
...
1. **What's the syntax?**
    ...
    |-|-|-
    | `{function}`| [{Function}](<../../../Talkers 😃/😃⚙️ Talker cmds/...functions 🐍/{Function} 🐍.md>) to valuate and log. | `{MyFunction}` | 
