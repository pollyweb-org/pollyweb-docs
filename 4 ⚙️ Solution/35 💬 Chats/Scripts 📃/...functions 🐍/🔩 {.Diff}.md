...
1. **What is a .Diff command?**
    ...
    * that outputs the difference between [Holders 🧠](<../../Talkers 😃/😃⚙️ Talker cmds/...holders 🧠/$Holder 🧠.md>).
...
1. **What's the .Diff output for time?**
    ...
    For the [Script 📃](<../...commands ⌘/Script 📃/📃 Script.md>) above, here's the `$diff`  [Holder 🧠](<../../Talkers 😃/😃⚙️ Talker cmds/...holders 🧠/$Holder 🧠.md>).
