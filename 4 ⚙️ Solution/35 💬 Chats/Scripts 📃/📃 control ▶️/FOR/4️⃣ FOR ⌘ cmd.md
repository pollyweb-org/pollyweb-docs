...
1. **What is the syntax of the FOR command?**
    ...
    | `<order>` | Optional sort property list | `A,B`
...
1. **How to order by a property?**

    Here's a [Chat 💬](<../../../Chats 💬/💬 Chat.md>)

    | [domain 👥](<../../../../40 👥 Domains/👥 Domain/👥 Domain.md>) | [Prompt 🤔](<../../../Prompts 🤔/🤔 Prompt.md>) | [Wallet 🧑‍🦰 apps](<../../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>)
    | - | - | - |
    | [Host 🤗 domains](<../../../../41 🎭 Domain Roles/Hosts 🤗/🤗 Host role/🤗🎭 Host role.md>) | ℹ️ Item `1` in a special order
    | [Host 🤗 domains](<../../../../41 🎭 Domain Roles/Hosts 🤗/🤗 Host role/🤗🎭 Host role.md>) | ℹ️ Item `2` in a special order
    | [Host 🤗 domains](<../../../../41 🎭 Domain Roles/Hosts 🤗/🤗 Host role/🤗🎭 Host role.md>) | ℹ️ Item `3` in a special order
