...
1. **What's the syntax?**
    ...
    | `<failure>` | [Script 📃](<../../📃 commands ⌘/Script 📃/📃 Script.md>) or [Command ⌘](<../../📃 basics/⌘ Command.md>) to run on failure
    | `<success>` | [Script 📃](<../../📃 commands ⌘/Script 📃/📃 Script.md>) or [Command ⌘](<../../📃 basics/⌘ Command.md>) to run on success
