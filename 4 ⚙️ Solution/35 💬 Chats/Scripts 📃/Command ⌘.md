...
1. **How to pass YAML objects to a [Command ⌘](<Command ⌘.md>)?**
    ...
    [Commands ⌘](<Command ⌘.md>) parse inputs with the [`.Evaluate`](<../../37 Scripts 📃/📃 Functions 🐍/🐍 System 🔩 functions/asserts/🔩 {.Evaluate}.md>) function.
...
1. **How to pass [Holders 🧠](<Holder 🧠.md>) to a [Command ⌘](<Command ⌘.md>)?**
    ...
    [Commands ⌘](<Command ⌘.md>) also parse [Holder 🧠](<Holder 🧠.md>) inputs with the [`.Evaluate`](<../../37 Scripts 📃/📃 Functions 🐍/🐍 System 🔩 functions/asserts/🔩 {.Evaluate}.md>) function.
