...
1. **What are the Input prompt commands?**
    ...
    | ⭐ [`STARS`](<../../37 Scripts 📃/📃 Prompts 🤔/🤔 Input ✏️ prompts/STARS ⭐/⭐ STARS ⌘ cmd.md>) | 5 ⭐ | Integer from 1 to 5
...
<!--
   ...
   * `REDIRECT|{host}|{locator}`	
       ...
       * With [🧩 pollyweb.org/HOST](<../../41 🎭 Domain Roles/Hosts 🤗/🤗🧩 Host schemas/🧩 HOST.md>)
   * `RESUBSCRIBE|<amount>`	
...
1. **How to pass YAML objects to a [Command ⌘](<Command ⌘.md>)?**
    ...
    | `$holder-n` | [Holder 🧠](<Holder 🧠.md>)    | [`$.Inputs`](<../../37 Scripts 📃/📃 Holders 🧠/System holders 🔩/$.Inputs 🏃/🏃 $.Inputs 🧠 holder.md>)
