...
1. **What are Flow commands?**
    ...
    Command | Purpose
    |-|-
    | ⏯️️ [`CASE`](<../../...control ▶️/CASE ⏯️/⏯️ CASE ⌘ cmd.md>) | Runs a [Command ⌘](<⌘ Command.md>) or [Script 📃](<../Script 📃/📃 Script.md>) based on a [{Function} 🐍](<../../../Talkers 😃/😃⚙️ Talker cmds/...functions 🐍/{Function} 🐍.md>).
    ...
    | ⬇️ [`EVAL`](<../../../Talkers 😃/😃⚙️ Talker cmds/...holders 🧠/EVAL ⬇️/⬇️ EVAL ⌘ cmd.md>) | Evaluates a [{Function}](<../../../Talkers 😃/😃⚙️ Talker cmds/...functions 🐍/{Function} 🐍.md>) into a holder.
    | ⤵️ [`IF`](<../../...control ▶️/IF ⤵️/⤵️ IF ⌘ cmd.md>) | Runs a [Command ⌘](<⌘ Command.md>) or [Script 📃](<../Script 📃/📃 Script.md>) based on a [{Function} 🐍](<../../../Talkers 😃/😃⚙️ Talker cmds/...functions 🐍/{Function} 🐍.md>).
