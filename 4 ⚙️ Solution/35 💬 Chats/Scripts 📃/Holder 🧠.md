...
1. **What are the system holders?**
    ...
    | [`$.Parent`](<../../37 Scripts 📃/📃 Holders 🧠/🧠 System holders/$.Parent ▶️/▶️ $.Parent 🧠 holder.md>) | References the [Holders 🧠](<Holder 🧠.md>) in the [`RUN`](<../../37 Scripts 📃/📃 Commands ⌘/⌘ for control ▶️/RUN ▶️/▶️ RUN ⌘ cmd.md>) caller
