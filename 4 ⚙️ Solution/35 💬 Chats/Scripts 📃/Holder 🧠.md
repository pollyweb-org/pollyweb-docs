...
1. **What type of holders are there?**
    ...
    |[`Time`](<../../37 Scripts 📃/📃 Holders 🧠/🧠 Input holders/Time/🧠 Time holders.md>)| Dates and times | `2018-12-10T13:45:00Z`
...
1. **What functions apply to any holder type?**
    ...
    |-|-|
    | [`.IsEmpty`](<../../37 Scripts 📃/📃 Functions 🐍/🐍🧠 Holder functions/🔩 {$holder.IsEmpty}.md>) | Is it empty?
