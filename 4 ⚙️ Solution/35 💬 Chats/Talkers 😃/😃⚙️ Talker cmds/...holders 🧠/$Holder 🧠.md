...
1. **What are the system placeholders?**
    ...
    | [`$.Inputs`](<$.Inputs ▶️/▶️ $.Inputs 🧠 holder.md>) | Contains the inputs of the current [`RUN` command](<../../../Scripts 📃/...control ▶️/RUN ▶️/▶️ RUN ⌘ cmd.md>) 
...
1. **How to read lists of values?**
    ...
    To loop a list holder called $list use [`PARALLEL`](<../../../Scripts 📃/...control ▶️/PARALLEL *️⃣/*️⃣ PARALLEL ⌘ cmd.md>).
    ...
    - PARALLEL|$list|$number:
        - INFO|$number
    ```
    Commands: [`EVAL`](<EVAL ⬇️/⬇️ EVAL ⌘ cmd.md>) [`INFO`](<../../../Prompts 🤔/🤔📢 Prompt status/INFO ℹ️/INFO ℹ️ prompt.md>) [`PARALLEL`](<../../../Scripts 📃/...control ▶️/PARALLEL *️⃣/*️⃣ PARALLEL ⌘ cmd.md>)
...
1. **How to reference a holder by name?**
    ...
    > Used in the [`FILTER`](<../../../Scripts 📃/...methods 🤵/FILTER 🔽/🔽 FILTER ⌘ cmd.md>) command

    Leverage `{$*}` interpolation with [Commands ⌘](<../../../Scripts 📃/...commands ⌘/Command ⌘/⌘ Command.md>).
