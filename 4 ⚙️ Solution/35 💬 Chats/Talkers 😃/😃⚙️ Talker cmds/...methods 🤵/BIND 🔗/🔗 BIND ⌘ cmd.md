...
1. **What's the BIND syntax?**
   ...
   ```
    ...
    | Input| Purpose
    |-|-
    | `{bindable}` | [{Function}](<../../../../Scripts 📃/...functions 🐍/{Function} 🐍.md>) to get the [Codes 🧩](<../../../../../30 🧩 Data/Codes 🧩/🧩 Schema Code.md>) for [Bindable @ Broker](<../../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🅰️ Broker methods/Binds 🔗 Bindable 🗄️🐌🤵/🤵 Bindable 🐌 msg.md>).
