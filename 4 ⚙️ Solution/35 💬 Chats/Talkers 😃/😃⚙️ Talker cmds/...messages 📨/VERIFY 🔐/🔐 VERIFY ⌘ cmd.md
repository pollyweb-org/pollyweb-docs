...
1. **How do Brokers verify a message from a Wallet?**
    ...
    Here's a [Talker 😃](<../../../😃 Talker role.md>) excerpt from [Pop Vault @ Broker](<../../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🅰️ Broker methods/Chats 💬 Pop 🧑‍🦰🐌🤵/Pop Vault/🤵 Pop Vault 📃 handler.md>).
    ...
    |-|-
    | 🧲 [`GET`](<../../../../Scripts 📃/...datasets 🪣/GET 🧲/🧲 GET ⌘ cmd.md>) | Get the Public Key of the [Wallet 🪣](<../../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🪣 Broker tables/Wallets 🧑‍🦰 table/🤵 Wallets 🪣 table.md>) in the [Message 📨](<../../../../../30 🧩 Data/Messages 📨/📨 Message.md>).
...
1. **How do Hosts verify a message from a Wallet?**
    ...
    | [Command ⌘](<../../../../Scripts 📃/...commands ⌘/Command ⌘/⌘ Command.md>) | Purpose
    |-|-
    | 🧲 [`GET`](<../../../../Scripts 📃/...datasets 🪣/GET 🧲/🧲 GET ⌘ cmd.md>) | To get the Public Key of [`Hello@Host`](<../../../../../41 🎭 Domain Roles/Hosts 🤗/🤗🅰️ Host methods/Hello 🤵🐌🤗/🤗 Hello 🐌 msg.md>).
