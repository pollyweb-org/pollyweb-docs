...
1. **What is a Talker?**
    ...
    * implemented by [Hoster ☁️ helper domains](<../../../45 🤲 Helper domains/Hosters ☁️/☁️ Hoster helper/☁️ Hoster 🤲 helper.md>).
...
1. **Why are Talkers important?**
    ...
    * They allow [Hoster ☁️ helper domains](<../../../45 🤲 Helper domains/Hosters ☁️/☁️ Hoster helper/☁️ Hoster 🤲 helper.md>) to manage the workflow state on behalf of [Hosted 📦 domains](<../../../55 👷 Build domains/Hosteds 📦/📦👥 Hosted domain.md>), removing the undifferentiated heavy-lifting of handling [Prompts 🤔](<../../Chats 💬/🤔 Prompt.md>) communications, and invoking [Hosted 📦 domains](<../../../55 👷 Build domains/Hosteds 📦/📦👥 Hosted domain.md>) only when it's necessary to execute business-specific logic.
    ---
    <br/>
...
1. **What flows are initiated by Talkers?**
    ...
    |Flow|Details
    |-|-
    | [😃⏩🧑‍💻 Handle 🐍](<../😃⏩ Talker flows/Run Sync Functions 😃⏩📦/😃 Call ⏩ flow.md>) | Ask [Hosteds 📦](<../../../55 👷 Build domains/Hosteds 📦/📦👥 Hosted domain.md>) to handle [{Functions} 🐍](<../../Scripts 📃/Function 🐍.md>)
    | [😃⏩🧑‍💻 Wait 🧘](<../😃⏩ Talker flows/Long Async Tasks 😃⏩📦/😃 Async ⏩ flow.md>) | Allow [Hosted 📦](<../../../55 👷 Build domains/Hosteds 📦/📦👥 Hosted domain.md>)  long-running tasks
...
1. **What API methods do Talkers expose?**
    ...
    |Method|Details
    |-|-
    | 🧑‍💻🚀 [Placed](<../😃📨 Talker msgs/Placed 🧑‍💻🚀😃/😃 Placed 🚀 call.md>) | Returns the value of a [holder 🧠](<../../Scripts 📃/Holder 🧠.md>)
    | 🧑‍💻🐌 [Place](<../😃📨 Talker msgs/Place 🧑‍💻🚀😃/😃 Place 🚀 call.md>) | Sets the value of a [holder 🧠](<../../Scripts 📃/Holder 🧠.md>)
    | 🧑‍💻🐌 [Handled](<../😃📨 Talker msgs/Handled 🧑‍💻🐌😃/😃 Handled 🐌 msg.md>) | Receives the evaluation of a [{Function} 🐍](<../../Scripts 📃/Function 🐍.md>)
