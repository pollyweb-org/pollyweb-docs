...
> Implements the [`Place@Talker` 🚀 call](<😃 Place 🚀 call.md>)
...
| [Datasets 🪣](<../../../../30 🧩 Data/Datasets 🪣/🪣 Dataset.md>) | [`HostChats` 🪣 table](<../../../../41 🎭 Domain Roles/Hosts 🤗/🤗🪣 Host tables/Chats 💬 table/🪣 Chats/🤗 Host.Chats 🪣 table.md>) [`TalkerHolders` 🪣 table](<../../😃🪣 Talker tables/Imprint🦶 » Recall 🪶/😃 Talker.Holders 🪣 table.md>)
