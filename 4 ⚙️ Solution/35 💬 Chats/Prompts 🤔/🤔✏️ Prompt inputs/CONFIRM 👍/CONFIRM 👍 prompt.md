...
1. **What's the syntax of a `CONFIRM`?**
    ...
    | Input| Purpose | Example
    |-|-|-
    | `Then` | [Script 📃](<../../../Scripts 📃/Script 📃.md>) or [Command ⌘](<../../../Scripts 📃/Command ⌘.md>) on `True` | `INFO\|OK`
    | `Else` | [Script 📃](<../../../Scripts 📃/Script 📃.md>) or [Command ⌘](<../../../Scripts 📃/Command ⌘.md>) on `False` | `INFO\|NOK`
