...
1. **What's the syntax of a `CONFIRM`?**
    ...
    | Argument| Purpose | Example
    |-|-|-
    | `Then` | [Script 📃](<../../😃 Talkers/😃⚙️ Talker cmds/for control/📃 Script.md>) or [Command ⌘](<../../😃 Talkers/😃⚙️ Talker cmds/for control/⌘ Command.md>) on `True` | `INFO\|OK`
    | `Else` | [Script 📃](<../../😃 Talkers/😃⚙️ Talker cmds/for control/📃 Script.md>) or [Command ⌘](<../../😃 Talkers/😃⚙️ Talker cmds/for control/⌘ Command.md>) on `False` | `INFO\|NOK`
