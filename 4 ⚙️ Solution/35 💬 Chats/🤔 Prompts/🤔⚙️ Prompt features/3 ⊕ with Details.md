...
1. **What are expandable details?**
    ...
    * rendered in Markdown format by [Wallet 🧑‍🦰 apps](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>)
...
1. **What's an example in a [Chat 💬](<../../💬 Chats/💬 Chat.md>)?**
    ...
    |-|-
    | ℹ️ [`INFO`](<../🤔📢 Prompt status/21 ℹ️ INFO prompt.md>) | To show the messages and details.
    

    <br/>

    Here's the [`Prompted@Host`](<../../../41 🎭 Domain Roles/Hosts 🤗/🤗🅰️ Host methods/🧑‍🦰🚀🤗 Prompted.md>) response.
