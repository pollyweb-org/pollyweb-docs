...
1. **What are the blocking formats available?**
    ...
    | [🔆&nbsp;SCAN](<../🤔✏️ Prompt inputs/72 🔆 SCAN prompt.md>) | Asks to touch/scan a [QR/NFC Locator 🔆](<../../../25 🔆 Locators/Locators 🔆/🔆 Locator.md>)
...
1. **How can Hosts protect users from input fatigue?**
    ...
    * instead, request users to share datasets using [Schema Code 🧩](<../../../30 🧩 Data/Codes 🧩/🧩 Schema Code.md>);
