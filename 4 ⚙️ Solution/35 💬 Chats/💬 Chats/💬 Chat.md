...
1. **What is a chat?**
    ...
    * between a [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) and a [Host 🤗 domain](<../../41 🎭 Domain Roles/Hosts 🤗/🤗🎭 Host role.md>) 
...
1. **How are the intervening parties in a chat?**
    ...
    |[🧑‍🦰 Wallet](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) | Held by the user, replies directly to the [Host 🤗 domain](<../../41 🎭 Domain Roles/Hosts 🤗/🤗🎭 Host role.md>).
...
1. **What are the message types supported in chats?**
    ...
    | 💳 *Pay* | [Seller 💵 domains](<../../41 🎭 Domain Roles/Sellers 💵/💵🎭 Seller role.md>)  request the user's [Payer 💳 agent](<../../41 🎭 Domain Roles/Payers/03 💳🎭 Payer role.md>) to pay an amount.
