...
1. **How are the intervening parties in a chat?**
    ...
    |[📣 Notifier](<../../20 🧑‍🦰 UI/2 📣 Notifiers/📣👥 Notifier domain.md>) | Implements the mobile push notifications, receiving the messages from the [Broker 🤵 domain](<../../20 🧑‍🦰 UI/3 🤵 Brokers/🤵🤲 Broker helper.md>) and forwarding them to the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>).
...
1. **What are the message types supported in chats?**
    ...
    | 💼 *Share* | [Consumer 💼 domains](<../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>)  request the user to share data from a specific [Schema Code 🧩](<../../30 🧩 Data/1 🧩 Schema Codes/🧩 Schema Code.md>) or to share a [Token 🎫](<../../30 🧩 Data/Tokens 🎫/🎫 Token.md>).
