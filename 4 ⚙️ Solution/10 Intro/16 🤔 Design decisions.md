...
1. **What is NLWeb's approach to conversational commerce?**
    ...
    - Similar to [Meta's WhatsApp 📺](<../../2 🏔️ Landscape/1 💼 Business landscape/10 💬 Chatting landscape/06 📺 WhatsApp business.md>), NLWeb [Wallet 🧑‍🦰 apps](<../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets>) allow users to keep a list of active [Chats 💬](<../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) with [Host 🤗 domains](<../20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>). 
    ...
    - Users may accept [Tokens 🎫](<../20 🧑‍🦰 UI/25 🎫 Tokens/01 🎫 Token.md>) issued by [Issuer 🎴 domains](<../20 🧑‍🦰 UI/25 🎫 Tokens/02 🎴🎭 Issuer role.md>) - these tokens are stored offline and can be shared and validated by [Consumer 💼 domains](<../25 Data/27 💼 Consumers/04 💼🎭 Consumer role.md>).
...
1. **What is NLWeb's approach to location-based interactions?**
    ...
    - Instead, NLWeb advocates for [Chat 💬](<../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) interactions to always start with the user's explicit intent, either by [scanning ✨ a QR code](<../20 🧑‍🦰 UI/11 🔆 Locators/03 🧑‍🦰✨ Wallet QR scan.md>) or by [tapping 🔆 an NFC tag](<../20 🧑‍🦰 UI/11 🔆 Locators/04 🧑‍🦰🔆 Wallet NFC tap.md>).
...
1. **What is NLWeb's approach to end-user autofill?**
    ...
    - Users [bind 🔗](<../25 Data/24 🗄️ Vaults/01 🔗 Bind.md>) their [Wallet 🧑‍🦰 app](<../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets>) to multiple [Vault 🗄️ domains](<../25 Data/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) holding parts of their personal data (e.g., banks, hospitals, governments);
    ...
    - However, users don't control the [Vault 🗄️ domains](<../25 Data/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>), unlike in [Solid 📺](<../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/02 🧢 Personalization landscape/05 📺 Berners-Lee vaults.md>) and [Affinidi 📺](<../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/02 🧢 Personalization landscape/12 📺 Affinidi.md>);
    ...
    - Nonetheless, [Vault 🗄️ domains](<../25 Data/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) may require users to provide a shared [Storage 📦 vault](<../30 🫥 Agents/01 📦 Storage/01 📦🫥 Storage agent.md>) to store the user's data;
 
        - this is a [Solid 📺](<../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/02 🧢 Personalization landscape/05 📺 Berners-Lee vaults.md>)-like user-centric [Vault 🗄️ domain](<../25 Data/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) that other [Vault 🗄️ domains](<../25 Data/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) may leverage to address [sovereignty 📺](<../../2 🏔️ Landscape/1 💼 Business landscape/02 🏳️ Sovereignty landscape/00 🏳️ Sovereignty index.md>) regulations 
        - e.g., a US-based [Vault 🗄️ domain](<../25 Data/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) may store the data of a German citizen in the citizen's Germany-based [Storage 📦 vault](<../30 🫥 Agents/01 📦 Storage/01 📦🫥 Storage agent.md>).

    - Those [bounded 🔗](<../25 Data/24 🗄️ Vaults/01 🔗 Bind.md>) [Vault 🗄️ domains](<../25 Data/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) allow users to quickly [autofill 📺](<../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/02 🧢 Personalization landscape/06 📺 SSI form auto filling.md>) forms;
    ...
    - [Vault 🗄️ domains](<../25 Data/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) may allow users to change their stored data via the user's [Folder editor 🗂️ domain](<../45 Helpers/26 🗂️ Folders/$ 🗂️ Folder editor.md>);

        - this is a user-centric interface that allows a user to edit their data in multiple [Vault 🗄️ domains](<../25 Data/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) from a single editor;

        - [Vault 🗄️ domains](<../25 Data/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) may require users to have a [Folder editor 🗂️ domain](<../45 Helpers/26 🗂️ Folders/$ 🗂️ Folder editor.md>) to avoid having to build a user interface.
...
1. **What is NLWeb's approach to end-user payments?**
    ...
    - As preconditions, users must first bind their [Wallet 🧑‍🦰 apps](<../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) to one or more [Payer 💳 vaults](<../30 🫥 Agents/04 💳 Payers/03 💳🎭 Payer role.md>) (e.g., their bank), while [Seller 💵 domains](<../30 🫥 Agents/04 💳 Payers/01 💵🎭 Seller role.md>) must bind to [Collector 🏦 vaults](<../45 Helpers/18 🏦 Collectors/$ 🏦🛠️ Collector helper.md>) (e.g., a payment gateway). 

    - The payment is sent from the [user's Payer 💳 vault](<../30 🫥 Agents/04 💳 Payers/03 💳🎭 Payer role.md>) (on behalf of the user) to the [Seller's Collector 🏦 vault](<../45 Helpers/18 🏦 Collectors/$ 🏦🛠️ Collector helper.md>) (on behalf of the [Seller 💵 domain](<../30 🫥 Agents/04 💳 Payers/01 💵🎭 Seller role.md>)). 
...
1. **What is NLWeb's approach to ads?**
    ...
    1. chat [Host 🤗 domain](<../20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) sends a summary of the [Chat 💬](<../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) to the user's [Wallet app 🧑‍🦰](<../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets>); 
