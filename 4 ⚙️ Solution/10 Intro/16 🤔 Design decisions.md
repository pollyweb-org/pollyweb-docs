...
1. **What is NLWeb's approach to end-user autofill?**
    ...
    - Users [bind 🔗](<../30 🧩 Data/Binds 🔗/🔗 Bind.md>) their [Wallet 🧑‍🦰 app](<../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets>) to multiple [Vault 🗄️ domains](<../41 🎭 Domain Roles/Vaults 🗄️/🗄️🎭 Vault role.md>) holding parts of their personal data (e.g., banks, hospitals, governments);
