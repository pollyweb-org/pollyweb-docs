...
1. **What is NLWeb's approach to end-user payments?**
    ...
    - The payment is sent from the [user's Payer 💳 vault](<../50 🫥 Agents/60 💳 Payers/03 💳🎭 Payer role.md>) (on behalf of the user) to the [Seller's Collector 🏦 vault](<../45 🤲 Helper domains/30 🏦 Collectors/$ 🏦🤲 Collector helper.md>) (on behalf of the [Seller 💵 domain](<../41 🎭 Domain Roles/70 💵 Sellers/💵🎭 Seller role.md>)). 
