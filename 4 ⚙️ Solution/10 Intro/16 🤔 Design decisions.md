...
1. **What is NLWeb's approach to end-user natural language?**
    ...
    NLWeb is designed for Q&A flows (like ChatGPT), where a [Host 🤗 domain](<../20 🧑‍🦰 UI/05 💬 Chats/04 🤗🎭 Host role.md>) asks the questions and defines the format that users are allowed to answer them. 
...
2. **What is NLWeb's approach to conversational commerce?**
    ...
    In NLWeb, [Wallet 🧑‍🦰 apps](<../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets>) are the way for users to communicate with [Host 🤗 domains](<../20 🧑‍🦰 UI/05 💬 Chats/04 🤗🎭 Host role.md>). 
    
    - Similar to [Meta's WhatsApp 📺](<../../2 🏔️ Landscape/1 💼 Business landscape/10 💬 Chatting landscape/06 📺 WhatsApp business.md>), NLWeb [Wallet 🧑‍🦰 apps](<../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets>) allow users to keep a list of active [Chats 💬](<../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>) with [Host 🤗 domains](<../20 🧑‍🦰 UI/05 💬 Chats/04 🤗🎭 Host role.md>). 
    ...
    - New chats are opened with a [Locator 🔆](<../20 🧑‍🦰 UI/04 🔆 Locators/01 🔆 Locator.md>) by scanning a [QR code ✨](<../20 🧑‍🦰 UI/04 🔆 Locators/03 🧑‍🦰✨ Wallet QR scan.md>) or by tapping an [NFC tag 🔆](<../20 🧑‍🦰 UI/04 🔆 Locators/04 🧑‍🦰🔆 Wallet NFC tap.md>). 
    
    - Users may accept [Tokens 🎫](<../20 🧑‍🦰 UI/25 🎫 Tokens/01 🎫 Token.md>) issued by [Issuer 🎴 domains](<../20 🧑‍🦰 UI/25 🎫 Tokens/02 🎴🎭 Issuer role.md>) - these tokens are stored offline and can be shared and validated by [Consumer 💼 domains](<../20 🧑‍🦰 UI/27 💼 Consumers/04 💼🎭 Consumer role.md>).
...
2. **What is NLWeb's approach to location-based interactions?**
    ...
    - Instead, NLWeb advocates for [Chat 💬](<../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>) interactions to always start with the user's explicit intent, either by [scanning ✨ a QR code](<../20 🧑‍🦰 UI/04 🔆 Locators/03 🧑‍🦰✨ Wallet QR scan.md>) or by [tapping 🔆 an NFC tag](<../20 🧑‍🦰 UI/04 🔆 Locators/04 🧑‍🦰🔆 Wallet NFC tap.md>).
...
3. **What is NLWeb's approach to end-user autofill?**
    ...
    - Users [bind 🔗](<../20 🧑‍🦰 UI/24 🗄️ Vaults/01 🔗 Bind.md>) their [Wallet 🧑‍🦰 app](<../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets>) to multiple [Vault 🗄️ domains](<../20 🧑‍🦰 UI/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) holding parts of their personal data (e.g., banks, hospitals, governments);
    ...
    - However, users don't control the [Vault 🗄️ domains](<../20 🧑‍🦰 UI/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>), unlike in [Solid 📺](<../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/02 🧢 Personalization landscape/05 📺 Berners-Lee vaults.md>) and [Affinidi 📺](<../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/02 🧢 Personalization landscape/12 📺 Affinidi.md>);
    ...
    - Nonetheless, [Vault 🗄️ domains](<../20 🧑‍🦰 UI/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) may require users to provide a shared [Storage 📦 vault](<../30 🫥 Agents/01 📦 Storage/01 📦🫥 Storage agent.md>) to store the user's data;
 
        - this is a [Solid 📺](<../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/02 🧢 Personalization landscape/05 📺 Berners-Lee vaults.md>)-like user-centric [Vault 🗄️ domain](<../20 🧑‍🦰 UI/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) that other [Vault 🗄️ domains](<../20 🧑‍🦰 UI/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) may leverage to address [sovereignty 📺](<../../2 🏔️ Landscape/1 💼 Business landscape/02 🏳️ Sovereignty landscape/00 🏳️ Sovereignty index.md>) regulations 
        - e.g., a US-based [Vault 🗄️ domain](<../20 🧑‍🦰 UI/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) may store the data of a German citizen in the citizen's Germany-based [Storage 📦 vault](<../30 🫥 Agents/01 📦 Storage/01 📦🫥 Storage agent.md>).

    - Those [bounded 🔗](<../20 🧑‍🦰 UI/24 🗄️ Vaults/01 🔗 Bind.md>) [Vault 🗄️ domains](<../20 🧑‍🦰 UI/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) allow users to quickly [autofill 📺](<../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/02 🧢 Personalization landscape/06 📺 SSI form auto filling.md>) forms;
    ...
    - [Vault 🗄️ domains](<../20 🧑‍🦰 UI/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) may allow users to change their stored data via the user's [Folder editor 🗂️ domain](<../20 🧑‍🦰 UI/26 🗂️ Folders/01 🗂️ Folder editor.md>);

        - this is a user-centric interface that allows a user to edit their data in multiple [Vault 🗄️ domains](<../20 🧑‍🦰 UI/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) from a single editor;

        - [Vault 🗄️ domains](<../20 🧑‍🦰 UI/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) may require users to have a [Folder editor 🗂️ domain](<../20 🧑‍🦰 UI/26 🗂️ Folders/01 🗂️ Folder editor.md>) to avoid having to build a user interface.
...
4. **What is NLWeb's approach to end-user payments?**
    ...
    NLWeb integrates payments in [Chats 💬](<../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>) between users and [Seller 💵 domains](<../30 🫥 Agents/04 💳 Payers/01 💵🎭 Seller role.md>). 
    ...
    In a [Chat 💬](<../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>): 
    1. the [Seller 💵 domain](<../30 🫥 Agents/04 💳 Payers/01 💵🎭 Seller role.md>) requests a payment amount (e.g., 123.45 USD) - the user accepts; 
    2. the [user's Payer 💳 vault](<../30 🫥 Agents/04 💳 Payers/03 💳🎭 Payer role.md>)  asks for the user's preferred payment method (e.g., my company card, my bank account, agreed credit note) - the user selects one; 
    3. depending on the risk associated (e.g., amount, Seller, date/time) the [user's Payer 💳 vault](<../30 🫥 Agents/04 💳 Payers/03 💳🎭 Payer role.md>)  may ask for an authentication method (e.g., face scan, OTP); 
    4. the [user's Payer 💳 vault](<../30 🫥 Agents/04 💳 Payers/03 💳🎭 Payer role.md>) shares the receipt; 
    5. the [Seller 💵 domain](<../30 🫥 Agents/04 💳 Payers/01 💵🎭 Seller role.md>) shares the order/invoice and delivers/promises the product/service.
...
6. **What is NLWeb's approach to ads?**
    ...
    1. chat [Host 🤗 domain](<../20 🧑‍🦰 UI/05 💬 Chats/04 🤗🎭 Host role.md>) sends a summary of the [Chat 💬](<../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>) to the user's [Wallet app 🧑‍🦰](<../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets>); 
