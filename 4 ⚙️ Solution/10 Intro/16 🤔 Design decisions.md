...
1. **What is NLWeb's approach to conversational commerce?**
    ...
    - Similar to [Meta's WhatsApp 📺](<../../2 🏔️ Landscape/1 💼 Business landscape/10 💬 Chatting landscape/06 📺 WhatsApp business.md>), NLWeb [Wallet 🧑‍🦰 apps](<../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets>) allow users to keep a list of active [Chats 💬](<../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) with [Host 🤗 domains](<../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>). 
...
1. **What is NLWeb's approach to end-user autofill?**
    ...
    - Users [bind 🔗](<../30 🧩 Data/20 🔗 Binds/🔗 Bind.md>) their [Wallet 🧑‍🦰 app](<../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets>) to multiple [Vault 🗄️ domains](<../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>) holding parts of their personal data (e.g., banks, hospitals, governments);
    ...
    - Nonetheless, [Vault 🗄️ domains](<../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>) may require users to provide a shared [Storage 📦 vault](<../50 🫥 Agents/80 📦 Storage/$ 📦🫥 Storage agent.md>) to store the user's data;
        ...
        - e.g., a US-based [Vault 🗄️ domain](<../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>) may store the data of a German citizen in the citizen's Germany-based [Storage 📦 vault](<../50 🫥 Agents/80 📦 Storage/$ 📦🫥 Storage agent.md>).

    - Those [bounded 🔗](<../30 🧩 Data/20 🔗 Binds/🔗 Bind.md>) [Vault 🗄️ domains](<../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>) allow users to quickly [autofill 📺](<../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/02 🧢 Personalization landscape/06 📺 SSI form auto filling.md>) forms;
    ...
    - Data is shared as data sets validated by [Schema Codes 🧩](<../30 🧩 Data/10 🧩 Schema Codes/🧩 Schema Code.md>), instead of as individual properties, thus not allowing [selective disclosure 📺](<../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/02 🧢 Personalization landscape/07 📺 SSI selective disclosure.md>);
    ...
    - [Vault 🗄️ domains](<../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>) may allow users to change their stored data via the user's [Folder editor 🗂️ domain](<../45 🛠️ Helper domains/35 🧑‍💻 Editors/🧑‍💻 Editor.md>);
        ...
        - [Vault 🗄️ domains](<../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>) may require users to have a [Folder editor 🗂️ domain](<../45 🛠️ Helper domains/35 🧑‍💻 Editors/🧑‍💻 Editor.md>) to avoid having to build a user interface.
...
1. **What is NLWeb's approach to end-user payments?**
    ...
    - As preconditions, users must first bind their [Wallet 🧑‍🦰 apps](<../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) to one or more [Payer 💳 vaults](<../50 🫥 Agents/60 💳 Payers/03 💳🎭 Payer role.md>) (e.g., their bank), while [Seller 💵 domains](<../41 🎭 Domain Roles/70 💵 Sellers/💵🎭 Seller role.md>) must bind to [Collector 🏦 vaults](<../45 🛠️ Helper domains/30 🏦 Collectors/$ 🏦🛠️ Collector helper.md>) (e.g., a payment gateway). 

    - The payment is sent from the [user's Payer 💳 vault](<../50 🫥 Agents/60 💳 Payers/03 💳🎭 Payer role.md>) (on behalf of the user) to the [Seller's Collector 🏦 vault](<../45 🛠️ Helper domains/30 🏦 Collectors/$ 🏦🛠️ Collector helper.md>) (on behalf of the [Seller 💵 domain](<../41 🎭 Domain Roles/70 💵 Sellers/💵🎭 Seller role.md>)). 
    ...
    2. the [user's Payer 💳 vault](<../50 🫥 Agents/60 💳 Payers/03 💳🎭 Payer role.md>)  asks for the user's preferred payment method (e.g., my company card, my bank account, agreed credit note) - the user selects one; 
    3. depending on the risk associated (e.g., amount, Seller, date/time) the [user's Payer 💳 vault](<../50 🫥 Agents/60 💳 Payers/03 💳🎭 Payer role.md>)  may ask for an authentication method (e.g., face scan, OTP); 
    4. the [user's Payer 💳 vault](<../50 🫥 Agents/60 💳 Payers/03 💳🎭 Payer role.md>) shares the receipt; 
...
1. **What is NLWeb's approach to ads?**
    ...
    1. chat [Host 🤗 domain](<../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) sends a summary of the [Chat 💬](<../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) to the user's [Wallet app 🧑‍🦰](<../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets>); 
