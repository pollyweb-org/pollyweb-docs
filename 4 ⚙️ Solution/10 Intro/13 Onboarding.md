...
1. **What does a user need to engage in an PollyWeb chat?**
    ...
    To engage in a PollyWeb [Chat 💬](<../35 💬 Chats/Chats 💬/💬 Chat.md>), a user needs an NLWeb-compatible [Wallet 🧑‍🦰 app](<../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>).
...
1. **What is the effort for organizations to onboard PollyWeb?**
    ...
    - Organizations can leverage the PollyWeb Stack to bootstrap, which includes a [Wallet app 🧑‍🦰](<../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>), deployment services, and support services. 
...
1. **What are the steps for a Seller to onboard PollyWeb?**
    ...
    3. Configure [Host 🤗](<../41 🎭 Domain Roles/Hosts 🤗/🤗 Host role/🤗🎭 Host role.md>) workflows integrated with the organization's IT;
    4. Publish a [Manifest 📜](<../30 🧩 Data/Manifests 📜/📜 Manifest/📜 Manifest.md>) with [Trusts 🫡](<../30 🧩 Data/Trusts 🫡/🫡 Domain Trust.md>) to required domains;
...
1. **Can PollyWeb be integrated into existing apps?**

    Yes. 
    - PollyWeb can be added as a chat window to an existing mobile app, allowing the user to interact with the service via text. 
    - The chat component must support the minimum feature requirements for chat over the PollyWeb protocol.
...
1. **Do wallets from Google, Apple, and the EU support PollyWeb?**
    ...
    No. 
    - As of 2025, these wallets don't support the PollyWeb protocol.
