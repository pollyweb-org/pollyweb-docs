...
1. **What does a user need to engage in an NLWeb chat?**
    ...
    To engage in a NLWeb [Chat 💬](<../35 Chats/💬 Chats/💬 Chat.md>), a user needs an NLWeb-compatible [Wallet 🧑‍🦰 app](<../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>).
...
1. **What are the steps for a user to onboard NLWeb?**
    ...
    1. Start touching/scanning NFC/QR [Locators 🔆](<../25 Locators/15 🔆 Locators/🔆 Locator.md>).
...
1. **What are the steps for a Seller to onboard NLWeb?**
    ...
    5. Order a batch of physical [NFC/QR locators 🔆](<../25 Locators/15 🔆 Locators/🔆 Locator.md>) from a [Printer 🖨️](<../45 🤲 Helper domains/75 🖨️ Printers/🖨️🤲 Printer helper.md>);
    6. Deploy [NFC/QR locators 🔆](<../25 Locators/15 🔆 Locators/🔆 Locator.md>) (e.g., web, app, stores, products).
