...
1. **What does a user need to engage in an NLWeb chat?**
    ...
    To engage in a NLWeb [Chat 💬](<../35 💬 Chats/💬 Chats/💬 Chat.md>), a user needs an NLWeb-compatible [Wallet 🧑‍🦰 app](<../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>).
...
1. **What are the steps for a user to onboard NLWeb?**
    ...
    1. Install an NLWeb [Wallet 🧑‍🦰](<../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) from an app store;
...
1. **What is the effort for organizations to onboard NLWeb?**
    ...
    - Organizations can leverage the NLWeb Stack to bootstrap, which includes a [Wallet app 🧑‍🦰](<../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>), deployment services, and support services. 
...
1. **What are the steps for a Seller to onboard NLWeb?**
    ...
    1. Bootstrap the [Seller 💵](<../41 🎭 Domain Roles/Sellers 💵/💵🎭 Seller role.md>) domain (e.g., nlweb.any-seller.com);
    ...
    5. Order a batch of physical [NFC/QR locators 🔆](<../25 🔆 Locators/1 🔆 Locators/🔆 Locator.md>) from a [Printer 🖨️](<../45 🤲 Helper domains/Printers 🖨️/🖨️🤲 Printer helper.md>);
    6. Deploy [NFC/QR locators 🔆](<../25 🔆 Locators/1 🔆 Locators/🔆 Locator.md>) (e.g., web, app, stores, products).
