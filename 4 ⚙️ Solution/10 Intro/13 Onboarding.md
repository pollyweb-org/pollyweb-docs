...
1. **What does a user need to engage in an NLWeb chat?**
    ...
    To engage in a NLWeb [Chat 💬](<../35 💬 Chats/Chats 💬/💬 Chat.md>), a user needs an NLWeb-compatible [Wallet 🧑‍🦰 app](<../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰🛠️ Wallet app.md>).
...
1. **What are the steps for a user to onboard NLWeb?**
    ...
    1. Install an NLWeb [Wallet 🧑‍🦰](<../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰🛠️ Wallet app.md>) from an app store;
...
1. **What is the effort for organizations to onboard NLWeb?**
    ...
    - Organizations can leverage the NLWeb Stack to bootstrap, which includes a [Wallet app 🧑‍🦰](<../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰🛠️ Wallet app.md>), deployment services, and support services. 
