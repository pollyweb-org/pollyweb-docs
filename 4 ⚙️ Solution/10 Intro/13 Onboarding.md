...
1. **What does a user need to engage in an NLWeb chat?**
    ...
    To engage in a NLWeb [Chat 💬](<../35 💬 Chats/Chats 💬/💬 Chat.md>), a user needs an NLWeb-compatible [Wallet 🧑‍🦰 app](<../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>).
...
1. **What is the effort for organizations to onboard NLWeb?**
    ...
    - Organizations can leverage the NLWeb Stack to bootstrap, which includes a [Wallet app 🧑‍🦰](<../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>), deployment services, and support services. 
