...
- Security is assured by:
    ...
    * digital signatures for [Messages 📨](<../40 👥 Domains/41 📨 Comms/01 📨 Domain Message.md>) and [files](<../30 🫥 Agents/05 🆔 Identities/08 🆔🔏 User Signature.md>);
    * global [Firewall 🔥 helper domains](<../40 👥 Domains/43 👍 Trusts/03 🔥🛠️ Firewall helper.md>) that actively monitor the ecosystem;
    * user [Identity 🆔 vault domains](<../30 🫥 Agents/05 🆔 Identities/03 🆔🫥 Identity agent.md>) that authenticate users on behalf of other [domains 👥](<../40 👥 Domains/44 📜 Manifests/00 👥 Domain.md>) while maintaining privacy and legal compliance;
