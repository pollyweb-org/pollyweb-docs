...
* Users interact with [Domains 👥](<../40 👥 Domains/$ 👥 Domains/👥 Domain.md>) using their [Wallet 🧑‍🦰 apps](<../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>).
    ...
    * Each [Notifier 📣 domain](<../20 🧑‍🦰 UI/02 📣 Notifiers/📣 Notifier domain.md>) depends on a [Broker 🤵 domain](<../45 🤲 Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) for [Chat 💬](<../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) orchestration with [Host 🤗 domains](<../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>). 
...
* Users store their data in [Vault 🗄️ domains](<../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>).
    ...
    * [Vault 🗄️ domains](<../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>) may allow users to edit their data through the user's [Folder 🗂️ editor](<../45 🤲 Helper domains/35 🧑‍💻 Editors/🧑‍💻 Editor.md>).
...
* Users designate [Agents 🫥 domains](<../50 🫥 Agents/$ 🫥 Agent Vaults/$ 🫥🗄️ Agent vault.md>) to handle specific well-defined roles in [Chats 💬](<../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) with [Host 🤗 domains](<../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) (e.g., payments).
    ...
    * These [Agents 🫥](<../50 🫥 Agents/$ 🫥 Agent Vaults/$ 🫥🗄️ Agent vault.md>) are [Vault 🗄️ domains](<../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>) that the user told their [Broker 🤵 domain](<../45 🤲 Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) to invoke by default when a role is required.
...
- Domains are extended by helper domains, e.g.:
    ...
    * [Biller 🤝 helper domains](<../45 🤲 Helper domains/20 🤝 Billers/🤝🛠️ Biller helper.md>) for financial contracts, 
    * [Advertiser 👀 helper domains](<../45 🤲 Helper domains/12 👀 Advertisers/👀🛠️ Advertiser helper.md>) for ads.

- Data integration and structural validation is assured via:
    - [Schema Codes 🧩](<../30 🧩 Data/10 🧩 Schema Codes/🧩 Schema Code.md>) that domains and [Authority 🏛️ helper domains](<../45 🤲 Helper domains/14 🏛️ Authorities/$ 🏛️🛠️ Authority helper.md>) can define on their [domain Manifests 📜](<../40 👥 Domains/44 📜 Manifests/📜 Manifest.md>) 
...
- Device integration is assured by:
    - natural language [Relayer 🛰️](<../45 🤲 Helper domains/80 🛰️ Relayers/$ 🛰️🛠️ Relayer helper.md>) domains;
...
- Security is assured by:
    ...
    * global [Firewall 🔥 helper domains](<../45 🤲 Helper domains/40 🔥 Firewalls/$ 🔥🛠️ Firewall helper.md>) that actively monitor the ecosystem;
...
- Performance at a global scale is assured by:
  * a distributed cluster of [Listener 👂 helper domains](<../45 🤲 Helper domains/60 👂 Listeners/👂🛠️ Listener helper.md>) that propagate [Schema Codes 🧩](<../30 🧩 Data/10 🧩 Schema Codes/🧩 Schema Code.md>) and [Trusts 👍](<../40 👥 Domains/43 👍 Trusts/👍 Domain Trust.md>) from [domain Manifests 📜](<../40 👥 Domains/44 📜 Manifests/📜 Manifest.md>) in near-real time;
  * and [Graph 🕸 helper domains](<../45 🤲 Helper domains/50 🕸 Graphs/🕸🛠️ Graph helper.md>) that cache them to support high-performant queries from any [domain 👥](<../40 👥 Domains/$ 👥 Domains/👥 Domain.md>).
