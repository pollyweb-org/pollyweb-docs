...
- Security is assured by:
    ...
    * user [Identity 🆔 vault domains](<../50 🫥 Agent domains/Identities 🆔/🆔🫥 Identity agent.md>) that authenticate users on behalf of other [domains 👥](<../40 👥 Domains/👥 Domain/👥 Domain.md>) while maintaining privacy and legal compliance;
