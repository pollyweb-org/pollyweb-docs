...
* Users store their data in [Vault 🗄️ domains](<../41 🎭 Domain Roles/80 🗄️ Vault/$ 🗄️🎭 Vault role.md>).
    ...
    * [Vault 🗄️ domains](<../41 🎭 Domain Roles/80 🗄️ Vault/$ 🗄️🎭 Vault role.md>) may allow users to edit their data through the user's [Folder 🗂️ editor](<../45 🛠️ Helper domains/26 🗂️ Folders/$ 🗂️ Folder editor.md>).
...
* Users designate [Agents 🫥 domains](<../25 Data/24 🗄️ Vaults/04 🫥🗄️ Agent vault.md>) to handle specific well-defined roles in [Chats 💬](<../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) with [Host 🤗 domains](<../20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) (e.g., payments).
    ...
    * These [Agents 🫥](<../25 Data/24 🗄️ Vaults/04 🫥🗄️ Agent vault.md>) are [Vault 🗄️ domains](<../41 🎭 Domain Roles/80 🗄️ Vault/$ 🗄️🎭 Vault role.md>) that the user told their [Broker 🤵 domain](<../20 🧑‍🦰 UI/03 🤵 Brokers/03 🤵 Broker domain.md>) to invoke by default when a role is required.
...
- Organizations interact with an email-like inbox API behind a domain name, and can assume a multitude of roles in parallel - e.g.:
    ...
    * user-bound [Vault 🗄️](<../41 🎭 Domain Roles/80 🗄️ Vault/$ 🗄️🎭 Vault role.md>), 
