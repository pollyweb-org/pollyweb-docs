...
4. **What is NLWeb's approach to end-user payments?**
    ...
    - As preconditions, users must first bind their [Wallets 🧑‍🦰](<../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) to one or more [Payer 💳](<../30 🫥 Agents/04 💳 Payers/02 💳🫥 Payer agent.md>) vaults (e.g., their bank), while [Seller 💵](<../30 🫥 Agents/04 💳 Payers/01 💵🎭 Seller role.md>) domains must bind to [Collector 🏦](<../30 🫥 Agents/01 📦 Storage/03 🏦🛠️ Collector helper.md>) vaults (e.g., a payment gateway). 

    - The payment is sent from the [Payer 💳](<../30 🫥 Agents/04 💳 Payers/02 💳🫥 Payer agent.md>) (on behalf of the user) to the [Collector 🏦](<../30 🫥 Agents/01 📦 Storage/03 🏦🛠️ Collector helper.md>) (on behalf of the Seller). 
    
    In a chat: 
    1. the [Seller 💵](<../30 🫥 Agents/04 💳 Payers/01 💵🎭 Seller role.md>) requests a payment amount (e.g., 123.45 USD) - the user accepts; 
    2. the [Payer 💳](<../30 🫥 Agents/04 💳 Payers/02 💳🫥 Payer agent.md>)  asks for the user's preferred payment method (e.g., my company card, my bank account, agreed credit note) - the user selects one; 
    3. depending on the risk associated (e.g., amount, Seller, date/time) the [Payer 💳](<../30 🫥 Agents/04 💳 Payers/02 💳🫥 Payer agent.md>)  may ask for an authentication method (e.g., face scan, OTP); 
    4. the [Payer 💳](<../30 🫥 Agents/04 💳 Payers/02 💳🫥 Payer agent.md>) shares the receipt; 
...
5. **What is NLWeb's approach to subscriptions?**
    ...
    NLWeb supports subscriptions via [Payer 💳](<../30 🫥 Agents/04 💳 Payers/02 💳🫥 Payer agent.md>) and [Collector 🏦](<../30 🫥 Agents/01 📦 Storage/03 🏦🛠️ Collector helper.md>) domains (explore to the payment sections for details). 
