...
4. **What is NLWeb's approach to end-user payments?**
    ...
    - As preconditions, users must first bind their [Wallets 🧑‍🦰](<../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) to one or more [Payer 💳](<../30 🫥 Agents/04 💳 Payers/03 💳🎭 Payer role.md>) vaults (e.g., their bank), while [Seller 💵](<../30 🫥 Agents/04 💳 Payers/01 💵🎭 Seller role.md>) domains must bind to [Collector 🏦](<../30 🫥 Agents/04 💳 Payers/02 🏦🛠️ Collector helper.md>) vaults (e.g., a payment gateway). 

    - The payment is sent from the [Payer 💳](<../30 🫥 Agents/04 💳 Payers/03 💳🎭 Payer role.md>) (on behalf of the user) to the [Collector 🏦](<../30 🫥 Agents/04 💳 Payers/02 🏦🛠️ Collector helper.md>) (on behalf of the Seller). 
...
5. **What is NLWeb's approach to subscriptions?**
    ...
    NLWeb supports subscriptions via [Payer 💳](<../30 🫥 Agents/04 💳 Payers/03 💳🎭 Payer role.md>) and [Collector 🏦](<../30 🫥 Agents/04 💳 Payers/02 🏦🛠️ Collector helper.md>) domains (explore to the payment sections for details). 
