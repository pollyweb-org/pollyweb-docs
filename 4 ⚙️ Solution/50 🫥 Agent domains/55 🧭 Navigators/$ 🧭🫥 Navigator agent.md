...
1. **What are Navigator domains**?
    ...
    * built from community-defined map points in [domain Manifests 📜](<../../40 👥 Domains/👥📜 Domain Manifests/📜 Manifest.md>).
...
1. **How do Navigators help in multi-level places?**
    ...
    * Signs with [Locators 🔆](<../../25 Locators/15 🔆 Locators/🔆 Locator.md>) are spread through the premisses (e.g., walls, posts).
    * Users read these [navigation Locators 🔆](<../../25 Locators/15 🔆 Locators/🔆 Locator.md>) with their [Wallet 🧑‍🦰 apps](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>).
    * Each [navigation Locators 🔆](<../../25 Locators/15 🔆 Locators/🔆 Locator.md>) points to a geographical point described in a [domain Manifest 📜](<../../40 👥 Domains/👥📜 Domain Manifests/📜 Manifest.md>).
