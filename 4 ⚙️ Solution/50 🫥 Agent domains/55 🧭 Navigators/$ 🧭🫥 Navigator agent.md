...
1. **How do Navigators help in multi-level places?**
    ...
    * Each [navigation Locators 🔆](<../../30 🧩 Data/15 🔆 Locators/$ 🔆 Locator.md>) points to a geographical point described in a [domain Manifest 📜](<../../40 👥 Domains/44 📜 Manifests/📜 Manifest.md>).
