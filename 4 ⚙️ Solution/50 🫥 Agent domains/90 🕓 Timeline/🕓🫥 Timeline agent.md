...
1. **What is a Timeline?**
    ...
    Timelines are user-bound [Vaults 🗄️](<../../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>) that anonymously store user events over time, mapping each event to a metric represented by a [Schema Code 🧩](<../../30 Data/1 🧩 Schema Codes/🧩 Schema Code.md>).
