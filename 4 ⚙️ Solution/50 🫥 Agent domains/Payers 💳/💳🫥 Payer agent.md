...
1. **What is a Payer agent in PollyWeb?**
    ...
    Payer agents are [Payer 💳 domains](<../../41 🎭 Domain Roles/Payers/💳🎭 Payer role.md>) that act as [Agent 🫥 vault domains](<../$/🫥🗄️ Agent vault.md>) for users with [Wallet 🧑‍🦰 apps](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>), interacting in [Chats 💬](<../../35 💬 Chats/Chats 💬/💬 Chat.md>) with [Seller 💵 host domains](<../../41 🎭 Domain Roles/Sellers 💵/💵 Seller /💵🎭 Seller role.md>).
...
1. **How are user payments processed for users?**
    ...
    * [Collector 🏦 helpers](<../../45 🤲 Helper domains/Collectors 🏦/🏦 Collector/🏦🤲 Collector helper.md>) - these are [Helper 🤲 domains](<../../41 🎭 Domain Roles/Helpers 🤲/🤲 Helper/🤲🎭 Helper role.md>) able to deposit money on the [Sellers 💵](<../../41 🎭 Domain Roles/Sellers 💵/💵 Seller /💵🎭 Seller role.md>) bank account. 
    ...
    Upon check-out, 
    - 1/ the [Seller 💵](<../../41 🎭 Domain Roles/Sellers 💵/💵 Seller /💵🎭 Seller role.md>) registers the upcoming payment to their [Collector 🏦](<../../45 🤲 Helper domains/Collectors 🏦/🏦 Collector/🏦🤲 Collector helper.md>), 
    - 2/ the [Seller 💵](<../../41 🎭 Domain Roles/Sellers 💵/💵 Seller /💵🎭 Seller role.md>) requests a payment from the user, 
    - 3/ the user delegates the payment to a Payer 💳, 
    - 4/ the user's Payer 💳 transfers the money to the [Seller's 💵](<../../41 🎭 Domain Roles/Sellers 💵/💵 Seller /💵🎭 Seller role.md>) [Collector 🏦](<../../45 🤲 Helper domains/Collectors 🏦/🏦 Collector/🏦🤲 Collector helper.md>), and 
    - 5/ the [Collector 🏦](<../../45 🤲 Helper domains/Collectors 🏦/🏦 Collector/🏦🤲 Collector helper.md>) notifies the [Seller 💵](<../../41 🎭 Domain Roles/Sellers 💵/💵 Seller /💵🎭 Seller role.md>) that the transaction was paid.
...
1. **What responsibilities do Payers have in a payment?**
    ...
    - receiving payment requests from [Collectors 🏦](<../../45 🤲 Helper domains/Collectors 🏦/🏦 Collector/🏦🤲 Collector helper.md>);
...
1. **After a payment, do users receive the Seller's receipt?**
    ...
    - Receipts and invoices are created by the Seller's 💵 [Collector 🏦 helper](<../../45 🤲 Helper domains/Collectors 🏦/🏦 Collector/🏦🤲 Collector helper.md>), and are sent to the user's Payer 💳 domain. 
