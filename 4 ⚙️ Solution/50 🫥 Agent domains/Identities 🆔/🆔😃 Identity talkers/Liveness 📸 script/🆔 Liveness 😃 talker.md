...
1. **Why do we need the first call to the [Hosted 📦 domain](<../../../../55 👷 Build domains/Hosteds 📦/📦👥 Hosted domain.md>)?**
    ...
    The first call to the `Liveness` function on the [Hosted 📦 domain](<../../../../55 👷 Build domains/Hosteds 📦/📦👥 Hosted domain.md>) allows the [Identity 🆔 domain](<../../🆔 Identity agent/🆔 Identity 🫥 agent.md>) to pass the context data in the backend, instead of sending the context to the [Wallet 🧑‍🦰 app](<../../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>).
