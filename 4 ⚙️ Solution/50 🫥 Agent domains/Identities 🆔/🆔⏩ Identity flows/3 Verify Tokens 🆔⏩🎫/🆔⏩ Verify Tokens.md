...
1. **How does it work?**
    ...
    The flow of an [Issuer 🎴 domain](<../../../../41 🎭 Domain Roles/Issuers 🎴/🎴 Issuer/🎴🎭 Issuer role.md>) issuing a [Token 🎫](<../../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) with [Identity 🆔](<../../🆔 Identity agent/🆔 Identity 🫥 agent.md>)  is as follows.
    ...
    | B| `Locator` | The [Issuer 🎴 domain](<../../../../41 🎭 Domain Roles/Issuers 🎴/🎴 Issuer/🎴🎭 Issuer role.md>) asks the user's [Identity 🆔 domain](<../../🆔 Identity agent/🆔 Identity 🫥 agent.md>) to generate a unique [Identity Locator 🔆](<../../../../25 🔆 Locators/Locators 🔆/🔆 Locator.md>) with a given expiration date:<br/>• unique [Locators 🔆](<../../../../25 🔆 Locators/Locators 🔆/🔆 Locator.md>) prevent attackers from relating any two [Tokens 🎫](<../../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) from the same user; <br/>• expiration dates allow [Identity 🆔 domains](<../../🆔 Identity agent/🆔 Identity 🫥 agent.md>) to charge the [Issuer 🎴 domain](<../../../../41 🎭 Domain Roles/Issuers 🎴/🎴 Issuer/🎴🎭 Issuer role.md>) for the commitment length.
    ...
    | 2| `Verify` | The [Consumer 💼 domain](<../../../../41 🎭 Domain Roles/Consumers 💼/💼 Consumer/💼🎭 Consumer role.md>), via the [Broker 🤵 domain](<../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵 Broker helper/🤵 Broker 🤲 helper.md>), asks the [Identity 🆔 domain](<../../🆔 Identity agent/🆔 Identity 🫥 agent.md>) in the [Token 🎫](<../../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) to verify the user, ensuring that the [Wallet 🧑‍🦰 app](<../../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>) holder is the [Token 🎫](<../../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) owner <br/> - i.e. the human referenced in the [Identity Locator 🔆](<../../../../25 🔆 Locators/Locators 🔆/🔆 Locator.md>).
    | 3 | `Selfie` | The [Identity 🆔 domain](<../../🆔 Identity agent/🆔 Identity 🫥 agent.md>) authenticates the user (e.g., face scan, OTP, security questions); <br/> • the [Identity 🆔 domain](<../../🆔 Identity agent/🆔 Identity 🫥 agent.md>) confirms to the [Consumer 💼 domain](<../../../../41 🎭 Domain Roles/Consumers 💼/💼 Consumer/💼🎭 Consumer role.md>) that the [Wallet 🧑‍🦰 app](<../../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>) holder is the [Token 🎫](<../../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) owner.
...
1. **How do domains authenticate printed identity-bound Tokens?**
    ...
    - 2/ the [Consumer 💼 domain](<../../../../41 🎭 Domain Roles/Consumers 💼/💼 Consumer/💼🎭 Consumer role.md>) verifies the [Trust 🫡 relationships](<../../../../30 🧩 Data/Trusts 🫡/🫡 Domain Trust.md>)  with the [Token's Issuer 🎴 domain](<../../../../41 🎭 Domain Roles/Issuers 🎴/🎴 Issuer/🎴🎭 Issuer role.md>) and [Identity 🆔 domain](<../../🆔 Identity agent/🆔 Identity 🫥 agent.md>);
    ...
    - 5/ the [Consumer 💼 domain](<../../../../41 🎭 Domain Roles/Consumers 💼/💼 Consumer/💼🎭 Consumer role.md>) asks the [Token's Identity 🆔 domain](<../../🆔 Identity agent/🆔 Identity 🫥 agent.md>) to match the biometrics with the [Identity Locator 🔆](<../../../../25 🔆 Locators/Locators 🔆/🔆 Locator.md>);
    - 6/ the [Identity 🆔 domain](<../../🆔 Identity agent/🆔 Identity 🫥 agent.md>) confirms to the [Consumer 💼 domain](<../../../../41 🎭 Domain Roles/Consumers 💼/💼 Consumer/💼🎭 Consumer role.md>) that the biometrics match the [Token 🎫](<../../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) owner.
