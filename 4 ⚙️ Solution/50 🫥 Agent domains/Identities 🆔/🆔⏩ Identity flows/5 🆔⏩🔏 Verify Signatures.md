...
1. **How do users sign a document?**
    ...
    * this allows users to visualize the full final version of the document, similar to what humans do today with any paper document. 
    ...
    - 2/ the human holding the [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰🛠️ Wallet app.md>) has the given personally identifiable information (PII).
...
1. **How does it work?**
    ...
    |#|Step
    |-|-
    |1| [Hosts 🤗](<../../../41 🎭 Domain Roles/Hosts 🤗/🤗 Host role/🤗🎭 Host role.md>) ask [Wallets 🧑‍🦰](<../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰🛠️ Wallet app.md>) for a user signature
    | 2| [Wallets 🧑‍🦰](<../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰🛠️ Wallet app.md>) validate the hash against the PDF bytes
    | 3| [Wallets 🧑‍🦰](<../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰🛠️ Wallet app.md>) show the PDF content to the user
    | 4| Users accept the PDF content and the signature request;
    | 5| [Wallets 🧑‍🦰](<../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰🛠️ Wallet app.md>) ask [Identities 🆔](<../🆔🫥 Identity agent.md>) to sign the hash on users' behalf 
