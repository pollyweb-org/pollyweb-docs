...
1. **What are the benefits of Token Identity binding?**
    ...
    * independent of the [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) the [Token 🎫](<../../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) is stored in, 
    * or whoever is holding that [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) when presenting the [Token 🎫](<../../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>);
...
1. **How does it work?**
    ...
    |C| `Token` | The [Issuer 🎴 domain](<../../../41 🎭 Domain Roles/Issuers 🎴/🎴🎭 Issuer role.md>) offers the [Token 🎫](<../../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) for the user to download: <br/> • the user downloads the [Token 🎫](<../../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) and stores it offline in the [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>).
    |

    <br/>

    The flow for a user to share a [Token 🎫](<../../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) with a [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) using their [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) is as follows.
