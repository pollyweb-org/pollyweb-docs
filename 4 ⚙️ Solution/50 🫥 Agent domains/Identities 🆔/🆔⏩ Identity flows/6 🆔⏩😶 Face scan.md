...
1. **What can users present in the first step of the flow?**
    ...
    | Presented | Question
    |-|-
    | 🧑‍🦰 [Wallet](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) | Is it really the [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) owner holding the device?
    |[🎫 Token](<../../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>)| Was the [Token 🎫](<../../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) really issued to the person holding the device?
    |[💍 Userable](<../../../25 🔆 Locators/4 💍 Userables/💍💠 Userable thing.md>)| Is it really the [Userable 💍](<../../../25 🔆 Locators/4 💍 Userables/💍💠 Userable thing.md>) owner [tapping 🔆](<../../../25 🔆 Locators/1 🔆 Locators/🔆⏩ Locator flows/🧑‍🦰🔆 Wallet NFC tap.md>) it on a scanner?
...
1. **How does NLWeb face verification compares with other technologies?**
    ...
    * NLWeb has a high security when we evaluate what the user has, is, and knows.
    ...
    |-|-|-|-|-|-|-|-
    | `Has`   | Phone | Phone | QR code | [Wallet 🧑‍🦰](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) | NFC card | - | [NFC 💍](<../../../25 🔆 Locators/4 💍 Userables/💍💠 Userable thing.md>) |
