...
1. **What are the benefits of Token Identity binding?**
    ...
    Identity binding 
    * allows [Issuer 🎴 domains](<../../../41 🎭 Domain Roles/Issuers 🎴/🎴🎭 Issuer role.md>) to lock a given [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>) to a specific human, 
    * independent of the [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) the [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>) is stored in, 
    * or whoever is holding that [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) when presenting the [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>);
...
1. **How does it work?**
    ...
    The flow of an [Issuer 🎴 domain](<../../../41 🎭 Domain Roles/Issuers 🎴/🎴🎭 Issuer role.md>) issuing a [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>) with [Identity 🆔](<../🆔🫥 Identity agent.md>)  is as follows.
    ...
    |C| `Token` | The [Issuer 🎴 domain](<../../../41 🎭 Domain Roles/Issuers 🎴/🎴🎭 Issuer role.md>) offers the [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>) for the user to download: <br/> • the user downloads the [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>) and stores it offline in the [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>).
    |

    <br/>

    The flow for a user to share a [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>) with a [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) using their [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) is as follows.

    |#|Category|Step
    |-|-|-
    | 1| `Share` | The user initiates a chat session with a [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>): <br/> • the [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) asks the user to share [Tokens 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>) of a specific [Schema Code 🧩](<../../../30 🧩 Data/1 🧩 Schema Codes/🧩 Schema Code.md>); <br/> • if the [Schema Code 🧩](<../../../30 🧩 Data/1 🧩 Schema Codes/🧩 Schema Code.md>) is marked as `SELF` and the [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) is the [Issuer 🎴 domain](<../../../41 🎭 Domain Roles/Issuers 🎴/🎴🎭 Issuer role.md>), then the sharing is silent;<br/> • otherwise, the user has to explicitly select the [Tokens 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>) to share; <br/> • the [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) verifies if the signature of the [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>)  matches the [DKIM 📨](<../../../30 🧩 Data/Messages 📨/📨 Message.md>) of the [Issuer 🎴 domain](<../../../41 🎭 Domain Roles/Issuers 🎴/🎴🎭 Issuer role.md>).
    | 2| `Verify` | The [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>), via the [Broker 🤵 domain](<../../../20 🧑‍🦰 UI/3 🤵 Brokers/🤵🤲 Broker helper.md>), asks the [Identity 🆔 domain](<../🆔🫥 Identity agent.md>) in the [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>) to verify the user, ensuring that the [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) holder is the [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>) owner <br/> - i.e. the human referenced in the [Identity Locator 🔆](<../../../25 🔆 Locators/1 🔆 Locators/🔆 Locator.md>).
    | 3 | `Selfie` | The [Identity 🆔 domain](<../🆔🫥 Identity agent.md>) authenticates the user (e.g., face scan, OTP, security questions); <br/> • the [Identity 🆔 domain](<../🆔🫥 Identity agent.md>) confirms to the [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) that the [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) holder is the [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>) owner.
...
1. **How do domains authenticate printed identity-bound Tokens?**
    ...
    The flow for a user to share an offline [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>) with a [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) is as follows:
    ...
    - 3/ the [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) verifies if the [Token's 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>) signature matches the [DKIM 📨](<../../../30 🧩 Data/Messages 📨/📨 Message.md>)  of the [Issuer 🎴 domain](<../../../41 🎭 Domain Roles/Issuers 🎴/🎴🎭 Issuer role.md>);
    ...
    - 6/ the [Identity 🆔 domain](<../🆔🫥 Identity agent.md>) confirms to the [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) that the biometrics match the [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token.md>) owner.
