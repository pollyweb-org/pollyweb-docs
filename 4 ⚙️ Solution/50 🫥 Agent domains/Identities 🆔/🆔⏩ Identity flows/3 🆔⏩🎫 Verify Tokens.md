...
1. **How does it work?**
    ...
    The flow of an [Issuer 🎴 domain](<../../../41 🎭 Domain Roles/Issuers 🎴/🎴 Issuer/🎴🎭 Issuer role.md>) issuing a [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) with [Identity 🆔](<../🆔🫥 Identity agent.md>)  is as follows.
    ...
    The flow for a user to share a [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) with a [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) using their [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>) is as follows.

    |#|Category|Step
    |-|-|-
    | 1| `Share` | The user initiates a chat session with a [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>): <br/> • the [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) asks the user to share [Tokens 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) of a specific [Schema 🧩](<../../../30 🧩 Data/Codes 🧩/🧩 Schema Code.md>); <br/> • if the [Schema 🧩](<../../../30 🧩 Data/Codes 🧩/🧩 Schema Code.md>) is marked as `SELF` and the [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) is the [Issuer 🎴 domain](<../../../41 🎭 Domain Roles/Issuers 🎴/🎴 Issuer/🎴🎭 Issuer role.md>), then the sharing is silent;<br/> • otherwise, the user has to explicitly select the [Tokens 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) to share; <br/> • the [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) verifies if the signature of the [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>)  matches the [DKIM 📨](<../../../30 🧩 Data/Messages 📨/📨 Message/📨 Message.md>) of the [Issuer 🎴 domain](<../../../41 🎭 Domain Roles/Issuers 🎴/🎴 Issuer/🎴🎭 Issuer role.md>).
    | 2| `Verify` | The [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>), via the [Broker 🤵 domain](<../../../20 🧑‍🦰 UI/Brokers 🤵/🤵 Broker helper/🤵 Broker 🤲 helper.md>), asks the [Identity 🆔 domain](<../🆔🫥 Identity agent.md>) in the [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) to verify the user, ensuring that the [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>) holder is the [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) owner <br/> - i.e. the human referenced in the [Identity Locator 🔆](<../../../25 🔆 Locators/Locators 🔆/🔆 Locator.md>).
    | 3 | `Selfie` | The [Identity 🆔 domain](<../🆔🫥 Identity agent.md>) authenticates the user (e.g., face scan, OTP, security questions); <br/> • the [Identity 🆔 domain](<../🆔🫥 Identity agent.md>) confirms to the [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) that the [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>) holder is the [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) owner.
...
1. **How do domains authenticate printed identity-bound Tokens?**
    ...
    The flow for a user to share an offline [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) with a [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) is as follows:
    ...
    - 2/ the [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) verifies the [Trust 🫡 relationships](<../../../30 🧩 Data/Trusts 🫡/🫡 Domain Trust.md>)  with the [Token's Issuer 🎴 domain](<../../../41 🎭 Domain Roles/Issuers 🎴/🎴 Issuer/🎴🎭 Issuer role.md>) and [Identity 🆔 domain](<../🆔🫥 Identity agent.md>);
    - 3/ the [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) verifies if the [Token's 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) signature matches the [DKIM 📨](<../../../30 🧩 Data/Messages 📨/📨 Message/📨 Message.md>)  of the [Issuer 🎴 domain](<../../../41 🎭 Domain Roles/Issuers 🎴/🎴 Issuer/🎴🎭 Issuer role.md>);
    - 4/ the [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) collects the user's biometrics;
    ...
    - 5/ the [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) asks the [Token's Identity 🆔 domain](<../🆔🫥 Identity agent.md>) to match the biometrics with the [Identity Locator 🔆](<../../../25 🔆 Locators/Locators 🔆/🔆 Locator.md>);
    - 6/ the [Identity 🆔 domain](<../🆔🫥 Identity agent.md>) confirms to the [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) that the biometrics match the [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) owner.
