...
1. **How does it work?**
    ...
    | 2| `Verify` | The [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>), via the [Broker 🤵 domain](<../../../20 🧑‍🦰 UI/Brokers 🤵/🤵 Broker helper/Broker 🤵 helper 🤲.md>), asks the [Identity 🆔 domain](<../🆔🫥 Identity agent.md>) in the [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) to verify the user, ensuring that the [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>) holder is the [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) owner <br/> - i.e. the human referenced in the [Identity Locator 🔆](<../../../25 🔆 Locators/Locators 🔆/🔆 Locator.md>).
