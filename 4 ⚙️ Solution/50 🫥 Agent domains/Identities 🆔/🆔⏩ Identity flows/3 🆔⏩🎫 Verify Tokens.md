...
1. **How do domains authenticate printed identity-bound Tokens?**
    ...
    - 2/ the [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼 Consumer/💼🎭 Consumer role.md>) verifies the [Trust 🫡 relationships](<../../../30 🧩 Data/Trusts 🫡/🫡 Domain Trust.md>)  with the [Token's Issuer 🎴 domain](<../../../41 🎭 Domain Roles/Issuers 🎴/🎴 Issuer/🎴🎭 Issuer role.md>) and [Identity 🆔 domain](<../🆔🫥 Identity agent.md>);
    ...
    - 5/ the [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼 Consumer/💼🎭 Consumer role.md>) asks the [Token's Identity 🆔 domain](<../🆔🫥 Identity agent.md>) to match the biometrics with the [Identity Locator 🔆](<../../../25 🔆 Locators/Locators 🔆/🔆 Locator.md>);
    - 6/ the [Identity 🆔 domain](<../🆔🫥 Identity agent.md>) confirms to the [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼 Consumer/💼🎭 Consumer role.md>) that the biometrics match the [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) owner.
