...
1. **How do domains authenticate printed identity-bound Tokens?**
    ...
    - 3/ the [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) verifies if the [Token's 🎫](<../../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) signature matches the [DKIM 📨](<../../../40 👥 Domains/📨 Messages/📨 Message.md>)  of the [Issuer 🎴 domain](<../../../41 🎭 Domain Roles/Issuers 🎴/🎴🎭 Issuer role.md>);
