...
1. **How does it work?**
    ...
    |#|Step
    |-|-
    |1| [Hosts 🤗](<../../41 🎭 Domain Roles/Hosts 🤗/🤗🎭 Host role.md>) ask [Wallets 🧑‍🦰](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) for a user signature
    ...
    | 7| [Identities 🆔](<🆔🫥 Identity agent.md>) issue a signature [Token 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) and send it to [Hosts 🤗](<../../41 🎭 Domain Roles/Hosts 🤗/🤗🎭 Host role.md>)
