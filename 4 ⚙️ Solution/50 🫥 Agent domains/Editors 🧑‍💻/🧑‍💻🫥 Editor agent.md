...
1. **How can users add a vault to the editor?**
    ...
    When clicking the "Add Vault" button in the desktop app, the [Editor 🧑‍💻 agent](<🧑‍💻🫥 Editor agent.md>) initiates a [Chat 💬](<../../35 💬 Chats/Chats 💬/💬 Chat.md>) with the user's [Wallet 🧑‍🦰](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>) - the interaction described in [Bind to Editor 🧑‍💻 domains](<🧑‍💻💬 Editor chats/🧑‍💻💬 Bind to Vault.md>).
...
1. **Is the user's data stored on the editor?**
    ...
    No. 
    - [Editor 🧑‍💻 domains](<🧑‍💻🫥 Editor agent.md>) only store a references to [Wallet 🧑‍🦰 apps](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>) and [Binds 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>).
