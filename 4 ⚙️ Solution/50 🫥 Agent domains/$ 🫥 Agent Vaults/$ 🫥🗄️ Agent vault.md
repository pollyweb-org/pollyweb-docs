...
1. **What are examples of Agent roles?**
    ...
    |🧳| [Custodian](<../35 🧳 Custodians/$ 🧳🫥 Custodian agent.md>) | FindMy | Manages the user's [Things 💠](<../../25 Locators/71 💠 Things/💠 Thing.md>), including [Userables 💍](<../../70 🌳 Ambient/74 💍 Userables/$ 💍 Userable thing.md>) and [⌚ Tapbands](<../../70 🌳 Ambient/76 ⌚ Tapbands/$ ⌚💠 Tapband thing.md>).
