...
9.  **Does NLWeb allow users to pay with NFC contactless?**
    ...
    - However, users can tap on a NLWeb [🔆 NFC Locator](<../../30 🧩 Data/15 🔆 Locators/$ 🔆 Locator.md>) with their devices to check out an NLWeb transaction, while continuing to use the device's standard NFC payments for traditional point of sale (POS) terminals. 
