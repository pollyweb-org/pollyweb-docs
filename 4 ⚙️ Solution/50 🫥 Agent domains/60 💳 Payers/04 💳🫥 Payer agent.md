...
1. **What is a Payer agent in NLWeb?**
    ...
    Payer agents are [Payer 💳 domains](<03 💳🎭 Payer role.md>) that act as [Agent 🫥 vault domains](<../$ 🫥 Agent Vaults/$ 🫥🗄️ Agent vault.md>) for users with [Wallet 🧑‍🦰 apps](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>), interacting in [Chats 💬](<../../35 Chats/12 💬 Chats/$ 💬 Chat.md>) with [Seller 💵 host domains](<../../41 🎭 Domain Roles/70 💵 Sellers/💵🎭 Seller role.md>).
