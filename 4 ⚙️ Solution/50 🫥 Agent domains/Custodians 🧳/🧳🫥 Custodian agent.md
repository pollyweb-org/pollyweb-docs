...
1. **What user Things can a Custodian manage?**
    ...
    | [🤖 Robots](<../../25 🔆 Locators/Robots 🤖/🤖💠 Robot thing.md>) | [Thing 💠](<../../25 🔆 Locators/2 💠 Things/💠🔆 Thing locator.md>) embedded to control an electrical device:<br/> • e.g.: a coffee machine, a printer, or a vehicle. 
    | [💍 Userables](<../../25 🔆 Locators/Userables 💍/💍💠 Userable thing.md>) | [Thing 💠](<../../25 🔆 Locators/2 💠 Things/💠🔆 Thing locator.md>) that also pays and enters secure areas: <br/> • e.g., jewelry, glasses, key-holders.
