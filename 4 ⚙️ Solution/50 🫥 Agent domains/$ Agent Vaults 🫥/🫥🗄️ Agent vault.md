...
1. **What are examples of Agent roles?**
    ...
    |🔎| [Finder](<../Finders 🔎/🔎🫥 Finder agent.md>) | Google | Searches for [Host 🤗 domains](<../../41 🎭 Domain Roles/Hosts 🤗/🤗🎭 Host role.md>), and  introduces them when they start a [Chat 💬](<../../35 💬 Chats/Chats 💬/💬 Chat.md>).
