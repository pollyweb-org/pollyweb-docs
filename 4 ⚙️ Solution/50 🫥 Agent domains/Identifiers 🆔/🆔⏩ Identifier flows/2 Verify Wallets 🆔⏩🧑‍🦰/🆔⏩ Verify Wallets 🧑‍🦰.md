...
1. **How to verify a Wallet ownership?**
    ...
    * for the ownership of a [Wallet 🧑‍🦰 app](<../../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>).
...
1. **How does remote face verification works?**
    ...
    | # | Step
    |-|-
    |1| The user's [Wallet 🧑‍🦰 app](<../../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>) <br/>• opens a web-browser window <br/>• to the liveness check URL of the [Locator's Identity 🆔 vault](<../../🆔 Identifier agent/🆔 Identifier 🫥 agent.md>), <br/>• passing anti-fraud information like device location and device configurations.
    |2| The webpage of the [Identity 🆔 vault](<../../🆔 Identifier agent/🆔 Identifier 🫥 agent.md>) <br/>• activates the device's camera to record the user's video for liveness check <br/>• extracts the relevant images <br/>• and compares them to the user images on the given [Locator 🔆](<../../../../25 🔆 Locators/Locators 🔆/🔆 Locator.md>). 
    |3| Additionally, depending on the anti-fraud contextualized info, <br/>• the [Identity 🆔 vault](<../../🆔 Identifier agent/🆔 Identifier 🫥 agent.md>) asks security questions and one-time-passwords (OTP).
...
1. **How are users' face biometrics protected from Sellers?**
    ...
    NLWeb advocates for online face authentication between [Wallet 🧑‍🦰 apps](<../../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>) and [Identity 🆔 vaults](<../../🆔 Identifier agent/🆔 Identifier 🫥 agent.md>), without sharing user biometrics with [Seller 💵 domains](<../../../../41 🎭 Domain Roles/Sellers 💵/💵 Seller /💵🎭 Seller role.md>);
    ...
    - it contacts the [Token's  Identity 🆔 domain](<../../🆔 Identifier agent/🆔 Identifier 🫥 agent.md>) to perform the authentication 
    - via the user's [Wallet 🧑‍🦰 app](<../../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>) in a [Chat 💬](<../../../../35 💬 Chats/Chats 💬/💬 Chat.md>), 
    - and only return a success/failure to the [Seller 💵 domain](<../../../../41 🎭 Domain Roles/Sellers 💵/💵 Seller /💵🎭 Seller role.md>) . 
    ...
    * then the [Seller 💵 domain](<../../../../41 🎭 Domain Roles/Sellers 💵/💵 Seller /💵🎭 Seller role.md>) needs to take the user's picture 
    * with a fixed camera in a supervised fashion, 
    * then ask the [Token's  Identity 🆔 domain](<../../🆔 Identifier agent/🆔 Identifier 🫥 agent.md>) to match the picture with the [Token 🎫](<../../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>), 
