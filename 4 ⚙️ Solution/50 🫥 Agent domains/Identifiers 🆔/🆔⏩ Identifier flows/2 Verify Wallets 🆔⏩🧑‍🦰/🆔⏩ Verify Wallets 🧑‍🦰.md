...
1. **How does remote face verification works?**
    ...
    | # | Step
    |-|-
    |1| The user's [Wallet 🧑‍🦰 app](<../../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>) <br/>• opens a web-browser window <br/>• to the liveness check URL of the [Locator's Identifier 🆔 vault](<../../🆔 Identifier agent/🆔 Identifier 🫥 agent.md>), <br/>• passing anti-fraud information like device location and device configurations.
    |2| The webpage of the [Identifier 🆔 vault](<../../🆔 Identifier agent/🆔 Identifier 🫥 agent.md>) <br/>• activates the device's camera to record the user's video for liveness check <br/>• extracts the relevant images <br/>• and compares them to the user images on the given [Locator 🔆](<../../../../25 🔆 Locators/Locators 🔆/🔆 Locator.md>). 
    |3| Additionally, depending on the anti-fraud contextualized info, <br/>• the [Identifier 🆔 vault](<../../🆔 Identifier agent/🆔 Identifier 🫥 agent.md>) asks security questions and one-time-passwords (OTP).
...
1. **How are users' face biometrics protected from Sellers?**
    ...
    * then ask the [Token's  Identifier 🆔 domain](<../../🆔 Identifier agent/🆔 Identifier 🫥 agent.md>) to match the picture with the [Token 🎫](<../../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>), 
