...
1. **What is a face verification?**
    ...
    * is a [face verification 📺](<../../../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/06 👮 Supervised ID landscape/01 📺 Difference.md>)  by an [Identifier 🆔 vault](<../../🆔 Identifier agent/🆔 Identifier 🫥 agent.md>) 
...
1. **What can users present in the first step of the flow?**
    ...
    | Presented | Question
    |-|-
    | 🧑‍🦰 [Wallet](<../../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>) | Is it really the [Wallet 🧑‍🦰 app](<../../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>) owner holding the device?
    |[🎫 Token](<../../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>)| Was the [Token 🎫](<../../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) really issued to the person holding the device?
    |[💍 Userable](<../../../../25 🔆 Locators/Userables 💍/💍💠 Userable thing.md>)| Is it really the [Userable 💍](<../../../../25 🔆 Locators/Userables 💍/💍💠 Userable thing.md>) owner [tapping 🔆](<../../../../25 🔆 Locators/Locators 🔆/🔆⏩ Locator flows/🧑‍🦰🔆 Wallet NFC tap.md>) it on a scanner?
...
1. **How is face recognition secured with remote liveness checks?**
    ...
    Services implementing [liveness-checks 📺](<../../../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/07 🧑‍💻 Unsupervised ID landscape/09 📺 Amazon liveness.md>) mitigate frauds and replay attacks even if the device of the [Wallet 🧑‍🦰 app](<../../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>) is running a sophisticated forgery software, is being used by an AI bot, or has been compromised by an attacker. 
