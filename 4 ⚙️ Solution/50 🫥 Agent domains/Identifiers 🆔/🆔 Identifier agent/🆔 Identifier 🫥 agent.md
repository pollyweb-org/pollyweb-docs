...
1. **How is this chapter broken down?**
    ...
    |-|-|-
    |`Registration` | [👮 Register biometrics](<../🆔⏩ Identifier flows/1 Register biometrics 🆔⏩👮/🆔⏩ Register biometrics.md>)| Map user biometrics to their Wallet.
    |`Verification` |[🧑‍🦰 Verify Wallets](<../🆔⏩ Identifier flows/2 Verify Wallets 🆔⏩🧑‍🦰/🆔⏩ Verify Wallets 🧑‍🦰.md>) | Verify is its the Wallet's owner.
    ||[🎫 Verify Tokens](<../🆔⏩ Identifier flows/3 Verify Tokens 🆔⏩🎫/🆔⏩ Verify Tokens.md>) | Verify if it's Token's legit holder.
    ||[💍 Verify Userables](<../🆔⏩ Identifier flows/4 Verify Userables 🆔⏩💍/🆔⏩ Verify Userables.md>) | Verify if it's the Userable's owner.
    ||[🔏 Verify Signatures](<../🆔⏩ Identifier flows/5 Verify Signatures 🆔⏩🔏/🆔⏩ Verify Signatures 🔏.md>) | Verify is its the Wallet's owner.
    |`Technology`|[😶 Face scans](<../🆔⏩ Identifier flows/6 Face scan 🆔⏩😶/6 🆔⏩😶 Face scan.md>) | Liveness checks on user devices.
    ||[🖐️ Palm scans](<../🆔⏩ Identifier flows/7 Palm scan 🆔⏩🖐️/7 🆔⏩🖐️ Palm scan.md>) | Alternative to face in public spaces.
