...
1. **What is a Timeline?**
    ...
    Timelines are user-bound [Vaults 🗄️](<../../41 🎭 Domain Roles/Vaults 🗄️/🗄️ Vault/🗄️🎭 Vault role.md>) that anonymously store user events over time, mapping each event to a metric represented by a [Schema 🧩](<../../30 🧩 Data/Codes 🧩/🧩 Schema Code.md>).
...
1. **Can photos and PDF documents be added as events?**
    ...
    PollyWeb advocates for files to be proxied by the user's [Persona Vault](<../Personas 🧢/🧢 Persona agent/🧢🫥 Persona agent.md>) to:
