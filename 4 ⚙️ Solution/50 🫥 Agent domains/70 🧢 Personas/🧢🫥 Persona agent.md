...
1. **What domain roles do Personas implement?**
    ...
    | [🤗 Host](<../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) | For managing [Chats 💬](<../../35 Chats/12 💬 Chats/$ 💬 Chat.md>) with users.
    | [🫥 Agent ](<../$ 🫥 Agent Vaults/$ 🫥🗄️ Agent vault.md>) | To participate in [Chats 💬](<../../35 Chats/12 💬 Chats/$ 💬 Chat.md>) from other [Host 🤗 domains](<../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>).
...
1. **How are Personas kept from selling user data?**
    ...
    - [Brokers 🤵](<../../45 🤲 Helper domains/24 🤵 Brokers/🤵🤲 Broker helper.md>) may revoke their [trust 👍](<../../40 👥 Domains/👥👍 Domain Trusts/👍 Domain Trust.md>) in misbehaved Personas who don't comply with this principle.
