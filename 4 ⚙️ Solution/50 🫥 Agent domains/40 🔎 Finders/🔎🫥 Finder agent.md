...
1. **Where do Finders get information about other domains?**
    ...
    |-|-
    | [🕸&nbsp;Graphs](<../../45 🤲 Helper domains/50 🕸 Graphs/🕸🤲 Graph helper.md>) | Finders subscribe to [Graphs 🕸 domains](<../../45 🤲 Helper domains/50 🕸 Graphs/🕸🤲 Graph helper.md>) to receive updates on [domain Manifests 📜](<../../40 👥 Domains/44 📜 Manifests/📜 Manifest.md>) across the NLWeb, including their public identity, [trust 👍](<../../40 👥 Domains/43 👍 Trusts/👍 Domain Trust.md>) relationships, and supported [integrations 🪢](<../../41 🎭 Domain Roles/35 🪢 Integrators/$ 🪢🎭 Integrator role.md>). 
    ...
    | [👀&nbsp;Advertisers](<../../45 🤲 Helper domains/12 👀 Advertisers/👀🤲 Advertiser helper.md>) | Finders subscribe to [Advertiser 👀 domains](<../../45 🤲 Helper domains/12 👀 Advertisers/👀🤲 Advertiser helper.md>) to know which ads to show to users in addition to search results from [domain Manifests 📜](<../../40 👥 Domains/44 📜 Manifests/📜 Manifest.md>). 
