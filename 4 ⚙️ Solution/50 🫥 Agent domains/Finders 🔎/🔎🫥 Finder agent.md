...
1. **What is a Finder domain in NLWeb?**
    ...
    A Finder is 
    * any [Vault 🗄️ domain](<../../41 🎭 Domain Roles/Vaults 🗄️/🗄️🎭 Vault role.md>) 
...
1. **How do Finders help to protect users?**
    ...
    [Broker 🤵 domains](<../../20 🧑‍🦰 UI/3 🤵 Brokers/🤵🤲 Broker helper.md>) leverage Finders to provide users with culturally-contextualized details and user feedback about [Host 🤗 domains](<../../41 🎭 Domain Roles/Hosts 🤗/🤗🎭 Host role.md>) when a [Chat 💬](<../../35 💬 Chats/💬 Chats/💬 Chat.md>) starts. 
...
1. **How do Finders help users with a search?**
    ...
    * Consider the following [Chat 💬](<../../35 💬 Chats/💬 Chats/💬 Chat.md>) excerpt of the [Find a bar 🤝 use case](<../../../3 🤝 Use Cases/02 🍲 Eat & Drink/30 🍸 Bars/11 🌐 Web: Find a bar.md>) as an example.
    ...
    | [🤗 Host](<../../41 🎭 Domain Roles/Hosts 🤗/🤗🎭 Host role.md>) | ✅ Over to 🍸 Any Bar.
    | [ new chat ]
...
1. **Where do Finders get information about other domains?**
    ...
    |-|-
    | [🕸&nbsp;Graphs](<../../45 🤲 Helper domains/Graphs 🕸/🕸🤲 Graph helper.md>) | Finders subscribe to [Graphs 🕸 domains](<../../45 🤲 Helper domains/Graphs 🕸/🕸🤲 Graph helper.md>) to receive updates on [domain Manifests 📜](<../../40 👥 Domains/👥📜 Domain Manifests/📜 Manifest.md>) across the NLWeb, including their public identity, [trust 👍](<../../40 👥 Domains/👥👍 Domain Trusts/👍 Domain Trust.md>) relationships, and supported [integrations 🪢](<../../41 🎭 Domain Roles/Integrators 🪢/🪢🎭 Integrator role.md>). 
    ...
    | [⭐&nbsp;Reviewers](<../Reviewers ⭐/⭐🫥 Reviewer agent.md>) | Finders subscribe to [Reviewer ⭐ domains](<../Reviewers ⭐/⭐🫥 Reviewer agent.md>) to receive updates of domain ranks across the NLWeb, as a result of user feedback. 
    | [👀&nbsp;Advertisers](<../../45 🤲 Helper domains/Advertisers 👀/👀🤲 Advertiser helper.md>) | Finders subscribe to [Advertiser 👀 domains](<../../45 🤲 Helper domains/Advertisers 👀/👀🤲 Advertiser helper.md>) to know which ads to show to users in addition to search results from [domain Manifests 📜](<../../40 👥 Domains/👥📜 Domain Manifests/📜 Manifest.md>). 
...
1. **How do Finders filter and rank the results for users?**
    ...
    - **[👍 Trust](<../../40 👥 Domains/👥👍 Domain Trusts/👍 Domain Trust.md>)**: domains untrusted by the user's [Broker 🤵](<../../20 🧑‍🦰 UI/3 🤵 Brokers/🤵🤲 Broker helper.md>) are discarded;
    - **🔥 Threats**: domains blocked by [Firewalls 🔥](<../../45 🤲 Helper domains/Firewalls 🔥/🔥🤲 Firewall helper.md>) may be discarded even when trusted;
    - **🧢 Preferences**: the user's preferences, as shared by the user's [Persona 🧢](<../Personas 🧢/🧢🫥 Persona agent.md>);
...
1. **Why not merge Finders and Graphs?**
    ...
    * Conversely, [Graph 🕸 domains](<../../45 🤲 Helper domains/Graphs 🕸/🕸🤲 Graph helper.md>) are typically AI-free, allowing to be more generic.
