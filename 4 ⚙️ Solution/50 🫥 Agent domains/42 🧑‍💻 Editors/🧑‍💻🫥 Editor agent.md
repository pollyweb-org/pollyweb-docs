...
1. **What is an NLWeb Editor?**
    ...
    An [Editor 🧑‍💻 agent](<🧑‍💻🫥 Editor agent.md>) is a [Vault 🗄️](<../../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>) that exposes a desktop app designed to concentrate into a single editor the CRUD datasets from multiple user-bound [Vaults 🗄️](<../../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>).
...
1. **What are the benefits for businesses?**
    ...
    With [Editor 🧑‍💻 domains](<🧑‍💻🫥 Editor agent.md>), businesses that implement a [Vault 🗄️](<../../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>) don't need to maintain a website for users to edit their datasets - only an API is required.
...
1. **How can users start using an Editor?**
    ...
    On the Editor's desktop app, users scan the editor's [Locator 🔆](<../../30 🧩 Data/15 🔆 Locators/$ 🔆 Locator.md>) with their [Wallets 🧑‍🦰](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) - the interaction is described in [Edit in folder 🗂️💬](<🧑‍💻💬 Editor chats/🧑‍💻💬 Edit in editor.md>).
...
1. **How can users add a vault to the editor?**
    ...
    When clicking the "Add Vault" button in the desktop app, the [Editor 🧑‍💻 agent](<🧑‍💻🫥 Editor agent.md>) initiates a [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) with the user's [Wallet 🧑‍🦰](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) - the interaction described in [Bind to folder 🗂️💬](<🧑‍💻💬 Editor chats/🧑‍💻💬 Bind to editor.md>).
...
1. **How are concurrency conflicts resolved?**
    ...
    - When saving a new version of the document back to the [Vault 🗄️](<../../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>), [Editor 🧑‍💻 domains](<🧑‍💻🫥 Editor agent.md>) send the original version.

    - If there's a mismatch between the document version currently stored in the [Vault 🗄️](<../../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>) and the original version sent by the [Editor 🧑‍💻](<🧑‍💻🫥 Editor agent.md>), then the [Vault 🗄️](<../../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>) returns a mismatch error.
  
    - The [Editor 🧑‍💻](<🧑‍💻🫥 Editor agent.md>) then cancels the change, reloads the latest version from the [Vault 🗄️](<../../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>), and asks the user to apply the changes again.

    - Smarter [Editor 🧑‍💻 domains](<🧑‍💻🫥 Editor agent.md>) may be able to compare and merge the 3 versions (the originally pulled, the changed by the user, and the new version from the [Vault 🗄️](<../../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>)), asking the user to just review the changes with a diff interface before resubmitting.
