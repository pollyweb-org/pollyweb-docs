...
1. **How to verify someone else's Userable?**
    ...
    * This is particularly useful when working with [Userable 💍 things](<../../25 Locators/74 💍 Userables/💍💠 Userable thing.md>) where the owner's identity needs to be confirmed on [payments 🤝 scenarios](<../../25 Locators/74 💍 Userables/💍⏩ Userable flows/21 💍💳 pay salesperson.md>) and [item recovery 🤝 scenarios](<../../25 Locators/74 💍 Userables/💍⏩ Userable flows/13 💍📱 senior user.md>) via another [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>).
...
1. **What are use cases of Identity in Userables?**
    ...
    |Industry|Use case 🤝
    |-|-
    | `Security`| 🎬 [Cross gates at an airport](<../../25 Locators/74 💍 Userables/💍⏩ Userable flows/14 💍🎬 gates.md>)
    | `Payments` | 💍 [Pay a salesperson ](<../../25 Locators/74 💍 Userables/💍⏩ Userable flows/21 💍💳 pay salesperson.md>) 
    | `Payments` | [💳 Pay seller on a kiosk](<../../25 Locators/74 💍 Userables/💍⏩ Userable flows/22 💍💳 pay at kiosk.md>) 
    ...
    |`Social`| [💍 Aid a confused senior ](<../../25 Locators/74 💍 Userables/💍⏩ Userable flows/13 💍📱 senior user.md>)
