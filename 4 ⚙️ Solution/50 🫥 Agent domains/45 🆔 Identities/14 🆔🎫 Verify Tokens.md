...
1. **What are the benefits of Token Identity binding?**
    ...
    Identity binding 
    * allows [Issuer 🎴 domains](<../../41 🎭 Domain Roles/40 🎴 Issuers/🎴🎭 Issuer role.md>) to lock a given [Token 🎫](<../../30 Data/3 🎫 Tokens/🎫 Token.md>) to a specific human, 
...
1. **How does it work?**
    ...
    The flow of an [Issuer 🎴 domain](<../../41 🎭 Domain Roles/40 🎴 Issuers/🎴🎭 Issuer role.md>) issuing a [Token 🎫](<../../30 Data/3 🎫 Tokens/🎫 Token.md>) with [Identity 🆔](<$ 🆔🫥 Identity agent.md>)  is as follows.

    |#|Category|Step
    |-|-|-
    | A| `Hello`| The user initiates a [Chat 💬](<../../35 Chats/💬 Chats/💬 Chat.md>) with an [Issuer 🎴 domain](<../../41 🎭 Domain Roles/40 🎴 Issuers/🎴🎭 Issuer role.md>): <br/>• the user asks the [Issuer 🎴 domain](<../../41 🎭 Domain Roles/40 🎴 Issuers/🎴🎭 Issuer role.md>) to issue a [Token 🎫](<../../30 Data/3 🎫 Tokens/🎫 Token.md>) (e.g., flight ticket).
    | B| `Locator` | The [Issuer 🎴 domain](<../../41 🎭 Domain Roles/40 🎴 Issuers/🎴🎭 Issuer role.md>) asks the user's [Identity 🆔 domain](<$ 🆔🫥 Identity agent.md>) to generate a unique [Identity Locator 🔆](<../../25 Locators/1 🔆 Locators/🔆 Locator.md>) with a given expiration date:<br/>• unique [Locators 🔆](<../../25 Locators/1 🔆 Locators/🔆 Locator.md>) prevent attackers from relating any two [Tokens 🎫](<../../30 Data/3 🎫 Tokens/🎫 Token.md>) from the same user; <br/>• expiration dates allow [Identity 🆔 domains](<$ 🆔🫥 Identity agent.md>) to charge the [Issuer 🎴 domain](<../../41 🎭 Domain Roles/40 🎴 Issuers/🎴🎭 Issuer role.md>) for the commitment length.
    |C| `Token` | The [Issuer 🎴 domain](<../../41 🎭 Domain Roles/40 🎴 Issuers/🎴🎭 Issuer role.md>) offers the [Token 🎫](<../../30 Data/3 🎫 Tokens/🎫 Token.md>) for the user to download: <br/> • the user downloads the [Token 🎫](<../../30 Data/3 🎫 Tokens/🎫 Token.md>) and stores it offline in the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>).
    |

    <br/>

    The flow for a user to share a [Token 🎫](<../../30 Data/3 🎫 Tokens/🎫 Token.md>) with a [Consumer 💼 domain](<../../41 🎭 Domain Roles/27 💼 Consumers/💼🎭 Consumer role.md>) using their [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) is as follows.

    |#|Category|Step
    |-|-|-
    | 1| `Share` | The user initiates a chat session with a [Consumer 💼 domain](<../../41 🎭 Domain Roles/27 💼 Consumers/💼🎭 Consumer role.md>): <br/> • the [Consumer 💼 domain](<../../41 🎭 Domain Roles/27 💼 Consumers/💼🎭 Consumer role.md>) asks the user to share [Tokens 🎫](<../../30 Data/3 🎫 Tokens/🎫 Token.md>) of a specific [Schema Code 🧩](<../../30 Data/1 🧩 Schema Codes/🧩 Schema Code.md>); <br/> • if the [Schema Code 🧩](<../../30 Data/1 🧩 Schema Codes/🧩 Schema Code.md>) is marked as `SELF` and the [Consumer 💼 domain](<../../41 🎭 Domain Roles/27 💼 Consumers/💼🎭 Consumer role.md>) is the [Issuer 🎴 domain](<../../41 🎭 Domain Roles/40 🎴 Issuers/🎴🎭 Issuer role.md>), then the sharing is silent;<br/> • otherwise, the user has to explicitly select the [Tokens 🎫](<../../30 Data/3 🎫 Tokens/🎫 Token.md>) to share; <br/> • the [Consumer 💼 domain](<../../41 🎭 Domain Roles/27 💼 Consumers/💼🎭 Consumer role.md>) verifies if the signature of the [Token 🎫](<../../30 Data/3 🎫 Tokens/🎫 Token.md>)  matches the [DKIM 📨](<../../40 👥 Domains/👥📨 Domain Messages/📨 Message.md>) of the [Issuer 🎴 domain](<../../41 🎭 Domain Roles/40 🎴 Issuers/🎴🎭 Issuer role.md>).
...
1. **How do domains authenticate printed identity-bound Tokens?**
    ...
    The flow for a user to share an offline [Token 🎫](<../../30 Data/3 🎫 Tokens/🎫 Token.md>) with a [Consumer 💼 domain](<../../41 🎭 Domain Roles/27 💼 Consumers/💼🎭 Consumer role.md>) is as follows:
    ...
    - 3/ the [Consumer 💼 domain](<../../41 🎭 Domain Roles/27 💼 Consumers/💼🎭 Consumer role.md>) verifies if the [Token's 🎫](<../../30 Data/3 🎫 Tokens/🎫 Token.md>) signature matches the [DKIM 📨](<../../40 👥 Domains/👥📨 Domain Messages/📨 Message.md>)  of the [Issuer 🎴 domain](<../../41 🎭 Domain Roles/40 🎴 Issuers/🎴🎭 Issuer role.md>);
    ...
    - 5/ the [Consumer 💼 domain](<../../41 🎭 Domain Roles/27 💼 Consumers/💼🎭 Consumer role.md>) asks the [Token's Identity 🆔 domain](<$ 🆔🫥 Identity agent.md>) to match the biometrics with the [Identity Locator 🔆](<../../25 Locators/1 🔆 Locators/🔆 Locator.md>);
    - 6/ the [Identity 🆔 domain](<$ 🆔🫥 Identity agent.md>) confirms to the [Consumer 💼 domain](<../../41 🎭 Domain Roles/27 💼 Consumers/💼🎭 Consumer role.md>) that the biometrics match the [Token 🎫](<../../30 Data/3 🎫 Tokens/🎫 Token.md>) owner.
