...
1. **How to verify a Wallet ownership?**
    ...
    * for the ownership of a [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>).
...
1. **What are industry use cases for age verification?**
    ...
    |`Health`| [💍 Trigger a Userable emergency](<../../25 Locators/74 💍 Userables/💍⏩ Userable flows/02 💍🚨 Userable emergencies.md>)
