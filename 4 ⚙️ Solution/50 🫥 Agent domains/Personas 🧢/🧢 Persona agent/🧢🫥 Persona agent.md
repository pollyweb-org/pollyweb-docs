...
1. **How do Persona vaults differ from Identity vaults?**
    ...
    - Conversely, [Identity 🆔 vaults](<../../Identifiers 🆔/🆔 Identifier agent/🆔 Identifier 🫥 agent.md>)  are controlled by nations on behalf of their citizens (e.g., the UK), allowing users to legally identity themselves at home and abroad.
