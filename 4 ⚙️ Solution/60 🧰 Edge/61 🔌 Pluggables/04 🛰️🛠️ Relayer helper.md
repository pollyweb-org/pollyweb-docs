...
4. **How do Relayers work?**
    ...
    |3| `Brand` | The Relayer 🛰️ registers the [Pluggable's Locator 🔆](<../../20 🧑‍🦰 UI/04 🔆 Locators/01 🔆 Locator.md>) in the [Pluggable's Brand 🍏 domain](<../../70 🌳 Ambient/71 💠 Brand Things/07 🍏🎭 Brand role.md>).
