...
1. **How do Relayers work?**
    ...
    |Z| `Propagate` | The Relayer 🛰️ sends sends the translated events to the [Buffer ⏳ helper](<../../45 Helpers/10 ⏳ Buffers/03 ⏳🛠️ Buffer helper.md>) of the owner [domain 👥](<../../40 👥 Domains/41 📨 Messages/00 👥 Domain.md>).
