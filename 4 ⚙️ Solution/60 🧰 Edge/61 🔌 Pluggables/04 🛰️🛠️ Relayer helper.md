...
4. **How do Relayers work?**
    ...
    |3| `Brand` | The Relayer 🛰️ registers the [Pluggable's Locator 🔆](<../../20 🧑‍🦰 UI/22 🔆 Locators/01 🔆 Locator.md>) in the [Pluggable's Brand 🍏 domain](<../../70 🌳 Ambient/71 💠 Brand Things/07 🍏🎭 Brand role.md>).
    ...
    |5| `Graph`|  The Relayer 🛰️ domain reads the [API Schema 🧩](<../../20 🧑‍🦰 UI/24 🗄️ Vaults/02 🧩 Schema Code.md>) from a [Graph 🕸 helper domain](<../../40 👥 Domains/44 📜 Manifests/03 🕸👥 Graph helper.md>).
