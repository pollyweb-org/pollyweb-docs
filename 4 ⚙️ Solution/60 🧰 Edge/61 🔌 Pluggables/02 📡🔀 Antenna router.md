...
1. **How do Antennas know the protocol of each Pluggable device?**
    ...
    They don't. 
    * When users plug the devices to an Antenna, the Antenna registers the device in the connected [🛰️ Relayer](<../../45 🛠️ Helper domains/70 🛰️ Relayers/$ 🛰️🛠️ Relayer helper.md>);
...
1. **How do Antennas connect to the Relayer?**
    ...
    Antennas connect automatically to their [🛰️ Relayer](<../../45 🛠️ Helper domains/70 🛰️ Relayers/$ 🛰️🛠️ Relayer helper.md>) as soon as they detect internet - this is a factory setting.
...
1. **How can a domain register an Antenna?**
    ...
    After buying an Antenna from a [Brand 🍏](<../../70 🌳 Ambient/71 💠 Brand Things/07 🍏🎭 Brand role.md>), a domain admin taps/scans the Antenna's [Locator](<../../20 🧑‍🦰 UI/11 🔆 Locators/$ 🔆 Locator.md>) and follows the option to register the Antenna. In the process, the [🛰️ Relayer](<../../45 🛠️ Helper domains/70 🛰️ Relayers/$ 🛰️🛠️ Relayer helper.md>) asks the user to share their domain ADMIN [Token 🎫](<../../20 🧑‍🦰 UI/25 🎫 Tokens/01 🎫 Token.md>) issued by the domain.
