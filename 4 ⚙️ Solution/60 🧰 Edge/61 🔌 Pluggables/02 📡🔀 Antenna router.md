...
1. **How can a domain register an Antenna?**
    ...
    After buying an Antenna from a [Brand 🍏](<../../41 🎭 Domain Roles/20 🍏 Brands/$ 🍏🎭 Brand role.md>), a domain admin taps/scans the Antenna's [Locator](<../../25 Locators/15 🔆 Locators/$ 🔆 Locator.md>) and follows the option to register the Antenna. In the process, the [🛰️ Relayer](<../../45 🤲 Helper domains/80 🛰️ Relayers/🛰️🤲 Relayer helper.md>) asks the user to share their domain ADMIN [Token 🎫](<../../30 Data/30 🎫 Tokens/🎫 Token.md>) issued by the domain.
