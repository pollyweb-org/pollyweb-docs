...
1. **What is an Antenna?**
    ...
    Antenna 📡 routers are devices that allow offline [Pluggable 🔌 devices](<01 🔌 Pluggable device.md>) to be controlled by a [domain 👥](<../../40 👥 Domains/👥 Domain/👥 Domain.md>) from the internet.
...
1. **What are use-cases of domains with Antennas?**
    ...
    | [Domain 👥](<../../40 👥 Domains/👥 Domain/👥 Domain.md>) | Use case |
    |-|-
