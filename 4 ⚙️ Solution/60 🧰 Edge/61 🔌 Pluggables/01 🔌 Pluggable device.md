...
1. **How do users install a Pluggable?**
    ...
    - 3/ users taps/scans the [Locator 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/01 🔆 Locator.md>) of the Pluggable 🔌 device - the [Relayer 🛰️ helper](<04 🛰️🛠️ Relayer helper.md>) confirms that a device with the Pluggable's resource key is connected, and the Pluggable's API [Schema Code 🧩](<../../20 🧑‍🦰 UI/24 🗄️ Vaults/02 🧩 Schema Code.md>) is valid.
...
1. **What are examples of Pluggable devices?**
    ...
    | 🎬 [Relays](<../65 🎬 Relayers/04 🎬🔌 Relay device.md>) | For [domains 👥](<../../40 👥 Domains/41 📨 Comms/00 👥 Domain.md>) to remotely control electrical circuits.
