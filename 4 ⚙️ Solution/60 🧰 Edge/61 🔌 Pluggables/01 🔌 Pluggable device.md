...
1. **How do users install a Pluggable?**
    ...
    - 3/ users taps/scans the [Locator 🔆](<../../25 🔆 Locators/Locators 🔆/🔆 Locator.md>) of the Pluggable 🔌 device - the [Relayer 🛰️ helper](<../../45 🤲 Helper domains/Relayers 🛰️/🛰️🤲 Relayer helper.md>) confirms that a device with the Pluggable's resource key is connected, and the Pluggable's API [Schema Code 🧩](<../../30 🧩 Data/Codes 🧩/🧩 Schema Code.md>) is valid.
