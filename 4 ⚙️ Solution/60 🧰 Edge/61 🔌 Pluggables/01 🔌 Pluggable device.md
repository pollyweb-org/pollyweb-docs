...
1. **How do users install a Pluggable?**
    ...
    |2| The owner taps/scans the [Locator 🔆](<../../25 🔆 Locators/Locators 🔆/🔆 Locator.md>) of the [Antenna 📡 router](<02 📡🔀 Antenna router.md>) with their [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>) to open a chat with its [Relayer 🛰️ helper](<../../45 🤲 Helper domains/Relayers 🛰️/🛰️🤲 Relayer helper.md>), and ask to add a Pluggable - the Relayer asks the user to tap/scan the Pluggable;
