...
1. **What are examples of Pluggable devices?**
    ...
    |-|-
    | ✨ [Scanners](<../66 ✨ Scanners/06 ✨🔌 Scanner device.md>) | For users to tap their  [Things 💠](<../../25 Locators/71 💠 Things/💠 Thing.md>), [Userables 💍](<../../70 🌳 Ambient/74 💍 Userables/$ 💍 Userable thing.md>), and [Tapbands ⌚](<../../70 🌳 Ambient/76 ⌚ Tapbands/$ ⌚💠 Tapband thing.md>).
