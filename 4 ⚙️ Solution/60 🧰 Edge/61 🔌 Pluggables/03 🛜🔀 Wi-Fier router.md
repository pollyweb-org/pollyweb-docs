...
4. **What does the Chat look like?**
    ...
    The [💬 Chat](<../../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>) may look similar to the following.

    | Service | Prompt  | User 
    |-|-|-
    | | | 🔆 [scan](<../../20 🧑‍🦰 UI/04 🔆 Locators/03 🧑‍🦰✨ Wallet QR scan.md>)
    ...
    | 🪄 Wand | ℹ️ Device: [Wi-Fier 🛜](<03 🛜🔀 Wi-Fier router.md>) || The [Locator 🔆](<../../20 🧑‍🦰 UI/04 🔆 Locators/01 🔆 Locator.md>) had a [Host 🤗](<../../20 🧑‍🦰 UI/05 💬 Chats/04 🤗🎭 Host role.md>)  callback.
    | 🪄 Wand | 😃 Hi! What do you need? <br/>- Set up [ 🛜 Wi-Fi ] <br/>- Call [Support] <br/>- [ Something else ] | > 🛜 Wi-Fi
    | [🤵 Broker](<../../20 🧑‍🦰 UI/03 🤵 Brokers/03 🤵 Broker domain.md>) | ⓘ Flow: Wi-Fi [+] || The [Host 🤗 role](<../../20 🧑‍🦰 UI/05 💬 Chats/04 🤗🎭 Host role.md>) changed the context.
...
3. **How does it work?**
    ...
    |#|Category|Step
    |-|-|-
    |0| `Bundle`| A [Brand 🍏 domain](<../../70 🌳 Ambient/71 💠 Brand Things/07 🍏🎭 Brand role.md>) selling an Internet-enabled product: <br/>- integrates a [Wi-Fier 🛜 feature](<03 🛜🔀 Wi-Fier router.md>) into the product; <br/>- registers the [Wi-Fier 🛜 feature](<03 🛜🔀 Wi-Fier router.md>) on a [Wand 🪄 helper domain](<../../70 🌳 Ambient/71 💠 Brand Things/09 🪄🛠️ Wand helper.md>); <br/>- prints the [registration Locator 🔆](<../../20 🧑‍🦰 UI/04 🔆 Locators/01 🔆 Locator.md>) into an NFC/QR tag on the product.
    |1| `Tap/Scan`| The user taps or scans the [Locator 🔆](<../../20 🧑‍🦰 UI/04 🔆 Locators/01 🔆 Locator.md>) of the [Wi-Fier 🛜](<03 🛜🔀 Wi-Fier router.md>) enabled product with their [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>).
    |2| `Translate`| That opens a [Chat 💬](<../../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>) with the [Wi-Fier's Wand 🪄 helper domain](<../../70 🌳 Ambient/71 💠 Brand Things/09 🪄🛠️ Wand helper.md>): <br/>- the [Wand 🪄 domain](<../../70 🌳 Ambient/71 💠 Brand Things/09 🪄🛠️ Wand helper.md>) offers a set of options (e.g., connect, support); <br/>- the user chooses the option to connect the device to a Wi-Fi network.
    ...
    |5| `Connect`| The [Wi-Fier 🛜](<03 🛜🔀 Wi-Fier router.md>) connects to the Wi-Fi network with the given credentials: <br/>- the [Wi-Fier 🛜](<03 🛜🔀 Wi-Fier router.md>) sends a successful confirmation to the [Wand 🪄 domain](<../../70 🌳 Ambient/71 💠 Brand Things/09 🪄🛠️ Wand helper.md>); <br/> - the [Wand 🪄 domain](<../../70 🌳 Ambient/71 💠 Brand Things/09 🪄🛠️ Wand helper.md>) informs the success to the user on the [Chat 💬](<../../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>).
...
5. **What are the advantages of Wi-Fiers?**
    ...
    |`Bundle` | There's a single [NFC/QR Locator 🔆](<../../20 🧑‍🦰 UI/04 🔆 Locators/01 🔆 Locator.md>) for onboarding and other [Wand 🪄](<../../70 🌳 Ambient/71 💠 Brand Things/09 🪄🛠️ Wand helper.md>) features.
