...
1. **What are Selfie domains?**
    ...
    A Selfie 📸 domain is a [Supplier 🏭 domain](<../../41 🎭 Domain Roles/Suppliers 🏭/🏭 Supplier/🏭🎭 Supplier role.md>) of [Selfie 📸 devices](<01 📸🔌 Selfie device.md>) that allow other [Domains 👥](<../../40 👥 Domains/👥 Domain/👥 Domain.md>) to buy devices. 
