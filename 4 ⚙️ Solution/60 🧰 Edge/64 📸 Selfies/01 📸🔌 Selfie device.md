...
1. **Why are Selfie devices important for NLWeb?**
    ...
    - the identification is first done by a [Userable 💍 thing](<../../25 🔆 Locators/Userables 💍/💍💠 Userable thing.md>), then the [Face scan 🆔😶](<../../50 🫥 Agent domains/Identifiers 🆔/🆔⏩ Identifier flows/6 Face scan 🆔⏩😶/6 🆔⏩😶 Face scan.md>) is invoked to verify the identity.
