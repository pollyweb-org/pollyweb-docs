...
1. **Isn't a rotating NFC tag enough?**
    ...
    - Conversely, for public-facing use cases (e.g., ATM machines), a QR code is an important fallback for when the smartphone's NFC reader is not working properly with the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>).
...
1. **How is an Ephemeral applicable to the financial industry?**
    ...
    1. Users [tap 🔆](<../../25 🔆 Locators/Locators 🔆/🔆⏩ Locator flows/🧑‍🦰🔆 Wallet NFC tap.md>) or [scan ✨](<../../25 🔆 Locators/Locators 🔆/🔆⏩ Locator flows/🧑‍🦰✨ Wallet QR scan.md>) the ATM's static [Locator 🔆](<../../25 🔆 Locators/Locators 🔆/🔆 Locator.md>) with their [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>) - this could be a big QR printed on a top banner;
    2. The [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>) opens a [Chat 💬](<../../35 💬 Chats/Chats 💬/💬 Chat.md>) with the ATM Company's [Host 🤗 domain](<../../41 🎭 Domain Roles/Hosts 🤗/🤗 Host role/🤗🎭 Host role.md>), and the user asks to withdraw cash;
    ...
    4. The user then [taps 🔆](<../../25 🔆 Locators/Locators 🔆/🔆⏩ Locator flows/🧑‍🦰🔆 Wallet NFC tap.md>) or [scans ✨](<../../25 🔆 Locators/Locators 🔆/🔆⏩ Locator flows/🧑‍🦰✨ Wallet QR scan.md>) the NRC/QR off the designated Ephemeral 🦋 device with their [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>);
