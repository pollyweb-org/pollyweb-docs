...
1. **How is an Ephemeral applicable to the financial industry?**
    ...
    - The setup requires an [Antenna 📡 router](<../61 🔌 Pluggables/02 📡🔀 Antenna router.md>) on site, connected to the [Relayer 🛰️ domain](<../61 🔌 Pluggables/04 🛰️🛠️ Relayer helper.md>), to allow the ATM [Host 🤗 domain](<../../20 🧑‍🦰 UI/23 💬 Chats/03 🤗🎭 Host role.md>) to remotely control the Ephemeral 🦋 device.
