...
1. **How is an Ephemeral applicable to the financial industry?**
    ...
    2. The [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) opens a [Chat 💬](<../../35 Chats/💬 Chats/💬 Chat.md>) with the ATM Company's [Host 🤗 domain](<../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>), and the user asks to withdraw cash;
