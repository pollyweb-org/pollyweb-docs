...
> Implemented by [👥⏩👥 Request Sync 🚀](<../../👥 Domains/👥⏩ Domain flows/👥⏩👥 Request Sync 🚀.md>)

<br/> 

1. **What are Synchronous Requests?**

    [Domains 👥](<../../👥 Domains/👥 Domain.md>) send requests and wait for the immediate response over an HTTPS request.
