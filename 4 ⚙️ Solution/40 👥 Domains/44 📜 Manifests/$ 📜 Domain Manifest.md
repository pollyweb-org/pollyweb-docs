...
1. **What information can be added to a Manifest?**
    ...
    |  🧩 [Schema Codes](<../../25 Data/Schema Codes/02 🧩 Schema Code.md>) | Defined by the domain. | [`./CODE` 🧩](<40 🧩 CODE code.md>) <br/>[`./CODE/SCHEMA` 🧩](<41 🧩 SCHEMA code.md>) <br/>[`./TRANSLATION` 🧩](<21 🧩 TRANSLATION code.md>)| Schema validation of a Code
    |  🧩 [Delegated Codes](<../../25 Data/Schema Codes/02 🧩 Schema Code.md>) | Codes delegated to other domains. | [`./DELEGATE` 🧩](<30 🧩 DELEGATE code.md>)
