...
1. **How can a domain inspect another domain's Manifest?**
    ...
    [Domains 👥](<../41 📨 Messages/00 👥 Domain.md>) leverage Manifest 📜 caches, called [Graph 🕸 domains](<../../45 🛠️ Helper domains/50 🕸 Graphs/$ 🕸🛠️ Graph helper.md>), that keep up-to-date representations of NLWeb [domain Manifests 📜](<$ 📜 Domain Manifest.md>).
...
1. **How does it work?**
    ...
    Each [domain 👥](<../41 📨 Messages/00 👥 Domain.md>) sends the content of their [domain Manifests 📜](<$ 📜 Domain Manifest.md>) in parts or in full to a [Listener 👂 helper domain](<../../45 🛠️ Helper domains/60 👂 Listeners/$ 👂🛠️ Listener helper.md>), who then propagates it to [Graph 🕸 domains](<../../45 🛠️ Helper domains/50 🕸 Graphs/$ 🕸🛠️ Graph helper.md>).
