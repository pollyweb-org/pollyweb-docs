...
# [🧩](<../../25 Data/10 🧩 Schema Codes/02 🧩 Schema Code.md>) [`.MANIFEST`](<10 🧩 MANIFEST code.md>) `/TRUST`
...
| `Domain` | string | [Domain 👥](<../41 📨 Messages/00 👥 Domain.md>) to [Trust 👍](<../43 👍 Trusts/$ 👍 Domain Trust.md>) <br/>- defaults to `*` | `*` `nlweb.org` 
| or `Domains` | array | Additional list of domains  | `[a.co, b.co]`
| `Query`  | string | [Schema Codes 🧩](<../../25 Data/10 🧩 Schema Codes/02 🧩 Schema Code.md>) to [Trust 👍](<../43 👍 Trusts/$ 👍 Domain Trust.md>) | `*` `/PERSONA/*`
...
* Note: When a [Schema Code 🧩](<../../25 Data/10 🧩 Schema Codes/02 🧩 Schema Code.md>) is removed from [`.MANIFEST/TRUSTS`](<50 🧩 TRUST code.md>), 
    * domains should explicitly inform the `REVOKE`;
    * otherwise, it might not be propagated by [Graph 🕸 domains](<../../45 🛠️ Helper domains/40 🕸 Graphs/$ 🕸🛠️ Graph helper.md>).
