...
# [🧩](<../../25 Data/Schema Codes/02 🧩 Schema Code.md>) [`.MANIFEST`](<10 🧩 MANIFEST code.md>) `/TRUST`
...
| `Query`  | string | [Schema Codes 🧩](<../../25 Data/Schema Codes/02 🧩 Schema Code.md>) to [Trust 👍](<../43 👍 Trusts/$ 👍 Domain Trust.md>) | `*` `/PERSONA/*`
...
* Note: When a [Schema Code 🧩](<../../25 Data/Schema Codes/02 🧩 Schema Code.md>) is removed from [`.MANIFEST/TRUSTS`](<50 🧩 TRUST code.md>), 
