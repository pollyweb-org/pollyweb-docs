# [🧩](<../../25 Data/10 🧩 Schema Codes/02 🧩 Schema Code.md>) [`.MANIFEST`](<10 🧩 MANIFEST code.md>) `/ABOUT`
...
| `Feedback` | string | Optional [Buffer ⏳ helper domain](<../../45 🛠️ Helper domains/16 ⏳ Buffers/$ ⏳🛠️ Buffer helper.md>) name <br/>- if not defined, then no feedback is given
