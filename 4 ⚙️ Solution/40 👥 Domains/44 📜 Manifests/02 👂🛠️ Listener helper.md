...
1. **How can domains know that their updates were rejected?**
    ...
    * Interested [domains 👥](<00 👥 Domain.md>) should [subscribe 🔔](<../42 🌬️ Streams/04 🔔🎭 Subscriber role.md>) to that [Stream 🌬️](<../42 🌬️ Streams/02 🌬️🎭 Streamer role.md>), filtering the domains they're interested in receiving alerts about.
