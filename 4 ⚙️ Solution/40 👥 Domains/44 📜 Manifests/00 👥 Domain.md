...
2. **What API methods does a Domain need to expose?**
    ...
    * The following list enumerates the possible roles a [domain 👥](<00 👥 Domain.md>) can assume.
    ...
    | [🪣 Dataset](<../../20 🧑‍🦰 UI/05 💬 Chats/07 🪣🎭 Dataset role.md>) | Exposes that exposes a synchronous data API. 
    | [🛠️ Helper](<../../20 🧑‍🦰 UI/24 🗄️ Vaults/05 🛠️👥 Helper domain.md>) | Helps other [domains 👥](<00 👥 Domain.md>) by offloading undifferentiated logic.
    | [🤗 Host](<../../20 🧑‍🦰 UI/05 💬 Chats/04 🤗🎭 Host role.md>) | Hosts [Chats 💬](<../../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>) for [Wallet 🧑‍🦰 apps](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) via [Broker 🤵 domains](<../../20 🧑‍🦰 UI/03 🤵 Brokers/03 🤵 Broker domain.md>).
    | [🪢 Integrator](<../../20 🧑‍🦰 UI/05 💬 Chats/06 🪢🎭 Integrator role.md>) |  [Manifests 📜](<../../40 👥 Domains/44 📜 Manifests/01 📜 Domain Manifest.md>) custom endpoints for [Finder 🔎 domains](<../../30 🫥 Agents/10 🔎 Finders/02 🔎🫥 Finder vault.md>) to index.
