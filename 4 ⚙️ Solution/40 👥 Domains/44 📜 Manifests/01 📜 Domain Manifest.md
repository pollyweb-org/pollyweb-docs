...
1. **How do domains publicize their identity?**
    ...
    In NLWeb, [domains 👥](<../41 📨 Msgs/00 👥 Domain.md>) publish their metadata in the form a [domain Manifest 📜](<01 📜 Domain Manifest.md>).
...
1. **How can a domain inspect another domain's Manifest?**
    ...
    [Domains 👥](<../41 📨 Msgs/00 👥 Domain.md>) leverage Manifest 📜 caches, called [Graph 🕸 domains](<../45 👂 Backbone/03 🕸🛠️ Graph helper.md>), that keep up-to-date representations of NLWeb [domain Manifests 📜](<01 📜 Domain Manifest.md>).
    * Manifest queries to these [Graphs 🕸](<../45 👂 Backbone/03 🕸🛠️ Graph helper.md>) are synchronous and expected to have millisecond latency.
...
1. **How does it work?**
    ...
    Each [domain 👥](<../41 📨 Msgs/00 👥 Domain.md>) sends the content of their [domain Manifests 📜](<01 📜 Domain Manifest.md>) in parts or in full to a [Listener 👂 helper domain](<../45 👂 Backbone/02 👂🛠️ Listener helper.md>), who then propagates it to [Graph 🕸 domains](<../45 👂 Backbone/03 🕸🛠️ Graph helper.md>).

    |Step|Description
    |-|-
    |A| When a [domain 👥](<../41 📨 Msgs/00 👥 Domain.md>) sends a request to another
    |B| the recipient queries a [Graph 🕸 helper domain](<../45 👂 Backbone/03 🕸🛠️ Graph helper.md>) for information about the sender to assess its [trustworthiness 👍](<../43 👍 Trusts/01 👍 Domain Trust.md>)
...
1. **What information can be added to a Manifest?**
    ...
    |-|-|-
    | 🤗 [Host Identity](<../../20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) | Domain identification (mandatory). | • [/MANIFEST 🧩](<../../../7 🧩 Codes/MANIFEST/🧩 Manifest.md>) <br/>• [/MANIFEST/IDENTITY 🧩](<../../../7 🧩 Codes/MANIFEST/🧩 ManifestIdentity.md>) <br/>• [/MANIFEST/TRANSLATION 🧩](<../../../7 🧩 Codes/MANIFEST/🧩 ManifestTranslation.md>)
    | 👍 [Domain Trusts](<../43 👍 Trusts/01 👍 Domain Trust.md>) | Trusted domains, Codes, and roles. | • [/MANIFEST/TRUST 🧩](<../../../7 🧩 Codes/MANIFEST/🧩 ManifestTrust.md>)
    |  🧩 [Schema Codes](<../../20 🧑‍🦰 UI/24 🗄️ Vaults/02 🧩 Schema Code.md>) | Defined by the domain. | • [/MANIFEST/CODE 🧩](<../../../7 🧩 Codes/MANIFEST/🧩 ManifestCode.md>) <br/>• [/MANIFEST/CODE/SCHEMA 🧩](<../../../7 🧩 Codes/MANIFEST/🧩 ManifestCodeSchema.md>) | Schema validation of a Code
    |  🧩 [Delegated Codes](<../../20 🧑‍🦰 UI/24 🗄️ Vaults/02 🧩 Schema Code.md>) | Codes delegated to other domains. | • [/MANIFEST/DELEGATE 🧩](<../../../7 🧩 Codes/MANIFEST/🧩 ManifestDelegate.md>)
    | 🪢 [Integrations](<../../20 🧑‍🦰 UI/12 💬 Chats/06 🪢🎭 Integrator role.md>) |Synchronous datasets, <br/>asynchronous supplies, <br/>and streaming endpoints. | • [/MANIFEST/OFFER 🧩](<../../../7 🧩 Codes/MANIFEST/🧩 ManifestOffer.md>)
