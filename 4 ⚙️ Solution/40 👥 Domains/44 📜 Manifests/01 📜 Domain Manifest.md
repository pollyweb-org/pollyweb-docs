...
1. **How can a domain inspect another domain's Manifest?**
    ...
    [Domains 👥](<../41 📨 Messages/00 👥 Domain.md>) leverage Manifest 📜 caches, called [Graph 🕸 domains](<../../42 Backbone/20 Graphs/03 🕸🛠️ Graph helper.md>), that keep up-to-date representations of NLWeb [domain Manifests 📜](<01 📜 Domain Manifest.md>).
    * Manifest queries to these [Graphs 🕸](<../../42 Backbone/20 Graphs/03 🕸🛠️ Graph helper.md>) are synchronous and expected to have millisecond latency.
...
1. **How does it work?**
    ...
    |B| the recipient queries a [Graph 🕸 helper domain](<../../42 Backbone/20 Graphs/03 🕸🛠️ Graph helper.md>) for information about the sender to assess its [trustworthiness 👍](<../43 👍 Trusts/01 👍 Domain Trust.md>)
