# [🧩](<../../25 Data/10 🧩 Schema Codes/02 🧩 Schema Code.md>) [`.MANIFEST`](<10 🧩 MANIFEST code.md>) `/OFFER`
...
| Property | Type | Notes
|-|-|-
| `Dataset` | string | Reference to a [Schema Code 🧩](<../../25 Data/10 🧩 Schema Codes/02 🧩 Schema Code.md>) that defines the dataset being offered
