...
1. **What is a Listener domain in NLWeb?**
    ...
    A Listener 👂 is a [Helper 🛠️ domain](<../../30 🫥 Agents/00 Entities/🛠️ Helper domain.md>) with a [Streamer 🌬️ role](<../41 📨 Comms/02 🌬️🎭 Streamer role.md>) that propagates [Manifest 📜](<01 📜 Domain Manifest.md>) updates. 
