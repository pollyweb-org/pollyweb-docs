...
1. **What can domains use Graphs for?**
    ...
    | [🌬️ Streams](<../42 Events/02 🌬️🎭 Streamer role.md>) | What are the event [Streams 🌬️](<../42 Events/02 🌬️🎭 Streamer role.md>) of [domain 👥](<00 👥 Domain.md>) `D`?
...
1. **How can domains know about Manifest events placed on hold?**
    ...
    - Interested domains should [subscribe 🔔](<../42 Events/04 🔔🎭 Subscriber role.md>) to the Graph's [Streamer 🌬️ role](<../42 Events/02 🌬️🎭 Streamer role.md>), filtering the [domains 👥](<00 👥 Domain.md>) they're interested in receiving alert notifications about. 
    - For privacy reasons, some security alerts may only be pushed to the [Subscriber 🔔 domain](<../42 Events/04 🔔🎭 Subscriber role.md>) that is referenced in the alert.
