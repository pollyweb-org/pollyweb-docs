# [🧩](<../../25 Data/10 🧩 Schema Codes/02 🧩 Schema Code.md>) [`.MANIFEST`](<10 🧩 MANIFEST code.md>) `/CODE`

> Part of [`.MANIFEST` 🧩](<10 🧩 MANIFEST code.md>)

> Implements [Schema Code🧩](<../../25 Data/10 🧩 Schema Codes/02 🧩 Schema Code.md>)
...
| Property | Type | Notes|
|-|-|-
| `Path`| string | Relative path of the [Code 🧩](<../../25 Data/10 🧩 Schema Codes/02 🧩 Schema Code.md>)  or group
...
| `Name` | string | Human name of the [Schema Code 🧩](<../../25 Data/10 🧩 Schema Codes/02 🧩 Schema Code.md>) 
| `Description`| string | Human  description of the [Schema Code 🧩](<../../25 Data/10 🧩 Schema Codes/02 🧩 Schema Code.md>)  
