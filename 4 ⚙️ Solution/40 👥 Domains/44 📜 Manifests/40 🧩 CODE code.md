# [🧩](<../../25 Data/24 🗄️ Vaults/02 🧩 Schema Code.md>) [`.MANIFEST`](<10 🧩 MANIFEST code.md>) `/CODE`

> Part of [`.MANIFEST` 🧩](<10 🧩 MANIFEST code.md>)

> Implements [Schema Code🧩](<../../25 Data/24 🗄️ Vaults/02 🧩 Schema Code.md>)
...
| [`Delegator 🧩`](<30 🧩 DELEGATE code.md>) | string | Optional [Authority 🏛️ domain](<../../45 Helpers/10 🏛️ Authorities/02 🏛️🛠️ Authority helper.md>) that delegated: <br/>- i.e., added it to [`.MANIFEST/DELEGATE` 🧩](<30 🧩 DELEGATE code.md>)
