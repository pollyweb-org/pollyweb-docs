...
1. **What are examples of domain stamps?**
    ...
    | Example | Details
    |-|-
    | [`Download@Host`](<../../../41 🎭 Domain Roles/Hosts 🤗/🤗🅰️ Host methods/Download 🧑‍🦰🚀🤗/🤗 Download 🚀 request.md>) | Download [Prompt 🤔](<../../../35 💬 Chats/Chats 💬/🤔 Prompt.md>) appendixes in [Chats 💬](<../../../35 💬 Chats/Chats 💬/💬 Chat.md>)
...
1. **How does it work**?
    ...
    |#| Step | Details
    |-|-|-
    |1| `DKIM` | Domain A rotates its [DKIM](<../../../30 🧩 Data/Messages 📨/📨 Message/📨 Message.md>) public key.
...
1. **What is contained in a domain stamp?**
    ...
    ```yaml
    Schema: nlweb.dom/SIGNATURE:1.0
    ...
    | `DKIM`| string | The [DKIM 📨](<../../../45 🤲 Helper domains/Graphs 🕸/🕸🅰️ Graph methods/👥🚀🕸 Public Key/🕸 Public Key 🚀 request.md>) key used to sign
...
1. **How do sender domains stamp files**?
    ...
    To stamp a file, sender [domains 👥](<../../👥 Domain/👥 Domain.md>): 
...
1. **How do receiver domains verify a sender's signature**?
    ...
    3. get the public key for the DKIM by calling [`PublicKey@Graph`](<../../../45 🤲 Helper domains/Graphs 🕸/🕸🅰️ Graph methods/👥🚀🕸 Public Key/🕸 Public Key 🚀 request.md>);
...
1. **What if the public key of the sender changes?**
    ...
    The stamp contains the key of the DKIM used to sign the file, so it can obtain the public key with [`PublicKey@Graph`](<../../../45 🤲 Helper domains/Graphs 🕸/🕸🅰️ Graph methods/👥🚀🕸 Public Key/🕸 Public Key 🚀 request.md>).
