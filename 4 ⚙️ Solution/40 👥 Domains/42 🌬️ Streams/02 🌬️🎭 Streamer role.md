...
1. **What are examples of domain event streams?**
    ...
    * [Listener 👂 domains](<../../42 Backbone/10 Listeners/02 👂🛠️ Listener helper.md>) and [Graph 🕸 domains](<../../42 Backbone/20 Graphs/03 🕸🛠️ Graph helper.md>) stream domain [Manifest 📜](<../44 📜 Manifests/01 📜 Domain Manifest.md>) updates.
...
1. **How to prevent Buffers from spoofing the events?**
    ...
    To avoid spoofing, [Streamer 🌬️ domains](<02 🌬️🎭 Streamer role.md>) encrypt the event content with the [DKIM public key 📨](<../41 📨 Messages/01 📨 Domain Message.md>) of the [Subscriber 🔔 domain](<04 🔔🎭 Subscriber role.md>) before sending it to the Subscriber's [Buffer ⏳ helper domain](<03 ⏳🛠️ Buffer helper.md>).
