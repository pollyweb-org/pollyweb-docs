...
1. **What is a Streamer domain role in NLWeb?**
    ...
    A Streamer 🌬️ is any [domain 👥](<../41 📨 Msgs/00 👥 Domain.md>) that 
...
1. **How do Streamer domains work?**
    ...
    ![](<../41 📨 Msgs/.📎 Assets/📨🌬️ Streamer-simple.png>)

    |Steps|Description
    |-|-
    |0| [Subscriber 🔔 domains](<04 🔔🎭 Subscriber role.md>) first need to subscribe to a [Streamer 🌬️ domain](<02 🌬️🎭 Streamer role.md>) by providing their [Buffer ⏳ helper domain](<03 ⏳🛠️ Buffer helper.md>).
    |1, 2, 3| [Streamer 🌬️ domains](<02 🌬️🎭 Streamer role.md>) then publish events at any time to the [Buffer ⏳ helper domain](<03 ⏳🛠️ Buffer helper.md>).
...
1. **What are examples of domain event streams?**
    ...
    * [Listener 👂 domains](<../44 📜 Manifests/02 👂🛠️ Listener helper.md>) and [Graph 🕸 domains](<../44 📜 Manifests/03 🕸🛠️ Graph helper.md>) stream domain [Manifest 📜](<../44 📜 Manifests/01 📜 Domain Manifest.md>) updates.
...
1. **How to prevent Buffers from spoofing the events?**
    ...
    To avoid spoofing, [Streamer 🌬️ domains](<02 🌬️🎭 Streamer role.md>) encrypt the event content with the [DKIM public key 📨](<../41 📨 Msgs/01 📨 Domain Message.md>) of the [Subscriber 🔔 domain](<04 🔔🎭 Subscriber role.md>) before sending it to the Subscriber's [Buffer ⏳ helper domain](<03 ⏳🛠️ Buffer helper.md>).
