...
1. **What are examples of domain event streams?**
    ...
    * [Listener 👂 domains](<../45 👂 Backbone/02 👂🛠️ Listener helper.md>) and [Graph 🕸 domains](<../45 👂 Backbone/03 🕸🛠️ Graph helper.md>) stream domain [Manifest 📜](<../44 📜 Manifests/01 📜 Domain Manifest.md>) updates.
