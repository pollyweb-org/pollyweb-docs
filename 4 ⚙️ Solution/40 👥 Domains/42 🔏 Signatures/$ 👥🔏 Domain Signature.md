...
1. **How do receiver domains verify a sender's signature**?
    ...
    3. get the public key for the DKIM by calling [Public Key @ Graph 🚀](<../../45 🛠️ Helper domains/50 🕸 Graphs/45 🕸🅰️ Graph/07 👥🚀🕸 Public Key.md>);
...
1. **What if the public key of the sender changes?**
    ...
    The stamp contains the key of the DKIM used to sign the file, so it can obtain the public key with [Public Key @ Graph 🚀](<../../45 🛠️ Helper domains/50 🕸 Graphs/45 🕸🅰️ Graph/07 👥🚀🕸 Public Key.md>).
