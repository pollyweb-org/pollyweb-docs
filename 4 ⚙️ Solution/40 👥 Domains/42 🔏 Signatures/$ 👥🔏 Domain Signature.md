...
1. **What are examples of domain stamps?**
    ...
    | Example | Details
    |-|-
    | [🚀 Download @ Host](<../../41 🎭 Domain Roles/30 🤗 Hosts/🅰️ Host methods/56 🧑‍🦰🚀🤗 Download@Host.md>) | Download [Prompt 🤔](<../../../9 😃 Talkers/10 📘 Talker specs/20 🤔 Prompt.md>) appendixes in [Chats 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>)
...
1. **How do receiver domains verify a sender's signature**?
    ...
    3. get the public key for the DKIM by calling [Public Key @ Graph 🚀](<../../45 🛠️ Helper domains/50 🕸 Graphs/🕸🅰️ Graph methods/👥🚀🕸 Public Key.md>);
...
1. **What if the public key of the sender changes?**
    ...
    The stamp contains the key of the DKIM used to sign the file, so it can obtain the public key with [Public Key @ Graph 🚀](<../../45 🛠️ Helper domains/50 🕸 Graphs/🕸🅰️ Graph methods/👥🚀🕸 Public Key.md>).
