...
1. **What does a domain DNS look like?**
    ...
    | 👉 [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) for outbound and [Tokens 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>)
    | `pk6`.`_domainkey`.[`any-domain.com`]() | `TXT` | `v=DKIM1;k=rsa;p=...` 
    | 👉 Old [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) for old [Tokens 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>)
...
1. **What API methods does a Domain need to expose?**
    ...
    * The following list enumerates the possible roles a [domain 👥](<00 👥 Domain.md>) can assume.
    ...
    | [🎴 Issuer](<../../41 🎭 Domain Roles/40 🎴 Issuers/$ 🎴🎭 Issuer role.md>) | Issues [Tokens 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) to be saved on users' [Wallets 🧑‍🦰](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>)
