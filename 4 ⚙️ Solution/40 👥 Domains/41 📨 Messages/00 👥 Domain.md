...
1. **What API methods does a Domain need to expose?**
    ...
    * The following list enumerates the possible roles a [domain 👥](<00 👥 Domain.md>) can assume.
    ...
    | [🌬️ Streamer](<../../41 🎭 Domain Roles/75 🌬️ Streamers/02 🌬️🎭 Streamer role.md>) | Pushes and replays domain events to [Subscribers 🔔](<../../41 🎭 Domain Roles/76 🔔 Subscribers/04 🔔🎭 Subscriber role.md>)
    | [🔔 Subscriber](<../../41 🎭 Domain Roles/76 🔔 Subscribers/04 🔔🎭 Subscriber role.md>) | Subscribes to domain events from a [Streamers 🌬️](<../../41 🎭 Domain Roles/75 🌬️ Streamers/02 🌬️🎭 Streamer role.md>)
