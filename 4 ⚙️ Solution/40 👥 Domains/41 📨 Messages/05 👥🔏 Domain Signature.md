...
1. **What are examples of domain stamps?**
    ...
    | Example | Details
    |-|-
    | [🚀 Download @ Host](<../../../6 🅰️ APIs/50 🤗🅰️ Host/06 🧑‍🦰🚀🤗 Download.md>) | Download [Prompt 🤔](<../../../9 😃 Talkers/10 📘 Talker specs/20 🤔 Prompt.md>) appendixes in [Chats 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>)
...
1. **What is contained in a domain stamp?**
    ...
    | `Domain` | string | The [domain 👥](<../$ 👥 Domains/00 👥 Domain.md>) name
...
1. **How do sender domains stamp files**?
    ...
    To stamp a file, sender [domains 👥](<../$ 👥 Domains/00 👥 Domain.md>): 
...
1. **How do receiver domains verify a sender's signature**?
    ...
    To verify a file, receiver [domains 👥](<../$ 👥 Domains/00 👥 Domain.md>): 
    1. calculate the hash of the file without the stamp;
