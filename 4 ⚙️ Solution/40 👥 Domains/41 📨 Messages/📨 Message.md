...
1. **What does a domain message look like?**
    ...
    * The [Schema 🧩](<../../30 🧩 Data/10 🧩 Schema Codes/🧩 Schema Code.md>) is defined at [`nlweb.org/MSG 🧩`](<📨🧩 Message schemas/🧩 MSG.md>).
...
1. **What is the signature for?**
    ...
    - and [Broker 🤵 domains](<../../45 🤲 Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) verify incoming [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) messages with the their pre-shared public key.
