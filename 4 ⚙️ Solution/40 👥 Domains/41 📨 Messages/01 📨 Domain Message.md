...
1. **What does a domain message look like?**
    ...
    * The [Schema 🧩](<../../25 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>) is defined at [`nlweb.org/MSG 🧩`](<../../../7 🧩 Codes/$/🧩 MSG code.md>).
...
1. **What is contained in a domain message envelope?**
    ...
    |-|-
    | `🤝` | The versioned [Schema Code 🧩](<../../25 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>) of the envelope.
...
1. **How do receiver domains handle upgraded schema versions?**
    ...
    An NLWeb envelop contains a [Schema Code 🧩](<../../25 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>) that allows receivers to support multiple versions concurrently, handling incoming envelopes differently depending on its version;
...
1. **Why are Messages in JSON while Manifests are in YAML?** 
    ...
    | `YAML` | Structured YAML for human-to-machine settings, because it supports comments and it's easier for humans to read, while still supporting schema validations; <br/>• e.g.: [Schema Codes 🧩](<../../25 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>) and [domain Manifests 📜](<../44 📜 Manifests/$ 📜 Domain Manifest.md>).
