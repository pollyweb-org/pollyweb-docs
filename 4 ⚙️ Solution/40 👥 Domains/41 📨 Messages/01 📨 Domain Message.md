...
1. **How can senders know if receivers discarded messages?**
    ...
    * Sender domains define their [Buffer ⏳ helper domain](<../../45 Helpers/10 ⏳ Buffers/$ ⏳🛠️ Buffer helper.md>) in the `Identity` section of their [domain Manifest 📜](<../44 📜 Manifests/$ 📜 Domain Manifest.md>).
