...
1. **How do receiver domains differentiate methods?**
    ...
    - e.g., `Hello@Host` refers to the [Hello 🐌 method](<../../41 🎭 Domain Roles/30 🤗 Hosts/51 🤵🐌🤗 Hello@Host.md>) in the [Host 🤗 domain role](<../../41 🎭 Domain Roles/30 🤗 Hosts/$ 🤗🎭 Host role.md>).
...
1. **How can senders know if receivers discarded messages?**
    ...
    * Sender domains define their [Buffer ⏳ helper domain](<../../45 🛠️ Helper domains/27 ⏳ Buffers/$ ⏳🛠️ Buffer helper.md>) in the `Identity` section of their [domain Manifest 📜](<../44 📜 Manifests/$ 📜 Domain Manifest.md>).
       ...
       * Domains get of the [Buffer ⏳ helper domain](<../../45 🛠️ Helper domains/27 ⏳ Buffers/$ ⏳🛠️ Buffer helper.md>) by calling the [Identity@Broker 🚀 request](<../../45 🛠️ Helper domains/50 🕸 Graphs/45 🕸🅰️ Graph methods/04 👥🚀🕸 Identity.md>).
