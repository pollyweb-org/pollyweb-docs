...
1. **How do Firewalls work?**
    ...
    |#|Step
    |-|-
    |1| [Firewall 🔥 domains](<03 🔥🛠️ Firewall helper.md>) subscribe to the [domain-event streams 🌬️](<../42 🌬️ Streams/02 🌬️🎭 Streamer role.md>) of [Reviewer ⭐ domains](<../../30 🫥 Agents/10 🔎 Finders/01 ⭐🫥 Reviewer vault.md>), [Listener 👂 domains](<../45 👂 Backbone/02 👂🛠️ Listener helper.md>), and [Graph 🕸 domains](<../45 👂 Backbone/03 🕸🛠️ Graph helper.md>), eventually throttling them with a [Buffer ⏳ helper domain](<../42 🌬️ Streams/03 ⏳🛠️ Buffer helper.md>);
    |2| [Firewall 🔥 domains](<03 🔥🛠️ Firewall helper.md>) then update the [Trust 👍 list](<01 👍 Domain Trust.md>) in their [domain Manifest 📜](<../44 📜 Manifests/01 📜 Domain Manifest.md>), which is propagated down by the [Listener 👂 helper domains](<../45 👂 Backbone/02 👂🛠️ Listener helper.md>) and subscribed by [Graph 🕸 helper domains](<../45 👂 Backbone/03 🕸🛠️ Graph helper.md>) and [Finder 🔎 vaults](<../../30 🫥 Agents/10 🔎 Finders/02 🔎🫥 Finder vault.md>).
...
1. **Do Firewalls monitor Listeners and Graphs?**
    ...
    Yes. 
    * [Firewall 🔥 helper domains](<03 🔥🛠️ Firewall helper.md>) subscribe to [Listener 👂 domain streams](<../45 👂 Backbone/02 👂🛠️ Listener helper.md>) and [Graph 🕸 domain streams](<../45 👂 Backbone/03 🕸🛠️ Graph helper.md>) to monitor their robustness, reliability, and conformity to the NLWeb protocol, revoking their [Trust 👍](<01 👍 Domain Trust.md>) when necessary;
        * e.g., compare information about a random [domain 👥](<../41 📨 Messages/00 👥 Domain.md>) in three or more [Listener 👂 domains](<../45 👂 Backbone/02 👂🛠️ Listener helper.md>) or [Graph 🕸 domains](<../45 👂 Backbone/03 🕸🛠️ Graph helper.md>) to identify discrepancies.
