...
1. **Do Firewalls monitor Listeners and Graphs?**
    ...
    * [Firewall 🔥 helper domains](<03 🔥🛠️ Firewall helper.md>) subscribe to [Listener 👂 domain streams](<../../42 Backbone/10 Listeners/02 👂🛠️ Listener helper.md>) and [Graph 🕸 domain streams](<../../42 Backbone/20 Graphs/03 🕸🛠️ Graph helper.md>) to monitor their robustness, reliability, and conformity to the NLWeb protocol, revoking their [Trust 👍](<01 👍 Domain Trust.md>) when necessary;
        * e.g., compare information about a random [domain 👥](<../41 📨 Messages/00 👥 Domain.md>) in three or more [Listener 👂 domains](<../../42 Backbone/10 Listeners/02 👂🛠️ Listener helper.md>) or [Graph 🕸 domains](<../../42 Backbone/20 Graphs/03 🕸🛠️ Graph helper.md>) to identify discrepancies.
