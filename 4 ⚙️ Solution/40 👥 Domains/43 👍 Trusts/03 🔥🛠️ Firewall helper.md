...
1. **How do Firewalls work?**
    ...
    |#|Step
    |-|-
    |1| [Firewall 🔥 domains](<03 🔥🛠️ Firewall helper.md>) subscribe to the [domain-event streams 🌬️](<../42 Events/02 🌬️🎭 Streamer role.md>) of [Reviewer ⭐ domains](<../../30 🫥 Agents/10 🔎 Finders/01 ⭐🫥 Reviewer vault.md>), [Listener 👂 domains](<../44 📜 Manifests/02 👂🛠️ Listener helper.md>), and [Graph 🕸 domains](<../44 📜 Manifests/03 🕸🛠️ Graph helper.md>), eventually throttling them with a [Buffer ⏳ helper domain](<../42 Events/03 ⏳🛠️ Buffer helper.md>);
