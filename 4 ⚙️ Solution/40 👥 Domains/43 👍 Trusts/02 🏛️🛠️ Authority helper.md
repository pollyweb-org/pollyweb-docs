...
1. **What is an Authority domain in NLWeb?**
    ...
    - converting standards to [Schema Codes 🧩](<../../20 🧑‍🦰 UI/24 🗄️ Vaults/02 🧩 Schema Code.md>) (e.g., electronic passports); and 
    - publishing reference [🪣 Datasets](<../../20 🧑‍🦰 UI/05 💬 Chats/07 🪣🎭 Dataset role.md>) for automated issues (e.g., accessibility codes for international travel).
...
1. **How do other domains parse the hierarchies?**
    ...
    * Instead, domains should rely on [Graphs 🕸](<../44 📜 Manifests/03 🕸🛠️ Graph helper.md>) to index the [Schema Codes 🧩](<../../20 🧑‍🦰 UI/24 🗄️ Vaults/02 🧩 Schema Code.md>) on their behalf.
