...
1. **How can domains know when another domain lost trust in them?**
    ...
    [Domains 👥](<../41 📨 Msgs/00 👥 Domain.md>) can rely on [Graph 🕸 domain helpers](<../44 📜 Manifests/03 🕸🛠️ Graph helper.md>):
...
1. **How can domains know when indirect trust changes affect them?**
    ...
    [Domains 👥](<../41 📨 Msgs/00 👥 Domain.md>) can rely on [Graph 🕸 domains](<../44 📜 Manifests/03 🕸🛠️ Graph helper.md>):
