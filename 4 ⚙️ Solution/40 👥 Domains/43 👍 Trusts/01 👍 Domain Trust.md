...
1. **How are immediate security bans imposed?**
    ...
    *  [domains 👥](<../41 📨 Messages/00 👥 Domain.md>)s may inherit all revokes from [Firewall 🔥 domains](<../../45 Helpers/21 Firewalls/03 🔥🛠️ Firewall helper.md>) to immediately block any new threat, regardless of any direct or indirect [trust 👍](<01 👍 Domain Trust.md>) to the harmful actor;
