...
1. **How do domains avoid interacting with bad actors?**
    ...
    * [sender domains 📤](<../41 📨 Messages/00 👥 Domain.md>) to know if they can [trust 👍](<$ 👍 Domain Trust.md>) a [receiver domain 📥](<../41 📨 Messages/00 👥 Domain.md>) with a specific [Schema Code 🧩](<../../25 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>) path - e.g. `nlweb.org/PERSONA/*`, and vice-versa.
...
1. **How to define Trust relationships?**
    ...
    * using the schema code [nlweb.org/MANIFEST/TRUST 🧩](<../44 📜 Manifests/50 🧩 TRUST code.md>).
    ...
    `Query`<br/>`Queries`  |string,<br/>string[]| [Schema Code 🧩](<../../25 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>)  paths to trust: <br/>• default: everything
