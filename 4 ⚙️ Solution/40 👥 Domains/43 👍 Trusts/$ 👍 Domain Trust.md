...
1. **How do domains avoid interacting with bad actors?**
    ...
    * [sender domains 📤](<../41 📨 Messages/00 👥 Domain.md>) to know if they can [trust 👍](<$ 👍 Domain Trust.md>) a [receiver domain 📥](<../41 📨 Messages/00 👥 Domain.md>) with a specific [Schema Code 🧩](<../../30 🧩 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>) path - e.g. `nlweb.org/PERSONA/*`, and vice-versa.
...
1. **How to define Trust relationships?**
    ...
    * using the schema code [nlweb.org/MANIFEST/TRUST 🧩](<../44 📜 Manifests/50 🧩 TRUST code.md>).
    ...
    `Query`<br/>`Queries`  |string,<br/>string[]| [Schema Code 🧩](<../../30 🧩 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>)  paths to trust: <br/>• default: everything
...
1. **How are immediate security bans imposed?**
    ...
    *  [domains 👥](<../41 📨 Messages/00 👥 Domain.md>)s may inherit all revokes from [Firewall 🔥 domains](<../../45 🛠️ Helper domains/40 🔥 Firewalls/$ 🔥🛠️ Firewall helper.md>) to immediately block any new threat, regardless of any direct or indirect [trust 👍](<$ 👍 Domain Trust.md>) to the harmful actor;
...
1. **How can domains know when another domain lost trust in them?**
    ...
    [Domains 👥](<../41 📨 Messages/00 👥 Domain.md>) can rely on [Graph 🕸 domain helpers](<../../45 🛠️ Helper domains/50 🕸 Graphs/$ 🕸🛠️ Graph helper.md>):
...
1. **How can domains know when indirect trust changes affect them?**
    ...
    [Domains 👥](<../41 📨 Messages/00 👥 Domain.md>) can rely on [Graph 🕸 domains](<../../45 🛠️ Helper domains/50 🕸 Graphs/$ 🕸🛠️ Graph helper.md>):
