...
1. **How do domains avoid interacting with bad actors?**
    ...
    * [sender domains 📤](<../👥 Domains/👥 Domain.md>) to know if they can [trust 👍](<👍 Domain Trust.md>) a [receiver domain 📥](<../👥 Domains/👥 Domain.md>) with a specific [Schema Code 🧩](<../../30 Data/🧩 Schema Codes/🧩 Schema Code.md>) path - e.g. `nlweb.org/PERSONA/*`, and vice-versa.
