...
1. **What flows are implemented by domains?**
    ...
    |[👥⏩👥 Request Sync 🚀](<👥⏩ Domain flows/Send Sync 👥🚀👥 /👥 Send Sync ⏩ flow.md>) | Send requests that wait for a response
    |[👥⏩👥 Send Async 🐌](<👥⏩ Domain flows/Send Async 👥🐌👥/👥 Send Async ⏩ flow.md>) | Send event-driven commands or events
