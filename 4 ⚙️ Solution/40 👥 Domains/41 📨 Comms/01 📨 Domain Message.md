...
1. **What does a domain message look like?**
    ...
    * The [Schema 🧩](<../../20 🧑‍🦰 UI/24 🗄️ Vaults/02 🧩 Schema Code.md>) is defined at [`nlweb.org/MSG 🧩`](<../../../7 🧩 Codes/$/🧩 Mgs.md>).
...
1. **What is contained in a domain message envelope?**
    ...
    The following properties are a summary of the schema at [`nlweb.org/MSG 🧩`](<../../../7 🧩 Codes/$/🧩 Mgs.md>).
