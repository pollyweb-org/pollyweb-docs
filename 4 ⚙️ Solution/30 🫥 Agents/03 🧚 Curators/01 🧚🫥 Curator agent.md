...
1. **What domain roles do Curators implement?**
    ...
    | [🗄️ Vault ](<../../41 🎭 Domain Roles/80 🗄️ Vault/03 🗄️🎭 Vault role.md>) | To share user selections with [Consumer 💼 host domains](<../../41 🎭 Domain Roles/27 💼 Consumers/04 💼🎭 Consumer role.md>).
