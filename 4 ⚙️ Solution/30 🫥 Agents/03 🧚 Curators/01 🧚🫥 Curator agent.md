...
1. **What domain roles do Curators implement?**
    ...
    | [🗄️ Vault ](<../../25 Data/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) | To share user selections with [Consumer 💼 host domains](<../../25 Data/27 💼 Consumers/04 💼🎭 Consumer role.md>).
...
1. **How do curators protect themselves from prompt injection?**
    ...
    - Suspicious behaviors are reported to [Firewall 🔥 helper domains](<../../45 Helpers/21 Firewalls/03 🔥🛠️ Firewall helper.md>).
