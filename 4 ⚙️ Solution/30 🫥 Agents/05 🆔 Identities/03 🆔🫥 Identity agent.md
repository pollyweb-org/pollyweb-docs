...
1. **What is an Identity domain in NLWeb?**
    ...
    * 🎴 is the one for whom a presented [Token 🎫](<../../20 🧑‍🦰 UI/27 🎫 Tokens/01 🎫 Token.md>) was issued to, or
