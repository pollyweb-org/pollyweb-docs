...
1. **How to verify a Wallet ownership?**
    ...
    * for the ownership of a [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>).
    ...
    | - | - | - |
    | 🤗 [Host](<../../20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) | 😐 Start risky task [Yes, No] | > Yes
    | 🆔 [Identity](<01 🆔🫥 Identity agent.md>) | 🫥 Let me see if it's you.   | [📸 selfie](<21 🆔😶 Face scan.md>)
    | 🤗 [Host](<../../20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) | ✅ Verified, task started!
...
1. **How does remote face verification works?**
    ...
    |2| The webpage of the [Identity 🆔 vault](<01 🆔🫥 Identity agent.md>) <br/>• activates the device's camera to record the user's video for liveness check <br/>• extracts the relevant images <br/>• and compares them to the user images on the given [Locator 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/01 🔆 Locator.md>). 
...
1. **How are users' face biometrics protected from Sellers?**
    ...
    NLWeb advocates for online face authentication between [Wallet 🧑‍🦰 apps](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) and [Identity 🆔 vaults](<01 🆔🫥 Identity agent.md>), without sharing user biometrics with [Seller 💵 domains](<../../41 🎭 Domain Roles/70 💵 Sellers/01 💵🎭 Seller role.md>);
    - e.g., when a [Seller 💵 domain](<../../41 🎭 Domain Roles/70 💵 Sellers/01 💵🎭 Seller role.md>) needs to match a person with a [Token 🎫](<../../20 🧑‍🦰 UI/25 🎫 Tokens/01 🎫 Token.md>), 
    - it contacts the [Token's  Identity 🆔 domain](<01 🆔🫥 Identity agent.md>) to perform the authentication 
    - via the user's [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) in a [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>), 
    - and only return a success/failure to the [Seller 💵 domain](<../../41 🎭 Domain Roles/70 💵 Sellers/01 💵🎭 Seller role.md>) . 
    ...
    * then the [Seller 💵 domain](<../../41 🎭 Domain Roles/70 💵 Sellers/01 💵🎭 Seller role.md>) needs to take the user's picture 
