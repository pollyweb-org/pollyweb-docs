...
4. **How do domains authenticate printed identity-bound Tokens?**
    ...
    - 5/ the [Consumer 💼 domain](<../../20 🧑‍🦰 UI/27 💼 Consumers/04 💼🎭 Consumer role.md>) asks the [Token's Identity 🆔 domain](<01 🆔🫥 Identity agent.md>) to match the biometrics with the [Identity Locator 🔆](<../../20 🧑‍🦰 UI/04 🔆 Locators/01 🔆 Locator.md>);
