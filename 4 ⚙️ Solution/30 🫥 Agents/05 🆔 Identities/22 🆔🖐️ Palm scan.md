...
1. **Why use palm vein scanners instead of cameras?**
    ...
    - **Privacy protection:** palm scanners prevent [💼 Consumers](<../../41 🎭 Domain Roles/27 💼 Consumers/04 💼🎭 Consumer role.md>) from cross referencing the user's selfie with photos on the internet (e.g., social media).
