...
1. **What is a Supplier domain role in NLWeb?**
    ...
    A Supplier 🏭 is an [Integrator 🪢 domain](<../../20 🧑‍🦰 UI/23 💬 Chats/06 🪢🎭 Integrator role.md>) that exposes order APIs to accept asynchronous order requests from other [domains 👥](<../../40 👥 Domains/44 📜 Manifests/00 👥 Domain.md>).
