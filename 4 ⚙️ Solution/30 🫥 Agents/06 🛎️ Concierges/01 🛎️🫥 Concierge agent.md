...
1. **How do Concierges handle inbound tasks?**
    ...
    | #| Category|Step
    |-|-|-
    |1| `Chat`| On [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) with a [Host 🤗 domain](<../../20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>), the user asks for a task that requires the help of a [Supplier 🏭 domain](<02 🏭🎭 Supplier role.md>) (e.g., deliver a pizza).
...
1. **Do Concierges speak in natural language with Suppliers?**
    ...
    * [Concierge 🛎️ agents](<01 🛎️🫥 Concierge agent.md>) look at the supplied services exposed in the [domain Manifest 📜](<../../40 👥 Domains/44 📜 Manifests/$ 📜 Domain Manifest.md>) of [Supplier 🏭 domains](<02 🏭🎭 Supplier role.md>), which may or may not support natural language requests. 
