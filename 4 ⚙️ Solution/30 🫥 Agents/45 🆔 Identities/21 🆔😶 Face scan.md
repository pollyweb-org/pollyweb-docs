...
1. **What can users present in the first step of the flow?**
    ...
    |[🎫 Token](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>)| Was the [Token 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) really issued to the person holding the device?
...
1. **What are the conditions for face biometrics to be spoofed?**
    ...
    - the user always first presents *something they own* (e.g., a [Token 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>)) plus context information (e.g., GPS coordinates and device configuration);
