...
1. **How do users sign a document?**
    ...
    * this allows users to visualize the full final version of the document, similar to what humans do today with any paper document. 
    ...
    A user signature is an offline [Token 🎫](<../../20 🧑‍🦰 UI/25 🎫 Tokens/$ 🎫 Token.md>) issued by an [Identity 🆔 domain](<01 🆔🫥 Identity agent.md>) that they [trust 👍](<../../40 👥 Domains/43 👍 Trusts/$ 👍 Domain Trust.md>) confirming that:
    ...
    A signature request from a [Host 🤗 domain](<../../41 🎭 Domain Roles/30 🤗 Hosts/$ 🤗🎭 Host role.md>) is a data set containing:
...
1. **How does it work?**
    ...
    |#|Step
    |-|-
    |1| [Hosts 🤗](<../../41 🎭 Domain Roles/30 🤗 Hosts/$ 🤗🎭 Host role.md>) ask [Wallets 🧑‍🦰](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>) for a user signature
    ...
    | 7| [Identities 🆔](<01 🆔🫥 Identity agent.md>) issue a signature [Token 🎫](<../../20 🧑‍🦰 UI/25 🎫 Tokens/$ 🎫 Token.md>) and send it to [Hosts 🤗](<../../41 🎭 Domain Roles/30 🤗 Hosts/$ 🤗🎭 Host role.md>)
...
1. **How do users sign files?**
    ...
    * The [Token 🎫](<../../20 🧑‍🦰 UI/25 🎫 Tokens/$ 🎫 Token.md>) attached to the file is signed by the [Identity 🆔 domain](<01 🆔🫥 Identity agent.md>), with an Identity-bound reference to the user.
...
1. **How do domains verify user signatures?**
    ...
    Domains accept user signatures verified by [Identity 🆔 domains](<01 🆔🫥 Identity agent.md>) that they [trust 👍](<../../40 👥 Domains/43 👍 Trusts/$ 👍 Domain Trust.md>). 
    ...
    * When a domain sends a file for the user to sign, it sends also a placeholder ID of that user in the document 
      ...
      * [Identity 🆔 domains](<01 🆔🫥 Identity agent.md>) include the received placeholder ID in the [Token 🎫](<../../20 🧑‍🦰 UI/25 🎫 Tokens/$ 🎫 Token.md>), matching the user to the placeholder ID. 
...
1. **What data is contained in a user-signature file Token?**
    ...
    A user-signature file [Token 🎫](<../../20 🧑‍🦰 UI/25 🎫 Tokens/$ 🎫 Token.md>) contains:
