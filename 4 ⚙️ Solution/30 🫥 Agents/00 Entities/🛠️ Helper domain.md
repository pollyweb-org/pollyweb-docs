...
1. **What are examples of Helper domains?**
    ...
    | [Keymaker 🔐](<../../70 🌳 Ambient/75 🔒 Brand Padlocks/05  🔐🏭 Keymaker supplier.md>) | - | Manages the lifecycle of [Padlocks 🔒](<01 🔒 Padlock device.md>) on behalf of [Brands 🍏](<../71 💠 Brand Things/07 🍏🎭 Brand role.md>).
    ...
    | [Printer 🖨️](<../../70 🌳 Ambient/71 💠 Brand Things/08 🖨️🏭 Printer supplier.md>) | - | Prints NFC/QR [Locators 🔆](<../../20 🧑‍🦰 UI/22 🔆 Locators/01 🔆 Locator.md>) on behalf of [Brand 🍏](<07 🍏🎭 Brand role.md>) and [Host 🤗](<../../20 🧑‍🦰 UI/23 💬 Chats/03 🤗🎭 Host role.md>) domains.
    | [Wand 🪄](<../../70 🌳 Ambient/71 💠 Brand Things/09 🪄👥 Wand helper.md>) | - | Manages [Chats 💬](<../../20 🧑‍🦰 UI/23 💬 Chats/01 💬 Chat.md>) for [Things 💠](<01 💠 Thing.md>) on behalf of [Brand 🍏 domains](<07 🍏🎭 Brand role.md>).
