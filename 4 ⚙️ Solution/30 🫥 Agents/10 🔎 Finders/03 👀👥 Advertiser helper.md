...
1. **How are ads selected?**
    ...
    | B | The Advertiser's 👀 [Payer 💳 helper](<../04 💳 Payers/03 💳🎭 Payer role.md>) sends the corresponding part to the [Collector 🏦 helper](<../04 💳 Payers/01 🏦🛠️ Collector helper.md>) of each [Host 🤗 domain](<../../20 🧑‍🦰 UI/23 💬 Chats/03 🤗🎭 Host role.md>) for their [Chat 💬](<../../20 🧑‍🦰 UI/23 💬 Chats/01 💬 Chat.md>) summaries.
