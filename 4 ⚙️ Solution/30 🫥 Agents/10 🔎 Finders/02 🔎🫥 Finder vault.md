...
5. **How do Finders help users with a search?**
    ...
    * Consider the following [Chat 💬](<../../20 🧑‍🦰 UI/23 💬 Chats/01 💬 Chat.md>) excerpt of the [Find a bar 🤝 use case](<../../../3 🤝 Use Cases/02 🍽️ Eat & Drink/70 🍸 Drink at bars/1 Customer @ Anywhere/11. Find a bar.md>) as an example.
