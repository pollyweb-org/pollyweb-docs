...
1. **Where do Finders get information about other domains?**
    ...
    |-|-
    | [🕸&nbsp;Graphs](<../../42 Backbone/20 Graphs/03 🕸🛠️ Graph helper.md>) | Finders subscribe to [Graphs 🕸 domains](<../../42 Backbone/20 Graphs/03 🕸🛠️ Graph helper.md>) to receive updates on [domain Manifests 📜](<../../40 👥 Domains/44 📜 Manifests/01 📜 Domain Manifest.md>) across the NLWeb, including their public identity, [trust 👍](<../../40 👥 Domains/43 👍 Trusts/01 👍 Domain Trust.md>) relationships, and supported [integrations 🪢](<../../20 🧑‍🦰 UI/12 💬 Chats/06 🪢🎭 Integrator role.md>). 
...
1. **Why not merge Finders and Graphs?**
    ...
    * Conversely, [Graph 🕸 domains](<../../42 Backbone/20 Graphs/03 🕸🛠️ Graph helper.md>) are typically AI-free, allowing to be more generic.
