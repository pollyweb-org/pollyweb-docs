...
1. **Where do Finders get information about other domains?**
    ...
    |-|-
    | [🕸&nbsp;Graphs](<../../42 Backbone/20 🕸 Graphs/$ 🕸🛠️ Graph helper.md>) | Finders subscribe to [Graphs 🕸 domains](<../../42 Backbone/20 🕸 Graphs/$ 🕸🛠️ Graph helper.md>) to receive updates on [domain Manifests 📜](<../../40 👥 Domains/44 📜 Manifests/01 📜 Domain Manifest.md>) across the NLWeb, including their public identity, [trust 👍](<../../40 👥 Domains/43 👍 Trusts/01 👍 Domain Trust.md>) relationships, and supported [integrations 🪢](<../../20 🧑‍🦰 UI/12 💬 Chats/06 🪢🎭 Integrator role.md>). 
