...
1. **What is a Finder domain in NLWeb?**
    ...
    A Finder is 
    * any [Vault 🗄️ domain](<../../25 Data/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) 
...
1. **How do Finders help users with a search?**
    ...
    * After the user selection, Finders also show potential next steps for [navigation 🧭](<../07 🧭 Navigators/01 🧭🫥 Navigator agent.md>), available [services 🪢](<../../20 🧑‍🦰 UI/12 💬 Chats/06 🪢🎭 Integrator role.md>), and [advertising 👀](<../../45 Helpers/12 👀 Advertisers/$ 👀👥 Advertiser helper.md>).
...
1. **Where do Finders get information about other domains?**
    ...
    | [👀&nbsp;Advertisers](<../../45 Helpers/12 👀 Advertisers/$ 👀👥 Advertiser helper.md>) | Finders subscribe to [Advertiser 👀 domains](<../../45 Helpers/12 👀 Advertisers/$ 👀👥 Advertiser helper.md>) to know which ads to show to users in addition to search results from [domain Manifests 📜](<../../40 👥 Domains/44 📜 Manifests/$ 📜 Domain Manifest.md>). 
...
1. **How do Finders filter and rank the results for users?**
    ...
    - **🔥 Threats**: domains blocked by [Firewalls 🔥](<../../45 Helpers/21 🔥 Firewalls/$ 🔥🛠️ Firewall helper.md>) may be discarded even when trusted;
...
1. **Why not merge Finders and Graphs?**
    ...
    * Conversely, [Graph 🕸 domains](<../../42 Backbone/20 🕸 Graphs/$ 🕸🛠️ Graph helper.md>) are typically AI-free, allowing to be more generic.
