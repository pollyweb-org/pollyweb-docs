...
1. **What is a Seller domain role in NLWeb?**
    ...
    Sellers 💵 are [domains 👥](<../../40 👥 Domains/41 📨 Msgs/00 👥 Domain.md>) that ask [Payer 💳 domains](<03 💳🎭 Payer role.md>) for payments to their [Collector 🏦 helpers](<01 🏦🛠️ Collector helper.md>) in return for products or services.
