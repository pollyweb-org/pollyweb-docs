...
1. **What is a Payer domain in NLWeb?**
    ...
    A Payer 💳 is a [domain 👥](<../../40 👥 Domains/44 📜 Manifests/00 👥 Domain.md>) that performs payments to [Collector 🏦 domains](<03 🏦🛠️ Collector helper.md>) under two categories:
...
14. **After a payment, do users receive the Seller's receipt?**
    ...
    - Receipts and invoices are created by the [Seller 💵](<01 💵🎭 Seller role.md>)'s [Collector 🏦](<03 🏦🛠️ Collector helper.md>) domain, and are sent to the user's Payer 💳 domain. 
