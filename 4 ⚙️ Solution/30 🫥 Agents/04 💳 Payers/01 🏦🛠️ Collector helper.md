...
1. **What is a Collector domain in NLWeb?**
    ...
    * that other [domains 👥](<../../40 👥 Domains/41 📨 Comms/00 👥 Domain.md>) can leverage 
...
1. **How do Collectors work?**
    ...
    |#|Step
    |-|-
    |1| A [Payer 💳 domain](<03 💳🎭 Payer role.md>) receives an order to make a payment, either from a user's [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) in a business-to-consumer (B2C) transaction, or from a [domain 👥](<../../40 👥 Domains/41 📨 Comms/00 👥 Domain.md>) in a business-to-business (B2B) transaction.
    ...
    |4| The [Collector 🏦 domain](<01 🏦🛠️ Collector helper.md>)notifies the recipient [domain 👥](<../../40 👥 Domains/41 📨 Comms/00 👥 Domain.md>) that the payment was successful.
...
1. **How does a domain withdraw its money from a Collector?**
    ...
    How a recipient [domain 👥](<../../40 👥 Domains/41 📨 Comms/00 👥 Domain.md>) receives the money on their bank account depends on the [Collector 🏦 domain](<01 🏦🛠️ Collector helper.md>) - options are as follows.
...
1. **What responsibilities do Collectors have with receipts?**
    ...
    - issuing receipts on behalf of the [domain 👥](<../../40 👥 Domains/41 📨 Comms/00 👥 Domain.md>), 
...
1. **Can a Collector be use in boutique's cash register?**
    ...
    Yes. Here's a possible configuration for [domain 👥](<../../40 👥 Domains/41 📨 Comms/00 👥 Domain.md>) admins:
    - add [🔆 NFC/QR Locators](<../../20 🧑‍🦰 UI/11 🔆 Locators/01 🔆 Locator.md>) on both sides of the counter;
    - issue cashier [Tokens 🎫](<../../20 🧑‍🦰 UI/25 🎫 Tokens/01 🎫 Token.md>) from your [domain 👥](<../../40 👥 Domains/41 📨 Comms/00 👥 Domain.md>);
