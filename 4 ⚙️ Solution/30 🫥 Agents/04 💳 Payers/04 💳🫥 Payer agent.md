...
1. **How are user payments processed for users?**
    ...
    * [Collector 🏦 helpers](<01 🏦🛠️ Collector helper.md>) - these are [Helper 🛠️ domains](<../../45 Helpers/$ 🛠️ Helpers/05 🛠️👥 Helper domain.md>) able to deposit money on the [Sellers 💵](<01 💵🎭 Seller role.md>) bank account. 
    ...
    - 4/ the user's Payer 💳 transfers the money to the [Seller's 💵](<01 💵🎭 Seller role.md>) [Collector 🏦](<01 🏦🛠️ Collector helper.md>), and 
    - 5/ the [Collector 🏦](<01 🏦🛠️ Collector helper.md>) notifies the [Seller 💵](<01 💵🎭 Seller role.md>) that the transaction was paid.
