...
1. **How are user payments processed for users?**
    ...
    * [Collector 🏦 helpers](<../../45 Helpers/18 🏦 Collectors/$ 🏦🛠️ Collector helper.md>) - these are [Helper 🛠️ domains](<../../45 Helpers/$ 🛠️ Helpers/$ 🛠️👥 Helper domain.md>) able to deposit money on the [Sellers 💵](<01 💵🎭 Seller role.md>) bank account. 
    
    Upon check-out, 
    - 1/ the [Seller 💵](<01 💵🎭 Seller role.md>) registers the upcoming payment to their [Collector 🏦](<../../45 Helpers/18 🏦 Collectors/$ 🏦🛠️ Collector helper.md>), 
    - 2/ the [Seller 💵](<01 💵🎭 Seller role.md>) requests a payment from the user, 
    - 3/ the user delegates the payment to a Payer 💳, 
    - 4/ the user's Payer 💳 transfers the money to the [Seller's 💵](<01 💵🎭 Seller role.md>) [Collector 🏦](<../../45 Helpers/18 🏦 Collectors/$ 🏦🛠️ Collector helper.md>), and 
    - 5/ the [Collector 🏦](<../../45 Helpers/18 🏦 Collectors/$ 🏦🛠️ Collector helper.md>) notifies the [Seller 💵](<01 💵🎭 Seller role.md>) that the transaction was paid.
...
1. **What responsibilities do Payers have in a payment?**
    ...
    - receiving payment requests from [Collectors 🏦](<../../45 Helpers/18 🏦 Collectors/$ 🏦🛠️ Collector helper.md>);
...
1. **After a payment, do users receive the Seller's receipt?**
    ...
    - Receipts and invoices are created by the Seller's 💵 [Collector 🏦 helper](<../../45 Helpers/18 🏦 Collectors/$ 🏦🛠️ Collector helper.md>), and are sent to the user's Payer 💳 domain. 
