...
1. **What is a Biller domain in NLWeb?**
    ...
    * between a [Payer 💳 domain](<03 💳🎭 Payer role.md>) and a [Collector 🏦 domain](<../../45 Helpers/18 🏦 Collectors/01 🏦🛠️ Collector helper.md>) 
...
1. **How can a user cancel a subscription?**
    ...
    * In a [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>), users can ask their [Payer 💳 agent](<03 💳🎭 Payer role.md>) to cancel the subscription.
