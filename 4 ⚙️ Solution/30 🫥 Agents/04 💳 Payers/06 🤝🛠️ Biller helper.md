...
1. **What is a Biller domain in NLWeb?**
    ...
    A Biller domain handles the terms and lifecycle of payment agreements between a [Payer 💳](<02 💳🎭 Payer role.md>) and a [Collector 🏦](<../01 📦 Storage/03 🏦🛠️ Collector helper.md>) (w.g., subscriptions, free tiers, direct debits) on behalf of [Wallets 🧑‍🦰](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) and [Sellers 💵](<01 💵🎭 Seller role.md>).
