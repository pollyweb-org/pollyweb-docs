...
1. **What is a Biller domain in NLWeb?**
    ...
    A Biller domain handles the terms and lifecycle of payment agreements between a [Payer 💳](<02 💳🫥 Payer agent.md>) and a [Collector 🏦](<../01 📦 Storage/03 🏦🛠️ Collector helper.md>) (w.g., subscriptions, free tiers, direct debits) on behalf of [Wallets 🧑‍🦰](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) and [Sellers 💵](<01 💵🎭 Seller role.md>).
...
1. **How can a user sign a subscription in a Seller?**
    ...
    - 1/ the user has default [Payer 💳](<02 💳🫥 Payer agent.md>) and [Identity 🆔](<../05 🆔 Identities/03 🆔🫥 Identity agent.md>) domains;
...
1. **How can a user cancel a subscription?**
    ...
    User subscriptions are attached to the user's [Payer 💳](<02 💳🫥 Payer agent.md>) - in a chat, users can ask their Payer to cancel the subscription.
