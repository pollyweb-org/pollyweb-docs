...
1. **What is a Payer domain in NLWeb?**
    ...
    * **[Payer 💳🫥 agents](<04 💳🫥 Payer agent.md>)**: 
        ...
        * interacting in [Chats 💬](<../../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>) with [Seller 💵 hosts](<01 💵🎭 Seller role.md>).
...
3. **Why not leverage the Open Banking protocol?**
    ...
    - e.g., the ability to jump between bank entities from within a [Chat 💬](<../../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>) in the user's [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>).
...
9.  **Does NLWeb allow users to pay with NFC contactless?**
    ...
    - However, users can tap on a NLWeb [🔆 NFC Locator](<../../20 🧑‍🦰 UI/04 🔆 Locators/01 🔆 Locator.md>) with their devices to check out an NLWeb transaction, while continuing to use the device's standard NFC payments for traditional point of sale (POS) terminals. 
