...
2. **How are user payments processed for users?**
    ...
    * [Collector 🏦 helpers](<../01 📦 Storage/03 🏦🛠️ Collector helper.md>) - these are [Helper 🛠️ domains](<../../20 🧑‍🦰 UI/24 🗄️ Vaults/05 🛠️👥 Helper vault.md>) able to deposit money on the [Sellers 💵](<01 💵🎭 Seller role.md>) bank account. 
