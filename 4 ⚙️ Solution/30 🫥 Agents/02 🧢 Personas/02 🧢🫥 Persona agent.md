...
2. **What domain roles do Personas implement?**
    ...
    | [🤗 Host](<../../20 🧑‍🦰 UI/05 💬 Chats/04 🤗🎭 Host role.md>) | For managing [Chats 💬](<../../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>) with users.
    | [🫥 Agent ](<../../20 🧑‍🦰 UI/24 🗄️ Vaults/04 🫥🗄️ Agent vault.md>) | To participate in [Chats 💬](<../../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>) from other [Host 🤗 domains](<../../20 🧑‍🦰 UI/05 💬 Chats/04 🤗🎭 Host role.md>).
