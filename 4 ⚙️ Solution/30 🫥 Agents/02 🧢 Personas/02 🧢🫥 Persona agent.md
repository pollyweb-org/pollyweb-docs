...
1. **What domain roles do Personas implement?**
    ...
    | [🌬️ Streamer](<../../41 🎭 Domain Roles/75 🌬️ Streamers/02 🌬️🎭 Streamer role.md>) | For streaming events to [Subscriber 🔔 domains](<../../41 🎭 Domain Roles/76 🔔 Subscribers/04 🔔🎭 Subscriber role.md>).
