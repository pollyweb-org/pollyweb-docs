...
1. **What is a Graph domain in NLWeb?**
    ...
    * that subscribes to [domain Manifest 📜](<../../40 👥 Domains/44 📜 Manifests/$ 📜 Domain Manifest.md>) change events from [Listener 👂 domains](<../../../../../../../4 ⚙️ Solution/45 🛠️ Helper domains/50 👂 Listeners/$ 👂🛠️ Listener helper.md>)
...
1. **How are NLWeb Graphs updated?**
    ...
    - To allow any graph to subscribe to changes in any [domain Manifests 📜](<../../40 👥 Domains/44 📜 Manifests/$ 📜 Domain Manifest.md>), NLWeb provides a cluster of [Listener 👂 nodes](<../../../../../../../4 ⚙️ Solution/45 🛠️ Helper domains/50 👂 Listeners/$ 👂🛠️ Listener helper.md>) for [domains 👥](<../../40 👥 Domains/41 📨 Messages/00 👥 Domain.md>) to publish change notifications to, and for [Graph 🕸 domains](<$ 🕸🛠️ Graph helper.md>) to receive notifications from. 
...
1. **How can domains reset their Manifest representation on Graphs?**
    ...
    * a [domain 👥](<../../40 👥 Domains/41 📨 Messages/00 👥 Domain.md>) can send a RESET event to their [Listener 👂 helper domain](<../../../../../../../4 ⚙️ Solution/45 🛠️ Helper domains/50 👂 Listeners/$ 👂🛠️ Listener helper.md>);
...
1. **How is a new NLWeb trust graph populated?**
    ...
    * it can ask a [Listener 👂 domain](<../../../../../../../4 ⚙️ Solution/45 🛠️ Helper domains/50 👂 Listeners/$ 👂🛠️ Listener helper.md>) 
...
1. **How do Graphs support the verification of Tokens?**
    ...
    [Issuer 🎴 domains](<../../20 🧑‍🦰 UI/25 🎫 Tokens/02 🎴🎭 Issuer role.md>) sign [Tokens 🎫](<../../20 🧑‍🦰 UI/25 🎫 Tokens/01 🎫 Token.md>) with their active [📨 DKIM](<../../40 👥 Domains/41 📨 Messages/01 📨 Domain Message.md>) key-pair. 
    ...
    * Instead, [Consumer 💼 domains](<../../41 🎭 Domain Roles/27 💼 Consumers/$ 💼🎭 Consumer role.md>) should ask a [Graph 🕸 domain](<$ 🕸🛠️ Graph helper.md>) for the Issuer's [📨 DKIM](<../../40 👥 Domains/41 📨 Messages/01 📨 Domain Message.md>) at the time the [Token 🎫](<../../20 🧑‍🦰 UI/25 🎫 Tokens/01 🎫 Token.md>) was issued.
