...
1. **How are ads selected?**
    ...
    3 | The [Broker 🤵 domain](<../../20 🧑‍🦰 UI/03 🤵 Brokers/03 🤵 Broker domain.md>) asks the Chat's 💬 [Host 🤗 domain](<../../20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) to share the [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) summary with the user's [Curator 🧚 agent](<../../30 🫥 Agents/30 🧚 Curators/$ 🧚🫥 Curator agent.md>), passing the bill's [Locator 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/01 🔆 Locator.md>).
...
1. **How are frauds prevented?**
    ...
    - [Curator 🧚 agents](<../../30 🫥 Agents/30 🧚 Curators/$ 🧚🫥 Curator agent.md>) and [Broker 🤵 domains](<../../20 🧑‍🦰 UI/03 🤵 Brokers/03 🤵 Broker domain.md>) send the number of options in the next-action prompt;
...
1. **How is PII protected?**
    ...
    * [Host 🤗 domains](<../../20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) send chat summaries directly to [Curator 🧚 agents](<../../30 🫥 Agents/30 🧚 Curators/$ 🧚🫥 Curator agent.md>), not to [Broker 🤵 domains](<../../20 🧑‍🦰 UI/03 🤵 Brokers/03 🤵 Broker domain.md>).
