...
1. **How do parties monetize by displaying Ads?**
    ...
    Monthly, the Broker's [Biller 🤝 helper](<../15 🤝 Billers/$ 🤝🛠️ Biller helper.md>) debits the transaction fees and percentages to the Advertisers, who then have to pay the [Curator 🧚 agents](<../../30 🫥 Agents/03 🧚 Curators/01 🧚🫥 Curator agent.md>) and the [Host 🤗 domains](<../../20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>)
...
1. **How are frauds prevented?**
    ...
    - Advertisers, [Curator 🧚 agents](<../../30 🫥 Agents/03 🧚 Curators/01 🧚🫥 Curator agent.md>), and [Seller 💵 domains](<../../41 🎭 Domain Roles/70 💵 Sellers/$ 💵🎭 Seller role.md>) send the IDs of the selected list of ads presented to the user;
    ...
    For ad clicks: 
    - [Curator 🧚 agents](<../../30 🫥 Agents/03 🧚 Curators/01 🧚🫥 Curator agent.md>), Advertisers 👀, and [Seller 💵 domains](<../../41 🎭 Domain Roles/70 💵 Sellers/$ 💵🎭 Seller role.md>) send the IDs of ads translated from option number to option Locator;
