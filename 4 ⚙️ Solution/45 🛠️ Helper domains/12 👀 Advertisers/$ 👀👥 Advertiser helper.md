...
1. **How are ads presented to users?**
    ...
    When a [Host 🤗 domain](<../../20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) ends a [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>), an Advertiser 👀 presents contextualized next-best actions for the user, e.g.: 
...
1. **How are ads selected?**
    ...
    | # | Showing ads
    |-|-
    | 1 | When closing a [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>), [Host 🤗 domains](<../../20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) send a Goodbye via the chat's [Broker 🤵 domain](<../../20 🧑‍🦰 UI/03 🤵 Brokers/$ 🤵 Broker domain.md>).
    ...
    3 | The [Broker 🤵 domain](<../../20 🧑‍🦰 UI/03 🤵 Brokers/$ 🤵 Broker domain.md>) asks the Chat's 💬 [Host 🤗 domain](<../../20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) to share the [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) summary with the user's [Curator 🧚 agent](<../../30 🫥 Agents/30 🧚 Curators/$ 🧚🫥 Curator agent.md>), passing the bill's [Locator 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/$ 🔆 Locator.md>).
    4 | The [Host 🤗 domain](<../../20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) sends an anonymized [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) summary to the user's [Curator 🧚 agent](<../../30 🫥 Agents/30 🧚 Curators/$ 🧚🫥 Curator agent.md>), plus the bill's [Locator 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/$ 🔆 Locator.md>).
    ...
    | B | The Advertiser's 👀 [Payer 💳 helper](<../../30 🫥 Agents/60 💳 Payers/03 💳🎭 Payer role.md>) sends the corresponding part to the [Collector 🏦 helper](<../18 🏦 Collectors/$ 🏦🛠️ Collector helper.md>) of each [Host 🤗 domain](<../../20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) for their [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) summaries.
...
1. **How is PII protected?**
    ...
    * When [Curator 🧚 agents](<../../30 🫥 Agents/30 🧚 Curators/$ 🧚🫥 Curator agent.md>) ask Advertisers 👀 for next best actions, they first anonymize the [Chat's 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) context, the user preferences, and the [Host 🤗](<../../20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) summary.
