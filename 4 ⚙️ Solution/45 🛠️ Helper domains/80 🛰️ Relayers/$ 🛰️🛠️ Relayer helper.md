...
1. **How do Relayers work?**
    ...
    |3| `Brand` | The Relayer 🛰️ registers the [Pluggable's Locator 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/$ 🔆 Locator.md>) in the [Pluggable's Brand 🍏 domain](<../../41 🎭 Domain Roles/20 🍏 Brands/07 🍏🎭 Brand role.md>).
    |4| `API Schema`| The [Brand 🍏](<../../41 🎭 Domain Roles/20 🍏 Brands/07 🍏🎭 Brand role.md>) tells the Relayer 🛰️ where to read the [API Schema 🧩](<../../30 🧩 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>) of the [Pluggable 🔌 device](<../../60 🧰 Edge/61 🔌 Pluggables/01 🔌 Pluggable device.md>).
    ...
    |Z| `Propagate` | The Relayer 🛰️ sends sends the translated events to the [Buffer ⏳ helper](<../27 ⏳ Buffers/$ ⏳🛠️ Buffer helper.md>) of the owner [domain 👥](<../../40 👥 Domains/$ 👥 Domains/$ 👥 Domain.md>).
...
1. **How do domains send commands to Pluggables?**
    ...
    | `Command` | The name of the command in the [Pluggable's API Schema 🧩](<../../30 🧩 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>) set by by the [Brand 🍏 domain](<../../41 🎭 Domain Roles/20 🍏 Brands/07 🍏🎭 Brand role.md>).
