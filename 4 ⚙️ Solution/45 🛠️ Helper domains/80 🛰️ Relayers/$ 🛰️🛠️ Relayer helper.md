...
1. **What is a Relayer domains?**
    ...
    * owned by other [domains 👥](<../../40 👥 Domains/$ 👥 Domains/00 👥 Domain.md>).
...
1. **How do Relayers work?**
    ...
    |4| `API Schema`| The [Brand 🍏](<../../70 🌳 Ambient/71 💠 Brand Things/07 🍏🎭 Brand role.md>) tells the Relayer 🛰️ where to read the [API Schema 🧩](<../../30 🧩 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>) of the [Pluggable 🔌 device](<../../60 🧰 Edge/61 🔌 Pluggables/01 🔌 Pluggable device.md>).
    |5| `Graph`|  The Relayer 🛰️ domain reads the [API Schema 🧩](<../../30 🧩 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>) from a [Graph 🕸 helper domain](<../50 🕸 Graphs/$ 🕸🛠️ Graph helper.md>).
    |6| `Domain` | The Relayer 🛰️ domain informs the owner [domain 👥](<../../40 👥 Domains/$ 👥 Domains/00 👥 Domain.md>) of the newly-plugged [Pluggable 🔌 device](<../../60 🧰 Edge/61 🔌 Pluggables/01 🔌 Pluggable device.md>).
    |A| `Command`| The owner [domain 👥](<../../40 👥 Domains/$ 👥 Domains/00 👥 Domain.md>) sends a natural language command (e.g., `Test`) on the [Pluggable 🔌 device](<../../60 🧰 Edge/61 🔌 Pluggables/01 🔌 Pluggable device.md>).
    ...
    |Z| `Propagate` | The Relayer 🛰️ sends sends the translated events to the [Buffer ⏳ helper](<../27 ⏳ Buffers/$ ⏳🛠️ Buffer helper.md>) of the owner [domain 👥](<../../40 👥 Domains/$ 👥 Domains/00 👥 Domain.md>).
...
1. **How do domains send commands to Pluggables?**
    ...
    For a [domain 👥](<../../40 👥 Domains/$ 👥 Domains/00 👥 Domain.md>) to send an API command to a [Pluggable 🔌 device](<../../60 🧰 Edge/61 🔌 Pluggables/01 🔌 Pluggable device.md>) via a Relayer 🛰️ domain, it needs to send the following parameters.
    ...
    | `Command` | The name of the command in the [Pluggable's API Schema 🧩](<../../30 🧩 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>) set by by the [Brand 🍏 domain](<../../70 🌳 Ambient/71 💠 Brand Things/07 🍏🎭 Brand role.md>).
