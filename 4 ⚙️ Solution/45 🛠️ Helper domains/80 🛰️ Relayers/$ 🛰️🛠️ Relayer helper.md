...
1. **How do domains send commands to Pluggables?**
    ...
    | `Command` | The name of the command in the [Pluggable's API Schema 🧩](<../../25 🧩 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>) set by by the [Brand 🍏 domain](<../../70 🌳 Ambient/71 💠 Brand Things/07 🍏🎭 Brand role.md>).
    | `Parameters`| Any command parameters, as defined by the [Pluggable's API Schema 🧩](<../../25 🧩 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>).
