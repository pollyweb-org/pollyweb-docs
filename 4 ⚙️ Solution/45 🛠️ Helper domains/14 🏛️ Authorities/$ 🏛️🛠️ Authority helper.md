...
1. **What is an Authority domain in NLWeb?**
    ...
    - converting standards to [Schema Codes 🧩](<../../25 Data/10 🧩 Schema Codes/02 🧩 Schema Code.md>) (e.g., electronic passports); and 
...
1. **How do other domains parse the hierarchies?**
    ...
    * Instead, domains should rely on [Graphs 🕸](<../40 🕸 Graphs/$ 🕸🛠️ Graph helper.md>) to index the [Schema Codes 🧩](<../../25 Data/10 🧩 Schema Codes/02 🧩 Schema Code.md>) on their behalf.
