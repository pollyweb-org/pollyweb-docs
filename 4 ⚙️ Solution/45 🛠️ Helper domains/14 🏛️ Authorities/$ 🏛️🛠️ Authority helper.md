...
1. **What is an Authority domain in NLWeb?**
    ...
    - publishing reference [🪣 Datasets](<../../41 🎭 Domain Roles/28 🪣 Datasets/07 🪣🎭 Dataset role.md>) for automated issues (e.g., accessibility codes for international travel).
...
1. **How do other domains parse the hierarchies?**
    ...
    * Instead, domains should rely on [Graphs 🕸](<../40 🕸 Graphs/$ 🕸🛠️ Graph helper.md>) to index the [Schema Codes 🧩](<../../25 Data/24 🗄️ Vaults/02 🧩 Schema Code.md>) on their behalf.
