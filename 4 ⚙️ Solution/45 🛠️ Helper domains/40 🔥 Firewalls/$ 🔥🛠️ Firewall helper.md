...
1. **Do Firewalls monitor domain reputation?**
    ...
    Yes. 
    * [Firewall 🔥 helper domains](<$ 🔥🛠️ Firewall helper.md>) subscribe to [Reviewer ⭐ domain streams](<../../50 🫥 Agents/73 ⭐ Reviewers/$ ⭐🫥 Reviewer vault.md>) to monitor the behavior of [Host 🤗 domains](<../../41 🎭 Domain Roles/30 🤗 Hosts/$ 🤗🎭 Host role.md>), revoking their [Trust 👍](<../../40 👥 Domains/43 👍 Trusts/$ 👍 Domain Trust.md>) when necessary.
...
1. **Do Firewalls report on suspicions before blocking?**
    ...
    No. 
    * NLWeb advocates the usage of [Reviewer ⭐ domains](<../../50 🫥 Agents/73 ⭐ Reviewers/$ ⭐🫥 Reviewer vault.md>) to assess the level of trustworthiness of another [Host 🤗 domain](<../../41 🎭 Domain Roles/30 🤗 Hosts/$ 🤗🎭 Host role.md>).
