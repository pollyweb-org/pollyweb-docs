...
1. **What are examples of Helper domains?**
    ...
    | [🔐 Keymaker](<../../70 🌳 Ambient/75 🔒 Brand Padlocks/05  🔐🏭 Keymaker supplier.md>) | - | Manages [Padlocks 🔒](<../../70 🌳 Ambient/75 🔒 Brand Padlocks/01 🔒 Padlock device.md>) for [Brands 🍏](<../../41 🎭 Domain Roles/20 🍏 Brands/07 🍏🎭 Brand role.md>)
    ...
    | [🖨️ Printer](<../75 🖨️ Printers/$ 🖨️🛠️ Printer helper.md>) | - | Prints [Locators 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/$ 🔆 Locator.md>) for [Brand 🍏](<../../41 🎭 Domain Roles/20 🍏 Brands/07 🍏🎭 Brand role.md>) and [Host 🤗](<../../41 🎭 Domain Roles/30 🤗 Hosts/$ 🤗🎭 Host role.md>)
    | [🛰️ Relayer](<../80 🛰️ Relayers/$ 🛰️🛠️ Relayer helper.md>)
    | [🪄 Wand](<../90 🪄 Wands/$ 🪄🛠️ Wand helper.md>) | - | Manages [Chats 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) for [Things 💠](<../../70 🌳 Ambient/71 💠 Brand Things/01 💠 Thing.md>) for [Brands 🍏](<../../41 🎭 Domain Roles/20 🍏 Brands/07 🍏🎭 Brand role.md>)
...
1. **How can domain-admin users register with a Helper?**
    ...
    |#| Group | Step
    |-|-|-
    |1| `Find` | [Find 🔎](<../../50 🫥 Agents/40 🔎 Finders/02 🔎🫥 Finder vault.md>) a [Helper 🛠️ ](<$ 🛠️👥 Helper domain.md>) with the desired services
...
1. **What does the registration Chat look like?**
    ...
    | 🆔 [Identity](<../../50 🫥 Agents/45 🆔 Identities/01 🆔🫥 Identity agent.md>) | 🫥 [Sign terms?](<../../50 🫥 Agents/45 🆔 Identities/16 🆔🔏 Verify Signatures.md>) 📄 [Yes, No] | > Yes
