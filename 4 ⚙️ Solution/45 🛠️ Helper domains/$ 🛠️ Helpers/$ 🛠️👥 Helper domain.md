...
1. **What does the registration Chat look like?**
    ...
    | 🤵 [Broker](<../24 🤵 Brokers/$ 🤵 Broker domain.md>) | 🫥 [Allow guest domain?](<../../41 🎭 Domain Roles/30 🤗 Hosts/⏩ Host flows/33 🤗⏩🧑‍🦰 Invite 🛠️ flow.md>) [Yes, No]  <br/> - Any Biller 🤝<br/>- [ Always ] for Any Helper 🛠️ | > Always
