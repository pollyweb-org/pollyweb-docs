...
1. **What domain roles do Printers typically implement?**
    ...
    | [💼 Consumer](<../../41 🎭 Domain Roles/27 💼 Consumers/04 💼🎭 Consumer role.md>) | For consuming data sets required to fill out the order.
    | [💵 Seller](<../../30 🫥 Agents/04 💳 Payers/01 💵🎭 Seller role.md>) | For receiving payments for the orders via their [Collector 🏦 helper](<../18 🏦 Collectors/$ 🏦🛠️ Collector helper.md>).
