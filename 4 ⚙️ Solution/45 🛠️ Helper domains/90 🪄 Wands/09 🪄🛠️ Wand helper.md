...
1. **How do Wands work?**
    ...
    |-|-|-
    |A| `Tap/Scan` | Guest users use their [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>) to [tap 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/04 🧑‍🦰🔆 Wallet NFC tap.md>) or [scan ✨](<../../20 🧑‍🦰 UI/11 🔆 Locators/03 🧑‍🦰✨ Wallet QR scan.md>) the [Locator 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/01 🔆 Locator.md>) of a [Thing 💠](<../../70 🌳 Ambient/71 💠 Brand Things/01 💠 Thing.md>) from a given [Brand 🍏 domain](<../../70 🌳 Ambient/71 💠 Brand Things/07 🍏🎭 Brand role.md>).
    |B| `Open`| That opens a [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) with the [Wand 🪄 domain](<09 🪄🛠️ Wand helper.md>), acting on behalf of the [Thing's Brand 🍏 domain](<../../70 🌳 Ambient/71 💠 Brand Things/07 🍏🎭 Brand role.md>).
    |C| `Interact` | Guests can then chat with the [Wand 🪄 domain](<09 🪄🛠️ Wand helper.md>) to search instructions, add private notes, join groups, contact the owner, call emergency, or return the item when found; all notes added by the guest are saved on the [guest's Storage 📦 agent](<../../30 🫥 Agents/80 📦 Storage/$ 📦🫥 Storage agent.md>).
    

    | # | Category | 🧑‍🦰 Steps for owners 
    |-|-|-
    |1| `Tap/Scan` | Owners use their [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>) to [tap 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/04 🧑‍🦰🔆 Wallet NFC tap.md>) or [scan ✨](<../../20 🧑‍🦰 UI/11 🔆 Locators/03 🧑‍🦰✨ Wallet QR scan.md>) the [Locator 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/01 🔆 Locator.md>) of a [Thing 💠](<../../70 🌳 Ambient/71 💠 Brand Things/01 💠 Thing.md>) with a given [Brand 🍏 domain](<../../70 🌳 Ambient/71 💠 Brand Things/07 🍏🎭 Brand role.md>).
    |2| `Open` | That opens a [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) with the [Wand 🪄 domain](<09 🪄🛠️ Wand helper.md>), acting on behalf of the [Brand 🍏](<../../70 🌳 Ambient/71 💠 Brand Things/07 🍏🎭 Brand role.md>). Owners can then do everything that guests can.
...
1. **What domain roles do Wands typically implement?**
    ...
    |-|-
    | [🪢 Integrator](<../../20 🧑‍🦰 UI/12 💬 Chats/06 🪢🎭 Integrator role.md>) | To promote the printing of [Locators 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/01 🔆 Locator.md>) in [Finder 🔎 domains](<../../30 🫥 Agents/40 🔎 Finders/02 🔎🫥 Finder vault.md>).
    | [🤗 Host](<../../20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) | For interacting with [Wallet 🧑‍🦰 apps](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>) in [Chats 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>).
    | [🏭 Supplier](<../../41 🎭 Domain Roles/78 🏭 Suppliers/$ 🏭🎭 Supplier role.md>) | For receiving orders to add [Chats 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) to [Things 💠](<../../70 🌳 Ambient/71 💠 Brand Things/01 💠 Thing.md>).
    | [💼 Consumer](<../../41 🎭 Domain Roles/27 💼 Consumers/$ 💼🎭 Consumer role.md>) | For consuming data sets required to fill out the order.
    | [💵 Seller](<../../41 🎭 Domain Roles/70 💵 Sellers/$ 💵🎭 Seller role.md>) | For receiving payments for the orders via their [Collector 🏦 helper](<../../45 🛠️ Helper domains/18 🏦 Collectors/$ 🏦🛠️ Collector helper.md>).
...
1. **Why are Wands important?**
    ...
    * **For businesses**, [Wand 🪄 domains](<09 🪄🛠️ Wand helper.md>) remove the overhead for [Brand 🍏 domains](<../../70 🌳 Ambient/71 💠 Brand Things/07 🍏🎭 Brand role.md>) in implementing the NLWeb protocol.
    
    * **For users**, [Wand 🪄 domains](<09 🪄🛠️ Wand helper.md>) ensure a seamless experience when interacting with [Things 💠](<../../70 🌳 Ambient/71 💠 Brand Things/01 💠 Thing.md>) from any [Brand 🍏 domains](<../../70 🌳 Ambient/71 💠 Brand Things/07 🍏🎭 Brand role.md>), given that the [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) session of a [Things 💠](<../../70 🌳 Ambient/71 💠 Brand Things/01 💠 Thing.md>) is controlled by the [Wand 🪄 domain](<09 🪄🛠️ Wand helper.md>).
...
1. **Do Wands know which user registered the Locator?**
    ...
    No. 
    * The owner of a [Thing 💠](<../../70 🌳 Ambient/71 💠 Brand Things/01 💠 Thing.md>) is hidden from [Wand 🪄 domains](<09 🪄🛠️ Wand helper.md>) by [Custodian 🧳 vault domains](<../../70 🌳 Ambient/71 💠 Brand Things/05 🧳🗄️ Custodian vault.md>).
...
1. **Can a user contact the Brand?**
    ...
    * [Brand 🍏 domains](<../../70 🌳 Ambient/71 💠 Brand Things/07 🍏🎭 Brand role.md>) may provide their contact details when placing an order to [Wand 🪄 domains](<09 🪄🛠️ Wand helper.md>);
        * in that case, [Wand 🪄 domains](<09 🪄🛠️ Wand helper.md>) can leverage the [Brand 🍏 domain](<../../70 🌳 Ambient/71 💠 Brand Things/07 🍏🎭 Brand role.md>) on behalf of users.
...
1. **What if a Brand ceases to exist?**
    ...
    [Wand 🪄 domains](<09 🪄🛠️ Wand helper.md>) verify if the [Brand 🍏 domains](<../../70 🌳 Ambient/71 💠 Brand Things/07 🍏🎭 Brand role.md>) is still active upon user interaction. 
    * A [Wand 🪄 domain](<09 🪄🛠️ Wand helper.md>) may decide to keep a [Thing 💠](<../../70 🌳 Ambient/71 💠 Brand Things/01 💠 Thing.md>) working even after the [Brand 🍏 domains](<../../70 🌳 Ambient/71 💠 Brand Things/07 🍏🎭 Brand role.md>) is inactive;
...
1. **How can Wands monetize?**
    ...
    - charge a [subscription 🗓️](<../../../2 🏔️ Landscape/1 💼 Business landscape/08 🗓️ Subscriptions landscape>) to users, by leveraging a [Biller 🤝 helper domain](<../../45 🛠️ Helper domains/15 🤝 Billers/$ 🤝🛠️ Biller helper.md>);
