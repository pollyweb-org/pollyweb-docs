...
1. **How do Wands work?**
    ...
    |B| `Open`| That opens a [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) with the [Wand 🪄 domain](<$ 🪄🛠️ Wand helper.md>), acting on behalf of the [Thing's Brand 🍏 domain](<../../70 🌳 Ambient/71 💠 Brand Things/07 🍏🎭 Brand role.md>).
    ...
    |2| `Open` | That opens a [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) with the [Wand 🪄 domain](<$ 🪄🛠️ Wand helper.md>), acting on behalf of the [Brand 🍏](<../../70 🌳 Ambient/71 💠 Brand Things/07 🍏🎭 Brand role.md>). Owners can then do everything that guests can.
...
1. **How can Wands monetize?**
    ...
    - introduce [advertising 👀](<../../../2 🏔️ Landscape/1 💼 Business landscape/04 👀 Advertising landscape>) in the user [Chats 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>), by leveraging an [Advertiser 👀 helper domain](<../12 👀 Advertisers/$ 👀👥 Advertiser helper.md>).
