...
1. **How do Brokers work?**
    ...
    |4| `Bye`    | The [user's Broker 🤵 domain](<$ 🤵 Broker domain.md>) forwards the [Messages 📨](<../../40 👥 Domains/41 📨 Messages/01 📨 Domain Message.md>) to the [user's Notifier 📣 domain](<../../20 🧑‍🦰 UI/02 📣 Notifiers/$ 📣 Notifier domain.md>), to be pushed to the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>).
...
1. **What API methods does a Broker expose?**
    ...
    | |[🔎🐌 Introduced](<../../../6 🅰️ APIs/15 🤵🅰️ Broker/30 🤵🅰️ Chats 💬/04 🔎🐌🤵 Introduced.md>) | A [Finder 🔎 domain](<../../50 🫥 Agents/40 🔎 Finders/02 🔎🫥 Finder vault.md>) finished the intro
    ...
    |[`🔗 Binds`](<../../25 Data/20 🔗 Binds/$ 🔗 Bind.md>)| [🧑‍🦰🚀 Binds](<../../../6 🅰️ APIs/15 🤵🅰️ Broker/40 🤵🅰️ Binds 🔗/10 🧑‍🦰🚀🤵 Binds.md>) | List the [Binds 🔗](<../../25 Data/20 🔗 Binds/$ 🔗 Bind.md>) of a [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>)
    ...
    | [`🎫 Tokens`](<../../25 Data/30 🎫 Tokens/$ 🎫 Token.md>) | [🧑‍🦰🚀 Tokens](<../../../6 🅰️ APIs/15 🤵🅰️ Broker/50 🤵🅰️ Tokens 🎫/54 🧑‍🦰🚀🤵 Tokens.md>) | List of [Tokens 🎫](<../../25 Data/30 🎫 Tokens/$ 🎫 Token.md>) of a [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>)
    ...
    || [🧑‍🦰🐌 Saved](<../../../6 🅰️ APIs/15 🤵🅰️ Broker/50 🤵🅰️ Tokens 🎫/53 🧑‍🦰🐌🤵 Saved.md>) | A [Wallet 🧑‍🦰](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>) saved a [Token 🎫](<../../25 Data/30 🎫 Tokens/$ 🎫 Token.md>) locally
