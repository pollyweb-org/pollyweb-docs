...
1. **What domains roles does a Hoster implement?**
    ...
    |Role|Description
    |-|-
    | [🗃️ Resourcer](<../../41 🎭 Domain Roles/60 🗃️ Resourcers/02 🗃️🎭 Resourcer role.md>) | To sync setup files with a [Syncer 🔃 tool](<../../../9 😃 Talkers/90 ☁️ Hosters/01 🔃🛠️ Syncer tool.md>)
...
1. **How to bootstrap?**
    ...
    | 🤵 [Broker](<../24 🤵 Brokers/$ 🤵 Broker domain.md>) | 🫥 Save token? [Yes, No] <br/> - [Host Admin 🧩](<../../../7 🧩 Codes/HOST/🧩 HostAdmin.md>)  | > Yes
