...
1. **How to bind to a new simple Vault domain?**
    ...
    | [🤵 Broker](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) | 🫥 Bind [Yes, No, +]<br/>- [ Any Schema Code 🧩](<../10 🧩 Schema Codes/🧩 Schema Code.md>) | > Yes 
    | 🗄️ Vault | ✅ Done! 
    |
...
1. **How to bind to an existing Vault domain with a Wallet app?**
    ...
    | [🤵 Broker](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) | 🫥 Bind [Yes, No, +]<br/>- [ Schema Code 🧩](<../10 🧩 Schema Codes/🧩 Schema Code.md>) #1  <br/> - [Schema Code 🧩](<../10 🧩 Schema Codes/🧩 Schema Code.md>) #2 | > Yes | 
    | 🗄️ Vault | ✅ Done! [+]
...
1. **How to bind to an existing Vault domain with a web browser?**
    ...
    | [🤵 Broker](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) | 🫥 Bind [Yes, No, +]<br/>- [ Schema Code 🧩](<../10 🧩 Schema Codes/🧩 Schema Code.md>) #1  <br/> - [Schema Code 🧩](<../10 🧩 Schema Codes/🧩 Schema Code.md>) #2 | > Yes | The [Broker 🤵](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) protected the user.
    | 🗄️ Vault | ✅ Done! [+]
...
| Workflow | Notes 
|-|-
| [ 🤵⏩🗄️ Bind Vault @ Broker ](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵⏩ Broker flows/05 🤵⏩🗄️ Bind vault.md>) ||
||
