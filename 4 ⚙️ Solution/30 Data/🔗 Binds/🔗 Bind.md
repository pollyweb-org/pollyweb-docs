...
1. **How can users bind to Vaults?**
    ...
    |#|Step|Interface|Step
    |-|-|-|-
    | 1| `Hello`| [Wallet 🧑‍🦰](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) | Open a [💬 Chat](<../../35 Chats/💬 Chats/💬 Chat.md>) with the [Vault 🗄️](<../../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>) and select `Bind`
    | 1| `Hello`| Browser | Login to the website of the [Vault 🗄️ ](<../../41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>) and click `Bind`
    | 2|  `Bind`|[Wallet 🧑‍🦰](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) | On the [💬 Chat](<../../35 Chats/💬 Chats/💬 Chat.md>), follow the steps detailed below
...
1. **How to bind to a new simple Vault domain?**
    ...
    | [🤵 Broker](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) | ⓘ Flow: Bla, bla, bla [+] 
    | [🤵 Broker](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) | 🫥 Bind [Yes, No, +]<br/>- [ Any Schema Code 🧩](<../🧩 Schema Codes/🧩 Schema Code.md>) | > Yes 
    | 🗄️ Vault | ✅ Done! 
    |
...
1. **How to bind to an existing Vault domain with a Wallet app?**
    ...
    4. selects one or more [Schema Codes 🧩](<../🧩 Schema Codes/🧩 Schema Code.md>) to [bind 🔗](<🔗 Bind.md>) to, from the list of available [Binds 🔗](<🔗 Bind.md>) provided to the user by the [domain 👥](<../../40 👥 Domains/👥 Domains/👥 Domain.md>).
    ...
    | [🤵 Broker](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) | ⓘ Flow: Bind on app [+] || The [Host 🤗 role](<../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) changed the context.
    ...
    | [🤵 Broker](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) | 🫥 Bind [Yes, No, +]<br/>- [ Schema Code 🧩](<../🧩 Schema Codes/🧩 Schema Code.md>) #1  <br/> - [Schema Code 🧩](<../🧩 Schema Codes/🧩 Schema Code.md>) #2 | > Yes | 
    | 🗄️ Vault | ✅ Done! [+]
...
1. **How to bind to an existing Vault domain with a web browser?**
    ...
    5. the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) opens with a new [💬 Chat](<../../35 Chats/💬 Chats/💬 Chat.md>) with the [domain 👥](<../../40 👥 Domains/👥 Domains/👥 Domain.md>).
    ...
    | 🔎 [Finder](<../../50 🫥 Agent domains/40 🔎 Finders/🔎🫥 Finder agent.md>) | ⓘ Any Vault (4.3 ⭐)  [+] || The [Broker 🤵](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) informed the user.
    ...
    | [🤵 Broker](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) | ⓘ Flow: Web bind [+] || The [Host 🤗 role](<../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) changed the context.
    | 🗄️ Vault | 😃 What to bind? [All] <br/> - [ Data Set #1 ] <br/> - [ Data Set #2 ] | > All
    | [🤵 Broker](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) | 🫥 Bind [Yes, No, +]<br/>- [ Schema Code 🧩](<../🧩 Schema Codes/🧩 Schema Code.md>) #1  <br/> - [Schema Code 🧩](<../🧩 Schema Codes/🧩 Schema Code.md>) #2 | > Yes | The [Broker 🤵](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) protected the user.
    | 🗄️ Vault | ✅ Done! [+]
...
| Workflow | Notes 
|-|-
| [ 🤵⏩🗄️ Bind Vault @ Broker ](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵⏩ Broker flows/🤵⏩🗄️ Bind vault.md>) ||
||
