...
1. **What is a Token?**
    ...
    [Tokens 🎫](<🎫 Token.md>) are NFC/QR [Locators 🔆](<../../25 Locators/15 🔆 Locators/🔆 Locator.md>) 
...
1. **How do Tokens work?**
    ...
    |2| `In-Chat`| While in a [Chat 💬](<../../35 Chats/12 💬 Chats/💬 Chat.md>) with a [Consumer 💼 host domain](<../../41 🎭 Domain Roles/27 💼 Consumers/💼🎭 Consumer role.md>), the user shares the [Token 🎫](<🎫 Token.md>).
    ...
    |7| `Identity` | If the [Token 🎫](<🎫 Token.md>) contains the [Locator 🔆](<../../25 Locators/15 🔆 Locators/🔆 Locator.md>) of an [Identity 🆔 domain](<../../50 🫥 Agent domains/45 🆔 Identities/$ 🆔🫥 Identity agent.md>), then it means that the [Token 🎫](<🎫 Token.md>) was issued to a specific person only.
...
1. **Can Tokens be used for documents with photo validation?**
    ...
    The following [Chat 💬](<../../35 Chats/12 💬 Chats/💬 Chat.md>) excerpt from the [Casino Entry 🤝 use case](<../../../3 🤝 Use Cases/02 🍲 Eat & Drink/10 🎰 Casinos/11 🚪 Enter anonymously.md>) illustrates the usage of an [Identity-bound 🆔 token](<../../50 🫥 Agent domains/45 🆔 Identities/14 🆔🎫 Verify Tokens.md>).
...
1. **Can Tokens be read in Chats without the use consent?**
    ...
    - Before sharing [SELF Tokens 🎫](<🎫 Token.md>) with other domains, [Broker 🤵 domains](<../../45 🤲 Helper domains/24 🤵 Brokers/🤵🤲 Broker helper.md>) ask the user for approval.
  
    - Exceptionally, if the [Schema Code 🧩](<../10 🧩 Schema Codes/🧩 Schema Code.md>) of the [Token 🎫](<🎫 Token.md>) is marked as SELF, then the user's [Broker 🤵 domain](<../../45 🤲 Helper domains/24 🤵 Brokers/🤵🤲 Broker helper.md>) silently share the [Token 🎫](<🎫 Token.md>) with the [Token's Issuer 🎴 domain](<../../41 🎭 Domain Roles/40 🎴 Issuers/🎴🎭 Issuer role.md>).


    The following [Chat 💬](<../../35 Chats/12 💬 Chats/💬 Chat.md>) excerpt illustrates the usage of a [SELF Token 🎫](<🎫 Token.md>) when [passing a gate at a train station 🤝](<../../../3 🤝 Use Cases/03 🧳 Travel/03 🧳 Travel by train 🚂/02 🚂 Customer @ Station/22 Pass gates 1 person.md>).
...
1. **Can users save multiple Tokens in a single NFC card?**
    ...
    Yes. 
    - Users can reference multiple [Tokens 🎫](<🎫 Token.md>) with a single NFC via [Userable 💍 things](<../../70 🌳 Ambient/74 💍 Userables/$ 💍 Userable thing.md>).
...
1. **What data is contained in a Token?**
    ...
    [Tokens 🎫](<🎫 Token.md>) derive from [Locators 🔆](<../../25 Locators/15 🔆 Locators/🔆 Locator.md>), so they contain the following properties.
