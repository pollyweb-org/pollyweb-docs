...
1. **What is the signature for?**
    ...
    - [domains 👥](<../../../40 👥 Domains/👥 Domains/👥 Domain.md>) verify incoming [domain 👥](<../../../40 👥 Domains/👥 Domains/👥 Domain.md>) messages with the sender's [DKIM 📺](<../../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) public key,
...
1. **How to create a signature with OpenSSL?**
    ...
    To create a signature with OpenSSL, first prepare the following files:
      - `canonical.json`: a canonical representation of {header,body};
      - `private.pem`: the private signature of the [domain 👥](<../../../40 👥 Domains/👥 Domains/👥 Domain.md>).
...
1. **How to validate a signature with OpenSSL?**
    ...
    - `signature.txt`: the signature received in a message from another [domain 👥](<../../../40 👥 Domains/👥 Domains/👥 Domain.md>);
    - `canonical.json`: a canonical representation of the received {header,body};
    - `public.pem`: the public key of the sender [domain 👥](<../../../40 👥 Domains/👥 Domains/👥 Domain.md>).
