...
1. **What does a domain message look like?**
    ...
    Messages from [domains 👥](<../../../40 👥 Domains/👥 Domains/👥 Domain.md>) are sent in JSON envelopes similar to email messages. 
...
1. **What is contained in a domain message envelope?**
    ...
    | `From` | The name of the [domain 👥](<../../../40 👥 Domains/👥 Domains/👥 Domain.md>) who sent the message.
    | `To`| The name of the [domain 👥](<../../../40 👥 Domains/👥 Domains/👥 Domain.md>) for whom the message is intended.
...
1. **How do receiver domains differentiate methods?**
    ...
    - The possible `Subject` values are defined by the APIs implemented by [domain Roles 🎭](<../../../40 👥 Domains/👥 Domains/👥 Domain.md>).
...
1. **Why are Messages in JSON while Manifests are in YAML?** 
    ...
    | Format | Rational
    |-|-
    | `JSON` | Structured JSON for machine-to-machine payloads, because it's faster and widely supported by cloud providers; e.g.: <br/>• [domain Messages 📨](<../📨 Message.md>) between any two [domains 👥](<../../../40 👥 Domains/👥 Domains/👥 Domain.md>), <br/>• data sharing between a [Vault 🗄️](<../../../41 🎭 Domain Roles/Vaults 🗄️/🗄️🎭 Vault role.md>) and a [Consumer 💼](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) domains, <br/>• payments between a [Payer 💳](<../../../41 🎭 Domain Roles/Payers/💳🎭 Payer role.md>) and a [Collector 🏦](<../../../45 🤲 Helper domains/Collectors 🏦/🏦🤲 Collector helper.md>) domains.
    | `YAML` | Structured YAML for human-to-machine settings, because it supports comments and it's easier for humans to read, while still supporting schema validations; <br/>• e.g.: [Schema Codes 🧩](<../../../30 🧩 Data/1 🧩 Schema Codes/🧩 Schema Code.md>) and [domain Manifests 📜](<../../../40 👥 Domains/👥📜 Domain Manifests/📜 Manifest.md>).
