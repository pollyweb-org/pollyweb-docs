...
1. **Why are Messages in JSON while Manifests are in YAML?** 
    ...
    | `YAML` | Structured YAML for human-to-machine settings, because it supports comments and it's easier for humans to read, while still supporting schema validations; <br/>• e.g.: [Schema Codes 🧩](<../../Schema Codes 🧩/🧩 Schema Code.md>) and [domain Manifests 📜](<../../../40 👥 Domains/👥📜 Domain Manifests/📜 Manifest.md>).
