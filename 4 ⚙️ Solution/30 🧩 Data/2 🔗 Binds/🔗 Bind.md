...
1. **How can users bind to Vaults?**
    ...
    |#|Step|Interface|Step
    |-|-|-|-
    | 1| `Hello`| [Wallet 🧑‍🦰](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) | Open a [💬 Chat](<../../35 💬 Chats/💬 Chats/💬 Chat.md>) with the [Vault 🗄️](<../../41 🎭 Domain Roles/Vaults 🗄️/🗄️🎭 Vault role.md>) and select `Bind`
    | 1| `Hello`| Browser | Login to the website of the [Vault 🗄️ ](<../../41 🎭 Domain Roles/Vaults 🗄️/🗄️🎭 Vault role.md>) and click `Bind`
    | 2|  `Bind`|[Wallet 🧑‍🦰](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) | On the [💬 Chat](<../../35 💬 Chats/💬 Chats/💬 Chat.md>), follow the steps detailed below
...
1. **How to bind to a new simple Vault domain?**
    ...
    Using their [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>):
...
1. **How to bind to an existing Vault domain with a web browser?**
    ...
    5. the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) opens with a new [💬 Chat](<../../35 💬 Chats/💬 Chats/💬 Chat.md>) with the [domain 👥](<../../40 👥 Domains/👥 Domains/👥 Domain.md>).
