...
1. **Can Tokens be read in Chats without the use consent?**
    ...
    - Before sharing [SELF Tokens 🎫](<🎫 Token.md>) with other domains, [Broker 🤵 domains](<../../45 🤲 Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) ask the user for approval.
  
    - Exceptionally, if the [Schema Code 🧩](<../10 🧩 Schema Codes/🧩 Schema Code.md>) of the [Token 🎫](<🎫 Token.md>) is marked as SELF, then the user's [Broker 🤵 domain](<../../45 🤲 Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) silently share the [Token 🎫](<🎫 Token.md>) with the [Token's Issuer 🎴 domain](<../../41 🎭 Domain Roles/40 🎴 Issuers/🎴🎭 Issuer role.md>).
    ...
    | 🤵 [Broker](<../../45 🤲 Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) | ⓘ Ticket [token 🎟️](<🎫 Token.md>) shared [+]
    | 🚂 Railway | ℹ️ Ticket presented: <br>- from MAD T4 to MAD T2 
    | 🚂 Railway | ✅ Entry gate opened!
    | 🤵 [Broker](<../../45 🤲 Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) | ⓘ Ticket voided [+]
