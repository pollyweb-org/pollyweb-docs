...
1. **How do Tokens work?**
    ...
    |3| `Userable` | Using their [Custodian 🧳 agent](<../../50 🫥 Agents/35 🧳 Custodians/$ 🧳🫥 Custodian agent.md>), users select which [Tokens 🎫](<$ 🎫 Token.md>) to be automatically shared by a specific [Userable 💍 thing](<../../70 🌳 Ambient/74 💍 Userables/01 💍 Userable thing.md>).
    | 4| `Userable`| When the NFC of the [Userable 💍 thing](<../../70 🌳 Ambient/74 💍 Userables/01 💍 Userable thing.md>) is [tapped 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/04 🧑‍🦰🔆 Wallet NFC tap.md>) on the [scanner ✨ device](<../../60 🧰 Edge/66 ✨ Scanners/06 ✨🔌 Scanner device.md>) of a [Consumer 💼 domain](<../../41 🎭 Domain Roles/27 💼 Consumers/$ 💼🎭 Consumer role.md>), the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>) shares the [Tokens 🎫](<$ 🎫 Token.md>).
    ...
    |7| `Identity` | If the [Token 🎫](<$ 🎫 Token.md>) contains the [Locator 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/$ 🔆 Locator.md>) of an [Identity 🆔 domain](<../../50 🫥 Agents/45 🆔 Identities/$ 🆔🫥 Identity agent.md>), then it means that the [Token 🎫](<$ 🎫 Token.md>) was issued to a specific person only.
...
1. **Can users print Tokens in paper?**
    ...
    | **[💍 Userable](<../../70 🌳 Ambient/74 💍 Userables/01 💍 Userable thing.md>)** | Add it to a [Userable 💍 thing](<../../70 🌳 Ambient/74 💍 Userables/01 💍 Userable thing.md>) via the user's [Custodian 🧳 vault](<../../50 🫥 Agents/35 🧳 Custodians/$ 🧳🫥 Custodian agent.md>).
...
1. **Can users save multiple Tokens in a single NFC card?**
    ...
    Yes. 
    - Users can reference multiple [Tokens 🎫](<$ 🎫 Token.md>) with a single NFC via [Userable 💍 things](<../../70 🌳 Ambient/74 💍 Userables/01 💍 Userable thing.md>).
...
1. **What data is contained in a Token?**
    ...
    | `Signature`| string | The Issuer's [signature](<../../40 👥 Domains/41 📨 Messages/$ 📨 Domain Message.md>) 📨 
