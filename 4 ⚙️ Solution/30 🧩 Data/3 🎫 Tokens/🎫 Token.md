...
1. **How do Tokens work?**
    ...
    |#|Category|Step
    |-|-|-
    |1| `Issue`| An [Issuer 🎴 domain](<../../41 🎭 Domain Roles/Issuers 🎴/🎴🎭 Issuer role.md>) issues a [Token 🎫](<🎫 Token.md>) the the user stores offline in the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>).
    ...
    |3| `Userable` | Using their [Custodian 🧳 agent](<../../50 🫥 Agent domains/Custodians 🧳/🧳🫥 Custodian agent.md>), users select which [Tokens 🎫](<🎫 Token.md>) to be automatically shared by a specific [Userable 💍 thing](<../../25 🔆 Locators/4 💍 Userables/💍💠 Userable thing.md>).
    ...
    |7| `Identity` | If the [Token 🎫](<🎫 Token.md>) contains the [Locator 🔆](<../../25 🔆 Locators/1 🔆 Locators/🔆 Locator.md>) of an [Identity 🆔 domain](<../../50 🫥 Agent domains/Identities 🆔/$ 🆔🫥 Identity agent.md>), then it means that the [Token 🎫](<🎫 Token.md>) was issued to a specific person only.
...
1. **Can Tokens be downloaded into the Wallet?**
    ...
    Yes.
    * Thus the term [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) when referring to NLWeb browsers. 
...
1. **Can Tokens be used for documents with photo validation?**
    ...
    - [Identity-bound 🆔 tokens](<../../50 🫥 Agent domains/Identities 🆔/14 🆔🎫 Verify Tokens.md>) reference a trusted [Identity 🆔 domain](<../../50 🫥 Agent domains/Identities 🆔/$ 🆔🫥 Identity agent.md>) that is able to authenticate the user - e.g., with a [Face scan 😶](<../../50 🫥 Agent domains/Identities 🆔/21 🆔😶 Face scan.md>).


    The following [Chat 💬](<../../35 💬 Chats/💬 Chats/💬 Chat.md>) excerpt from the [Casino Entry 🤝 use case](<../../../3 🤝 Use Cases/02 🍲 Eat & Drink/10 🎰 Casinos/11 🚪 Enter anonymously.md>) illustrates the usage of an [Identity-bound 🆔 token](<../../50 🫥 Agent domains/Identities 🆔/14 🆔🎫 Verify Tokens.md>).
...
1. **Can Tokens be read in Chats without the use consent?**
    ...
    - Before sharing [SELF Tokens 🎫](<🎫 Token.md>) with other domains, [Broker 🤵 domains](<../../20 🧑‍🦰 UI/3 🤵 Brokers/🤵🤲 Broker helper.md>) ask the user for approval.
  
    - Exceptionally, if the [Schema Code 🧩](<../1 🧩 Schema Codes/🧩 Schema Code.md>) of the [Token 🎫](<🎫 Token.md>) is marked as SELF, then the user's [Broker 🤵 domain](<../../20 🧑‍🦰 UI/3 🤵 Brokers/🤵🤲 Broker helper.md>) silently share the [Token 🎫](<🎫 Token.md>) with the [Token's Issuer 🎴 domain](<../../41 🎭 Domain Roles/Issuers 🎴/🎴🎭 Issuer role.md>).
...
1. **Why do SELF Tokens exist?**
    ...
    [SELF Tokens 🎫](<🎫 Token.md>) are typically issued as a pass to be presented back to the [Token's Issuer 🎴 domain](<../../41 🎭 Domain Roles/Issuers 🎴/🎴🎭 Issuer role.md>) in a later moment in time, aiming for the least possible friction in the future - e.g.:
...
1. **Can users share Tokens in Wallets without internet?**
    ...
    Not via [Wallet 🧑‍🦰 apps](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>), no, because Wallets need Internet connectivity to share the [Token 🎫](<🎫 Token.md>) with other domains. 
...
1. **Can users print Tokens in paper?**
    ...
    Yes. 
    - Offline [Tokens 🎫](<🎫 Token.md>) allow users to remove the dependency on the device's battery, or technical issues with the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) resulting from low or no internet connectivity;
    ...
    | **[💍 Userable](<../../25 🔆 Locators/4 💍 Userables/💍💠 Userable thing.md>)** | Add it to a [Userable 💍 thing](<../../25 🔆 Locators/4 💍 Userables/💍💠 Userable thing.md>) via the user's [Custodian 🧳 vault](<../../50 🫥 Agent domains/Custodians 🧳/🧳🫥 Custodian agent.md>).
    | **[⌚ Tapband ](<../../25 🔆 Locators/5 ⌚ Tapbands/⌚💠 Tapband thing.md>)** | Add it to a [Tapband ⌚ thing](<../../25 🔆 Locators/5 ⌚ Tapbands/⌚💠 Tapband thing.md>) via the user's [Custodian 🧳 vault](<../../50 🫥 Agent domains/Custodians 🧳/🧳🫥 Custodian agent.md>).
...
1. **What data is contained in a Token?**
    ...
    |Property| Type | Details
    |-|-|-
    |`Schema` | string | The Token's [Schema Code 🧩](<../1 🧩 Schema Codes/🧩 Schema Code.md>)
    | `Issued` | timestamp | When it was issued
    |`Starts` |timestamp| Valid from
    |`Expires`|timestamp| Valid until (optional)
    | `Signature`| string | The Issuer's [signature](<../../40 👥 Domains/👥📨 Domain Messages/📨 Message.md>) 📨 
