...
1. **How do Tokens work?**
    ...
    |#|Category|Step
    |-|-|-
    |1| `Issue`| An [Issuer 🎴 domain](<../../41 🎭 Domain Roles/Issuers 🎴/🎴🎭 Issuer role.md>) issues a [Token 🎫](<🎫 Token.md>) the the user stores offline in the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>).
...
1. **Can Tokens be downloaded into the Wallet?**
    ...
    Yes.
    * Thus the term [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) when referring to NLWeb browsers. 
...
1. **Can users share Tokens in Wallets without internet?**
    ...
    Not via [Wallet 🧑‍🦰 apps](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>), no, because Wallets need Internet connectivity to share the [Token 🎫](<🎫 Token.md>) with other domains. 
...
1. **Can users print Tokens in paper?**
    ...
    Yes. 
    - Offline [Tokens 🎫](<🎫 Token.md>) allow users to remove the dependency on the device's battery, or technical issues with the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) resulting from low or no internet connectivity;
    ...
    | Option | Description
    |-|-
    | **🖨️ Paper**| Ask the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) to print it on paper.
