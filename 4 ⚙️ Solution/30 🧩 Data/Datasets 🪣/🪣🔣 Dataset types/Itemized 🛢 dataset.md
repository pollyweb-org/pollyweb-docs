...
1. **What are use cases of itemized dataset?**
    ...
    | Example | Feature
    |---------|--------
    | 🪣 [`Notifiers`](<../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🪣 Broker tables/Notifiers 📣 table/🤵 BrokerNotifiers 🪣 table.md>)  at [Broker 🤵](<../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🤲 Broker helper.md>) | With a named key
    | 🪣 [`Binds`](<../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🪣 Broker tables/Binds 🔗 table/🤵 BrokerBinds 🪣 table.md>) at [Broker 🤵](<../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🤲 Broker helper.md>) | With parents
    | 🪣 [`Notifiers`](<../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🪣 Broker tables/Notifiers 📣 table/🤵 BrokerNotifiers 🪣 table.md>) at  at [Broker 🤵](<../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🤲 Broker helper.md>) | With children
    | 🪣 [`Wallets`](<../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🪣 Broker tables/Wallets 🧑‍🦰 table/🤵 Wallets 🪣 table.md>) at  at [Broker 🤵](<../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🤲 Broker helper.md>) | With grand children
...
1. **How to block updates?**
    ...
    |-|-|-
    | 💾 [`SAVE`](<../../../35 💬 Chats/Scripts 📃/📃 for datasets 🪣/SAVE 💾/💾 SAVE ⌘ cmd.md>) | Same value | Allows multiple  idempotent saves
    | |Different | Blocked, raises an error
    | 🗑️ [`DELETE`](<../../../35 💬 Chats/Scripts 📃/📃 for datasets 🪣/DELETE 🗑️/🗑️ DELETE ⌘ cmd.md>) | - | Allows multiple idempotent times
...
1. **What are the possible triggers?**
    ...
    |Value|Description|
    |-|-|
    | `ADDED`   | Item inserted on the [Itemized 🛢 dataset](<../../../30 🧩 Data/Datasets 🪣/🪣🔣 Dataset types/Itemized 🛢 dataset.md>) on a [`SAVE`](<../../../35 💬 Chats/Scripts 📃/📃 for datasets 🪣/SAVE 💾/💾 SAVE ⌘ cmd.md>)
    | `CHANGED` | The content of the item has changed on a [`SAVE`](<../../../35 💬 Chats/Scripts 📃/📃 for datasets 🪣/SAVE 💾/💾 SAVE ⌘ cmd.md>)
    | `EXPIRED` | Item removed automatically due to a [`SAVE`](<../../../35 💬 Chats/Scripts 📃/📃 for datasets 🪣/SAVE 💾/💾 SAVE ⌘ cmd.md>) expiration
    | `DELETED` | Item deleted on a [`DELETE`](<../../../35 💬 Chats/Scripts 📃/📃 for datasets 🪣/DELETE 🗑️/🗑️ DELETE ⌘ cmd.md>), either soft or hard
    | `PURGED`  | Item removed automatically due to an [`UNDO`](<../../../35 💬 Chats/Scripts 📃/📃 for datasets 🪣/UNDO ↩️/↩️ UNDO ⌘ cmd.md>) timeout
    |
