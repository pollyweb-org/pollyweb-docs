...
1. **What are use cases of itemized dataset?**
    ...
    | 🪣 [`Wallets`](<../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🪣 Broker tables/Wallets 🧑‍🦰 table/🤵 BrokerWallets 🪣 table.md>) at  at [Broker 🤵](<../../../20 🧑‍🦰 UI/Brokers 🤵/🤵 Broker helper/🤵 Broker 🤲 helper.md>) | With grand children
...
1. **What properties are available?**
    ...
    | [`Views`](<../🪣🛢 Itemized datasets/e 🛢 Views.md>) | map | Filtered children | `Vs:Cs:[p=3]`
    | [`Distincts`](<../🪣🛢 Itemized datasets/e 🛢 Views.md>) | map | Unique values in child properties | `Ds:Cs.d`
