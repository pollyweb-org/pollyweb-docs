# [🧩](<../../../30 🧩 Data/Schema Codes 🧩/🧩 Schema Code.md>) [`.MANIFEST`](<🧩 MANIFEST.md>) `/CODE`

> Part of [`.MANIFEST` 🧩](<🧩 MANIFEST.md>)

> Implements [Schema Code🧩](<../../../30 🧩 Data/Schema Codes 🧩/🧩 Schema Code.md>)
...
| Property | Type | Notes|
|-|-|-
| `Path`| string | Relative path of the [Code 🧩](<../../../30 🧩 Data/Schema Codes 🧩/🧩 Schema Code.md>)  or group
...
| `Name` | string | Human name of the [Schema Code 🧩](<../../../30 🧩 Data/Schema Codes 🧩/🧩 Schema Code.md>) 
| `Description`| string | Human  description of the [Schema Code 🧩](<../../../30 🧩 Data/Schema Codes 🧩/🧩 Schema Code.md>)  
