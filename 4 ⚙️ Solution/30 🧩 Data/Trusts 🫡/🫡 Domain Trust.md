...
1. **How to calculate indirect trust paths when nodes are down?**
    ...
    Domains can rely on [Graph 🕸 domains](<../../45 🤲 Helper domains/Graphs 🕸/🕸 Graph helper/🕸🤲 Graph helper.md>):
...
1. **How can domains know when indirect trust changes affect them?**
    ...
    [Domains 👥](<../../40 👥 Domains/👥 Domain/👥 Domain.md>) can rely on [Graph 🕸 domains](<../../45 🤲 Helper domains/Graphs 🕸/🕸 Graph helper/🕸🤲 Graph helper.md>):
