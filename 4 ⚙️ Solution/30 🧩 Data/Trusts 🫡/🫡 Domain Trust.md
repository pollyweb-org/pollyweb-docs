...
1. **How can domains know when another domain lost trust in them?**
    ...
    [Domains 👥](<../../40 👥 Domains/👥 Domain/👥 Domain.md>) can rely on [Graph 🕸 domain helpers](<../../45 🤲 Helper domains/Graphs 🕸/🕸🤲 Graph helper.md>):
...
1. **How can domains know when indirect trust changes affect them?**
    ...
    [Domains 👥](<../../40 👥 Domains/👥 Domain/👥 Domain.md>) can rely on [Graph 🕸 domains](<../../45 🤲 Helper domains/Graphs 🕸/🕸🤲 Graph helper.md>):
