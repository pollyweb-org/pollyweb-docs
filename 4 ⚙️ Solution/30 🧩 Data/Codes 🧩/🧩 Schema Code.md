...
1. **How are Schema Codes used in data sharing between domains?**
    ...
    * it invokes the [`Query@Broker`](<../../20 🧑‍🦰 UI/Brokers 🤵/🤵🅰️ Broker methods/...for Share 💼/Query/💼🐌🤵 Query.md>) from the [user's Broker 🤵 domain](<../../20 🧑‍🦰 UI/Brokers 🤵/🤵🤲 Broker helper.md>), asking for datasets that comply with a given [Schema 🧩](<🧩 Schema Code.md>).
