...
1. **How can domains read Schemas in domain Manifests?**
    ...
    * Instead, [domains 👥](<../../40 👥 Domains/$ 👥 Domains/$ 👥 Domain.md>) need to query [Graph 🕸 domains](<../../45 🛠️ Helper domains/50 🕸 Graphs/$ 🕸🛠️ Graph helper.md>) for a schema definition, by passing the [Schema Code 🧩](<$ 🧩 Schema Code.md>) to the [`Schema@Graph`](<../../../6 🅰️ APIs/45 🕸🅰️ Graph/08 👥🚀🕸 Schema.md>).
