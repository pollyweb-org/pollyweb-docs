...
> Relates to [👥🔏 Domain Signature](<../../40 👥 Domains/👥⏩ Domain flows/Sign Files 👥🔏📄/👥 Sign Files ⏩ flow.md>)

> Relates to [Prompts 🤔 with an Appendix 📎](<../../35 💬 Chats/Prompts 🤔/🤔⚙️ Prompt features/5 📎 with Appendix.md>)

> Relates to [`{/path/file}` Function 🐍](<../../35 💬 Chats/Scripts 📃/📃 basics/Function 🐍.md>)
...
1. **How to use files?**
    ...
    | `Sign` | Domain | [👥🔏 Domain Signature](<../../40 👥 Domains/👥⏩ Domain flows/Sign Files 👥🔏📄/👥 Sign Files ⏩ flow.md>)
    |