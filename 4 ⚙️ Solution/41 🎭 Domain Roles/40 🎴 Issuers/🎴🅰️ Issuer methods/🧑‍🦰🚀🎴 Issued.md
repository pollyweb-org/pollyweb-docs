...
> Allows for a [Token 🎫](<../../../30 Data/30 🎫 Tokens/🎫 Token.md>) to be downloaded from the [Issuer 🎴 domain](<../🎴🎭 Issuer role.md>) into the [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>).
...
| Body | `ChatID` | string | [Chat 💬](<../../../35 Chats/💬 Chats/💬 Chat.md>) ID from [`Offer@Broker`](<../../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🅰️ Broker methods/50 🤵🅰️ Tokens 🎫/🎴🐌🤵 Offer.md>)
| | `TokenID`| string | [Token 🎫](<../../../30 Data/30 🎫 Tokens/🎫 Token.md>) ID from [`Offer@Broker`](<../../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🅰️ Broker methods/50 🤵🅰️ Tokens 🎫/🎴🐌🤵 Offer.md>)
|
