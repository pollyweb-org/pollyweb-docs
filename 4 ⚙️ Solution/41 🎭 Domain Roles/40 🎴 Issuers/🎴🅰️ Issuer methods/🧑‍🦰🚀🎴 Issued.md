...
> Allows for a [Token 🎫](<../../../30 Data/🎫 Tokens/🎫 Token.md>) to be downloaded from the [Issuer 🎴 domain](<../🎴🎭 Issuer role.md>) into the [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>).
...
| | `TokenID`| string | [Token 🎫](<../../../30 Data/🎫 Tokens/🎫 Token.md>) ID from [`Offer@Broker`](<../../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🅰️ Broker methods/5 🤵🅰️ Tokens 🎫/🎴🐌🤵 Offer.md>)
|
