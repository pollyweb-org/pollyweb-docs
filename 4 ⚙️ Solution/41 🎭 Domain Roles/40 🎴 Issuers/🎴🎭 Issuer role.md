...
1. **Can an Issuer domain suspend or revoke a Token?**
    ...
    * [Broker 🤵 domains](<../../45 🤲 Helper domains/24 🤵 Brokers/🤵🤲 Broker helper.md>) only share active [Tokens 🎫](<../../30 Data/30 🎫 Tokens/🎫 Token.md>) when [Consumer 💼 domains](<../../50 🫥 Agent domains/80 💾 Storage/💾🫥 Storage agent.md>) ask for them in a [Chat 💬](<../../35 Chats/💬 Chats/💬 Chat.md>).
