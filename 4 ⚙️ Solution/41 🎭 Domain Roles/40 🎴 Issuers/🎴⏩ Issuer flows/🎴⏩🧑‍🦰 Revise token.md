...
| 🤵 [Broker](<../../../45 🤲 Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) | ⓘ Ticket shared 
...
2| [🤵⏩🧑‍🦰 Update Tokens 🎫](<../../../../5 ⏩ Flows/10 🤵⏩ Brokers/08 🤵⏩🧑‍🦰 Update Tokens 🎫.md>) | [Brokers 🤵](<../../../45 🤲 Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) tell [Wallets 🧑‍🦰](<../../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) to update the list
3| [🤗⏩🧑‍🦰 Prompt 🤔](<../../30 🤗 Hosts/🤗⏩ Host flows/🤗⏩🧑‍🦰 Prompt 🤔.md>) | [Brokers 🤵](<../../../45 🤲 Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) tell users about what happened
|