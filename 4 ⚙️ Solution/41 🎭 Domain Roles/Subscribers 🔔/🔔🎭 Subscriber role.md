...
1. **How do Subscribers work?**
    ...
    |2| The [Subscriber 🔔 domain](<🔔🎭 Subscriber role.md>) then subscribes to a stream from a [Streamer 🌬️ domain](<../Streamers 🌬️/🌬️🎭 Streamer role.md>), informing the [Buffer ⏳ helper domain](<../../45 🤲 Helper domains/27 ⏳ Buffers/⏳🤲 Buffer helper.md>).
    |3| The [Streamer 🌬️ domain](<../Streamers 🌬️/🌬️🎭 Streamer role.md>) pushes an encrypted event through the [Buffer ⏳ helper domain](<../../45 🤲 Helper domains/27 ⏳ Buffers/⏳🤲 Buffer helper.md>), who places it in a queue.
...
1. **What are examples of event subscribers?**
    ...
    * [Graph 🕸 helper domains](<../../45 🤲 Helper domains/50 🕸 Graphs/🕸🤲 Graph helper.md>) build their graph databases with subscriptions to [domain Manifest 📜](<../../40 👥 Domains/👥📜 Domain Manifests/📜 Manifest.md>) updates from [Listener 👂 streams](<../../45 🤲 Helper domains/60 👂 Listeners/👂🤲 Listener helper.md>).
