...
1. **What are examples of domain event streams?**
    ...
    * [Listener 👂 domains](<../../45 🤲 Helper domains/Listeners 👂/👂 Listener helper/👂🤲 Listener helper.md>) and [Graph 🕸 domains](<../../45 🤲 Helper domains/Graphs 🕸/🕸 Graph helper/🕸🤲 Graph helper.md>) stream domain [Manifest 📜](<../../30 🧩 Data/Manifests 📜/📜 Manifest/📜 Manifest.md>) updates.
...
1. **Do Streams guarantee unique delivery?**
    ...
    * [Buffer ⏳ helper domains](<../../45 🤲 Helper domains/Buffers ⏳/⏳ Buffer/⏳🤲 Buffer helper.md>) are responsible for deduping when necessary.
...
1. **Do Streams guarantee ordered delivery?**
    ...
    * [Buffer ⏳ helper domains](<../../45 🤲 Helper domains/Buffers ⏳/⏳ Buffer/⏳🤲 Buffer helper.md>) are responsible for ordering events when necessary.
...
1. **What if a push fails with a timeout or 5XX error?**
    ...
    Upon receiving a timeout or 5XX error from a [Buffer ⏳ helper domain](<../../45 🤲 Helper domains/Buffers ⏳/⏳ Buffer/⏳🤲 Buffer helper.md>), 
...
1. **What if a push fails with a 4XX HTTP error?**
    ...
    Upon receiving a non-authorized 4XX error from a [Buffer ⏳ helper domain](<../../45 🤲 Helper domains/Buffers ⏳/⏳ Buffer/⏳🤲 Buffer helper.md>), 
    * [Streamer 🌬️ domains](<🌬️🎭 Streamer role.md>) assume that the [Buffer ⏳ domain](<../../45 🤲 Helper domains/Buffers ⏳/⏳ Buffer/⏳🤲 Buffer helper.md>) does not want the message, 
...
1. **What if a Subscriber returns a 429 Too Many Requests?**
    ...
    Upon receiving a 429 Too Many Requests from a [Buffer ⏳ helper domain](<../../45 🤲 Helper domains/Buffers ⏳/⏳ Buffer/⏳🤲 Buffer helper.md>), 
    * [Streamer 🌬️ domains](<🌬️🎭 Streamer role.md>) conclude that the [Buffer ⏳ domain](<../../45 🤲 Helper domains/Buffers ⏳/⏳ Buffer/⏳🤲 Buffer helper.md>) is failing to do its one and only job, 
