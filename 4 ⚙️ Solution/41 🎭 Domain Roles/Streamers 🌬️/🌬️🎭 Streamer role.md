...
1. **What are examples of domain event streams?**
    ...
    * [Listener 👂 domains](<../../45 🤲 Helper domains/Listeners 👂/👂 Listener helper/👂🤲 Listener helper.md>) and [Graph 🕸 domains](<../../45 🤲 Helper domains/Graphs 🕸/🕸 Graph/🕸🤲 Graph helper.md>) stream domain [Manifest 📜](<../../30 🧩 Data/Manifests 📜/📜 Manifest/📜 Manifest.md>) updates.
