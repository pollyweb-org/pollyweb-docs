...
|| `Buffer`| string | [Buffer ⏳ domain](<../../../45 🤲 Helper domains/27 ⏳ Buffers/⏳🤲 Buffer helper.md>) name
|| `Queue` | uuid | Callback for [Push@Buffer 🐌](<../../../45 🤲 Helper domains/27 ⏳ Buffers/⏳🅰️ Buffer methods/🌬️🐌⏳ Push.md>)
