...
> Used in [💼⏩🧑‍🦰 Query Vault @ Consumer](<../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰💬 Wallet chats/...in Prompts 🤔/👉💼 Share Bind 🔗.md>) flow.
...
|4|[💼🚀🗄️ `Collect@Vault`](<../🗄️🅰️ Vault methods/Collect 💼🚀🗄️/💼🚀🗄️ Collect.md>) | [Consumers 💼](<../../Consumers 💼/💼🎭 Consumer role.md>) collect the data shared
|
...
1. **Why Consume+Collect instead of a single call?**
    ...
    * This is the [`Collect@Vault`](<../🗄️🅰️ Vault methods/Collect 💼🚀🗄️/💼🚀🗄️ Collect.md>) call.
