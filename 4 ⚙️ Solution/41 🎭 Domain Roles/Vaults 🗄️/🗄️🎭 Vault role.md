...
1. **What is a Vault domain role in NLWeb?**
    ...
    * has a [Bind 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) with the user's [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>), 
...
1. **How are Vault domains configured on a Wallet?**
    ...
    For a [domain 👥](<../../40 👥 Domains/👥 Domain.md>) to be listed as a [Vault 🗄️ domain](<🗄️🎭 Vault role.md>) in the [user's Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>), the user first needs to [bind 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) the [domain 👥](<../../40 👥 Domains/👥 Domain.md>) to the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>).

    | | Workflow |  Description
    |-|-|-
    | | [👉 Binds ](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰💬 Wallet in App 🏠/💬🤵 List Binds 🔗.md>) | List the user's [Binds 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>)
    || [👉 Bind](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰💬 Wallet in Prompts 🤔/👉🗄️ Bind 🔗.md>) | [Bind 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) the [Wallet 🧑‍🦰](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>) to a [Vault 🗄️](<🗄️🎭 Vault role.md>)
    || [👉 Unbind](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰💬 Wallet in Vaults 🗄️/💬🤵 Unbind 🗄️.md>) | Remove a [Bind 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) from a [Vault 🗄️](<🗄️🎭 Vault role.md>)
...
1. **What are default Vaults?**
    ...
    To streamline user onboarding, [Broker 🤵 domains](<../../20 🧑‍🦰 UI/Brokers 🤵/🤵🤲 Broker helper.md>) may automatically [bind 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) new [Wallet 🧑‍🦰 apps](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>) to default [Agent 🫥 vault domains](<../../50 🫥 Agent domains/$ Agent Vaults 🫥/🫥🗄️ Agent vault.md>).
        
    | | Workflow |  Description
    |-|-|-
    ||[👉 Onboard](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰✨ Wallet onboard/💬🤵 Onboard.md>) | Register the [Wallet 🧑‍🦰](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>) on a [Broker 🤵](<../../20 🧑‍🦰 UI/Brokers 🤵/🤵🤲 Broker helper.md>)
...
1. **Can users ask Vaults to share data with other Hosts?**
    ...
    | | Workflow |  Description
    |-|-|-
    ||[👉 Share](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰💬 Wallet in Prompts 🤔/👉💼 Share Bind 🔗.md>) | Shares a [Bind 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) with a [Consumer 💼](<../Consumers 💼/💼🎭 Consumer role.md>)
...
1. **What API methods does a Vault exposes?**
    ...
    |-|--------|-------------|
    | [🤵 Broker](<../../20 🧑‍🦰 UI/Brokers 🤵/🤵🤲 Broker helper.md>) | [`Bound`](<🗄️🅰️ Vault methods/to Bind/🤵🐌🗄️ Bound.md>) | A [Bind 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) was added |
    |  | [`Unbound`](<🗄️🅰️ Vault methods/to Bind/🤵🐌🗄️ Unbound.md>) | A [Bind 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) was removed |
    | | [`Disclose`](<🗄️🅰️ Vault methods/to Share/🤵🐌🗄️ Disclose.md>) | Disclose the data of a [Bind 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) |
    ...
    | [💼 Consumer](<../Consumers 💼/💼🎭 Consumer role.md>) | [`Collect`](<🗄️🅰️ Vault methods/to Share/💼🚀🗄️ Collect.md>) | Return the data disclosed
