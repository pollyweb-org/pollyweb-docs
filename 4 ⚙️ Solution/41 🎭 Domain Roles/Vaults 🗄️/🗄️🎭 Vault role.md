...
1. **What is a Vault domain role in NLWeb?**
    ...
    * has a [Bind 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) with the user's [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>), 
...
1. **How are Vault domains configured on a Wallet?**
    ...
    For a [domain 👥](<../../40 👥 Domains/👥 Domain.md>) to be listed as a [Vault 🗄️ domain](<🗄️🎭 Vault role.md>) in the [user's Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>), the user first needs to [bind 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) the [domain 👥](<../../40 👥 Domains/👥 Domain.md>) to the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>).

    | | Workflow |  Description
    |-|-|-
    | | [👉 Binds ](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰💬 Wallet in App 🏠/💬🤵 List Binds 🔗.md>) | List the user's [Binds 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>)
    || [👉 Bind](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰💬 Wallet in Prompts 🤔/👉🗄️ Bind 🔗.md>) | [Bind 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) the [Wallet 🧑‍🦰](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) to a [Vault 🗄️](<🗄️🎭 Vault role.md>)
    || [👉 Unbind](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰💬 Wallet in Vaults 🗄️/💬🤵 Unbind 🗄️.md>) | Remove a [Bind 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) from a [Vault 🗄️](<🗄️🎭 Vault role.md>)
...
1. **What are default Vaults?**
    ...
    To streamline user onboarding, [Broker 🤵 domains](<../../20 🧑‍🦰 UI/3 🤵 Brokers/🤵🤲 Broker helper.md>) may automatically [bind 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) new [Wallet 🧑‍🦰 apps](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) to default [Agent 🫥 vault domains](<../../50 🫥 Agent domains/$ Agent Vaults 🫥/🫥🗄️ Agent vault.md>).
...
1. **Can users ask Vaults to share data with other Hosts?**
    ...
    | | Workflow |  Description
    |-|-|-
    ||[👉 Share](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰💬 Wallet in Prompts 🤔/👉💼 Share Bind 🔗.md>) | Shares a [Bind 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) with a [Consumer 💼](<../Consumers 💼/💼🎭 Consumer role.md>)
...
1. **Why can't users control their Vaults, like in the Solid project?**
    ...
    * [Trusts 👍](<../../30 🧩 Data/Trusts 👍/👍 Domain Trust.md>) in [domain Manifests 📜](<../../30 🧩 Data/Manifests 📜/📜 Manifest.md>) to represent partnerships;
...
1. **What if the user only wants to have one Vault?**
    ...
    A single [domain 👥](<../../40 👥 Domains/👥 Domain.md>) can, in theory, implement all existing [Schema Codes 🧩](<../../30 🧩 Data/Schema Codes 🧩/🧩 Schema Code.md>) and establish [trust 👍](<../../30 🧩 Data/Trusts 👍/👍 Domain Trust.md>) relationships with all existing [domains 👥](<../../40 👥 Domains/👥 Domain.md>).

    * Thus, a user may wish to [bind 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) to that single [Vault 🗄️ domain](<🗄️🎭 Vault role.md>) with all [Schema Codes 🧩](<../../30 🧩 Data/Schema Codes 🧩/🧩 Schema Code.md>) the user is interested in sharing, and is [trusted 👍](<../../30 🧩 Data/Trusts 👍/👍 Domain Trust.md>) buy all the [domains 👥](<../../40 👥 Domains/👥 Domain.md>) the user is interested in interacting with. 
...
1. **What flows are initiated by Vaults?**
    ...
    |-|-
    | [💼 Consume](<🗄️⏩ Vault flows/🗄️⏩💼 Consume 🔗.md>) | Tells a [Consumer 💼](<../Consumers 💼/💼🎭 Consumer role.md>) to collect data
    | [🧑‍🦰 Engage](<🗄️⏩ Vault flows/🗄️⏩🧑‍🦰 Engage 💬.md>) | Opens a new [Chat 💬](<../../35 💬 Chats/💬 Chats/💬 Chat.md>) with a [Bound 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) user
...
1. **What API methods does a Vault exposes?**
    ...
    |-|--------|-------------|
    | [🤵 Broker](<../../20 🧑‍🦰 UI/3 🤵 Brokers/🤵🤲 Broker helper.md>) | [`Bound`](<🗄️🅰️ Vault methods/🤵🐌🗄️ Bound.md>) | A [Bind 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) was added |
    |  | [`Unbound`](<🗄️🅰️ Vault methods/🤵🐌🗄️ Unbound.md>) | A [Bind 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) was removed |
    | | [`Disclose`](<🗄️🅰️ Vault methods/🤵🐌🗄️ Disclose.md>) | Disclose the data of a [Bind 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) |
