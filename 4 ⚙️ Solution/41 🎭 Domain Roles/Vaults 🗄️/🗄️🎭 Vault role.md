...
1. **How are Vault domains configured on a Wallet?**
    ...
    For a [domain 👥](<../../40 👥 Domains/👥 Domains/👥 Domain.md>) to be listed as a [Vault 🗄️ domain](<🗄️🎭 Vault role.md>) in the [user's Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>), the user first needs to [bind 🔗](<../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) the [domain 👥](<../../40 👥 Domains/👥 Domains/👥 Domain.md>) to the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>).
