...
* [Script 📃](<../../../../../35 💬 Chats/Scripts 📃/Script 📃.md>) 
    * that reacts to the [`BIND` command](<../../../🗄️⌘ Vault cmds/BIND 🔗/🔗 BIND ⌘ cmd.md>), 
    * which is implemented by the [`BIND` 📃 script](<../../../🗄️⌘ Vault cmds/BIND 🔗/🔗 BIND 📃 script.md>).
...
| [Messages 📨](<../../../../../30 🧩 Data/Messages 📨/📨 Message/📨 Message.md>) | [`Bind@Broker` 🐌 msg](<../../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵📨 Broker msgs/Binds 🔗 Bind 🗄️🐌🤵/🤵 Bind 🐌 msg.md>)
|