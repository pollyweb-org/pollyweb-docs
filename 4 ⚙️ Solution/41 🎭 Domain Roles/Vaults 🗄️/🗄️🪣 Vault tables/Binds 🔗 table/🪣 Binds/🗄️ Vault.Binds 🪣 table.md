...
|-|-|-|-
| [`Bind`](<../🪣🧱 10 Bind ⏩ flow/🗄️ Vault.Binds.Bind ⏩ flow.md>) | [`OFFERED`](<../🪣🧱 11 Offered 🔔 event/🗄️ OnBindOffered 🔔 handler.md>) |[`BIND` ⌘](<../../../🗄️⌘ Vault commands/BIND 🔗/🔗 BIND 📃 script.md>)| Created but not yet accepted by the user |
...
| `Schema` |text| [Schema Code 🧩](<../../../../../30 🧩 Data/Codes 🧩/🧩 Schema Code.md>) | [`BIND`](<../../../🗄️⌘ Vault commands/BIND 🔗/🔗 BIND ⌘ cmd.md>) | [`Bind@Broker`](<../../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🅰️ Broker methods/Binds 🔗 Bind 🗄️🐌🤵/🤵 Bind 🐌 msg.md>)
| `Reference` | text | [Hosted 📦](<../../../../../55 👷 Build domains/Hosteds 📦/📦👥 Hosted domain.md>) internal anchor | [`BIND`](<../../../🗄️⌘ Vault commands/BIND 🔗/🔗 BIND ⌘ cmd.md>) | [`ASYNC`](<../../../../../37 Scripts 📃/📃 Commands ⌘/⌘ for async/ASYNC 👷🏼/👷🏼 ASYNC ⌘ cmd.md>)
| `Internals` | map | [Hosted 📦](<../../../../../55 👷 Build domains/Hosteds 📦/📦👥 Hosted domain.md>) internal data | [`BIND`](<../../../🗄️⌘ Vault commands/BIND 🔗/🔗 BIND ⌘ cmd.md>) | [`ASYNC`](<../../../../../37 Scripts 📃/📃 Commands ⌘/⌘ for async/ASYNC 👷🏼/👷🏼 ASYNC ⌘ cmd.md>)
