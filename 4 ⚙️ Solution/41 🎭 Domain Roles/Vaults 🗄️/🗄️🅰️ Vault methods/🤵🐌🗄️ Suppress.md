...
> Suppress [🖐️ Palm scans](<../../../50 🫥 Agent domains/Identities 🆔/🆔⏩ Identity flows/22 🆔🖐️ Palm scan.md>) on Palmist devices.
...
|Body| `Consumer` | string | [Consumer 💼 domain](<../../Consumers 💼/💼🎭 Consumer role.md>)
...
* If the session is tracked, stop it - e.g.: 
    ...
    * AND stop sending findings to the [Host 🤗 domain](<../../Hosts 🤗/🤗🎭 Host role.md>).
