...
1. **Whe is the BindID generated?**
    ...
    * This is to ensure that the [Broker 🤵 domain](<../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🤲 Broker helper.md>) has always the most updated list of [Binds 🔗](<../../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) to share with the [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>), even if the [Vault 🗄️ domain](<../🗄️🎭 Vault role.md>) has not yet processed that [Bind 🔗](<../../../30 🧩 Data/Binds 🔗/🔗 Bind.md>).
