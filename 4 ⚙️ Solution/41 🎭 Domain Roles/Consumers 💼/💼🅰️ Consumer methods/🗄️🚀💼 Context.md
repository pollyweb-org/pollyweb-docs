...
* Asks the [Consumer 💼 domain](<../💼🎭 Consumer role.md>) for the context of a [`Query@Broker`](<../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🅰️ Broker methods/6 🤵🅰️ Share/💼🐌🤵 Query.md>), if the requested [Schema Code 🧩](<../../../30 🧩 Data/Codes 🧩/🧩 Schema Code.md>) defines a context for requests.
