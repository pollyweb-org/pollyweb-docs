...
* Asks the [Consumer 💼 domain](<../💼🎭 Consumer role.md>) for the context of a [`Query@Broker`](<../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🅰️ Broker methods/...for Share 💼/Query 💼🐌🤵/Query 🐌 msg.md>), if the requested [Schema 🧩](<../../../30 🧩 Data/Codes 🧩/🧩 Schema Code.md>) defines a context for requests.
