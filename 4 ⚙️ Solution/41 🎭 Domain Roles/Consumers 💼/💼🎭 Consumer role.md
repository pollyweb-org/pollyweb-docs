...
1. **What kind of user data is supported by Consumers?**
    ...
    - downloaded [Tokens 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) issued by an [Issuer 🎴 domain](<../Issuers 🎴/🎴🎭 Issuer role.md>) and stored on the Wallet.
...
1. **How do Consumers receive downloaded Tokens?**
    ...
    - **Request on a chat**: 
        ...
        - if the user accepts, the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) shares with the [Consumer 💼](<💼🎭 Consumer role.md>) both the [bound 🔗 Vaults](<../../30 🧩 Data/2 🔗 Binds/🔗 Bind.md>) and the downloaded [Tokens 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) that match that [Schema Code 🧩](<../../30 🧩 Data/1 🧩 Schema Codes/🧩 Schema Code.md>);
        - e.g., an airline may ask a user to share their passport [Token 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>).

    - **On chat hello**: 
        - when a [Broker 🤵 domain](<../../20 🧑‍🦰 UI/3 🤵 Brokers/🤵🤲 Broker helper.md>) initiates a chat session with a [Consumer 💼 domain](<💼🎭 Consumer role.md>), it automatically shares the [Tokens 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) issued by that [Consumer 💼 domain](<💼🎭 Consumer role.md>) if the [Token's Schema Code 🧩](<../../30 🧩 Data/1 🧩 Schema Codes/🧩 Schema Code.md>) is marked as SELF;
        - e.g., booking and ticket [Schema Codes 🧩](<../../30 🧩 Data/1 🧩 Schema Codes/🧩 Schema Code.md>) typically allow users to tap on for check-in when arrival at the place of destination, like a restaurant.
...
1. **Can Consumers use SELF Tokens to tracked domains?**
    ...
    - [Tokens 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) using a [Schema Code 🧩](<../../30 🧩 Data/1 🧩 Schema Codes/🧩 Schema Code.md>) marked as SELF are silently shared with [Consumer 💼 domains](<💼🎭 Consumer role.md>), who can then track users;
...
1. **How can Consumers validate the data schema when consuming?**
    ...
    When consuming data from a [Vault 🗄️ domain](<../Vaults 🗄️/🗄️🎭 Vault role.md>), the data envelope indicates the [Schema Code 🧩](<../../30 🧩 Data/1 🧩 Schema Codes/🧩 Schema Code.md>) and the version (e.g., `any-authority.com/any-schema:1.0`). 
    
    - The code identifies the [domain Manifest 📜](<../../40 👥 Domains/👥📜 Domain Manifests/📜 Manifest.md>) where the [Schema Code 🧩](<../../30 🧩 Data/1 🧩 Schema Codes/🧩 Schema Code.md>) is defined (e.g., `any-schema` is defined in the [domain Manifest 📜](<../../40 👥 Domains/👥📜 Domain Manifests/📜 Manifest.md>) of `any-authority.com`), so [Consumer 💼 domains](<💼🎭 Consumer role.md>) can then fetch the schema definitions from a cached [Graph 🕸 domain](<../../45 🤲 Helper domains/Graphs 🕸/🕸🤲 Graph helper.md>) or directly from the [Manifest 📜](<../../40 👥 Domains/👥📜 Domain Manifests/📜 Manifest.md>).
...
1. **How do Consumers verify a Token's signature?**
    ...
    When issuing [Tokens 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>), the [Issuer 🎴 domains](<../Issuers 🎴/🎴🎭 Issuer role.md>) sign them with the same key-pair used in their [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) public key. 
    - Other [domains 👥](<../../40 👥 Domains/👥 Domains/👥 Domain.md>) can use the [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) key to verify the signature on the [Token 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>).
...
1. **Can Consumers verify Tokens when Issuers are offline?**
    ...
    - NLWeb advocates for domains to ask [Graph 🕸 domains](<../../45 🤲 Helper domains/Graphs 🕸/🕸🤲 Graph helper.md>) for the [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) of the [Issuer 🎴 domain](<../Issuers 🎴/🎴🎭 Issuer role.md>) when verifying [Tokens 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>). 
...
1. **Can Consumers verify Tokens when Issuers rotate a DKIM?**
    ...
    [Graph 🕸 domains](<../../45 🤲 Helper domains/Graphs 🕸/🕸🤲 Graph helper.md>) will find the [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) of the [Issuer 🎴 domain](<../Issuers 🎴/🎴🎭 Issuer role.md>) that was in use when the [Token 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) was issued.
...
1. **How are Consumers protected when Graph are compromised by attackers?**
    ...
    * If necessary, [Firewall 🔥 domains](<../../45 🤲 Helper domains/Firewalls 🔥/🔥🤲 Firewall helper.md>) immediately revoke a Graph's [trust 👍](<../../40 👥 Domains/👥👍 Domain Trusts/👍 Domain Trust.md>).
...
1. **Why aren't all Tokens validated online?**
    ...
    In scenarios where physical gates need to allow for large influx of people (e.g., a concert or a subway station), it is quicker to validate the [Tokens 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) offline at the edge, opening the gate if the [Token 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) seems valid. 
    
    * The [Consumer 💼 domain](<💼🎭 Consumer role.md>) may then perform an asynchronous validation of the [Token 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>), marking it as expired in a local database so that the passage is blocked on the next pass.
...
1. **How do sellers prevent swapping of identity Tokens?**
    ...
    [Seller 💵 domains](<../Sellers 💵/💵🎭 Seller role.md>) can prevent frauds where users share their [Tokens 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) with someone else.
...
1. **What API methods does a Consumer expose?**
    ...
    | [🧑‍🦰🐌 Receive](<💼🅰️ Consumer methods/🧑‍🦰🐌💼 Receive.md>) | Receive [Tokens 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) from a [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>)
...
1. **What flows does a Consumer initiate?**
    ...
    |  Flow | Purpose
    |-|-
    | [⏩🧑‍🦰 Query Vault](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰💬 Wallet chats/in Prompts 🤔/🧑‍🦰👉💼 Share Bind 🔗.md>) | Ask for [Schema Codes 🧩](<../../30 🧩 Data/1 🧩 Schema Codes/🧩 Schema Code.md>) in [Vaults 🗄️](<../Vaults 🗄️/🗄️🎭 Vault role.md>) 
    | [⏩🧑‍🦰 Share Token](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰💬 Wallet chats/in Prompts 🤔/🧑‍🦰👉💼 Share Token 🎫.md>) | Ask for [Tokens 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) in  [Wallet 🧑‍🦰 apps](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) 
    | [⏩🧑‍🦰 Share ID Token](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰💬 Wallet chats/in Prompts 🤔/🧑‍🦰👉💼 Share Token+ID.md>) | Ask for [Identity 🆔](<../../50 🫥 Agent domains/Identities 🆔/🆔🫥 Identity agent.md>) bound [Tokens 🎫](<../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>)
