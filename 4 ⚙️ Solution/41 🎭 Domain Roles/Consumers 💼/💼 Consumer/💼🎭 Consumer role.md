...
1. **Can Consumers verify if a Token was issued to the holder?**
    ...
    - This requires an online request to an [Identity 🆔 domain](<../../../50 🫥 Agent domains/Identifiers 🆔/🆔 Identifier agent/🆔 Identifier 🫥 agent.md>) that is [bound 🔗](<../../../30 🧩 Data/Binds 🔗/🔗 Bind.md>) to the user and [trusted 🫡](<../../../30 🧩 Data/Trusts 🫡/🫡 Domain Trust.md>) by the [Consumer 💼 domain](<💼🎭 Consumer role.md>), allowing the token to be matched to the holder without disclosing the holder's identity to the [Consumer 💼 domain](<💼🎭 Consumer role.md>):
    ...
    - The [Identity 🆔 domain](<../../../50 🫥 Agent domains/Identifiers 🆔/🆔 Identifier agent/🆔 Identifier 🫥 agent.md>) can perform the authentication:
...
1. **How do sellers prevent swapping of identity Tokens?**
    ...
    - [Seller 💵 domains](<../../Sellers 💵/💵 Seller /💵🎭 Seller role.md>) ask the user's trusted [Identity 🆔 domain](<../../../50 🫥 Agent domains/Identifiers 🆔/🆔 Identifier agent/🆔 Identifier 🫥 agent.md>) to perform the authentication inside the [Chat 💬](<../../../35 💬 Chats/Chats 💬/💬 Chat.md>) on the user's device;
    ...
    - the [Seller 💵 domain](<../../Sellers 💵/💵 Seller /💵🎭 Seller role.md>) takes a photo of the user with a fixed camera, and then asks the [Token's Identity 🆔 domain](<../../../50 🫥 Agent domains/Identifiers 🆔/🆔 Identifier agent/🆔 Identifier 🫥 agent.md>) to match the [Token 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) with the picture.
...
1. **How are consumers prevented from collecting too much user data?**
    ...
    * That configuration would result in the following [Chat 💬](<../../../35 💬 Chats/Chats 💬/💬 Chat.md>) excerpt. 
        ...
        | 🆔 [Identity](<../../../50 🫥 Agent domains/Identifiers 🆔/🆔 Identifier agent/🆔 Identifier 🫥 agent.md>) | 🫥 Share identity? [Yes, No] |
        | ... | 
...
1. **What flows does a Consumer initiate?**
    ...
    | [⏩🧑‍🦰 Share ID Token](<../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰💬 Wallet chats/...in Prompts 🤔/Share Token+ID 👉🆔💼/🧑‍🦰 Share Token+ID ⏩ flow.md>) | Ask for [Identity 🆔](<../../../50 🫥 Agent domains/Identifiers 🆔/🆔 Identifier agent/🆔 Identifier 🫥 agent.md>) bound [Tokens 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>)
