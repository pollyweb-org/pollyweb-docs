...
> Related to
* [📝 Talker `INFORM` command](<../../../../35 💬 Chats/Scripts 📃/📃 for methods 🤵/INFORM 📝/📝 INFORM ⌘ cmd.md>)
...
|-|-
| 📝 [`INFORM`](<../../../../35 💬 Chats/Scripts 📃/📃 for methods 🤵/INFORM 📝/📝 INFORM ⌘ cmd.md>) | Show user instructions and allow inputs.
|
...
|7|[🤵🐌🗄️ `Disclose@Broker`](<../../../Vaults 🗄️/🗄️🅰️ Vault methods/Disclose 🤵🐌🗄️/🗄️ Disclose 🐌 msg.md>) | [Brokers 🤵](<../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🤲 Broker helper.md>) ask [Vaults 🗄️](<../../../Vaults 🗄️/🗄️🎭 Vault role.md>) to disclose
|