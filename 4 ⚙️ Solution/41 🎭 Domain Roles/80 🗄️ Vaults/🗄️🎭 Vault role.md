...
1. **What is a Vault domain role in NLWeb?**
    ...
    * has a [Bind 🔗](<../../30 Data/🔗 Binds/🔗 Bind.md>) with the user's [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>), 
...
1. **How are Vault domains configured on a Wallet?**
    ...
    For a [domain 👥](<../../40 👥 Domains/👥 Domains/👥 Domain.md>) to be listed as a [Vault 🗄️ domain](<🗄️🎭 Vault role.md>) in the [user's Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>), the user first needs to [bind 🔗](<../../30 Data/🔗 Binds/🔗 Bind.md>) the [domain 👥](<../../40 👥 Domains/👥 Domains/👥 Domain.md>) to the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>).

    | | Workflow |  Description
    |-|-|-
    | | [👉 Binds ](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/30 👉🔗 Binds/01 🧑‍🦰👉🤵 List binds.md>) | List the user's [Binds 🔗](<../../30 Data/🔗 Binds/🔗 Bind.md>)
    || [👉 Bind](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/30 👉🔗 Binds/02 🧑‍🦰👉🗄️ Bind 🔗.md>) | [Bind 🔗](<../../30 Data/🔗 Binds/🔗 Bind.md>) the [Wallet 🧑‍🦰](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) to a [Vault 🗄️](<🗄️🎭 Vault role.md>)
    || [👉 Unbind](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/30 👉🔗 Binds/03 🧑‍🦰👉🗄️ Unbind.md>) | Remove a [Bind 🔗](<../../30 Data/🔗 Binds/🔗 Bind.md>) from a [Vault 🗄️](<🗄️🎭 Vault role.md>)
...
1. **What are default Vaults?**
    ...
    To streamline user onboarding, [Broker 🤵 domains](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) may automatically [bind 🔗](<../../30 Data/🔗 Binds/🔗 Bind.md>) new [Wallet 🧑‍🦰 apps](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) to default [Agent 🫥 vault domains](<../../50 🫥 Agent domains/$ 🫥 Agent Vaults/$ 🫥🗄️ Agent vault.md>).
        
    | | Workflow |  Description
    |-|-|-
    ||[👉 Onboard](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/10 👉🤵 Set-up/11 🧑‍🦰👉🤵 Onboard.md>) | Register the [Wallet 🧑‍🦰](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) on a [Broker 🤵](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>)
...
1. **Can users ask Vaults to share data with other Hosts?**
    ...
    - This requires both [Vault 🗄️](<🗄️🎭 Vault role.md>) and [Consumer 💼 host](<../27 💼 Consumers/💼🎭 Consumer role.md>) domains to [trust 👍](<../../40 👥 Domains/👥👍 Domain Trusts/👍 Domain Trust.md>) one another for the [Schema Code 🧩](<../../30 Data/🧩 Schema Codes/🧩 Schema Code.md>) of the dataset to be shared.

    | | Workflow |  Description
    |-|-|-
    ||[👉 Share](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/30 👉🔗 Binds/04 🧑‍🦰👉💼 Share Bind 🔗.md>) | Shares a [Bind 🔗](<../../30 Data/🔗 Binds/🔗 Bind.md>) with a [Consumer 💼](<../27 💼 Consumers/💼🎭 Consumer role.md>)
...
1. **Why can't users control their Vaults, like in the Solid project?**
    ...
    * [Broker 🤵 domains](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) to protect users from bad corporate actors;
...
1. **How are users protected from stalking from vaults?**
    ...
    * When a user [binds 🔗](<../../30 Data/🔗 Binds/🔗 Bind.md>) to a [Host 🤗 domain](<../30 🤗 Hosts/🤗🎭 Host role.md>), the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) passes a unique [bind 🔗](<../../30 Data/🔗 Binds/🔗 Bind.md>) ID to the [Host 🤗](<../30 🤗 Hosts/🤗🎭 Host role.md>) to be able to identify the user across sessions, turning the [Host 🤗 domain](<../30 🤗 Hosts/🤗🎭 Host role.md>) into a [Vault 🗄️ domain](<🗄️🎭 Vault role.md>).
    
    * While the [Vault 🗄️ domain](<🗄️🎭 Vault role.md>) is now able to track the user across [Chats 💬](<../../35 Chats/💬 Chats/💬 Chat.md>), it cannot track the user across [Host 🤗 domains](<../30 🤗 Hosts/🤗🎭 Host role.md>) because the [Bind 🔗](<../../30 Data/🔗 Binds/🔗 Bind.md>) ID is unique for the relationship between that user and that [Host 🤗](<../30 🤗 Hosts/🤗🎭 Host role.md>).
...
1. **What API methods does a Vault exposes?**
    ...
    |-|--------|-------------|
    | [🤵 Broker](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) | [`Bound`](<🗄️🅰️ Vault methods/🤵🐌🗄️ Bound.md>) | Add a [Bind 🔗](<../../30 Data/🔗 Binds/🔗 Bind.md>) |
    |  | [`Unbind`](<🗄️🅰️ Vault methods/🤵🐌🗄️ Unbind.md>) | Remove a [Bind 🔗](<../../30 Data/🔗 Binds/🔗 Bind.md>) |
