...
> Tells it to reply with the data [shared](<../../../../6 🅰️ APIs/30 💼🅰️ Consumer/02 🗄️🐌💼 Consume.md>) by the user.
...
|Body|`VaultKey` | uuid | Callback from [Consume@Consumer](<../../../../6 🅰️ APIs/30 💼🅰️ Consumer/02 🗄️🐌💼 Consume.md>)
|
