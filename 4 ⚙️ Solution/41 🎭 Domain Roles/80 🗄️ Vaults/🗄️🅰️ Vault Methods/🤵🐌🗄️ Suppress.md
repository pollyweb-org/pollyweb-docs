...
> Suppress [🖐️ Palm scans](<../../../50 🫥 Agent domains/45 🆔 Identities/22 🆔🖐️ Palm scan.md>) on Palmist devices.
...
* If the session is tracked, stop it - e.g.: 
    ...
    * AND the palm reader is actively looking for the user of the [Chat 💬](<../../../35 Chats/12 💬 Chats/$ 💬 Chat.md>)
    * WHEN suppressed 
