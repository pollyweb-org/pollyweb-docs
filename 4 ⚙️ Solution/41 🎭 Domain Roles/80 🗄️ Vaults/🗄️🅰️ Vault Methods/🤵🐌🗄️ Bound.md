...
|Bind| `ID`| uuid | [Bind 🔗](<../../../30 🧩 Data/20 🔗 Binds/🔗 Bind.md>) ID on the [Broker 🤵 domain](<../../../45 🛠️ Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>)
...
1. **Whe is the BindID generated?**
    ...
    The [Bind 🔗](<../../../30 🧩 Data/20 🔗 Binds/🔗 Bind.md>) ID is generated by the [Broker 🤵 domain](<../../../45 🛠️ Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) (and not on the [Vault 🗄️ domain](<../🗄️🎭 Vault role.md>)).
    
    * This is to ensure that the [Broker 🤵 domain](<../../../45 🛠️ Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) has always the most updated list of [Binds 🔗](<../../../30 🧩 Data/20 🔗 Binds/🔗 Bind.md>) to share with the [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>), even if the [Vault 🗄️ domain](<../🗄️🎭 Vault role.md>) has not yet processed that [Bind 🔗](<../../../30 🧩 Data/20 🔗 Binds/🔗 Bind.md>).
