...
1. **Can users ask Vaults to share data with other Hosts?**
    ...
    || [💼 Consume](<80 🗄️⏩ Vaults/32 🗄️⏩💼 Consume 🔗.md>) | Tells a [Consumer 💼](<../27 💼 Consumers/$ 💼🎭 Consumer role.md>) to collect data
...
1. **What flows are initiated by Vaults?**
    ...
    |-|-
    | [💼 Consume](<80 🗄️⏩ Vaults/32 🗄️⏩💼 Consume 🔗.md>) | Tells a [Consumer 💼](<../27 💼 Consumers/$ 💼🎭 Consumer role.md>) to collect data
    | [🧑‍🦰 Engage](<80 🗄️⏩ Vaults/34 🗄️⏩🧑‍🦰 Engage 💬.md>) | Opens a new [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) with a [Bound 🔗](<../../30 🧩 Data/20 🔗 Binds/$ 🔗 Bind.md>) user
...
1. **What API methods does a Vault exposes?**
    ...
    |-|--------|-------------|
    | [🤵 Broker](<../../45 🛠️ Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) | [`Bound`](<95 🗄️🅰️ Vault/02 🤵🐌🗄️ Bound@Vault.md>) | Add a [Bind 🔗](<../../30 🧩 Data/20 🔗 Binds/$ 🔗 Bind.md>) |
    |  | [`Unbind`](<95 🗄️🅰️ Vault/02 🤵🐌🗄️ Unbind@Vault.md>) | Remove a [Bind 🔗](<../../30 🧩 Data/20 🔗 Binds/$ 🔗 Bind.md>) |
    | | [`Disclose`](<95 🗄️🅰️ Vault/03 🤵🐌🗄️ Disclose@Vault.md>) | Disclose the data of a [Bind 🔗](<../../30 🧩 Data/20 🔗 Binds/$ 🔗 Bind.md>) |
    | | [`Suppress`](<95 🗄️🅰️ Vault/04 🤵🐌🗄️ Suppress@Vault.md>) | Suppress [🖐️ Palm scans](<../../50 🫥 Agents/45 🆔 Identities/22 🆔🖐️ Palm scan.md>) |
    | [💼 Consumer](<../27 💼 Consumers/$ 💼🎭 Consumer role.md>) | [`Collect`](<95 🗄️🅰️ Vault/01 💼🚀🗄️ Collect@Vault.md>) | Return the data disclosed
