...
1. **What is a Vault domain role in NLWeb?**
    ...
    A [domain 👥](<../../40 👥 Domains/$ 👥 Domains/00 👥 Domain.md>) with a [Vault 🗄️ role](<$ 🗄️🎭 Vault role.md>) 
    * is any [domain 👥](<../../40 👥 Domains/$ 👥 Domains/00 👥 Domain.md>) that stores user data,
...
1. **How are Vault domains configured on a Wallet?**
    ...
    For a [domain 👥](<../../40 👥 Domains/$ 👥 Domains/00 👥 Domain.md>) to be listed as a [Vault 🗄️ domain](<$ 🗄️🎭 Vault role.md>) in the [user's Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>), the user first needs to [bind 🔗](<../../30 🧩 Data/20 🔗 Binds/$ 🔗 Bind.md>) the [domain 👥](<../../40 👥 Domains/$ 👥 Domains/00 👥 Domain.md>) to the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>).
...
1. **What if the user only wants to have one Vault?**
    ...
    A single [domain 👥](<../../40 👥 Domains/$ 👥 Domains/00 👥 Domain.md>) can, in theory, implement all existing [Schema Codes 🧩](<../../30 🧩 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>) and establish [trust 👍](<../../40 👥 Domains/43 👍 Trusts/$ 👍 Domain Trust.md>) relationships with all existing [domains 👥](<../../40 👥 Domains/$ 👥 Domains/00 👥 Domain.md>).

    * Thus, a user may wish to [bind 🔗](<../../30 🧩 Data/20 🔗 Binds/$ 🔗 Bind.md>) to that single [Vault 🗄️ domain](<$ 🗄️🎭 Vault role.md>) with all [Schema Codes 🧩](<../../30 🧩 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>) the user is interested in sharing, and is [trusted 👍](<../../40 👥 Domains/43 👍 Trusts/$ 👍 Domain Trust.md>) buy all the [domains 👥](<../../40 👥 Domains/$ 👥 Domains/00 👥 Domain.md>) the user is interested in interacting with. 
...
1. **What flows are initiated by Vaults?**
    ...
    |-|-
    | [💼 Consume](<../../../5 ⏩ Flows/80 🗄️⏩ Vaults/02 🗄️⏩💼 Consume 🔗.md>) | Tells a [Consumer 💼](<../27 💼 Consumers/$ 💼🎭 Consumer role.md>) to collect data
    | [🧑‍🦰 Engage](<../../../5 ⏩ Flows/80 🗄️⏩ Vaults/04 🗄️⏩🧑‍🦰 Engage 💬.md>) | Opens a new [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) with a [Bound 🔗](<../../30 🧩 Data/20 🔗 Binds/$ 🔗 Bind.md>) user
...
1. **What API methods does a Vault exposes?**
    ...
    |-|--------|-------------|
    | [🤵 Broker](<../../45 🛠️ Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) | [`Bound`](<../../../6 🅰️ APIs/95 🗄️🅰️ Vault/02 🤵🐌🗄️ Bound.md>) | Add a [Bind 🔗](<../../30 🧩 Data/20 🔗 Binds/$ 🔗 Bind.md>) |
    |  | [`Unbind`](<../../../6 🅰️ APIs/95 🗄️🅰️ Vault/02 🤵🐌🗄️ Unbind.md>) | Remove a [Bind 🔗](<../../30 🧩 Data/20 🔗 Binds/$ 🔗 Bind.md>) |
    | | [`Disclose`](<../../../6 🅰️ APIs/95 🗄️🅰️ Vault/03 🤵🐌🗄️ Disclose.md>) | Disclose the data of a [Bind 🔗](<../../30 🧩 Data/20 🔗 Binds/$ 🔗 Bind.md>) |
