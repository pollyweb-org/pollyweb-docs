...
1. **What are examples of Vault domains?**
    ...
    |[🫥 `Agents`](<../../25 Data/24 🗄️ Vaults/04 🫥🗄️ Agent vault.md>) | These are [Vaults 🗄️](<$ 🗄️🎭 Vault role.md>) with well-known NLWeb APIs.
...
1. **What are default Vaults?**
    ...
    To streamline user onboarding, [Broker 🤵 domains](<../../20 🧑‍🦰 UI/03 🤵 Brokers/$ 🤵 Broker domain.md>) may automatically [bind 🔗](<../../25 Data/24 🗄️ Vaults/01 🔗 Bind.md>) new [Wallet 🧑‍🦰 apps](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>) to default [Agent 🫥 vault domains](<../../25 Data/24 🗄️ Vaults/04 🫥🗄️ Agent vault.md>).
...
1. **Can users ask Vaults to share data with other Hosts?**
    ...
    - This requires both [Vault 🗄️](<$ 🗄️🎭 Vault role.md>) and [Consumer 💼 host](<../27 💼 Consumers/$ 💼🎭 Consumer role.md>) domains to [trust 👍](<../../40 👥 Domains/43 👍 Trusts/$ 👍 Domain Trust.md>) one another for the [Schema Code 🧩](<../../25 Data/24 🗄️ Vaults/02 🧩 Schema Code.md>) of the dataset to be shared.

    | | Workflow |  Description
    |-|-|-
    ||[👉 Share](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/30 👉🔗 Binds/04 🧑‍🦰👉💼 Share Bind 🔗.md>) | Shares a [Bind 🔗](<../../25 Data/24 🗄️ Vaults/01 🔗 Bind.md>) with a [Consumer 💼](<../27 💼 Consumers/$ 💼🎭 Consumer role.md>)
...
1. **Can users ask Vaults to download data to the device?**
    ...
    No. 
    * That is covered by the [Issuer 🎴 domain](<../../../../../../../4 ⚙️ Solution/41 🎭 Domain Roles/40 🎴 Issuers/$ 🎴🎭 Issuer role.md>) role. 
...
1. **What if the user only wants to have one Vault?**
    ...
    A single [domain 👥](<../../40 👥 Domains/41 📨 Messages/00 👥 Domain.md>) can, in theory, implement all existing [Schema Codes 🧩](<../../25 Data/24 🗄️ Vaults/02 🧩 Schema Code.md>) and establish [trust 👍](<../../40 👥 Domains/43 👍 Trusts/$ 👍 Domain Trust.md>) relationships with all existing [domains 👥](<../../40 👥 Domains/41 📨 Messages/00 👥 Domain.md>).

    * Thus, a user may wish to [bind 🔗](<../../25 Data/24 🗄️ Vaults/01 🔗 Bind.md>) to that single [Vault 🗄️ domain](<$ 🗄️🎭 Vault role.md>) with all [Schema Codes 🧩](<../../25 Data/24 🗄️ Vaults/02 🧩 Schema Code.md>) the user is interested in sharing, and is [trusted 👍](<../../40 👥 Domains/43 👍 Trusts/$ 👍 Domain Trust.md>) buy all the [domains 👥](<../../40 👥 Domains/41 📨 Messages/00 👥 Domain.md>) the user is interested in interacting with. 
...
1. **How are users protected from stalking from vaults?**
    ...
    * When a user [binds 🔗](<../../25 Data/24 🗄️ Vaults/01 🔗 Bind.md>) to a [Host 🤗 domain](<../30 🤗 Hosts/$ 🤗🎭 Host role.md>), the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>) passes a unique [bind 🔗](<../../25 Data/24 🗄️ Vaults/01 🔗 Bind.md>) ID to the [Host 🤗](<../30 🤗 Hosts/$ 🤗🎭 Host role.md>) to be able to identify the user across sessions, turning the [Host 🤗 domain](<../30 🤗 Hosts/$ 🤗🎭 Host role.md>) into a [Vault 🗄️ domain](<$ 🗄️🎭 Vault role.md>).
    
    * While the [Vault 🗄️ domain](<$ 🗄️🎭 Vault role.md>) is now able to track the user across [Chats 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>), it cannot track the user across [Host 🤗 domains](<../30 🤗 Hosts/$ 🤗🎭 Host role.md>) because the [Bind 🔗](<../../25 Data/24 🗄️ Vaults/01 🔗 Bind.md>) ID is unique for the relationship between that user and that [Host 🤗](<../30 🤗 Hosts/$ 🤗🎭 Host role.md>).
...
1. **What flows are initiated by Vaults?**
    ...
    |-|-
    | [💼 Consume](<../../../5 ⏩ Flows/80 🗄️⏩ Vaults/02 🗄️⏩💼 Consume 🔗.md>) | Tells a [Consumer 💼](<../27 💼 Consumers/$ 💼🎭 Consumer role.md>) to collect data
    | [🧑‍🦰 Engage](<../../../5 ⏩ Flows/80 🗄️⏩ Vaults/04 🗄️⏩🧑‍🦰 Engage 💬.md>) | Opens a new [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) with a [Bound 🔗](<../../25 Data/24 🗄️ Vaults/01 🔗 Bind.md>) user
...
1. **What API methods does a Vault exposes?**
    ...
    |-|--------|-------------|
    | [🤵 Broker](<../../20 🧑‍🦰 UI/03 🤵 Brokers/$ 🤵 Broker domain.md>) | [`Bound`](<../../../6 🅰️ APIs/95 🗄️🅰️ Vault/02 🤵🐌🗄️ Bound.md>) | Add a [Bind 🔗](<../../25 Data/24 🗄️ Vaults/01 🔗 Bind.md>) |
