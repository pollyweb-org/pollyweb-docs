...
1. **What is a Seller domain role in NLWeb?**
    ...
    Sellers 💵 are [domains 👥](<../../40 👥 Domains/$ 👥 Domains/$ 👥 Domain.md>) that ask [Payer 💳 domains](<../../50 🫥 Agents/60 💳 Payers/03 💳🎭 Payer role.md>) for payments to their [Collector 🏦 helpers](<../../45 🛠️ Helper domains/30 🏦 Collectors/$ 🏦🛠️ Collector helper.md>) in return for products or services.
...
1. **What workflows do Sellers implement?**
    ...
    |-|-
    | [🧑‍🦰 Charge users](<32 💵⏩🧑‍🦰 Charge flow.md>) | How Sellers 💵 charge users.
...
1. **What API messages do Sellers implement?**
    ...
    |Message|Description
    |-|-
    | [🐌 Paid](<51 🏦🐌💵 Paid@Seller.md>) | The [Collector 🏦 helper](<../../45 🛠️ Helper domains/30 🏦 Collectors/$ 🏦🛠️ Collector helper.md>) confirms the payment.
