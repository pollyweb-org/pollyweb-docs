...
1. **What is a Seller domain role in NLWeb?**
    ...
    Sellers 💵 are [domains 👥](<../../40 👥 Domains/41 📨 Messages/00 👥 Domain.md>) that ask [Payer 💳 domains](<../../30 🫥 Agents/60 💳 Payers/03 💳🎭 Payer role.md>) for payments to their [Collector 🏦 helpers](<../../45 🛠️ Helper domains/30 🏦 Collectors/$ 🏦🛠️ Collector helper.md>) in return for products or services.
...
1. **How do Sellers sell to users?**
    ...
    | 3 | The user's [Payer 💳 agent](<../../30 🫥 Agents/60 💳 Payers/04 💳🫥 Payer agent.md>) informs the Seller's [Collector 🏦 helper](<../../45 🛠️ Helper domains/30 🏦 Collectors/$ 🏦🛠️ Collector helper.md>) about the money transfer.
    ...
    | 5 | The [Collector 🏦](<../../45 🛠️ Helper domains/30 🏦 Collectors/$ 🏦🛠️ Collector helper.md>) issues a receipt to the user's [Payer 💳](<../../30 🫥 Agents/60 💳 Payers/04 💳🫥 Payer agent.md>), who may store it in the user's [Storage 📦 agent](<../../30 🫥 Agents/80 📦 Storage/$ 📦🫥 Storage agent.md>).
...
1. **Do Sellers need to trust user Payers?**
    ...
    - Sellers 💵 delegate that [trust 👍](<../../40 👥 Domains/43 👍 Trusts/$ 👍 Domain Trust.md>) relationship to their [Collectors 🏦](<../../45 🛠️ Helper domains/30 🏦 Collectors/$ 🏦🛠️ Collector helper.md>);
        - i.e., the [Collector 🏦](<../../45 🛠️ Helper domains/30 🏦 Collectors/$ 🏦🛠️ Collector helper.md>) and [Payer 💳](<../../30 🫥 Agents/60 💳 Payers/03 💳🎭 Payer role.md>) are the ones who need to have a [trust 👍](<../../40 👥 Domains/43 👍 Trusts/$ 👍 Domain Trust.md>) relationship.
...
1. **Do Sellers define how they want the user to pay?**
    ...
    No. 
    - The payment method is decided between the user's [Payer 💳](<../../30 🫥 Agents/60 💳 Payers/03 💳🎭 Payer role.md>) and the Seller's [Collector 🏦](<../../45 🛠️ Helper domains/30 🏦 Collectors/$ 🏦🛠️ Collector helper.md>). 
