...
|-|-|-|-
|Header | `From`  | string  | [Broker 🤵](<../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🤲 Broker helper.md>) from [`Offer@Broker`](<../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🅰️ Broker methods/...for Tokens 🎫/Offer 🐌/🎴🐌🤵 Offer.md>)
|       | `To`    | string  | [Issuer 🎴](<../🎴🎭 Issuer role.md>) from [`Offer@Broker`](<../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🅰️ Broker methods/...for Tokens 🎫/Offer 🐌/🎴🐌🤵 Offer.md>)
||`Subject`|string|`Token@Issuer` 
| Body  | `Hook`| uuid | `Hook` from [`Offer@Broker`](<../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🅰️ Broker methods/...for Tokens 🎫/Offer 🐌/🎴🐌🤵 Offer.md>)
...
|-|-
| ⏬ [`GET`](<../../../35 💬 Chats/😃 Talkers/😃⚙️ Talker cmds/...datasets 🪣/GET/GET ⏬ item.md>) | Get the [Hook 🪣](<../../../35 💬 Chats/😃 Talkers/😃🪣 Talker tables/😃🪣 Hooks 🪝 table.md>) from [`Offer@Broker`](<../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🅰️ Broker methods/...for Tokens 🎫/Offer 🐌/🎴🐌🤵 Offer.md>)
