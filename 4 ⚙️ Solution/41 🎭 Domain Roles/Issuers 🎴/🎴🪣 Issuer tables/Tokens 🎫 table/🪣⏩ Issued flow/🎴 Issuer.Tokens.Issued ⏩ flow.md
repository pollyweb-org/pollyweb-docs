...
* Counterpart of the [🤵 `Broker.Tokens.Issue` ⏩ flow](<../../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🪣 Broker tables/Tokens 🎫 table/🪣🧱 1 Issue ⏩ flow/🤵 Broker.Tokens.Issue ⏩ flow.md>)
...
|[`OnTokenIssued` 🔔 handler](<../../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🪣 Broker tables/Tokens 🎫 table/🪣🧱 1 Issued 🔔 event/🤵 OnTokenIssued 🔔 handler.md>) | [`Issuer.Tokens` 🪣](<../🪣 Tokens/🎴 Issuer.Tokens 🪣 table.md>) event that calls [`SEND` 📬](<../../../../../37 Scripts 📃/📃 Commands ⌘/⌘ for messages 📨/SEND 📬/📬 SEND ⌘ cmd.md>)
...
|[`OnTokenOffered` 🔔 handler](<../../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🪣 Broker tables/Tokens 🎫 table/🪣🧱 3 Offered 🔔 event/🤵 OnTokenOffered 🔔 handler.md>) | [`Issuer.Tokens` 🪣](<../🪣 Tokens/🎴 Issuer.Tokens 🪣 table.md>) event that returns to [`ISSUE` ⌘](<../../../../../37 Scripts 📃/📃 Commands ⌘/⌘ for methods 🤵/ISSUE 🎫/🎫 ISSUE ⌘ cmd.md>)
|
