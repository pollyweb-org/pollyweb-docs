...
|[`OnTokenOffered` 🔔 handler](<../../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🪣 Broker tables/Tokens 🎫 table/🪣🧱 13 Offered 🔔 event/🤵 OnTokenOffered 🔔 handler.md>) | [`Issuer.Tokens` 🪣](<../🪣 Tokens/🎴 Issuer.Tokens 🪣 table.md>) event that returns to [`ISSUE` ⌘](<../../../../../37 Scripts 📃/📃 Commands ⌘/⌘ for methods 🤵/ISSUE 🎫/🎫 ISSUE ⌘ cmd.md>)
|
