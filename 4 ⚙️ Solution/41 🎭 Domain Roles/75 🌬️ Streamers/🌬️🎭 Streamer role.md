...
1. **What are examples of domain event streams?**
    ...
    * [Listener 👂 domains](<../../45 🛠️ Helper domains/60 👂 Listeners/👂🛠️ Listener helper.md>) and [Graph 🕸 domains](<../../45 🛠️ Helper domains/50 🕸 Graphs/🕸🛠️ Graph helper.md>) stream domain [Manifest 📜](<../../40 👥 Domains/44 📜 Manifests/📜 Manifest.md>) updates.
    * [Advertiser 👀 domains](<../../45 🛠️ Helper domains/12 👀 Advertisers/👀🛠️ Advertiser helper.md>) and [Reviewer ⭐ domains](<../../50 🫥 Agents/73 ⭐ Reviewers/⭐🫥 Reviewer agent.md>) stream feedbacks about [Host 🤗 domain](<../30 🤗 Hosts/🤗🎭 Host role.md>).
