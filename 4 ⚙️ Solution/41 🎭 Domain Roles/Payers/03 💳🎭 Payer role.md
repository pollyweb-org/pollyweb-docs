...
1. **How are currency conversions handled?**
    ...
    Payers 💳 are responsible for converting the currency to the price of the [Seller 💵 domain](<../../41 🎭 Domain Roles/Sellers 💵/💵🎭 Seller role.md>).

    - [Seller 💵 domains](<../../41 🎭 Domain Roles/Sellers 💵/💵🎭 Seller role.md>) always receive payments in their requested currency and in the exact amount requested.
...
1. **What happens if a transaction is cancelled?**
    ...
    Typically, the money is reverted, but it depends on the relationship between the [Payer 💳 domain](<03 💳🎭 Payer role.md>) and the [Collector 🏦 domain](<../../45 🤲 Helper domains/Collectors 🏦/🏦🤲 Collector helper.md>).
...
7.  **How does it differ from India's ONDC?**
    ...
    - Conversely, NLWeb is against any form of central governance for payments 
        - i.e., there should be multiple channels for [Payer 💳 domains](<03 💳🎭 Payer role.md>) and [Collector 🏦 domains](<../../45 🤲 Helper domains/Collectors 🏦/🏦🤲 Collector helper.md>) to communicate;
...
1. **Do Payers transfer money to collectors, or pay by card?**
    ...
    [Payer 💳 domains](<03 💳🎭 Payer role.md>) and [Collector 🏦 domains](<../../45 🤲 Helper domains/Collectors 🏦/🏦🤲 Collector helper.md>) may support multiple ways to transact. 
...
1. **Can a payment be reverted or cancelled?**
    ...
    Yes. 
    * [Collector 🏦 domains](<../../45 🤲 Helper domains/Collectors 🏦/🏦🤲 Collector helper.md>) can initiate it, but [Payer 💳 domains](<03 💳🎭 Payer role.md>) can't.
...
1. **Can payments be done with credit/debit notes?**
    ...
    Yes, as long as the [Payer 💳 domain](<03 💳🎭 Payer role.md>) and the [Collector 🏦 domain](<../../45 🤲 Helper domains/Collectors 🏦/🏦🤲 Collector helper.md>) support it.
...
1. **Why not use blockchain to perform the money transfer?**
    ...
    - **simplicity:** if only two entities ([Payer 💳 domain](<03 💳🎭 Payer role.md>) and [Collector 🏦 domain](<../../45 🤲 Helper domains/Collectors 🏦/🏦🤲 Collector helper.md>)) need to communicate, then two simple mutually authenticated API endpoints are enough to do the job.
