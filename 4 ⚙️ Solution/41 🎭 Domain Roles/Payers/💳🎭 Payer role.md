...
1. **What is a Payer domain in NLWeb?**
    ...
    * **[Payer 💳🫥 agents](<../../50 🫥 Agent domains/Payers 💳/💳🫥 Payer agent.md>)**: 
        ...
        * for users with [Wallet 🧑‍🦰 apps](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰🛠️ Wallet app.md>), 
...
1. **Why not leverage the Open Banking protocol?**
    ...
    - e.g., the ability to jump between bank entities from within a [Chat 💬](<../../35 💬 Chats/Chats 💬/💬 Chat.md>) in the user's [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰🛠️ Wallet app.md>).
...
1. **What responsibilities do Payers have with invoices?**
    ...
    None. 
    * [Collector 🏦 domains](<../../45 🤲 Helper domains/Collectors 🏦/🏦🤲 Collector helper.md>) are responsible for invoices.
...
1. **What happens if a transaction is cancelled?**
    ...
    Typically, the money is reverted, but it depends on the relationship between the [Payer 💳 domain](<💳🎭 Payer role.md>) and the [Collector 🏦 domain](<../../45 🤲 Helper domains/Collectors 🏦/🏦🤲 Collector helper.md>).
...
1. **How does it differ from India's ONDC?**
    ...
    - Conversely, NLWeb is against any form of central governance for payments 
        - i.e., there should be multiple channels for [Payer 💳 domains](<💳🎭 Payer role.md>) and [Collector 🏦 domains](<../../45 🤲 Helper domains/Collectors 🏦/🏦🤲 Collector helper.md>) to communicate;
...
1. **Do Payers transfer money to collectors, or pay by card?**
    ...
    [Payer 💳 domains](<💳🎭 Payer role.md>) and [Collector 🏦 domains](<../../45 🤲 Helper domains/Collectors 🏦/🏦🤲 Collector helper.md>) may support multiple ways to transact. 
    
    - When multiple choices are possible, [Payer 💳 domains](<💳🎭 Payer role.md>) may ask the user for their preference. 
    - The exact payment method will depend on the transfer methods supported by both parties (e.g., SWIFT, TransferWise), and the user configurations supported by the [Payer 💳 domain](<💳🎭 Payer role.md>) (e.g., Visa, MasterCard, Brazilian Pix).
...
1. **Can a payment be reverted or cancelled?**
    ...
    Yes. 
    * [Collector 🏦 domains](<../../45 🤲 Helper domains/Collectors 🏦/🏦🤲 Collector helper.md>) can initiate it, but [Payer 💳 domains](<💳🎭 Payer role.md>) can't.
...
1. **Can payments be done with credit/debit notes?**
    ...
    Yes, as long as the [Payer 💳 domain](<💳🎭 Payer role.md>) and the [Collector 🏦 domain](<../../45 🤲 Helper domains/Collectors 🏦/🏦🤲 Collector helper.md>) support it.
...
1. **Why not use blockchain to perform the money transfer?**
    ...
    - **simplicity:** if only two entities ([Payer 💳 domain](<💳🎭 Payer role.md>) and [Collector 🏦 domain](<../../45 🤲 Helper domains/Collectors 🏦/🏦🤲 Collector helper.md>)) need to communicate, then two simple mutually authenticated API endpoints are enough to do the job.
...
1. **Can a group split a bill in equal parts?**
    ...
    Yes, but split bills are managed by [Collector 🏦 domains](<../../45 🤲 Helper domains/Collectors 🏦/🏦🤲 Collector helper.md>), as in the following examples:
