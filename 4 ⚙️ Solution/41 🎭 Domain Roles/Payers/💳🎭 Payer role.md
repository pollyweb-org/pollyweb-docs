...
1. **What is a Payer domain in NLWeb?**
    ...
    * **[Payer 💳🫥 agents](<../../50 🫥 Agent domains/Payers 💳/💳🫥 Payer agent.md>)**: 
        ...
        * for users with [Wallet 🧑‍🦰 apps](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>), 
...
1. **Why not leverage the Open Banking protocol?**
    ...
    - e.g., the ability to jump between bank entities from within a [Chat 💬](<../../35 💬 Chats/💬 Chats/💬 Chat.md>) in the user's [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>).
