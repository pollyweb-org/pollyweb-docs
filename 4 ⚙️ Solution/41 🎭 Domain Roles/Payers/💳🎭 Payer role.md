...
1. **What is a Payer domain in PollyWeb?**
    ...
    * **[Payer 💳🤲 Helpers](<../../45 🤲 Helper domains/Payers 💳/💳🤲 Payer helper.md>)**:
        * these are [Payer 💳 domains](<💳🎭 Payer role.md>) that act as [Helper 🤲 domains](<../Helpers 🤲/🤲 Helper/🤲🎭 Helper role.md>)
...
1. **What responsibilities do Payers have with invoices?**
    ...
    None. 
    * [Collector 🏦 domains](<../../45 🤲 Helper domains/Collectors 🏦/🏦 Collector/🏦🤲 Collector helper.md>) are responsible for invoices.
...
1. **What happens if a transaction is cancelled?**
    ...
    Typically, the money is reverted, but it depends on the relationship between the [Payer 💳 domain](<💳🎭 Payer role.md>) and the [Collector 🏦 domain](<../../45 🤲 Helper domains/Collectors 🏦/🏦 Collector/🏦🤲 Collector helper.md>).
...
1. **Does PollyWeb allow users to pay with NFC contactless?**
    ...
    - However, users can tap on a PollyWeb [🔆 NFC Locator](<../../25 🔆 Locators/Locators 🔆/🔆 Locator.md>) with their devices to check out a PollyWeb transaction, while continuing to use the device's standard NFC payments for traditional point of sale (POS) terminals. 
...
1. **Do Payers transfer money to collectors, or pay by card?**
    ...
    [Payer 💳 domains](<💳🎭 Payer role.md>) and [Collector 🏦 domains](<../../45 🤲 Helper domains/Collectors 🏦/🏦 Collector/🏦🤲 Collector helper.md>) may support multiple ways to transact. 
...
1. **Can a payment be reverted or cancelled?**
    ...
    Yes. 
    * [Collector 🏦 domains](<../../45 🤲 Helper domains/Collectors 🏦/🏦 Collector/🏦🤲 Collector helper.md>) can initiate it, but [Payer 💳 domains](<💳🎭 Payer role.md>) can't.
...
1. **Can payments be done with credit/debit notes?**
    ...
    Yes, as long as the [Payer 💳 domain](<💳🎭 Payer role.md>) and the [Collector 🏦 domain](<../../45 🤲 Helper domains/Collectors 🏦/🏦 Collector/🏦🤲 Collector helper.md>) support it.
...
1. **Can a group split a bill in equal parts?**
    ...
    Yes, but split bills are managed by [Collector 🏦 domains](<../../45 🤲 Helper domains/Collectors 🏦/🏦 Collector/🏦🤲 Collector helper.md>), as in the following examples:
