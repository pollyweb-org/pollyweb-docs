...
* Asks the [Consumer 💼 domain](<../💼🎭 Consumer role.md>) for the context of a [`Query@Broker`](<../../../../6 🅰️ APIs/15 🤵🅰️ Broker/60 🤵🅰️ Share/61 💼🐌🤵 Query.md>), if the requested [Schema Code 🧩](<../../../30 🧩 Data/10 🧩 Schema Codes/🧩 Schema Code.md>) defines a context for requests.
