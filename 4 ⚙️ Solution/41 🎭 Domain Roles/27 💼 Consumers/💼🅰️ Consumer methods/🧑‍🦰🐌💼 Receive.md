...
* [Wallet 🧑‍🦰 apps](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) send [Tokens 🎫](<../../../30 Data/3 🎫 Tokens/🎫 Token.md>) to a [Consumer 💼 domain](<../💼🎭 Consumer role.md>).
...
| Token |  `Issuer` | string | [Issuer 🎴](<../../40 🎴 Issuers/🎴🎭 Issuer role.md>) from [`Save@Notifier`](<../../../20 🧑‍🦰 UI/2 📣 Notifiers/📣🅰️ Notifier methods/4 🎫 Tokens/1 🤵🐌📣 Save.md>)
