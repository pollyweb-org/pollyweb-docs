...
* Asks the [Consumer 💼 domain](<../💼🎭 Consumer role.md>) for the context of a [`Query@Broker`](<../../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🅰️ Broker methods/6 🤵🅰️ Share/💼🐌🤵 Query.md>), if the requested [Schema Code 🧩](<../../../30 Data/🧩 Schema Codes/🧩 Schema Code.md>) defines a context for requests.
