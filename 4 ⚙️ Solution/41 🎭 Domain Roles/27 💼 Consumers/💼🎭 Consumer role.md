...
1. **What kind of user data is supported by Consumers?**
    ...
    - downloaded [Tokens 🎫](<../../30 Data/3 🎫 Tokens/🎫 Token.md>) issued by an [Issuer 🎴 domain](<../40 🎴 Issuers/🎴🎭 Issuer role.md>) and stored on the Wallet.
...
1. **How do Consumers receive downloaded Tokens?**
    ...
    - **When users tap Userables**: 
        ...
        - see [Userable at gates 💍🎬](<../../25 Locators/74 💍 Userables/💍⏩ Userable flows/14 💍🎬 Userable gates.md>) for details.
...
1. **How can Consumers validate the data schema when consuming?**
    ...
    When consuming data from a [Vault 🗄️ domain](<../80 🗄️ Vaults/🗄️🎭 Vault role.md>), the data envelope indicates the [Schema Code 🧩](<../../30 Data/1 🧩 Schema Codes/🧩 Schema Code.md>) and the version (e.g., `any-authority.com/any-schema:1.0`). 
...
1. **How do Consumers verify a Token's signature?**
    ...
    When issuing [Tokens 🎫](<../../30 Data/3 🎫 Tokens/🎫 Token.md>), the [Issuer 🎴 domains](<../40 🎴 Issuers/🎴🎭 Issuer role.md>) sign them with the same key-pair used in their [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) public key. 
...
1. **Can Consumers verify Tokens when Issuers are offline?**
    ...
    - NLWeb advocates for domains to ask [Graph 🕸 domains](<../../45 🤲 Helper domains/50 🕸 Graphs/🕸🤲 Graph helper.md>) for the [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) of the [Issuer 🎴 domain](<../40 🎴 Issuers/🎴🎭 Issuer role.md>) when verifying [Tokens 🎫](<../../30 Data/3 🎫 Tokens/🎫 Token.md>). 
...
1. **Can Consumers verify Tokens when Issuers rotate a DKIM?**
    ...
    [Graph 🕸 domains](<../../45 🤲 Helper domains/50 🕸 Graphs/🕸🤲 Graph helper.md>) will find the [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) of the [Issuer 🎴 domain](<../40 🎴 Issuers/🎴🎭 Issuer role.md>) that was in use when the [Token 🎫](<../../30 Data/3 🎫 Tokens/🎫 Token.md>) was issued.
...
1. **How do sellers prevent swapping of identity Tokens?**
    ...
    [Seller 💵 domains](<../70 💵 Sellers/💵🎭 Seller role.md>) can prevent frauds where users share their [Tokens 🎫](<../../30 Data/3 🎫 Tokens/🎫 Token.md>) with someone else.
    ...
    - the [Seller 💵 domain](<../70 💵 Sellers/💵🎭 Seller role.md>) takes a photo of the user with a fixed camera, and then asks the [Token's Identity 🆔 domain](<../../50 🫥 Agent domains/45 🆔 Identities/$ 🆔🫥 Identity agent.md>) to match the [Token 🎫](<../../30 Data/3 🎫 Tokens/🎫 Token.md>) with the picture.
...
1. **What API methods does a Consumer expose?**
    ...
    | [🧑‍🦰🐌 Receive](<💼🅰️ Consumer methods/🧑‍🦰🐌💼 Receive.md>) | Receive [Tokens 🎫](<../../30 Data/3 🎫 Tokens/🎫 Token.md>) from a [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>)
...
1. **What flows does a Consumer initiate?**
    ...
    |  Flow | Purpose
    |-|-
    | [⏩🧑‍🦰 Query Vault](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/30 👉🔗 Binds/04 🧑‍🦰👉💼 Share Bind 🔗.md>) | Ask for [Schema Codes 🧩](<../../30 Data/1 🧩 Schema Codes/🧩 Schema Code.md>) in [Vaults 🗄️](<../80 🗄️ Vaults/🗄️🎭 Vault role.md>) 
    | [⏩🧑‍🦰 Share Token](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/40 👉🎫 Tokens/04 🧑‍🦰👉💼 Share Token 🎫.md>) | Ask for [Tokens 🎫](<../../30 Data/3 🎫 Tokens/🎫 Token.md>) in  [Wallet 🧑‍🦰 apps](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) 
    | [⏩🧑‍🦰 Share ID Token](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/40 👉🎫 Tokens/05 🧑‍🦰👉💼 Share Token+ID.md>) | Ask for [Identity 🆔](<../../50 🫥 Agent domains/45 🆔 Identities/$ 🆔🫥 Identity agent.md>) bound [Tokens 🎫](<../../30 Data/3 🎫 Tokens/🎫 Token.md>)
