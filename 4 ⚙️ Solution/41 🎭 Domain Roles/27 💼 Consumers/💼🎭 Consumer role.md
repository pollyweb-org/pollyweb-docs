...
1. **What kind of user data is supported by Consumers?**
    ...
    - downloaded [Tokens 🎫](<../../30 Data/30 🎫 Tokens/🎫 Token.md>) issued by an [Issuer 🎴 domain](<../40 🎴 Issuers/🎴🎭 Issuer role.md>) and stored on the Wallet.
...
1. **How do Consumers receive downloaded Tokens?**
    ...
    [Tokens 🎫](<../../30 Data/30 🎫 Tokens/🎫 Token.md>) are shared with Consumers 💼 by [Broker 🤵 domains](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) in a number of ways.

    - **Request on a chat**: 
        - in a [Chat 💬](<../../35 Chats/💬 Chats/💬 Chat.md>), [Consumers 💼](<💼🎭 Consumer role.md>) can ask the user to share a specific [Schema Code 🧩](<../../30 Data/10 🧩 Schema Codes/🧩 Schema Code.md>);
...
1. **Can Consumers use SELF Tokens to tracked domains?**
    ...
    - [Tokens 🎫](<../../30 Data/30 🎫 Tokens/🎫 Token.md>) using a [Schema Code 🧩](<../../30 Data/10 🧩 Schema Codes/🧩 Schema Code.md>) marked as SELF are silently shared with [Consumer 💼 domains](<💼🎭 Consumer role.md>), who can then track users;
...
1. **How do Consumers verify a Token's signature?**
    ...
    When issuing [Tokens 🎫](<../../30 Data/30 🎫 Tokens/🎫 Token.md>), the [Issuer 🎴 domains](<../40 🎴 Issuers/🎴🎭 Issuer role.md>) sign them with the same key-pair used in their [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) public key. 
    - Other [domains 👥](<../../40 👥 Domains/👥 Domains/👥 Domain.md>) can use the [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) key to verify the signature on the [Token 🎫](<../../30 Data/30 🎫 Tokens/🎫 Token.md>).
...
1. **Can Consumers verify Tokens when Issuers are offline?**
    ...
    - NLWeb advocates for domains to ask [Graph 🕸 domains](<../../45 🤲 Helper domains/50 🕸 Graphs/🕸🤲 Graph helper.md>) for the [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) of the [Issuer 🎴 domain](<../40 🎴 Issuers/🎴🎭 Issuer role.md>) when verifying [Tokens 🎫](<../../30 Data/30 🎫 Tokens/🎫 Token.md>). 
...
1. **Can Consumers verify Tokens when Issuers rotate a DKIM?**
    ...
    [Graph 🕸 domains](<../../45 🤲 Helper domains/50 🕸 Graphs/🕸🤲 Graph helper.md>) will find the [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) of the [Issuer 🎴 domain](<../40 🎴 Issuers/🎴🎭 Issuer role.md>) that was in use when the [Token 🎫](<../../30 Data/30 🎫 Tokens/🎫 Token.md>) was issued.
...
1. **Why aren't all Tokens validated online?**
    ...
    In scenarios where physical gates need to allow for large influx of people (e.g., a concert or a subway station), it is quicker to validate the [Tokens 🎫](<../../30 Data/30 🎫 Tokens/🎫 Token.md>) offline at the edge, opening the gate if the [Token 🎫](<../../30 Data/30 🎫 Tokens/🎫 Token.md>) seems valid. 
    
    * The [Consumer 💼 domain](<💼🎭 Consumer role.md>) may then perform an asynchronous validation of the [Token 🎫](<../../30 Data/30 🎫 Tokens/🎫 Token.md>), marking it as expired in a local database so that the passage is blocked on the next pass.
...
1. **How do sellers prevent swapping of identity Tokens?**
    ...
    [Seller 💵 domains](<../70 💵 Sellers/💵🎭 Seller role.md>) can prevent frauds where users share their [Tokens 🎫](<../../30 Data/30 🎫 Tokens/🎫 Token.md>) with someone else.
    ...
    - the [Seller 💵 domain](<../70 💵 Sellers/💵🎭 Seller role.md>) takes a photo of the user with a fixed camera, and then asks the [Token's Identity 🆔 domain](<../../50 🫥 Agent domains/45 🆔 Identities/$ 🆔🫥 Identity agent.md>) to match the [Token 🎫](<../../30 Data/30 🎫 Tokens/🎫 Token.md>) with the picture.
...
1. **What flows does a Consumer initiate?**
    ...
    | [⏩🧑‍🦰 Share ID Token](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/40 👉🎫 Tokens/05 🧑‍🦰👉💼 Share Token+ID.md>) | Ask for [Identity 🆔](<../../50 🫥 Agent domains/45 🆔 Identities/$ 🆔🫥 Identity agent.md>) bound [Tokens 🎫](<../../30 Data/30 🎫 Tokens/🎫 Token.md>)
