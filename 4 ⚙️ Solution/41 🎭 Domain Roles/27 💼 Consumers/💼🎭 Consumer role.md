...
1. **What kind of user data is supported by Consumers?**
    ...
    - downloaded [Tokens 🎫](<../../30 Data/🎫 Tokens/🎫 Token.md>) issued by an [Issuer 🎴 domain](<../40 🎴 Issuers/🎴🎭 Issuer role.md>) and stored on the Wallet.
...
1. **How do Consumers receive downloaded Tokens?**
    ...
    [Tokens 🎫](<../../30 Data/🎫 Tokens/🎫 Token.md>) are shared with Consumers 💼 by [Broker 🤵 domains](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) in a number of ways.

    - **Request on a chat**: 
        - in a [Chat 💬](<../../35 Chats/💬 Chats/💬 Chat.md>), [Consumers 💼](<💼🎭 Consumer role.md>) can ask the user to share a specific [Schema Code 🧩](<../../30 Data/🧩 Schema Codes/🧩 Schema Code.md>);
        - if the user accepts, the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) shares with the [Consumer 💼](<💼🎭 Consumer role.md>) both the [bound 🔗 Vaults](<../../30 Data/🔗 Binds/🔗 Bind.md>) and the downloaded [Tokens 🎫](<../../30 Data/🎫 Tokens/🎫 Token.md>) that match that [Schema Code 🧩](<../../30 Data/🧩 Schema Codes/🧩 Schema Code.md>);
        - e.g., an airline may ask a user to share their passport [Token 🎫](<../../30 Data/🎫 Tokens/🎫 Token.md>).

    - **On chat hello**: 
        - when a [Broker 🤵 domain](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) initiates a chat session with a [Consumer 💼 domain](<💼🎭 Consumer role.md>), it automatically shares the [Tokens 🎫](<../../30 Data/🎫 Tokens/🎫 Token.md>) issued by that [Consumer 💼 domain](<💼🎭 Consumer role.md>) if the [Token's Schema Code 🧩](<../../30 Data/🧩 Schema Codes/🧩 Schema Code.md>) is marked as SELF;
        - e.g., booking and ticket [Schema Codes 🧩](<../../30 Data/🧩 Schema Codes/🧩 Schema Code.md>) typically allow users to tap on for check-in when arrival at the place of destination, like a restaurant.

    - **When users tap/scan offline Tokens**: 
        - when users tap or scan an offline [Token 🎫](<../../30 Data/🎫 Tokens/🎫 Token.md>) on a scanner of a [Consumer 💼 domain](<💼🎭 Consumer role.md>) (e.g., a printed flight ticket at an airport gate), the [Consumer 💼 domain](<💼🎭 Consumer role.md>) can validate the [Token 🎫](<../../30 Data/🎫 Tokens/🎫 Token.md>) without the need for a chat or any interactions with the [user's Broker 🤵 domain](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>).

    - **When users tap Userables**: 
        - when users tap a [Userable 💍](<../../70 🌳 Ambient/74 💍 Userables/$ 💍 Userable thing.md>) on the scanner of a [Consumer 💼 domain](<💼🎭 Consumer role.md>) (e.g., a wristband at an airport gate), the [Consumer 💼 domain](<💼🎭 Consumer role.md>) can ask the [user's Custodian 🧳 domain](<../../50 🫥 Agent domains/35 🧳 Custodians/$ 🧳🫥 Custodian agent.md>) to silently share all [Tokens 🎫](<../../30 Data/🎫 Tokens/🎫 Token.md>) marked as public by the user and matching a list of expected [Schema Codes 🧩](<../../30 Data/🧩 Schema Codes/🧩 Schema Code.md>);
        - see [Userable at gates 💍🎬](<../../70 🌳 Ambient/74 💍 Userables/14 💍🎬 Userable gates.md>) for details.
...
1. **Can Consumers use SELF Tokens to tracked domains?**
    ...
    - [Tokens 🎫](<../../30 Data/🎫 Tokens/🎫 Token.md>) using a [Schema Code 🧩](<../../30 Data/🧩 Schema Codes/🧩 Schema Code.md>) marked as SELF are silently shared with [Consumer 💼 domains](<💼🎭 Consumer role.md>), who can then track users;
...
1. **How can Consumers validate the data schema when consuming?**
    ...
    When consuming data from a [Vault 🗄️ domain](<../80 🗄️ Vaults/🗄️🎭 Vault role.md>), the data envelope indicates the [Schema Code 🧩](<../../30 Data/🧩 Schema Codes/🧩 Schema Code.md>) and the version (e.g., `any-authority.com/any-schema:1.0`). 
...
1. **How do Consumers verify a Token's signature?**
    ...
    When issuing [Tokens 🎫](<../../30 Data/🎫 Tokens/🎫 Token.md>), the [Issuer 🎴 domains](<../40 🎴 Issuers/🎴🎭 Issuer role.md>) sign them with the same key-pair used in their [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) public key. 
    - Other [domains 👥](<../../40 👥 Domains/👥 Domains/👥 Domain.md>) can use the [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) key to verify the signature on the [Token 🎫](<../../30 Data/🎫 Tokens/🎫 Token.md>).
...
1. **Can Consumers verify Tokens when Issuers are offline?**
    ...
    - NLWeb advocates for domains to ask [Graph 🕸 domains](<../../45 🤲 Helper domains/50 🕸 Graphs/🕸🤲 Graph helper.md>) for the [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) of the [Issuer 🎴 domain](<../40 🎴 Issuers/🎴🎭 Issuer role.md>) when verifying [Tokens 🎫](<../../30 Data/🎫 Tokens/🎫 Token.md>). 
...
1. **Can Consumers verify Tokens when Issuers rotate a DKIM?**
    ...
    [Graph 🕸 domains](<../../45 🤲 Helper domains/50 🕸 Graphs/🕸🤲 Graph helper.md>) will find the [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) of the [Issuer 🎴 domain](<../40 🎴 Issuers/🎴🎭 Issuer role.md>) that was in use when the [Token 🎫](<../../30 Data/🎫 Tokens/🎫 Token.md>) was issued.
...
1. **Can Consumers verify if a Token was issued to the holder?**
    ...
    - This requires an online request to an [Identity 🆔 domain](<../../50 🫥 Agent domains/45 🆔 Identities/$ 🆔🫥 Identity agent.md>) that is [bound 🔗](<../../30 Data/🔗 Binds/🔗 Bind.md>) to the user and [trusted 👍](<../../40 👥 Domains/👥👍 Domain Trusts/👍 Domain Trust.md>) by the [Consumer 💼 domain](<💼🎭 Consumer role.md>), allowing the token to be matched to the holder without disclosing the holder's identity to the [Consumer 💼 domain](<💼🎭 Consumer role.md>):
...
1. **How do sellers prevent swapping of identity Tokens?**
    ...
    [Seller 💵 domains](<../70 💵 Sellers/💵🎭 Seller role.md>) can prevent frauds where users share their [Tokens 🎫](<../../30 Data/🎫 Tokens/🎫 Token.md>) with someone else.
    ...
    - the [Seller 💵 domain](<../70 💵 Sellers/💵🎭 Seller role.md>) takes a photo of the user with a fixed camera, and then asks the [Token's Identity 🆔 domain](<../../50 🫥 Agent domains/45 🆔 Identities/$ 🆔🫥 Identity agent.md>) to match the [Token 🎫](<../../30 Data/🎫 Tokens/🎫 Token.md>) with the picture.
...
1. **How are consumers prevented from collecting too much user data?**
    ...
    To protect users from [Consumer 💼 domains](<💼🎭 Consumer role.md>) that collect too much Personally Identifiable Information (PII), [Broker 🤵 domains](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) verify if any [Consumer 💼 domain](<💼🎭 Consumer role.md>) request is explicitly mentioned on their [domain Manifest 📜](<../../40 👥 Domains/👥📜 Domain Manifests/📜 Manifest.md>).
    ...
    * When interacting in a [Chat 💬](<../../35 Chats/💬 Chats/💬 Chat.md>), [Consumer 💼 domains](<💼🎭 Consumer role.md>) need to notify the [Broker 🤵 domain](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) of a context change before requesting data under that context.

    * [Broker 🤵 domains](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) only process sharing requests that are publicly manifested in advance.

    * [Broker 🤵 domains](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) inform users of every context change, identifying the data that may be collected, then block any data request from the Consumer that does not comply with that context - e.g., [Order pizza 🍕](<../../../3 🤝 Use Cases/02 🍲 Eat & Drink/70 🍕 Order pizza/21 🏠 Home: Order pizza.md>), [Hotel check-in 🛎️](<../../../3 🤝 Use Cases/03 🧳 Travel/08 🧳 Stay at hotels 🏨/03 🏨 Guest @ Reception 🛎️/04 🛎️ Check-in.md>).
    ...
    * That configuration would result in the following [Chat 💬](<../../35 Chats/💬 Chats/💬 Chat.md>) excerpt. 
        ...
        | 🤵 [Broker](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) | 🫥 Ready to check-in? [Yes, No] <br/> - your identity 🆔 shares your ID <br/> - your curator 🧚 sets the room  <br/> - your payer 💳 pays the stay   <br/> - your broker 🤵 saves the room key  | > Yes
...
1. **What API methods does a Consumer expose?**
    ...
    | [🧑‍🦰🐌 Receive](<💼🅰️ Consumer methods/🧑‍🦰🐌💼 Receive.md>) | Receive [Tokens 🎫](<../../30 Data/🎫 Tokens/🎫 Token.md>) from a [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>)
...
1. **What flows does a Consumer initiate?**
    ...
    |  Flow | Purpose
    |-|-
    | [⏩🧑‍🦰 Query Vault](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/30 👉🔗 Binds/04 🧑‍🦰👉💼 Share Bind 🔗.md>) | Ask for [Schema Codes 🧩](<../../30 Data/🧩 Schema Codes/🧩 Schema Code.md>) in [Vaults 🗄️](<../80 🗄️ Vaults/🗄️🎭 Vault role.md>) 
    | [⏩🧑‍🦰 Share Token](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/40 👉🎫 Tokens/04 🧑‍🦰👉💼 Share Token 🎫.md>) | Ask for [Tokens 🎫](<../../30 Data/🎫 Tokens/🎫 Token.md>) in  [Wallet 🧑‍🦰 apps](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) 
    | [⏩🧑‍🦰 Share ID Token](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/40 👉🎫 Tokens/05 🧑‍🦰👉💼 Share Token+ID.md>) | Ask for [Identity 🆔](<../../50 🫥 Agent domains/45 🆔 Identities/$ 🆔🫥 Identity agent.md>) bound [Tokens 🎫](<../../30 Data/🎫 Tokens/🎫 Token.md>)
