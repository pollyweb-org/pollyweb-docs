...
1. **How do sellers prevent swapping of identity Tokens?**
    ...
    - [Seller 💵 domains](<../70 💵 Sellers/💵🎭 Seller role.md>) ask the user's trusted [Identity 🆔 domain](<../../50 🫥 Agents/45 🆔 Identities/$ 🆔🫥 Identity agent.md>) to perform the authentication inside the [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) on the user's device;
    ...
    - the [Seller 💵 domain](<../70 💵 Sellers/💵🎭 Seller role.md>) takes a photo of the user with a fixed camera, and then asks the [Token's Identity 🆔 domain](<../../50 🫥 Agents/45 🆔 Identities/$ 🆔🫥 Identity agent.md>) to match the [Token 🎫](<../../30 🧩 Data/30 🎫 Tokens/🎫 Token.md>) with the picture.
