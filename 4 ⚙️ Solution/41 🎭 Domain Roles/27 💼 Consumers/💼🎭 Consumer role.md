...
1. **How are consumers prevented from collecting too much user data?**
    ...
    * When interacting in a [Chat 💬](<../../35 Chats/💬 Chats/💬 Chat.md>), [Consumer 💼 domains](<💼🎭 Consumer role.md>) need to notify the [Broker 🤵 domain](<../../45 🤲 Helper domains/24 🤵 Brokers/🤵🤲 Broker helper.md>) of a context change before requesting data under that context.
