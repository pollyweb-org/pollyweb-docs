...
Here's the [Manifest 📜](<../../../40 👥 Domains/44 📜 Manifests/📜 Manifest.md>).
```yaml
Forms:
  TableOrder:
    Verb: order
...
|2|[🤗⏩🧑‍🦰 Prompt 🤔](<../../30 🤗 Hosts/🤗⏩ Host flows/🤗⏩🧑‍🦰 Prompt 🤔.md>) | [Brokers 🤵](<../../../45 🛠️ Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) reject non-announced asks
...
|5|[🤗⏩🧑‍🦰 Prompt 🤔](<../../30 🤗 Hosts/🤗⏩ Host flows/🤗⏩🧑‍🦰 Prompt 🤔.md>) | [Brokers 🤵](<../../../45 🛠️ Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) inform the user on the steps
