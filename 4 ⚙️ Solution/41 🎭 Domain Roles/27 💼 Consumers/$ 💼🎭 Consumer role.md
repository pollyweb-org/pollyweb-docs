...
1. **What kind of user data is supported by Consumers?**
    ...
    - downloaded [Tokens 🎫](<../../20 🧑‍🦰 UI/25 🎫 Tokens/01 🎫 Token.md>) issued by an [Issuer 🎴 domain](<../40 🎴 Issuers/$ 🎴🎭 Issuer role.md>) and stored on the Wallet.
...
1. **How do Consumers verify a Token's signature?**
    ...
    When issuing [Tokens 🎫](<../../20 🧑‍🦰 UI/25 🎫 Tokens/01 🎫 Token.md>), the [Issuer 🎴 domains](<../40 🎴 Issuers/$ 🎴🎭 Issuer role.md>) sign them with the same key-pair used in their [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) public key. 
...
1. **Can Consumers verify Tokens when Issuers are offline?**
    ...
    - NLWeb advocates for domains to ask [Graph 🕸 domains](<../../45 🛠️ Helper domains/40 🕸 Graphs/$ 🕸🛠️ Graph helper.md>) for the [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) of the [Issuer 🎴 domain](<../40 🎴 Issuers/$ 🎴🎭 Issuer role.md>) when verifying [Tokens 🎫](<../../20 🧑‍🦰 UI/25 🎫 Tokens/01 🎫 Token.md>). 
...
1. **Can Consumers verify Tokens when Issuers rotate a DKIM?**
    ...
    [Graph 🕸 domains](<../../45 🛠️ Helper domains/40 🕸 Graphs/$ 🕸🛠️ Graph helper.md>) will find the [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) of the [Issuer 🎴 domain](<../40 🎴 Issuers/$ 🎴🎭 Issuer role.md>) that was in use when the [Token 🎫](<../../20 🧑‍🦰 UI/25 🎫 Tokens/01 🎫 Token.md>) was issued.
