...
1. **What kind of user data is supported by Consumers?**
    ...
    - downloaded [Tokens 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) issued by an [Issuer 🎴 domain](<../40 🎴 Issuers/$ 🎴🎭 Issuer role.md>) and stored on the Wallet.
...
1. **How do Consumers receive downloaded Tokens?**
    ...
    [Tokens 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) are shared with Consumers 💼 by [Broker 🤵 domains](<../../20 🧑‍🦰 UI/03 🤵 Brokers/$ 🤵 Broker domain.md>) in a number of ways.

    - **Request on a chat**: 
        - in a [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>), [Consumers 💼](<$ 💼🎭 Consumer role.md>) can ask the user to share a specific [Schema Code 🧩](<../../25 Data/Schema Codes/02 🧩 Schema Code.md>);
        - if the user accepts, the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>) shares with the [Consumer 💼](<$ 💼🎭 Consumer role.md>) both the [bound 🔗 Vaults](<../../25 Data/24 🔗 Binds/01 🔗 Bind.md>) and the downloaded [Tokens 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) that match that [Schema Code 🧩](<../../25 Data/Schema Codes/02 🧩 Schema Code.md>);
        - e.g., an airline may ask a user to share their passport [Token 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>).

    - **On chat hello**: 
        - when a [Broker 🤵 domain](<../../20 🧑‍🦰 UI/03 🤵 Brokers/$ 🤵 Broker domain.md>) initiates a chat session with a [Consumer 💼 domain](<$ 💼🎭 Consumer role.md>), it automatically shares the [Tokens 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) issued by that [Consumer 💼 domain](<$ 💼🎭 Consumer role.md>) if the [Token's Schema Code 🧩](<../../25 Data/Schema Codes/02 🧩 Schema Code.md>) is marked as SELF;
        - e.g., booking and ticket [Schema Codes 🧩](<../../25 Data/Schema Codes/02 🧩 Schema Code.md>) typically allow users to tap on for check-in when arrival at the place of destination, like a restaurant.

    - **When users tap/scan offline Tokens**: 
        - when users tap or scan an offline [Token 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) on a scanner of a [Consumer 💼 domain](<$ 💼🎭 Consumer role.md>) (e.g., a printed flight ticket at an airport gate), the [Consumer 💼 domain](<$ 💼🎭 Consumer role.md>) can validate the [Token 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) without the need for a chat or any interactions with the [user's Broker 🤵 domain](<../../20 🧑‍🦰 UI/03 🤵 Brokers/$ 🤵 Broker domain.md>).

    - **When users tap Userables**: 
        - when users tap a [Userable 💍](<../../70 🌳 Ambient/74 💍 Brand Userables/01 💍 Userable thing.md>) on the scanner of a [Consumer 💼 domain](<$ 💼🎭 Consumer role.md>) (e.g., a wristband at an airport gate), the [Consumer 💼 domain](<$ 💼🎭 Consumer role.md>) can ask the [user's Custodian 🧳 domain](<../../70 🌳 Ambient/71 💠 Brand Things/05 🧳🗄️ Custodian vault.md>) to silently share all [Tokens 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) marked as public by the user and matching a list of expected [Schema Codes 🧩](<../../25 Data/Schema Codes/02 🧩 Schema Code.md>);
...
1. **Can Consumers use SELF Tokens to tracked domains?**
    ...
    - [Tokens 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) using a [Schema Code 🧩](<../../25 Data/Schema Codes/02 🧩 Schema Code.md>) marked as SELF are silently shared with [Consumer 💼 domains](<$ 💼🎭 Consumer role.md>), who can then track users;
...
1. **How can Consumers validate the data schema when consuming?**
    ...
    When consuming data from a [Vault 🗄️ domain](<../80 🗄️ Vaults/$ 🗄️🎭 Vault role.md>), the data envelope indicates the [Schema Code 🧩](<../../25 Data/Schema Codes/02 🧩 Schema Code.md>) and the version (e.g., `any-authority.com/any-schema:1.0`). 
    
    - The code identifies the [domain Manifest 📜](<../../40 👥 Domains/44 📜 Manifests/$ 📜 Domain Manifest.md>) where the [Schema Code 🧩](<../../25 Data/Schema Codes/02 🧩 Schema Code.md>) is defined (e.g., `any-schema` is defined in the [domain Manifest 📜](<../../40 👥 Domains/44 📜 Manifests/$ 📜 Domain Manifest.md>) of `any-authority.com`), so [Consumer 💼 domains](<$ 💼🎭 Consumer role.md>) can then fetch the schema definitions from a cached [Graph 🕸 domain](<../../45 🛠️ Helper domains/40 🕸 Graphs/$ 🕸🛠️ Graph helper.md>) or directly from the [Manifest 📜](<../../40 👥 Domains/44 📜 Manifests/$ 📜 Domain Manifest.md>).
...
1. **How do Consumers verify a Token's signature?**
    ...
    When issuing [Tokens 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>), the [Issuer 🎴 domains](<../40 🎴 Issuers/$ 🎴🎭 Issuer role.md>) sign them with the same key-pair used in their [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) public key. 
    - Other [domains 👥](<../../40 👥 Domains/41 📨 Messages/00 👥 Domain.md>) can use the [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) key to verify the signature on the [Token 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>).
...
1. **Can Consumers verify Tokens when Issuers are offline?**
    ...
    - NLWeb advocates for domains to ask [Graph 🕸 domains](<../../45 🛠️ Helper domains/40 🕸 Graphs/$ 🕸🛠️ Graph helper.md>) for the [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) of the [Issuer 🎴 domain](<../40 🎴 Issuers/$ 🎴🎭 Issuer role.md>) when verifying [Tokens 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>). 
...
1. **Can Consumers verify Tokens when Issuers rotate a DKIM?**
    ...
    [Graph 🕸 domains](<../../45 🛠️ Helper domains/40 🕸 Graphs/$ 🕸🛠️ Graph helper.md>) will find the [DKIM 📺](<../../../2 🏔️ Landscape/2 🧑‍🦰 User landscape/08 🔐 Passwordless ID landscape/07 📺 Email DKIM.md>) of the [Issuer 🎴 domain](<../40 🎴 Issuers/$ 🎴🎭 Issuer role.md>) that was in use when the [Token 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) was issued.
...
1. **Why aren't all Tokens validated online?**
    ...
    In scenarios where physical gates need to allow for large influx of people (e.g., a concert or a subway station), it is quicker to validate the [Tokens 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) offline at the edge, opening the gate if the [Token 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) seems valid. 
    
    * The [Consumer 💼 domain](<$ 💼🎭 Consumer role.md>) may then perform an asynchronous validation of the [Token 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>), marking it as expired in a local database so that the passage is blocked on the next pass.
...
1. **Can Consumers verify if a Token was issued to the holder?**
    ...
    - Certain scenarios require the [Consumer 💼 domain](<$ 💼🎭 Consumer role.md>) to verify if the person holding the [Token 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) is the person to whom the [Token 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) was issue to - e.g.:
...
1. **How do sellers prevent swapping of identity Tokens?**
    ...
    [Seller 💵 domains](<../70 💵 Sellers/$ 💵🎭 Seller role.md>) can prevent frauds where users share their [Tokens 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) with someone else.
    ...
    - the [Seller 💵 domain](<../70 💵 Sellers/$ 💵🎭 Seller role.md>) takes a photo of the user with a fixed camera, and then asks the [Token's Identity 🆔 domain](<../../30 🫥 Agents/45 🆔 Identities/01 🆔🫥 Identity agent.md>) to match the [Token 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) with the picture.
...
1. **What API methods does a Consumer expose?**
    ...
    | [🧑‍🦰🐌 Receive](<../../../6 🅰️ APIs/30 💼🅰️ Consumer/03 🧑‍🦰🐌💼 Receive.md>) | Receive [Tokens 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) from a [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>)
...
1. **What flows does a Consumer initiate?**
    ...
    |  Flow | Purpose
    |-|-
    | [⏩🧑‍🦰 Query Vault](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/30 👉🔗 Binds/04 🧑‍🦰👉💼 Share Bind 🔗.md>) | Ask for [Schema Codes 🧩](<../../25 Data/Schema Codes/02 🧩 Schema Code.md>) in [Vaults 🗄️](<../80 🗄️ Vaults/$ 🗄️🎭 Vault role.md>) 
    | [⏩🧑‍🦰 Share Token](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/40 👉🎫 Tokens/04 🧑‍🦰👉💼 Share Token 🎫.md>) | Ask for [Tokens 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) in  [Wallet 🧑‍🦰 apps](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>) 
    | [⏩🧑‍🦰 Share ID Token](<../../../5 ⏩ Flows/90 🧑‍🦰👉 Wallets/40 👉🎫 Tokens/05 🧑‍🦰👉💼 Share Token+ID.md>) | Ask for [Identity 🆔](<../../30 🫥 Agents/45 🆔 Identities/01 🆔🫥 Identity agent.md>) bound [Tokens 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>)
    | [⏩🧑‍🦰 Token status](<05 💼⏩🤵 Token status.md>) | Ask for the status of a [Token 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>)
