...
1. **How do Consumers receive downloaded Tokens?**
    ...
    [Tokens 🎫](<../../20 🧑‍🦰 UI/25 🎫 Tokens/01 🎫 Token.md>) are shared with Consumers 💼 by [Broker 🤵 domains](<../../20 🧑‍🦰 UI/03 🤵 Brokers/$ 🤵 Broker domain.md>) in a number of ways.
...
1. **How are consumers prevented from collecting too much user data?**
    ...
    * When interacting in a [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>), [Consumer 💼 domains](<$ 💼🎭 Consumer role.md>) need to notify the [Broker 🤵 domain](<../../20 🧑‍🦰 UI/03 🤵 Brokers/$ 🤵 Broker domain.md>) of a context change before requesting data under that context.
