...
| Body      | `WalletPin`  | string | Pin displayed on the [Wallet 🧑‍🦰](<../../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>)
|           | `SyncerPin`   | string | Pin displayed on the [Syncer 🔃](<../../../90 👷 Build/01 🛠️ Syncers/01 🔃🛠️ Syncer tool.md>)
|           | `PublicKey`   | string | [Syncer 🔃](<../../../90 👷 Build/01 🛠️ Syncers/01 🔃🛠️ Syncer tool.md>) public key
|
