...
1. **Do Hosts send messages to users via web sockets?**
    ...
    No. 
    - [Host 🤗 domains](<🤗🎭 Host role.md>) send [Messages 📨](<../../../30 🧩 Data/Messages 📨/📨 Message/📨 Message.md>) via HTTPS POST to a proxy [Broker 🤵 domain](<../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🤲 Broker helper.md>) that then communicate with the user's [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>) with real-time protocols (e.g., web sockets, MQTT). 
