...
1. **What flows are initiated by Host domains?**
    ...
    | [🛠️ `Invite`](<../🤗⏩ Host flows/Invite 🤗⏩🤲/🤗 Invite ⏩ flow.md>) | Invites a [Helper 🤲 domain](<../../../45 🤲 Helper domains/$ Helpers 🤲/🤲 Helper/🤲👥 Helper domain.md>) to a [Chat 💬](<../../../35 💬 Chats/Chats 💬/💬 Chat.md>)
...
1. **What API methods are exposed by a Host domain?**
    ...
    | | [`Download`](<../🤗🅰️ Host methods/Download 🧑‍🦰🚀🤗/🤗 Download 🚀 call.md>) | Download an [Appendix 📎](<../../../35 💬 Chats/Prompts 🤔/🤔⚙️ Prompt features/6 📎 with Appendix.md>)
