...
* Activated by:
    * [❄️ Talker `FREEZE` command](<../../../35 💬 Chats/😃 Talkers/😃⚙️ Talker cmds/for flows/FREEZE ❄️ msg.md>)
    * [💳 Talker `CHARGE` command](<../../../35 💬 Chats/😃 Talkers/😃⚙️ Talker cmds/for flows/CHARGE 💳 msg.md>)
