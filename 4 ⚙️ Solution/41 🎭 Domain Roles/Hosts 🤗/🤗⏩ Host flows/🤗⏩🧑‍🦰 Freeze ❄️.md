...
* Activated by:
    * [❄️ Talker `FREEZE` command](<../../../35 💬 Chats/😃 Talkers/😃⚙️ Talker cmds/...methods 🤵/FREEZE/FREEZE ❄️ msg.md>)
    * [💳 Talker `CHARGE` command](<../../../35 💬 Chats/😃 Talkers/😃⚙️ Talker cmds/...methods 🤵/CHARGE/CHARGE 💳 msg.md>)
...
|4|[🤗🐌🤵 `Freeze@Broker`](<../../../20 🧑‍🦰 UI/Brokers 🤵/🤵🅰️ Broker methods/3 ...for Chats 💬/Freeze 🤗🐌🤵/Freeze 🅰️ method.md>) | The [Host 🤗](<../🤗🎭 Host role.md>) freezes the [Chat 💬](<../../../35 💬 Chats/💬 Chats/💬 Chat.md>)
...
|8|[🧑‍🦰🐌🤗 `Reply@Host`](<../🤗🅰️ Host methods/🧑‍🦰🐌🤗 Reply.md>) | Non-compliant [Wallets 🧑‍🦰](<../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>) may try to reply
