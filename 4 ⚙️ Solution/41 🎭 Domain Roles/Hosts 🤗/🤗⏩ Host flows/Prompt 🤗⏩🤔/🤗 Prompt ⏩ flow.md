...
| 2 | [🤵🐌📣 `Prompt@Notifier`](<../../../../20 🧑‍🦰 UI/Notifiers 📣/📣🅰️ Notifier methods/Chats 💬 Prompt 🤵🐌📣/📣 Prompt 🐌 msg.md>) | [Brokers 🤵](<../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵 Broker helper/🤵 Broker 🤲 helper.md>) push to [Wallets 🧑‍🦰](<../../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰🛠️ Wallet app.md>) via [Notifiers 📣](<../../../../20 🧑‍🦰 UI/Notifiers 📣/📣 Notifier domain/📣 Notifier 👥 domain.md>)
| 3 | [🧑‍🦰🚀🤗 `Prompted@Host`](<../../🤗🅰️ Host methods/Prompted 🧑‍🦰🚀🤗/🤗 Prompted 🚀 request.md>) | [Wallets 🧑‍🦰](<../../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰🛠️ Wallet app.md>) pull the content from the [Host 🤗](<../../🤗 Host role/🤗🎭 Host role.md>)
| 4| [🧑‍🦰🚀🤗 `Download@Host`](<../../🤗🅰️ Host methods/Download 🧑‍🦰🚀🤗/🤗 Download 🚀 request.md>) | [Wallets 🧑‍🦰](<../../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰🛠️ Wallet app.md>) download files from the [Host 🤗](<../../🤗 Host role/🤗🎭 Host role.md>)
| 5 | [🧑‍🦰🐌🤗 `Reply@Host`](<../../🤗🅰️ Host methods/Reply 🧑‍🦰🐌🤗/🤗 Reply 🐌 msg.md>) | The [Wallet 🧑‍🦰](<../../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰🛠️ Wallet app.md>) replies directly to the [Host 🤗](<../../🤗 Host role/🤗🎭 Host role.md>)
||
...
1. **Why the Prompted callback to get the Prompt?**
    ...
    - Instead, [Wallet 🧑‍🦰 apps](<../../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰🛠️ Wallet app.md>) download the [Prompt's 🤔](<../../../../35 💬 Chats/Prompts 🤔/🤔 Prompt.md>) content and attachments directly from [Host 🤗 domains](<../../🤗 Host role/🤗🎭 Host role.md>).
    - Replies to [Prompts 🤔](<../../../../35 💬 Chats/Prompts 🤔/🤔 Prompt.md>) are also sent directly to [Host 🤗 domains](<../../🤗 Host role/🤗🎭 Host role.md>) by [Wallet 🧑‍🦰 apps](<../../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰🛠️ Wallet app.md>).
