...
1. **What's the CHAT command for?**
    ...
    The `CHAT` command
    * sets the [`$.Chat` 🧠 holder](<../../../../37 Scripts 📃/📃 Holders 🧠/System holders 🔩/$.Chat 💬/💬 $.Chat 🧠 holder.md>) holder
...
1. **When is the CHAT command used?**
    ...
    |[Helper 🤲 domain](<../../../../45 🤲 Helper domains/$ Helpers 🤲/🤲 Helper/🤲👥 Helper domain.md>) | [`Invited@Host`](<../../../../41 🎭 Domain Roles/Hosts 🤗/🤗🧩 Host schemas/🧩 HOST.md>)
