...
1. **What's an example?**
    ...
    | - | - | - |
    | [🤗 Host](<../../🤗 Host role/🤗🎭 Host role.md>) | 😃 Joyful? [Yes, No] | > Yes
    | [🤗 Host](<../../🤗 Host role/🤗🎭 Host role.md>) | ℹ️ Changing to neutral.
    | [🤗 Host](<../../🤗 Host role/🤗🎭 Host role.md>) | 😶 Now neutral? [Yes, No] | > Yes
    | [🤗 Host](<../../🤗 Host role/🤗🎭 Host role.md>) | 😶 Still neutral? [Yes, No] | > Yes
    |
