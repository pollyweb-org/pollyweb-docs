...
*  verified with the `PublicKey` from [`Hello@Host`](<../🤵🐌🤗 Hello/🤵🐌🤗 Hello.md>)
...
| [`Appendix`](<../../../../35 💬 Chats/🤔 Prompts/🤔⚙️ Prompt features/5 📎 with Appendix.md>)| uuid   | File to download via [`Download@Host`](<../🧑‍🦰🚀🤗 Download/🧑‍🦰🚀🤗 Download.md>)
...
|Property|Type|Description
|-|-|-
| `ID`          | string  | ID of the [option](<../../../../35 💬 Chats/🤔 Prompts/🤔⚙️ Prompt features/4 🔘 with Options.md>) for [`Reply@Host`](<../🧑‍🦰🐌🤗 Reply/🧑‍🦰🐌🤗 Reply.md>)
