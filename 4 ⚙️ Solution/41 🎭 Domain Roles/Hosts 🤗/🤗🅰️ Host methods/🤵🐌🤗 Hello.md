...
> Used by:
> <br/>• [🧑‍🦰👉🤗 Scan host QR @ Wallet](<../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰💬 Wallet chats/...in App 🏠/🔆🤗 Tap host locator.md>)
> <br/>• [🧑‍🦰👉🤗 Scan printer QR @ Wallet](<../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰💬 Wallet chats/...in App 🏠/🔆🖨️ Tap alias locator.md>)
...
| 😃 [`TALK`](<../../../35 💬 Chats/😃 Talkers/😃⚙️ Talker cmds/for handlers/TALK 😃.md>) | Start a [Talker 😃](<../../../35 💬 Chats/😃 Talkers/😃 Talker role.md>)
| 🫡 [`TRUSTS`](<../../../35 💬 Chats/😃 Talkers/😃⚙️ Talker cmds/for handlers/TRUSTS 🫡.md>) | Assert a [Trust 🫡](<../../../30 🧩 Data/Trusts 🫡/🫡 Domain Trust.md>) on 
|