...
> Implemented by the [`Home` 📃 script](<../../🤗📃 Host scripts/...handlers/🤗📃 Home handler.md>)

> Shows the main menu of the [Host 🤗 domain](<../../🤗🎭 Host role.md>).

> Used by:
* [🧑‍🦰👉🗄️ Unbind](<../../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰💬 Wallet chats/...in Vaults 🗄️/💬🤵 Unbind 🗄️ chat.md>) flow
* [🧑‍🦰👉🤵 Remove Token](<../../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰💬 Wallet chats/...in Tokens 🎫/💬🤵 Remove 🎫 chat.md>) flow
...
|Body  |`Chat`   |uuid  | [Chat 💬](<../../../../35 💬 Chats/💬 Chats/💬 Chat.md>) ID from [`Hello@Host`](<../🤵🐌🤗 Hello/🤵🐌🤗 Hello.md>)
|
