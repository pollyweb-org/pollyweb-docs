...
1. **What is a Supplier domain role in NLWeb?**
    ...
    A [domain 👥](<../../40 👥 Domains/41 📨 Messages/00 👥 Domain.md>) with a [Supplier 🏭 role](<$ 🏭🎭 Supplier role.md>) is 
...
1. **What are examples of Suppliers?**
    ...
    * [Courier 🛵 suppliers](<../../../3 🤝 Use Cases/02 🍲 Eat & Drink/70 🍕 Order pizza/82 🛵 Driver: Pick-up.md>) accept orders to deliver pizzas, as requested by a [Concierge 🛎️ domain](<../../50 🫥 Agents/25 🛎️ Concierges/01 🛎️🫥 Concierge agent.md>). 
...
1. **What are examples of order requesters?**
    ...
    * When users have tasks to complete, [Concierge 🛎️ domains](<../../50 🫥 Agents/25 🛎️ Concierges/01 🛎️🫥 Concierge agent.md>) send order requests to [Supplier 🏭 domains](<$ 🏭🎭 Supplier role.md>) for them to perform steps in those tasks.
