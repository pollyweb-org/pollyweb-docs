...
|           | `To`          | string    | [Host 🤗 domain](<$ 🤗🎭 Host role.md>) from:<br/>- [`Hello@Host`](<51 🤵🐌🤗 Hello@Host.md>) <br/>- [`Invited@Helper`](<../../../6 🅰️ APIs/49 🛠️🅰️ Helper/11 🤵🐌🛠️ Invited.md>) <br/>-  [`Disclose@Vault`](<../80 🗄️ Vaults/53 🤵🐌🗄️ Disclose@Vault.md>)
