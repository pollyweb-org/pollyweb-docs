...
| # | Call | Notes
|-|-|-
|1|[🤗⏩🧑‍🦰 Prompt 🐶](<01 🤗⏩🧑‍🦰 Prompt 🤔 flow.md>) | The [Host 🤗](<$ 🤗🎭 Host role.md>) sends a first dog 🐶 prompt
|2|[🤗⏩🧑‍🦰 Prompt 🐱](<01 🤗⏩🧑‍🦰 Prompt 🤔 flow.md>) | The [Host 🤗](<$ 🤗🎭 Host role.md>) sends a second cat 🐱 prompt
...
|5|[🤗⏩🧑‍🦰 Prompt 🐠](<01 🤗⏩🧑‍🦰 Prompt 🤔 flow.md>) | The [Host 🤗](<$ 🤗🎭 Host role.md>) sends a third fish  prompt 🐠
