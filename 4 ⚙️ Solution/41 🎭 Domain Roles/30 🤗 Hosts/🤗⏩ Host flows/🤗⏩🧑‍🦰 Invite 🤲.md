...
The associated [Talker 😃](<../../../../9 😃 Talkers/10 😃 Talker.md>) is as follows.
...
|-|-
| ℹ️ [`INFO`](<../../../35 Chats/20 🤔 Prompts/4 ⚠️ Status prompts/21 ℹ️ INFO prompt.md>) | To show the messages to the user.
| 🛠️ [`INVITE`](<../../../../9 😃 Talkers/😃📨 Talker msgs/46 🤲 INVITE msg.md>) | To collect a random number.
|
