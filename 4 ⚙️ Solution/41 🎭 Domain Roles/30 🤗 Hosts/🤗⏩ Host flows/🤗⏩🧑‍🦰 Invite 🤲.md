...
* Used in:
    * [💼⏩🧑‍🦰 Share Token+ID @ Consumer](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰👉 Wallet flows/40 👉🎫 Tokens/05 🧑‍🦰👉💼 Share Token+ID.md>) flow
  
* Examples: 
    * [Split bill at a restaurant 🍽️](<../../../../3 🤝 Use Cases/02 🍲 Eat & Drink/60 🍽️ Restaurants/74 💳 Pay: Split bill ✂️.md>) use case
    * [Confused senior user 👴🏻](<../../../25 Locators/4 💍 Userables/💍⏩ Userable flows/💍📱 Senior user.md>) use case for [Userable 💍 things](<../../../25 Locators/4 💍 Userables/💍💠 Userable thing.md>)
...
The associated [Talker 😃](<../../../90 👷 Build/3 😃 Talkers/😃 Talker.md>) is as follows.
...
| 🛠️ [`INVITE`](<../../../90 👷 Build/3 😃 Talkers/😃📨 Talker msgs/46 🤲 INVITE msg.md>) | To collect a random number.
|
