...
* Activated by:
    * [❄️ Talker `FREEZE` command](<../../../55 👷 Build domains/3 😃 Talkers/😃📨 Talker msgs/42 ❄️ FREEZE msg.md>)
    * [💳 Talker `CHARGE` command](<../../../55 👷 Build domains/3 😃 Talkers/😃📨 Talker msgs/53 💳 CHARGE msg.md>)
