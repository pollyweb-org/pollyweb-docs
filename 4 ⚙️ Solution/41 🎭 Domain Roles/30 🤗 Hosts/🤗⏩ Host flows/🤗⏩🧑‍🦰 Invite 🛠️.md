...
* A [Host 🤗 domain](<../🤗🎭 Host role.md>) 
    * invites a [Helper 🛠️ domain](<../../../45 🤲 Helper domains/$ 🤲 Helpers/🛠️👥 Helper domain.md>) 
...
| 🤵 [Broker](<../../../45 🤲 Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) | 🫥 [Allow invited guest?](<🤗⏩🧑‍🦰 Invite 🛠️.md>) [Yes, No]  <br/> - Any Helper 🛠️ <br/>- [ Always ] for Any Host  🤗 | > Yes
...
|3| [🤵🐌🛠️ `Invited@Helper`](<../../../45 🤲 Helper domains/$ 🤲 Helpers/🛠️🅰️ Helper methods/🤵🐌🛠️ Invited.md>) | Proxy  invites to [Helper 🛠️](<../../../45 🤲 Helper domains/$ 🤲 Helpers/🛠️👥 Helper domain.md>) invitees
