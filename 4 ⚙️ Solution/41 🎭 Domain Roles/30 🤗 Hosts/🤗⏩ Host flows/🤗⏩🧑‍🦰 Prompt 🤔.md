...
* A [Host 🤗 domain](<../🤗🎭 Host role.md>) 
    ...
    * with a [Prompt 🤔](<../../../35 Chats/20 🤔 Prompts/🤔 Prompt.md>).
...
Consider the following [Chat 💬](<../../../35 Chats/12 💬 Chats/💬 Chat.md>) with two [Prompts 🤔](<../../../35 Chats/20 🤔 Prompts/🤔 Prompt.md>) as an example.
...
| # | Call | Description
|-|-|-
| 1 | [🤗🐌🤵 `Prompt@Broker`](<../../../45 🤲 Helper domains/24 🤵 Brokers/🤵🅰️ Broker methods/30 🤵🅰️ Chats 💬/🤗🐌🤵 Prompt.md>) | [Hosts 🤗](<../🤗🎭 Host role.md>) tell [Brokers 🤵](<../../../45 🤲 Helper domains/24 🤵 Brokers/🤵🤲 Broker helper.md>) of [Prompt 🤔](<../../../35 Chats/20 🤔 Prompts/🤔 Prompt.md>) intents
...
1. **Why the Prompted callback to get the Prompt?**
    ...
    `Privacy` To protect the user's privacy, the content of the [Prompts 🤔](<../../../35 Chats/20 🤔 Prompts/🤔 Prompt.md>) is not proxied via [Broker 🤵 domains](<../../../45 🤲 Helper domains/24 🤵 Brokers/🤵🤲 Broker helper.md>).
    - Instead, [Wallet 🧑‍🦰 apps](<../../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) download the [Prompt's 🤔](<../../../35 Chats/20 🤔 Prompts/🤔 Prompt.md>) content and attachments directly from [Host 🤗 domains](<../🤗🎭 Host role.md>).
    - Replies to [Prompts 🤔](<../../../35 Chats/20 🤔 Prompts/🤔 Prompt.md>) are also sent directly to [Host 🤗 domains](<../🤗🎭 Host role.md>) by [Wallet 🧑‍🦰 apps](<../../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>).
