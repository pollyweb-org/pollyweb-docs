...
|           | `Binds`   | uuid[] | List of [Binds 🔗](<../../../30 Data/2 🔗 Binds/🔗 Bind.md>) for a [Vault 🗄️](<../../80 🗄️ Vaults/🗄️🎭 Vault role.md>) host
|           | `Tokens`  | uuid[] | List of [Tokens 🎫](<../../../30 Data/3 🎫 Tokens/🎫 Token.md>) for an [Issuer 🎴](<../../40 🎴 Issuers/🎴🎭 Issuer role.md>) host
