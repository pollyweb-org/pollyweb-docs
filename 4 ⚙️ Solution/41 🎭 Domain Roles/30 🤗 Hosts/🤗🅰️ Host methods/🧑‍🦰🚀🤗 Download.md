...
> Downloads the content of an [Appendix 📎](<../../../35 Chats/🤔 Prompts/1 📘 Prompt features/05 📎 with Appendix.md>).
...
|| `FileID`    | uuid      | [Appendix 📎](<../../../35 Chats/🤔 Prompts/1 📘 Prompt features/05 📎 with Appendix.md>) from [`Prompted@Host`](<🧑‍🦰🚀🤗 Prompted.md>)
|
