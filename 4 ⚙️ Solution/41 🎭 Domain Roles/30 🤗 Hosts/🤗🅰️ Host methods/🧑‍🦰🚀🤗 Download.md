...
> Downloads the content of an [Appendix 📎](<../../../35 Chats/🤔 Prompts/🤔📘 Prompt features/05 📎 with Appendix.md>).
...
|| `FileID`    | uuid      | [Appendix 📎](<../../../35 Chats/🤔 Prompts/🤔📘 Prompt features/05 📎 with Appendix.md>) from [`Prompted@Host`](<🧑‍🦰🚀🤗 Prompted.md>)
|
