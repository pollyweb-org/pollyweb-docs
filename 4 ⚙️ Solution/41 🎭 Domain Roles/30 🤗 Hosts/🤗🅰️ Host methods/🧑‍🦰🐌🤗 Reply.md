...
> A [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) replies to a [Prompt 🤔](<../../../../9 😃 Talkers/10 📘 Talker specs/20 🤔 Prompt.md>) of a [Host 🤗 domain](<../🤗🎭 Host role.md>) in a [Chat 💬](<../../../35 Chats/12 💬 Chats/$ 💬 Chat.md>).
