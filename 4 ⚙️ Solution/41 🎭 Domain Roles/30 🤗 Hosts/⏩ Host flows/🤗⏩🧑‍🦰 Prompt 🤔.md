...
| 2 | [🤵🐌📣 `Prompt@Notifier`](<../../../20 🧑‍🦰 UI/02 📣 Notifiers/🅰️ Notifier methods/2 💬 Chats/2 🤵🐌📣 Prompt.md>) | [Brokers 🤵](<../../../45 🛠️ Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) push to [Wallets 🧑‍🦰](<../../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) via [Notifiers 📣](<../../../20 🧑‍🦰 UI/02 📣 Notifiers/📣 Notifier domain.md>)
| 3 | [🧑‍🦰🚀🤗 `Prompted@Host`](<../🅰️ Host methods/54 🧑‍🦰🚀🤗 Prompted@Host.md>) | [Wallets 🧑‍🦰](<../../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) pull the content from the [Host 🤗](<../$ 🤗🎭 Host role.md>)
| 4| [🧑‍🦰🚀🤗 `Download@Host`](<../🅰️ Host methods/56 🧑‍🦰🚀🤗 Download@Host.md>) | [Wallets 🧑‍🦰](<../../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) download files from the [Host 🤗](<../$ 🤗🎭 Host role.md>)
| 5 | [🧑‍🦰🐌🤗 `Reply@Host`](<../🅰️ Host methods/55 🧑‍🦰🐌🤗 Reply@Host.md>) | The [Wallet 🧑‍🦰](<../../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) replies directly to the [Host 🤗](<../$ 🤗🎭 Host role.md>)
||
