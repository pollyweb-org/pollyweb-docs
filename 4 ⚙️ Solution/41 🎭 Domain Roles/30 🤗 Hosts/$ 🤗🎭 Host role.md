...
1. **Do Hosts send messages to users via web sockets?**
    ...
    No. 
    - [Host 🤗 domains](<$ 🤗🎭 Host role.md>) send [Messages 📨](<../../40 👥 Domains/41 📨 Messages/$ 📨 Domain Message.md>) via HTTPS POST to a proxy [Broker 🤵 domain](<../../45 🛠️ Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) that then communicate with the user's [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) with real-time protocols (e.g., web sockets, MQTT). 
...
1. **What proxy services are involved in the flow?**
    ...
    [Messages 📨](<../../40 👥 Domains/41 📨 Messages/$ 📨 Domain Message.md>) sent from [Host 🤗 domains](<$ 🤗🎭 Host role.md>) first reach the user's [Broker 🤵 domain](<../../45 🛠️ Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) via HTTPS POST:
...
1. **Are chat prompt messages encrypted from Hosts to Wallets?**
    ...
    Not applicable - [Host 🤗 domains](<$ 🤗🎭 Host role.md>) don't send [Messages 📨](<../../40 👥 Domains/41 📨 Messages/$ 📨 Domain Message.md>) to [Wallet 🧑‍🦰 apps](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>). 
    ...
    * When the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) app receives the intent from the [Notifier 📣 domain](<../../20 🧑‍🦰 UI/02 📣 Notifiers/📣 Notifier domain.md>), it pulls the [Message 📨](<../../40 👥 Domains/41 📨 Messages/$ 📨 Domain Message.md>) content directly from the [Host 🤗 domain](<$ 🤗🎭 Host role.md>) with a synchronous HTTPS call. 

    * This keeps the [Broker 🤵 domain](<../../45 🛠️ Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) and the [Notifier 📣 domain](<../../20 🧑‍🦰 UI/02 📣 Notifiers/📣 Notifier domain.md>) in the dark regarding the content of the [Message 📨](<../../40 👥 Domains/41 📨 Messages/$ 📨 Domain Message.md>) (even in the event of a cryptography attack) because no content actually passes by these proxy services.
...
1. **Are chat reply messages encrypted from Wallets to Hosts?**
    ...
    - Although the user's [Messages 📨](<../../40 👥 Domains/41 📨 Messages/$ 📨 Domain Message.md>) content is JSON not encrypted, it is sent over HTTPS POST directly from the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) to the [Host 🤗 domain](<$ 🤗🎭 Host role.md>).
...
1. **What flows are initiated by Host domains?**
    ...
    | Flow ⏩ | Description
    |-|-
    | [🤔 `Prompt`](<⏩ Host flows/31 🤗⏩🧑‍🦰 Prompt 🤔 flow.md>) | Sends a [Prompt 🤔](<../../../9 😃 Talkers/10 📘 Talker specs/20 🤔 Prompt.md>) to a user [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>)
    | [🛠️ `Invite`](<⏩ Host flows/33 🤗⏩🧑‍🦰 Invite 🛠️ flow.md>) | Invites a [Helper 🛠️ domain](<../../45 🛠️ Helper domains/$ 🛠️ Helpers/$ 🛠️👥 Helper domain.md>) to a [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>)
    ...
    | [❄️ `Freeze`](<⏩ Host flows/36 🤗⏩🧑‍🦰 Freeze ❄️ flow.md>) | Blocks changes on all previous [Inputs ✏️](<../../../9 😃 Talkers/20 🤔 Prompts/1 📘 Prompt specs/09 ✏️ as Input.md>)
    | [👋 `Goodbye`](<⏩ Host flows/37 🤗⏩🧑‍🦰 Goodbye 👋 flow.md>) | Triggers the [advertising 👀](<../../45 🛠️ Helper domains/12 👀 Advertisers/$ 👀👥 Advertiser helper.md>) flow
...
1. **What API methods are exposed by a Host domain?**
    ...
    |-|-|-
    |[🤵 Broker](<../../45 🛠️ Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) | [`Hello`](<🅰️ Host methods/51 🤵🐌🤗 Hello@Host.md>) | The user started a [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>)
    | | [`Home`](<🅰️ Host methods/52 🤵🐌🤗 Home@Host.md>) | Show the top menu on the [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>)
    | | [`Abandoned`](<🅰️ Host methods/53 🤵🐌🤗 Abandoned@Host.md>) |  The user abandoned a [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>)
    | | [`Summarize`](<🅰️ Host methods/60 🤵🐌🤗 Summarize@Host.md>) | Return a [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) advertising summary
    |[🧑‍🦰 Wallet](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) | [`Prompted`](<🅰️ Host methods/54 🧑‍🦰🚀🤗 Prompted@Host.md>) | Return a [Prompt's 🤔](<../../../9 😃 Talkers/10 📘 Talker specs/20 🤔 Prompt.md>) content
    | | [`Reply`](<🅰️ Host methods/55 🧑‍🦰🐌🤗 Reply@Host.md>) | Accept the reply to a [Prompt 🤔](<../../../9 😃 Talkers/10 📘 Talker specs/20 🤔 Prompt.md>)
    | | [`Download`](<🅰️ Host methods/56 🧑‍🦰🚀🤗 Download@Host.md>) | Download an [Appendix 📎](<../../../9 😃 Talkers/20 🤔 Prompts/1 📘 Prompt specs/05 📎 with Appendix.md>)
    [🖐️ Palmist](<../../60 🧰 Edge/63 🖐️ Palmists/01 🖐️🔌 Palmist device.md>) | [`Found`](<🅰️ Host methods/58 🖐️🐌🤗 Found@Host.md>) | A [Palmist 🖐️](<../../60 🧰 Edge/63 🖐️ Palmists/01 🖐️🔌 Palmist device.md>) found the Chat's user
    [⭐ Reviewer](<../../50 🫥 Agents/73 ⭐ Reviewers/⭐🫥 Reviewer agent.md>) | [`Rated`](<🅰️ Host methods/59 ⭐🐌🤗 Rated@Host.md>) | The [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) received user reviews
