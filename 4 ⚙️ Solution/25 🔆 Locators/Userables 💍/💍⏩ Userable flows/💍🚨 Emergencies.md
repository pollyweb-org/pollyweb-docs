...
1. **How is the [Chat 💬](<../../../35 💬 Chats/Chats 💬/💬 Chat.md>)?**
    ...
    | 🪄 [Wand](<../../../45 🤲 Helper domains/Wands 🪄/🪄🤲 Wand helper.md>) | [📍 Share location?](<../../../35 💬 Chats/Prompts 🤔/🤔✏️ Prompt inputs/LOCATION 📍/LOCATION 📍 prompt.md>) [Yes, No] | > Yes
...
1. **How does it work?**
    ...
    |#|Category|Step
    |-|-|-
    |1| `Tap NFC` | A guest user [taps 🔆](<../../Locators 🔆/🔆⏩ Locator flows/🧑‍🦰🔆 Wallet NFC tap.md>) the [rotating NFC tag 📺](<../../../../2 🏔️ Landscape/1 💼 Business landscape/11 🔆 Scanning landscape/11 📺 NFC authentication.md>) of the [Userable 💍 thing](<../💍💠 Userable thing.md>) with their [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰🛠️ Wallet app.md>).
...
1. **How are Userable owners protected from harassment frauds?**
    ...
    * by a [trusted 🫡](<../../../30 🧩 Data/Trusts 🫡/🫡 Domain Trust.md>) [Identity 🆔 domain](<../../../50 🫥 Agent domains/Identities 🆔/🆔🫥 Identity agent.md>).
