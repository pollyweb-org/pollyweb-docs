...
1. **How can a confused senior user leverage their Userables?**
    ...
    * FindMy apps (e.g., Apple) and [UWB tags 📺](<../../../../2 🏔️ Landscape/3 🌳 Ambient landscape/02 🔑 Smart Keys/11 📺 Apple Key UWB.md>)  can't help, because the owner typically needs another of his authenticated devices (e.g., a phone, a tablet, or laptop).
    ...
    With NLWeb, the person can ask anyone else (e.g., the staff from a restaurant nearby) to use their [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>) and [tap 🔆](<../../Locators 🔆/🔆⏩ Locator flows/🧑‍🦰🔆 Wallet NFC tap.md>) one of the person's [Userable 💍 things](<../💍💠 Userable thing.md>) (e.g., wedding ring, neckless, watch) in order to:
    ...
    - see the current location of their [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>) (like Apple Find My), 
    - and remotely ring their [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>) (like Apple Find My). 
