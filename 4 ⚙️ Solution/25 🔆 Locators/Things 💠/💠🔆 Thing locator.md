...
1. **What is a Thing?**
    ...
    A Thing 💠 
    * is an [🔆 NFC/QR Locator](<../Locators 🔆/🔆 Locator.md>) 
    * brought to life by a [Wand 🪄 domain](<../../45 🤲 Helper domains/Wands 🪄/🪄🤲 Wand helper.md>)
...
1. **What are examples of Things?**
    ...
    - **[💠 Standard Things](<💠🔆 Thing locator.md>)**: 
    ...
    - [**💍 Userable specialization**](<../Userables 💍/💍💠 Userable thing.md>): 
        - besides supporting all features of standard Things 💠, [Userables 💍](<../Userables 💍/💍💠 Userable thing.md>) allow users without a smart device to make payments and access restricted areas, and are typically an NFC embedded into objects that a user may carry;
          - e.g.: jewelry, glasses, key holders.

    - [**⌚ Tapbands**](<../Tapbands ⌚/⌚💠 Tapband thing.md>): 
        - besides supporting all features of [Userables 💍](<../Userables 💍/💍💠 Userable thing.md>), a [⌚ Tapband](<../Tapbands ⌚/⌚💠 Tapband thing.md>) allow users to also open [Padlocks 🔒](<../../70 🌳 Ambient/75 🔒 Padlocks/$ 🔒 Padlock device.md>) while assuring users cannot be traced between interactions with [Host 🤗 domains](<../../41 🎭 Domain Roles/Hosts 🤗/🤗 Host role/🤗🎭 Host role.md>).


    - [**🤖 Robot specialization**](<../Robots 🤖/🤖💠 Robot thing.md>): 
        - besides supporting all features of standard Things 💠, [🤖 Robots](<../Robots 🤖/🤖💠 Robot thing.md>) can be embed into physical devices to enable them to be controlled remotely, even without a display; 
...
1. **What can a user do with a Thing?**
    ...
    Owner features, available via their [Custodian 🧳 agent](<../../50 🫥 Agent domains/Custodians 🧳/🧳🫥 Custodian agent.md>):
...
1. **How cans Things make a vintage book smarter?**
    ...
    |#|Category|Step
    |-|-|-
    |1| `Order` | A [Printer 🖨️ domain](<../../45 🤲 Helper domains/Printers 🖨️/🖨️🤲 Printer helper.md>) orders a [Chat 💬](<../../35 💬 Chats/Chats 💬/💬 Chat.md>) interaction from a [Wand 🪄 helper domain](<../../45 🤲 Helper domains/Wands 🪄/🪄🤲 Wand helper.md>). 
    |2| `Create` | The [Wand 🪄 domain](<../../45 🤲 Helper domains/Wands 🪄/🪄🤲 Wand helper.md>) creates a [Thing 💠](<💠🔆 Thing locator.md>) and shares its [digital Locator 🔆](<../Locators 🔆/🔆 Locator.md>). |
    ...
    |6| `Register` | The user scans it with their [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰🛠️ Wallet app.md>) to register on their [Custodian 🧳 vault](<../../50 🫥 Agent domains/Custodians 🧳/🧳🫥 Custodian agent.md>).
...
1. **How can Things make a dog collar smarter?**
    ...
    |#|Category|Step
    |-|-|-
    |1| `Create` | A [Brand 🍏 domain](<../../41 🎭 Domain Roles/Brands 🍏/🍏🎭 Brand role.md>) orders a [Thing 💠](<💠🔆 Thing locator.md>) from a [Wand 🪄 helper domain](<../../45 🤲 Helper domains/Wands 🪄/🪄🤲 Wand helper.md>). 
    ...
    |5| `Register` | The user scans it with their [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰🛠️ Wallet app.md>) to register on their [Custodian 🧳 vault](<../../50 🫥 Agent domains/Custodians 🧳/🧳🫥 Custodian agent.md>).
