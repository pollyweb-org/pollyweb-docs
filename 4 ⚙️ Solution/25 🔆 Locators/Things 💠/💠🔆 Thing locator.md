...
1. **How cans Things make a vintage book smarter?**
    ...
    |6| `Register` | The user scans it with their [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>) to register on their [Custodian 🧳 vault](<../../50 🫥 Agent domains/Custodians 🧳/🧳🫥 Custodian agent.md>).
...
1. **How can Things make a dog collar smarter?**
    ...
    |5| `Register` | The user scans it with their [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>) to register on their [Custodian 🧳 vault](<../../50 🫥 Agent domains/Custodians 🧳/🧳🫥 Custodian agent.md>).
