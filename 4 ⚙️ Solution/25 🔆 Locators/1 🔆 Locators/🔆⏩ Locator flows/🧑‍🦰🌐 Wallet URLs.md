...
1. **What if an NLWeb Wallet is not installed in the device?**
    ...
    NLWeb advocates for developers to use the redirect script at `https://nlweb.org/go/` so that users without an installed [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) can fallback to a page with instructions on how to install one. 
...
1. **How can website developers add NLWeb links?**
    ...
    * Website developers can also opt to link the JavaScript library `https://nlweb.org/sdk/nlweb.js` - this allows [Wallets 🧑‍🦰](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) to achieve the same behavior without browser redirects.
