...
1. **How can app developers handle NLWeb URLs?**
    ...
    * When installing, [Wallet 🧑‍🦰 apps](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) register themselves to handle the `nlweb` protocol - if more than one app is able to handle the protocol, then the Operating System (OS) asks the user to select one of the apps. 
...
1. **What if an NLWeb Wallet is not installed in the device?**
    ...
    NLWeb advocates for developers to use the redirect script at `https://nlweb.org/go/` so that users without an installed [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) can fallback to a page with instructions on how to install one. 
    
    * If a user with an NLWeb [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) installed navigates to a redirect link (e.g., `https://nlweb.org/go/ABC`), the browser redirects to a `nlweb` URL, signaling the OS to open the [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) - the [Wallet 🧑‍🦰](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) then opens with a [Chat 💬](<../../../35 💬 Chats/💬 Chats/💬 Chat.md>) to the link's host. 
...
1. **How can website developers add NLWeb links?**
    ...
    * Website developers can also opt to link the JavaScript library `https://nlweb.org/sdk/nlweb.js` - this allows [Wallets 🧑‍🦰](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) to achieve the same behavior without browser redirects.
...
1. **What happens to NFC/QR Locators if `nlweb.org` goes down?**
    ...
    * Users using their [Wallet 🧑‍🦰 apps](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) as the default NFC/QR reader won't notice any difference, because the [Wallet 🧑‍🦰](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) will parse the destination [Host 🤗](<../../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) from the URL.
