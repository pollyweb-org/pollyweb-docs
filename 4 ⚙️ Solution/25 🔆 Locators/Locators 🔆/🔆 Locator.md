...
1. **What data is contained in a Locator?**
    ...
    * `nlweb.dom/ALIAS:1.0,any-printer.dom,ANY-KEY`
    ...
    |-|-|-
    | `Schema` |  `.HOST` | [Schema 🧩](<../../30 🧩 Data/Codes 🧩/🧩 Schema Code.md>) for [`Schema@Graph`](<../../45 🤲 Helper domains/Graphs 🕸/🕸🅰️ Graph methods/👥🚀🕸 Schema/🕸 Schema 🚀 request.md>)
    | `Domain` | `any-host.dom` | [Domain 👥](<../../40 👥 Domains/👥 Domain/👥 Domain.md>) for a [Broker 🤵](<../../20 🧑‍🦰 UI/Brokers 🤵/🤵 Broker helper/🤵 Broker 🤲 helper.md>) to interact 
...
1. **How can users detect business impersonation attacks?**
    ...
    - Exceptionally, users will be directed to the `nlweb.dom` website if they do not have a [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>) installed on their smartphone.
