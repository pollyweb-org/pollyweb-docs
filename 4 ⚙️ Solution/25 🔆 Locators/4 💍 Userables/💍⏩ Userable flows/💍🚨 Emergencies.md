...
1. **How does it work?**
    ...
    |2| `Interact`| A [Chat 💬](<../../../35 💬 Chats/💬 Chats/💬 Chat.md>) opens with the [Userable's Wand 🪄 domain](<../../../45 🤲 Helper domains/90 🪄 Wands/🪄🤲 Wand helper.md>) (i.e., the helper defined by the [Userable's Brand 🍏 domain](<../../../41 🎭 Domain Roles/Brands 🍏/$ 🍏🎭 Brand role.md>)) - this allows the guest user to read the landing notes that the owner user left, and allowing the guest to active the emergency script defined by the owner user.
