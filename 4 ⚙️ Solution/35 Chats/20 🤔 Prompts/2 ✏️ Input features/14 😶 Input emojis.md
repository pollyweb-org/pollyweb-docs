...
1. **Are emojis mandatory in inputs?**
    ...
    * To help [Host 🤗 domain](<../../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) developers, 
        * [Talkers 😃](<../../../../9 😃 Talkers/10 😃 Talker.md>) add emojis to [`Prompted@Host`](<../../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🅰️ Host methods/🧑‍🦰🚀🤗 Prompted.md>) messages. 
...
1. **Can Talker prompts use alternative emojis?**
    ...
    The default [Talker 😃](<../../../../9 😃 Talkers/10 😃 Talker.md>) emoji `😃` can be replaced with one of the following.
