...
1. **How do client-side validations work?**
    ...
    * It's close to impossible to enforce [Wallet 🧑‍🦰 apps](<../../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) to comply with the rules across a large landscape of vendors and user interface (UI) technologies: 
...
1. **How to implement client-side validations?**
    ...
    When applicable, only minimum and maximum values are eventually implemented by [Wallet 🧑‍🦰 apps](<../../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) on a best-effort basis, given that this interval is useful when rendering HTML sliders.
