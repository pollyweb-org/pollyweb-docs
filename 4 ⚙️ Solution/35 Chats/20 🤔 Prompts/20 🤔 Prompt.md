...
> Part of a [Chat 💬](<../12 💬 Chats/$ 💬 Chat.md>) 
...
1. **What is a Prompt?**
    ...
    * is a line in [Chat 💬](<../12 💬 Chats/$ 💬 Chat.md>) 
...
1. **What input formats can Hosts ask Wallets to render?**
    ...
    Similar to HTTP, on NLWeb the [Host 🤗 domain](<../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) servers request the [Wallet 🧑‍🦰 apps](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) to render the requested [Prompts 🤔](<20 🤔 Prompt.md>).
...
1. **Can Hosts replace sent prompts?**
    ...
    - If a [Host 🤗 domain](<../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) sends  two consecutive blocking [Prompts 🤔](<20 🤔 Prompt.md>) while the user has not answered the first, then the first becomes readonly and the second becomes the active input.
    - If the [Host 🤗 domain](<../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) wants a [Prompts 🤔](<20 🤔 Prompt.md>) to be visually replaced, then they need to use a temporary [Prompts 🤔](<20 🤔 Prompt.md>), visually represented by an hourglass ⏳ emoji. 
...
1. **Can users change an answer to an answered prompt?**
    ...
    * [Chats 💬](<../12 💬 Chats/$ 💬 Chat.md>) are designed to be forward-only workloads managed by a [Host 🤗 domain](<../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) (and not by the user). 
    ...
    * However, [Host 🤗 domains](<../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) can [Freeze ❄️](<../../41 🎭 Domain Roles/30 🤗 Hosts/🤗⏩ Host flows/🤗⏩🧑‍🦰 Freeze ❄️.md>) a [Chat 💬](<../12 💬 Chats/$ 💬 Chat.md>) until a certain checkpoint.
    ...
    * ⚠️ Note: [`Options`](<1 📘 Prompt features/04 🔘 with Options.md>) with a `§` open a new [Chat 💬](<../12 💬 Chats/$ 💬 Chat.md>)  and are never frozen.
