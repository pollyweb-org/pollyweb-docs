...
1. **What is a Talker?**
    ...
    * referencing [{Functions} 🐍](<😃💾 Talker data/12 🐍 {Function}.md>) evaluated by [Hosted 📦 domains](<../../55 👷 Build domains/1 📦 Hosteds/📦👥 Hosted domain.md>)
...
1. **What flows are initiated by Talkers?**
    ...
    |Flow|Details
    |-|-
    | [😃⏩🧑‍💻 Handle 🐍](<😃⏩ Talker flows/20 😃⏩🧑‍💻 Handle 🐍.md>) | Ask [Hosteds 📦](<../../55 👷 Build domains/1 📦 Hosteds/📦👥 Hosted domain.md>) to handle [{Functions} 🐍](<😃💾 Talker data/12 🐍 {Function}.md>)
    | [😃⏩🧑‍💻 Wait ⏸️](<😃⏩ Talker flows/30 😃⏩🧑‍💻 Wait ⏸️.md>) | Allow [Hosted 📦](<../../55 👷 Build domains/1 📦 Hosteds/📦👥 Hosted domain.md>)  long-running tasks
