...
1. **What's the OFFER syntax?**
    ...
    | Argument| Purpose
    |-|-
    | `{function}`  | [{Function}](<../😃🗃️ Talker data/12 🐍 {Function}.md>) that issues the [Token 🎫](<../../../30 Data/30 🎫 Tokens/🎫 Token.md>) ID.
    | `<accepted>`| Boolean placeholder for [Accepted @ Issuer](<../../../41 🎭 Domain Roles/40 🎴 Issuers/🎴🅰️ Issuer methods/🤵🐌🎴 Accepted.md>).
