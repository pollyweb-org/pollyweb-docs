...
1. **What is a SHARE message command?**
    ...
    * that asks for user data in [Schema Codes 🧩](<../../../30 Data/10 🧩 Schema Codes/🧩 Schema Code.md>)
...
1. **What's the SHARE syntax?**
    ...
    | Argument| Purpose
    |-|-
    | `<code-n>`  | [Schema Codes 🧩](<../../../30 Data/10 🧩 Schema Codes/🧩 Schema Code.md>) for [`Query@Broker`](<../../../45 🤲 Helper domains/24 🤵 Brokers/🤵🅰️ Broker methods/60 🤵🅰️ Share/💼🐌🤵 Query.md>) <br/>For readability, a dot replaces `nlweb.org/`
...
1. **What does a [Chat 💬](<../../💬 Chats/💬 Chat.md>) look like?**
    ...
    | Data | [Schema Code 🧩](<../../../30 Data/10 🧩 Schema Codes/🧩 Schema Code.md>)
    |-|-
