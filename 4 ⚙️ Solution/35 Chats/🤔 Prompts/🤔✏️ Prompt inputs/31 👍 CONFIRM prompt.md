...
1. **What's the syntax of a `CONFIRM`?**
    ...
    | Argument| Purpose | Example
    |-|-|-
    | `Then` | [Procedure ⚙️](<../../../90 👷 Build/😃 Talkers/😃⚙️ Talker cmds/11 ⚙️ Procedure.md>) or [Command ⌘](<../../../90 👷 Build/😃 Talkers/😃⚙️ Talker cmds/10 ⌘ Command.md>) on `True` | `INFO\|OK`
    | `Else` | [Procedure ⚙️](<../../../90 👷 Build/😃 Talkers/😃⚙️ Talker cmds/11 ⚙️ Procedure.md>) or [Command ⌘](<../../../90 👷 Build/😃 Talkers/😃⚙️ Talker cmds/10 ⌘ Command.md>) on `False` | `INFO\|NOK`
