...
1. **What's the syntax of AMOUNT in a [Talker 😃](<../../../90 👷 Build/😃 Talkers/😃 Talker.md>)?**
...
1. **How does AMOUNT process money signs?**
    ...
    When collecting an [`AMOUNT`](<43 💰 AMOUNT prompt.md>) input, [Talkers 😃](<../../../90 👷 Build/😃 Talkers/😃 Talker.md>) 
