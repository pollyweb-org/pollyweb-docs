...
1. **What's the syntax of AMOUNT in a [Talker 😃](<../../../55 👷 Build domains/3 😃 Talkers/😃 Talker.md>)?**
...
1. **How does AMOUNT process money signs?**
    ...
    When collecting an [`AMOUNT`](<43 💰 AMOUNT prompt.md>) input, [Talkers 😃](<../../../55 👷 Build domains/3 😃 Talkers/😃 Talker.md>) 
