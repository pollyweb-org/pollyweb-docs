...
1. **How to default quantities in a [Chat 💬](<../../💬 Chats/💬 Chat.md>)?**
    ...
    | [🤗 Host](<../../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) | 😃 How many exactly? | ↕️ 8
    ...
    | 🔀 [`CASE`](<../../../90 👷 Build/3 😃 Talkers/😃⚙️ Talker cmds/22 🔀 CASE flow.md>) | To check the selected option.
...
1. **How does Precision work?**
    ...
    When collecting a [`QUANTITY`](<42 ↕️ QUANTITY prompt.md>) input, [Talkers 😃](<../../../90 👷 Build/3 😃 Talkers/😃 Talker.md>) 
    ...
    * and ask confirmation to the user if the value differs.
    ...
    | [🤗 Host](<../../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) | 😃 How much? | ↕️ 4.5678   
    | [🤗 Host](<../../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) | 😃 OK with `4.57`? [Yes, No] | > Yes
    | [🤗 Host](<../../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) | ℹ️ You entered `4.57`
    |
    ...
    | 🔁 [`REPEAT`](<../../../90 👷 Build/3 😃 Talkers/😃⚙️ Talker cmds/23 🔁 REPEAT flow.md>) | To repeat the input cycle forever.
...
1. **What's contained in the QUANTITY placeholder?**
    ...
    | [`$p.$`](<../../../90 👷 Build/3 😃 Talkers/😃💾 Talker data/12 🐍 {Function}.md>) | The value of `$p.Pretty` | `1,234.57`
    | `$p` | The [default value](<../../../90 👷 Build/3 😃 Talkers/😃💾 Talker data/12 🐍 {Function}.md>) `$p.$` | `1,234.57`
