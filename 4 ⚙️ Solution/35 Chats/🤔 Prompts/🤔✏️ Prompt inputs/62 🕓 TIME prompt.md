...
1. **What's the format of a [Talker 😃](<../../../90 👷 Build/3 😃 Talkers/😃 Talker.md>)?**
    ...
    | `$placeholder`| [$placeholder 💾](<../../../90 👷 Build/3 😃 Talkers/😃💾 Talker data/10 💾 $Placeholder.md>) with  ISO 8601 time | `14:23:59` 
...
1. **How to provide default time options in a [Chat 💬](<../../💬 Chats/💬 Chat.md>)?**
    ...
    The associated [Talker 😃](<../../../90 👷 Build/3 😃 Talkers/😃 Talker.md>) would be the following.
