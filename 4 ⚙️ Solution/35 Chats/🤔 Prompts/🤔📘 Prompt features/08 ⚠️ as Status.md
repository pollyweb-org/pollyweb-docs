...
1. **How do non-blocking options work?**
    ...
    - If it contains [`Options`](<04 🔘 with Options.md>), then the user may click an option any time before or after the [Host 🤗 domain](<../../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) sends other subsequent [Prompts 🤔](<../🤔 Prompt.md>).
