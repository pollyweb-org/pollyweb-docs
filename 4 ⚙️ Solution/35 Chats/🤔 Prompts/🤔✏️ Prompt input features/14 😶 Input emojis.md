...
1. **Are emojis mandatory in inputs?**
    ...
    * To help [Host 🤗 domain](<../../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) developers, 
        * [Talkers 😃](<../../../90 👷 Build/😃 Talkers/😃 Talker.md>) add emojis to [`Prompted@Host`](<../../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🅰️ Host methods/🧑‍🦰🚀🤗 Prompted.md>) messages. 
...
1. **Can Talker prompts use alternative emojis?**
    ...
    The default [Talker 😃](<../../../90 👷 Build/😃 Talkers/😃 Talker.md>) emoji `😃` can be replaced with one of the following.
