...
1. **What are Navigator domains**?
    ...
    * built from community-defined map points in [domain Manifests 📜](<../../40 👥 Domains/44 📜 Manifests/📜 Manifest.md>).
...
1. **How do Navigators help in multi-level places?**
    ...
    * Signs with [Locators 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/$ 🔆 Locator.md>) are spread through the premisses (e.g., walls, posts).
    * Users read these [navigation Locators 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/$ 🔆 Locator.md>) with their [Wallet 🧑‍🦰 apps](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>).
    * Each [navigation Locators 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/$ 🔆 Locator.md>) points to a geographical point described in a [domain Manifest 📜](<../../40 👥 Domains/44 📜 Manifests/📜 Manifest.md>).
    * Each point may point to other points in other [domain Manifests 📜](<../../40 👥 Domains/44 📜 Manifests/📜 Manifest.md>).
