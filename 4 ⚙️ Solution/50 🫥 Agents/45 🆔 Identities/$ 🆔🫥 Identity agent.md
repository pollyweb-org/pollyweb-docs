...
1. **Can users with dual nationality bind to two Identity domains?**
    ...
    Yes. 
    * Users with dual nationality may even have two or more bound [Identity 🆔 vault](<../../../../../../../4 ⚙️ Solution/50 🫥 Agents/45 🆔 Identities/$ 🆔🫥 Identity agent.md>), one per nationality. 
...
1. **What authentication mechanisms are supported by Wallets?**
    ...
    * However, [Identity 🆔 vault](<../../../../../../../4 ⚙️ Solution/50 🫥 Agents/45 🆔 Identities/$ 🆔🫥 Identity agent.md>) are free to implement whatever authentication mechanisms they want using the generic tools available. 
