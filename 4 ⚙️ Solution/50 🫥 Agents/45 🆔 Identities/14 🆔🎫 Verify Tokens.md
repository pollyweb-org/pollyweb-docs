...
1. **How do domains authenticate printed identity-bound Tokens?**
    ...
    - 5/ the [Consumer 💼 domain](<../../41 🎭 Domain Roles/27 💼 Consumers/$ 💼🎭 Consumer role.md>) asks the [Token's Identity 🆔 domain](<$ 🆔🫥 Identity agent.md>) to match the biometrics with the [Identity Locator 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/$ 🔆 Locator.md>);
