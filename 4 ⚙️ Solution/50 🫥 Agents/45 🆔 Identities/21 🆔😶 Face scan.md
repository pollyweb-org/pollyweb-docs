...
1. **What can users present in the first step of the flow?**
    ...
    |[💍 Userable](<../../70 🌳 Ambient/74 💍 Userables/$ 💍 Userable thing.md>)| Is it really the [Userable 💍](<../../70 🌳 Ambient/74 💍 Userables/$ 💍 Userable thing.md>) owner [tapping 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/04 🧑‍🦰🔆 Wallet NFC tap.md>) it on a scanner?
