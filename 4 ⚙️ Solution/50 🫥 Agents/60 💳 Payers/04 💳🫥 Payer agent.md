...
1. **How are user payments processed for users?**
    ...
    * [Collector 🏦 helpers](<../../45 🤲 Helper domains/30 🏦 Collectors/$ 🏦🤲 Collector helper.md>) - these are [Helper 🛠️ domains](<../../45 🤲 Helper domains/$ 🤲 Helpers/🛠️👥 Helper domain.md>) able to deposit money on the [Sellers 💵](<../../41 🎭 Domain Roles/70 💵 Sellers/💵🎭 Seller role.md>) bank account. 
