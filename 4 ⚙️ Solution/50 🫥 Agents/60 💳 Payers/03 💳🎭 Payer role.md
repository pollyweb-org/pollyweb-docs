...
1. **What is a Payer domain in NLWeb?**
    ...
    * **[Payer 💳🛠️ helpers](<../../45 🤲 Helper domains/70 💳 Payers/05 💳🛠️ Payer helper.md>)**:
        * these are [Payer 💳 domains](<03 💳🎭 Payer role.md>) that act as [Helper 🛠️ domains](<../../45 🤲 Helper domains/$ 🤲 Helpers/🛠️👥 Helper domain.md>)
