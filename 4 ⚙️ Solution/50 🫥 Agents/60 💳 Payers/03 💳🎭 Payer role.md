...
1. **What is a Payer domain in NLWeb?**
    ...
    A Payer 💳 is any [domain 👥](<../../40 👥 Domains/41 📨 Messages/00 👥 Domain.md>) that sends payments to [Collector 🏦 domains](<../../45 🛠️ Helper domains/30 🏦 Collectors/$ 🏦🛠️ Collector helper.md>) under two categories:
