...
1. **What is a Payer domain in NLWeb?**
    ...
    A Payer 💳 is any [domain 👥](<../../40 👥 Domains/$ 👥 Domains/00 👥 Domain.md>) that sends payments to [Collector 🏦 domains](<../../45 🛠️ Helper domains/30 🏦 Collectors/$ 🏦🛠️ Collector helper.md>) under two categories:
    ...
    * **[Payer 💳🛠️ helpers](<../../45 🛠️ Helper domains/70 💳 Payers/05 💳🛠️ Payer helper.md>)**:
        ...
        * for other [domains 👥](<../../40 👥 Domains/$ 👥 Domains/00 👥 Domain.md>), 
...
1. **Why not leverage the Open Banking protocol?**
    ...
    - e.g., the ability to jump between bank entities from within a [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) in the user's [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>).
...
1. **What responsibilities do Payers have with invoices?**
    ...
    None. 
    * [Collector 🏦 domains](<../../45 🛠️ Helper domains/30 🏦 Collectors/$ 🏦🛠️ Collector helper.md>) are responsible for invoices.
...
1. **What happens if a transaction is cancelled?**
    ...
    Typically, the money is reverted, but it depends on the relationship between the [Payer 💳 domain](<03 💳🎭 Payer role.md>) and the [Collector 🏦 domain](<../../45 🛠️ Helper domains/30 🏦 Collectors/$ 🏦🛠️ Collector helper.md>).
...
7.  **How does it differ from India's ONDC?**
    ...
    - Conversely, NLWeb is against any form of central governance for payments 
        - i.e., there should be multiple channels for [Payer 💳 domains](<03 💳🎭 Payer role.md>) and [Collector 🏦 domains](<../../45 🛠️ Helper domains/30 🏦 Collectors/$ 🏦🛠️ Collector helper.md>) to communicate;
...
9.  **Does NLWeb allow users to pay with NFC contactless?**
    ...
    - However, users can tap on a NLWeb [🔆 NFC Locator](<../../20 🧑‍🦰 UI/11 🔆 Locators/$ 🔆 Locator.md>) with their devices to check out an NLWeb transaction, while continuing to use the device's standard NFC payments for traditional point of sale (POS) terminals. 
...
1. **Do Payers transfer money to collectors, or pay by card?**
    ...
    [Payer 💳 domains](<03 💳🎭 Payer role.md>) and [Collector 🏦 domains](<../../45 🛠️ Helper domains/30 🏦 Collectors/$ 🏦🛠️ Collector helper.md>) may support multiple ways to transact. 
...
1. **Can a payment be reverted or cancelled?**
    ...
    Yes. 
    * [Collector 🏦 domains](<../../45 🛠️ Helper domains/30 🏦 Collectors/$ 🏦🛠️ Collector helper.md>) can initiate it, but [Payer 💳 domains](<03 💳🎭 Payer role.md>) can't.
...
1. **Can payments be done with credit/debit notes?**
    ...
    Yes, as long as the [Payer 💳 domain](<03 💳🎭 Payer role.md>) and the [Collector 🏦 domain](<../../45 🛠️ Helper domains/30 🏦 Collectors/$ 🏦🛠️ Collector helper.md>) support it.
...
1. **Why not use blockchain to perform the money transfer?**
    ...
    - **simplicity:** if only two entities ([Payer 💳 domain](<03 💳🎭 Payer role.md>) and [Collector 🏦 domain](<../../45 🛠️ Helper domains/30 🏦 Collectors/$ 🏦🛠️ Collector helper.md>)) need to communicate, then two simple mutually authenticated API endpoints are enough to do the job.
...
1. **Can a group split a bill in equal parts?**
    ...
    Yes, but split bills are managed by [Collector 🏦 domains](<../../45 🛠️ Helper domains/30 🏦 Collectors/$ 🏦🛠️ Collector helper.md>), as in the following examples:
