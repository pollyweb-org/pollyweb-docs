...
|        | `To`      | string | [Broker 🤵](<../../45 🛠️ Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) from [`Converse@Notifier`](<../../20 🧑‍🦰 UI/02 📣 Notifiers/📣🅰️ Notifier methods/02 📣💬🅰️ Chats/21 🤵🐌📣 Converse.md>) |
|        | `Subject` | string | `Introduced@Broker`
| Body   | `ChatID`  | uuid   | [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) from [`Converse@Notifier`](<../../20 🧑‍🦰 UI/02 📣 Notifiers/📣🅰️ Notifier methods/02 📣💬🅰️ Chats/21 🤵🐌📣 Converse.md>)
|       | `Host`| string | [Host 🤗](<../../41 🎭 Domain Roles/30 🤗 Hosts/$ 🤗🎭 Host role.md>) from [`Converse@Notifier`](<../../20 🧑‍🦰 UI/02 📣 Notifiers/📣🅰️ Notifier methods/02 📣💬🅰️ Chats/21 🤵🐌📣 Converse.md>)
|