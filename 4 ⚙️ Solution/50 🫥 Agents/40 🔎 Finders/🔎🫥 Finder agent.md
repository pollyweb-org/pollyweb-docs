...
1. **Where do Finders get information about other domains?**
    ...
    | [👀&nbsp;Advertisers](<../../45 🛠️ Helper domains/12 👀 Advertisers/👀🛠️ Advertiser helper.md>) | Finders subscribe to [Advertiser 👀 domains](<../../45 🛠️ Helper domains/12 👀 Advertisers/👀🛠️ Advertiser helper.md>) to know which ads to show to users in addition to search results from [domain Manifests 📜](<../../40 👥 Domains/44 📜 Manifests/$ 📜 Domain Manifest.md>). 
