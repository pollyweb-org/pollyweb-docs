...
1. **When is the `OnDelete` triggered?**
    ...
    | 🗑️ [`DELETE`](<../../../../35 💬 Chats/😃 Talkers/😃⚙️ Talker cmds/for data/DELETE 🗑️ item.md>) | When the [`UNDO` ↩️](<../../../../35 💬 Chats/😃 Talkers/😃⚙️ Talker cmds/for data/UNDO ↩️.md>) window of a delete expires.
    |