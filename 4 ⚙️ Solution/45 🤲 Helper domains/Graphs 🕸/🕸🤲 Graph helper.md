...
1. **How are NLWeb Graphs updated?**
    ...
    - Domains have the responsibility to raise an event every time they publish a new version of their [domain Manifest 📜](<../../30 🧩 Data/Manifests 📜/📜 Manifest/📜 Manifest.md>) or [📨 DKIM](<../../30 🧩 Data/Messages 📨/📨 Message.md>). 
