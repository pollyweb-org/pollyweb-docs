...
1. **What is a Graph domain in NLWeb?**
    ...
    * then builds network representations of [Trust 🫡](<../../30 🧩 Data/Trusts 🫡/🫡 Domain Trust.md>) relationships between [domains 👥](<../../40 👥 Domains/👥 Domain.md>)
...
1. **What can domains use Graphs for?**
    ...
    [Graph 🕸 domains](<🕸🤲 Graph helper.md>) can answer the following questions synchronously from any [domain 👥](<../../40 👥 Domains/👥 Domain.md>).
    ...
    | [🌬️ Streams](<../../41 🎭 Domain Roles/Streamers 🌬️/🌬️🎭 Streamer role.md>) | What are the event [Streams 🌬️](<../../41 🎭 Domain Roles/Streamers 🌬️/🌬️🎭 Streamer role.md>) of [domain 👥](<../../40 👥 Domains/👥 Domain.md>) `D`?
...
1. **How are NLWeb Graphs updated?**
    ...
    - To allow any graph to subscribe to changes in any [domain Manifests 📜](<../../30 🧩 Data/Manifests 📜/📜 Manifest/📜 Manifest.md>), NLWeb provides a cluster of [Listener 👂 nodes](<../Listeners 👂/👂🤲 Listener helper.md>) for [domains 👥](<../../40 👥 Domains/👥 Domain.md>) to publish change notifications to, and for [Graph 🕸 domains](<🕸🤲 Graph helper.md>) to receive notifications from. 
...
1. **How can domains reset their Manifest representation on Graphs?**
    ...
    * a [domain 👥](<../../40 👥 Domains/👥 Domain.md>) can send a RESET event to their [Listener 👂 helper domain](<../Listeners 👂/👂🤲 Listener helper.md>);
...
1. **How can domains know about Manifest events placed on hold?**
    ...
    - Interested domains should [subscribe 🔔](<../../41 🎭 Domain Roles/Subscribers 🔔/🔔🎭 Subscriber role.md>) to the Graph's [Streamer 🌬️ role](<../../41 🎭 Domain Roles/Streamers 🌬️/🌬️🎭 Streamer role.md>), filtering the [domains 👥](<../../40 👥 Domains/👥 Domain.md>) they're interested in receiving alert notifications about. 
