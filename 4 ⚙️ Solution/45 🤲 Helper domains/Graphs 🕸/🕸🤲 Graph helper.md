...
1. **How are NLWeb Graphs updated?**
    ...
    - To allow any graph to subscribe to changes in any [domain Manifests 📜](<../../30 🧩 Data/Manifests 📜/📜 Manifest.md>), NLWeb provides a cluster of [Listener 👂 nodes](<../Listeners 👂/👂🤲 Listener helper.md>) for [domains 👥](<../../40 👥 Domains/👥 Domain.md>) to publish change notifications to, and for [Graph 🕸 domains](<🕸🤲 Graph helper.md>) to receive notifications from. 
