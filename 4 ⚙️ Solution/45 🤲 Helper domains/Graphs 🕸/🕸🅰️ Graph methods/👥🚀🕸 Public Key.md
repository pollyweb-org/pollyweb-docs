...
* Returns the historical public key of an [Issuer 🎴 domain](<../../../41 🎭 Domain Roles/Issuers 🎴/🎴🎭 Issuer role.md>) by the name of the key.
    * Allows a [Consumer 💼 domain](<../../../41 🎭 Domain Roles/Consumers 💼/💼🎭 Consumer role.md>) to verify a [Token 🎫](<../../../30 🧩 Data/3 🎫 Tokens/🎫 Token.md>) issued before a [DKIM 📨](<../../../40 👥 Domains/📨 Messages/📨 Message.md>) rotation.
* Used by:
...
|       | `DKIM`| string | [DKIM 📨](<../../../40 👥 Domains/📨 Messages/📨 Message.md>) name
|
...
|-|-|-
| `Algorithm` | string | [DKIM 📨](<../../../40 👥 Domains/📨 Messages/📨 Message.md>) algorithm used in the period
| `PublicKey` | string | [DKIM 📨](<../../../40 👥 Domains/📨 Messages/📨 Message.md>) public key in the period
|