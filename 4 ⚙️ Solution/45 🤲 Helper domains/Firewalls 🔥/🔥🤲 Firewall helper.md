...
1. **How do Firewalls work?**
    ...
    |#|Step
    |-|-
    |1| [Firewall 🔥 domains](<🔥🤲 Firewall helper.md>) subscribe to the [domain-event streams 🌬️](<../../41 🎭 Domain Roles/Streamers 🌬️/🌬️🎭 Streamer role.md>) of [Reviewer ⭐ domains](<../../50 🫥 Agent domains/Reviewers ⭐/⭐ Reviewer agent/⭐ Reviewer 🫥 agent.md>), [Listener 👂 domains](<../Listeners 👂/👂 Listener helper/👂🤲 Listener helper.md>), and [Graph 🕸 domains](<../Graphs 🕸/🕸 Graph helper/🕸🤲 Graph helper.md>), eventually throttling them with a [Buffer ⏳ helper domain](<../Buffers ⏳/⏳🤲 Buffer helper.md>);
