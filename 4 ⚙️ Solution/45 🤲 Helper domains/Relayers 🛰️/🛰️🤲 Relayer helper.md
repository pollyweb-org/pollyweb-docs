...
1. **How do Relayers work?**
    ...
    |B| `Translate`| The Relayer 🛰️ translates it with a cached [API Schema 🧩](<../../30 🧩 Data/Schema Codes 🧩/🧩 Schema Code.md>) and relays it via the [Antenna 📡 device](<../../60 🧰 Edge/61 🔌 Pluggables/02 📡🔀 Antenna router.md>).
...
1. **How do domains send commands to Pluggables?**
    ...
    For a [domain 👥](<../../40 👥 Domains/👥 Domain.md>) to send an API command to a [Pluggable 🔌 device](<../../60 🧰 Edge/61 🔌 Pluggables/01 🔌 Pluggable device.md>) via a Relayer 🛰️ domain, it needs to send the following parameters.
    ...
    | `Command` | The name of the command in the [Pluggable's API Schema 🧩](<../../30 🧩 Data/Schema Codes 🧩/🧩 Schema Code.md>) set by by the [Brand 🍏 domain](<../../41 🎭 Domain Roles/Brands 🍏/🍏🎭 Brand role.md>).
    | `Parameters`| Any command parameters, as defined by the [Pluggable's API Schema 🧩](<../../30 🧩 Data/Schema Codes 🧩/🧩 Schema Code.md>).
