...
1. **How do Relayers work?**
    ...
    |4| `API Schema`| The [Brand 🍏](<../../41 🎭 Domain Roles/Brands 🍏/🍏🎭 Brand role.md>) tells the Relayer 🛰️ where to read the [API Schema 🧩](<../../30 🧩 Data/1 🧩 Schema Codes/🧩 Schema Code.md>) of the [Pluggable 🔌 device](<../../60 🧰 Edge/61 🔌 Pluggables/01 🔌 Pluggable device.md>).
    |5| `Graph`|  The Relayer 🛰️ domain reads the [API Schema 🧩](<../../30 🧩 Data/1 🧩 Schema Codes/🧩 Schema Code.md>) from a [Graph 🕸 helper domain](<../Graphs 🕸/🕸🤲 Graph helper.md>).
    ...
    |Z| `Propagate` | The Relayer 🛰️ sends sends the translated events to the [Buffer ⏳ helper](<../Buffers ⏳/⏳🤲 Buffer helper.md>) of the owner [domain 👥](<../../40 👥 Domains/👥 Domains/👥 Domain.md>).
...
1. **How do domains send commands to Pluggables?**
    ...
    | `Command` | The name of the command in the [Pluggable's API Schema 🧩](<../../30 🧩 Data/1 🧩 Schema Codes/🧩 Schema Code.md>) set by by the [Brand 🍏 domain](<../../41 🎭 Domain Roles/Brands 🍏/🍏🎭 Brand role.md>).
