...
1. **What are the setup requirements for ads to work?**
    ...
    * [Broker 🤵 domains](<../../20 🧑‍🦰 UI/Brokers 🤵/🤵🤲 Broker helper.md>) set up one Advertiser 👀 helper to manage ads, and one [Biller 🤝 helper](<../Billers 🤝/🤝🤲 Biller helper.md>) to orchestrate the payments to all domains involved in ad printing for its registered [Wallets 🧑‍🦰](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>).
