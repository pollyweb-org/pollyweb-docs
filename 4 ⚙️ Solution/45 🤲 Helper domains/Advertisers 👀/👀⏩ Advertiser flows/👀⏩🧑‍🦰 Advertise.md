...
| 8 | [🤗⏩🧑‍🦰 Prompt 🤔](<../../../41 🎭 Domain Roles/Hosts 🤗/🤗⏩ Host flows/🤗⏩🧑‍🦰 Prompt 🤔.md>) | [Advertisers 👀](<../👀🤲 Advertiser helper.md>) show  next best actions to [Wallets 🧑‍🦰](<../../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>)
...
1. **How resilient is the process?**
    ...
    [Hosts 🤗](<../../../41 🎭 Domain Roles/Hosts 🤗/🤗🎭 Host role.md>) or [Curators 🧚](<../../../50 🫥 Agent domains/Curators 🧚/🧚🫥 Curator agent.md>) may fail to do their part.
