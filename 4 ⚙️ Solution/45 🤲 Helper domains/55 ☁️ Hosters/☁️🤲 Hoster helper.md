...
1. **What is a Hoster?**
    ...
    * that provides the infrastructure of a [Hosted 📦 domain](<../../55 👷 Build domains/1 📦 Hosteds/📦👥 Hosted domain.md>)
...
1. **What domains roles does a Hoster implement?**
    ...
    |Role|Description
    |-|-
    | [🗃️ Resourcer](<../../41 🎭 Domain Roles/60 🗃️ Resourcers/🗃️🎭 Resourcer role.md>) | To sync setup files with a [Syncer 🔃 tool](<../../55 👷 Build domains/2 🛠️ Syncers/🔃🛠️ Syncer tool.md>)
    | [😃 Talker](<../../55 👷 Build domains/3 😃 Talkers/😃 Talker.md>) | To manage [Chat 💬](<../../35 Chats/💬 Chats/💬 Chat.md>) workflows
...
1. **How to bootstrap?**
    ...
    | ☁️ Hoster | ℹ️ [Clone](<../../55 👷 Build domains/2 🛠️ Syncers/🔃⏩ Syncer flows/10 🔃⏩🗃️ Clone.md>) with: `syncer \`<br/>`clone any-hoster.com 12345`
    | ☁️ Hoster | ⏳ Waiting for one minute... | (clone)
    | ☁️ Hoster | ℹ️ Received `67890`.
    | ☁️ Hoster | 😃 Is it correct? [Yes, No] | > Yes
    | ☁️ Hoster | ✅ Run [`syncer sync`](<../../55 👷 Build domains/2 🛠️ Syncers/🔃⏩ Syncer flows/20 🔃⏩🗃️ Sync.md>).
