...
1. **What is a Biller domain in NLWeb?**
    ...
    * between a [Payer 💳 domain](<../../50 🫥 Agent domains/60 💳 Payers/03 💳🎭 Payer role.md>) and a [Collector 🏦 domain](<../Collectors 🏦/🏦🤲 Collector helper.md>) 
...
1. **How can a user cancel a subscription?**
    ...
    User subscriptions are attached to the user's [Payer 💳 agent](<../../50 🫥 Agent domains/60 💳 Payers/03 💳🎭 Payer role.md>).
    * In a [Chat 💬](<../../35 💬 Chats/💬 Chats/💬 Chat.md>), users can ask their [Payer 💳 agent](<../../50 🫥 Agent domains/60 💳 Payers/03 💳🎭 Payer role.md>) to cancel the subscription.
