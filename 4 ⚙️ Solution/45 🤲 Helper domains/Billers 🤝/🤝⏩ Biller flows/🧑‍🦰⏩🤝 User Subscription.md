...
- 1/ the user has default [Payer 💳](<../../../41 🎭 Domain Roles/Payers/03 💳🎭 Payer role.md>) and [Identity 🆔](<../../../50 🫥 Agent domains/Identities 🆔/$ 🆔🫥 Identity agent.md>) domains;
...
- 6/ the user's [Payer 💳](<../../../41 🎭 Domain Roles/Payers/03 💳🎭 Payer role.md>) asks the user for a payment method;
