...
1. **What is a Listener domain in NLWeb?**
    ...
    * a [Helper 🤲 domain](<../../../41 🎭 Domain Roles/Helpers 🤲/🤲 Helper/🤲👥 Helper domain.md>) 
    * with a [Streamer 🌬️ domain role](<../../../41 🎭 Domain Roles/Streamers 🌬️/🌬️🎭 Streamer role.md>) 
    * that propagates [domain Manifest 📜](<../../../30 🧩 Data/Manifests 📜/📜 Manifest/📜 Manifest.md>) updates. 
...
1. **How do Listeners work?**
    ...
    |4| Each [Listener 👂 domain](<👂🤲 Listener helper.md>) performs a fan-out propagation of update events to all [Graph 🕸 helper domains](<../../Graphs 🕸/🕸 Graph helper/🕸🤲 Graph helper.md>) that [subscribed 🔔](<../../../41 🎭 Domain Roles/Subscribers 🔔/🔔 Subscriber/🔔🎭 Subscriber role.md>) to the Listener's 👂 [domain-event Stream 🌬️](<../../../41 🎭 Domain Roles/Streamers 🌬️/🌬️🎭 Streamer role.md>).
...
1. **How aren't Listeners and Graphs the same?**
    ...
    * While [Graph 🕸 domains](<../../Graphs 🕸/🕸 Graph helper/🕸🤲 Graph helper.md>) can be built by anyone, [Listener 👂 domains](<👂🤲 Listener helper.md>) are a lightweight layer managed by a coordinated consortium of cloud providers.
...
1. **What is contained in a Manifest-changed event?**
    ...
    An event from a [domain 👥](<../../../40 👥 Domains/👥 Domain/👥 Domain.md>) about a [Manifest 📜](<../../../30 🧩 Data/Manifests 📜/📜 Manifest/📜 Manifest.md>) change comes inside an [envelope 📨](<../../../30 🧩 Data/Messages 📨/📨 Message/📨 Message.md>) containing the following properties.
...
1. **What is the syntax of the path in the Manifest-changed event?**
    ...
    |-|-|-
    | `Identity` | Encompassing the Identity object of a [domain Manifest 📜](<../../../30 🧩 Data/Manifests 📜/📜 Manifest/📜 Manifest.md>). | `Identity`
...
1. **Do Listeners validate the content of events?**
    ...
    - does the path informed match a valid [domain Manifest 📜](<../../../30 🧩 Data/Manifests 📜/📜 Manifest/📜 Manifest.md>) schema part?
...
1. **How can domains know that their updates were rejected?**
    ...
    * Interested [domains 👥](<../../../40 👥 Domains/👥 Domain/👥 Domain.md>) should [subscribe 🔔](<../../../41 🎭 Domain Roles/Subscribers 🔔/🔔 Subscriber/🔔🎭 Subscriber role.md>) to that [Stream 🌬️](<../../../41 🎭 Domain Roles/Streamers 🌬️/🌬️🎭 Streamer role.md>), filtering the domains they're interested in receiving alerts about.
    * For privacy reasons, some alerts are only be pushed to the [Subscriber 🔔 domain](<../../../41 🎭 Domain Roles/Subscribers 🔔/🔔 Subscriber/🔔🎭 Subscriber role.md>) that is referenced in the alert.
...
1. **Do Listeners read domain Manifests from the domain?**
    ...
    * [Manifest 📜](<../../../30 🧩 Data/Manifests 📜/📜 Manifest/📜 Manifest.md>) events contain the content changed. 
    * However, [domains 👥](<../../../40 👥 Domains/👥 Domain/👥 Domain.md>) may explicitly request [Listener 👂 domains](<👂🤲 Listener helper.md>) to reset the domain's [Manifest 📜](<../../../30 🧩 Data/Manifests 📜/📜 Manifest/📜 Manifest.md>) based on a content located in a given URL, as long as the content doesn't reach a maximum size for a [Manifest 📜](<../../../30 🧩 Data/Manifests 📜/📜 Manifest/📜 Manifest.md>).
...
1. **What are the size limits for events and Manifests?**
    ...
    * [Manifest 📜](<../../../30 🧩 Data/Manifests 📜/📜 Manifest/📜 Manifest.md>) full content: 1 GB.
...
1. **Why is there a size limitation on the entire Manifest?**
    ...
    Domains may ask [Graph 🕸 domains](<../../Graphs 🕸/🕸 Graph helper/🕸🤲 Graph helper.md>) and [Listener 👂 domains](<👂🤲 Listener helper.md>) to download their [Manifest 📜](<../../../30 🧩 Data/Manifests 📜/📜 Manifest/📜 Manifest.md>) for drift detection and sync reset. 
...
1. **How can domains keep Manifest-change events small?**
    ...
    Domains can apply the following techniques to keep [Manifest 📜](<../../../30 🧩 Data/Manifests 📜/📜 Manifest/📜 Manifest.md>) parts small:
    ...
    - when creating and updating [Manifest 📜](<../../../30 🧩 Data/Manifests 📜/📜 Manifest/📜 Manifest.md>) parts, keep each part below 200 KB.
...
1. **Do Listeners propagate all notifications downstream?**
    ...
    Not necessarily. 
    - [Subscriber 🔔 domains](<../../../41 🎭 Domain Roles/Subscribers 🔔/🔔 Subscriber/🔔🎭 Subscriber role.md>) can filter the events they subscribe to.
...
1. **What's the retention commitment of Listeners?**
    ...
    [Listener 👂 domains](<👂🤲 Listener helper.md>) keep all changes from all domain [Manifests 📜](<../../../30 🧩 Data/Manifests 📜/📜 Manifest/📜 Manifest.md>) and public keys indefinitely. 
...
1. **What if a subscriber wants to read all history?**
    ...
    [Subscriber 🔔 domains](<../../../41 🎭 Domain Roles/Subscribers 🔔/🔔 Subscriber/🔔🎭 Subscriber role.md>) can ask [Listener 👂 domains](<👂🤲 Listener helper.md>) to replay all domain updates in a given period, or from the beginning of times.
...
1. **Is there data loss when a Listener goes down?**
    ...
    No. 
    * Each [Listener 👂 domain](<👂🤲 Listener helper.md>) is fully independent, being responsible for replying the entire history of [domain Manifest 📜](<../../../30 🧩 Data/Manifests 📜/📜 Manifest/📜 Manifest.md>) changes, even if it is the only [Listener 👂 node](<👂🤲 Listener helper.md>) available in the cluster. 
...
1. **How do Listeners avoid infinite loop cycles?**
    ...
    [Listener 👂 domains](<👂🤲 Listener helper.md>) propagate the correlation ID sent by the original [domain 👥](<../../../40 👥 Domains/👥 Domain/👥 Domain.md>), discarding any repeated update notifications.
...
1. **How can a subscriber filter notifications by content?**
    ...
    [Subscriber 🔔 domains](<../../../41 🎭 Domain Roles/Subscribers 🔔/🔔 Subscriber/🔔🎭 Subscriber role.md>) can set a filter when subscribing to [Listener 👂 domains](<👂🤲 Listener helper.md>):
    - e.g., a financial regulator may only want notifications about changes in domains referencing bank [Schema Codes 🧩](<../../../30 🧩 Data/Codes 🧩/🧩 Schema Code.md>).
