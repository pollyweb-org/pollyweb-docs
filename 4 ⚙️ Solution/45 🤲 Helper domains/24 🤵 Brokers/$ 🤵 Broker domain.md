...
1. **What is a Broker domain in NLWeb?**
    ...
    * is any [Helper 🛠️ domain](<../$ 🤲 Helpers/🛠️👥 Helper domain.md>) 
...
1. **How do Brokers work?**
    ...
    |4| `Bye`    | The [user's Broker 🤵 domain](<$ 🤵 Broker domain.md>) forwards the [Messages 📨](<../../40 👥 Domains/41 📨 Messages/📨 Message.md>) to the [user's Notifier 📣 domain](<../../20 🧑‍🦰 UI/02 📣 Notifiers/📣 Notifier domain.md>), to be pushed to the [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>).
    ...
    |D| `Bye`   | The [user's Broker 🤵 domain](<$ 🤵 Broker domain.md>) forwards the [Messages 📨](<../../40 👥 Domains/41 📨 Messages/📨 Message.md>) again.
...
1. **Why aren't Brokers and Notifiers the same domain?**
    ...
    * The NLWeb organization is responsible for verifying and onboarding [Broker 🤵 domains](<$ 🤵 Broker domain.md>), listing them as [trustworthy 👍](<../../40 👥 Domains/43 👍 Trusts/👍 Domain Trust.md>) on its public [domain Manifest 📜](<../../40 👥 Domains/44 📜 Manifests/📜 Manifest.md>), so that other [domains 👥](<../../40 👥 Domains/$ 👥 Domains/👥 Domain.md>) can inherit that [trust 👍](<../../40 👥 Domains/43 👍 Trusts/👍 Domain Trust.md>).
