...
1. **How do Brokers work?**
    ...
    | # | Category  | Step
    |-|-|-
    |1| `Hi`     | The user initiates an interaction with their [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) - e.g., by scanning a QR and sending the [QR Locator 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/$ 🔆 Locator.md>) to the their [Broker 🤵 domain](<🤵🤲 Broker helper.md>).
...
1. **What API methods does a Broker expose?**
    ...
    | [`💬 Chats`](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>)  | [🧑‍🦰🚀 Assess](<../../../6 🅰️ APIs/15 🤵🅰️ Broker/20 🤵🅰️ Locators/01 🧑‍🦰🐌🤵 Assess.md>) | Parse the [Locator 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/$ 🔆 Locator.md>) on the [Broker 🤵](<🤵🤲 Broker helper.md>)
