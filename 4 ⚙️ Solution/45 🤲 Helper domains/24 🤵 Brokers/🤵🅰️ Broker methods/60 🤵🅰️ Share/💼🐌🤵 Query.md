...
* In a [Chat 💬](<../../../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>), 
    ...
    * in one or more [Schema Codes 🧩](<../../../../30 🧩 Data/10 🧩 Schema Codes/🧩 Schema Code.md>).
...
| Body | `ChatID` | string | [Chat 💬](<../../../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) ID
...
1. **Why a list of Codes instead of a single one?**
    ...
    Although many [Schema Codes 🧩](<../../../../30 🧩 Data/10 🧩 Schema Codes/🧩 Schema Code.md>) may be requested, 
...
1. **Are suspended Tokens shared?**
    ...
    For [Tokens 🎫](<../../../../30 🧩 Data/30 🎫 Tokens/🎫 Token.md>), 
...
1. **How are SELF Tokens are shared?**
    ...
    For the [Schema Codes 🧩](<../../../../30 🧩 Data/10 🧩 Schema Codes/🧩 Schema Code.md>) marked with SELF, 
    * only shows the [Tokens 🎫](<../../../../30 🧩 Data/30 🎫 Tokens/🎫 Token.md>) issued by the [Consumer 💼 domain](<../../../../41 🎭 Domain Roles/27 💼 Consumers/💼🎭 Consumer role.md>),
