...
> The [Broker 🤵 domain](<../../🤵🤲 Broker helper.md>) lists the [Chats 💬](<../../../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) of a [Wallet 🧑‍🦰 app](<../../../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>).
...
| Chat      | `ChatID`        | uuid  | [Chat 💬](<../../../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) ID
