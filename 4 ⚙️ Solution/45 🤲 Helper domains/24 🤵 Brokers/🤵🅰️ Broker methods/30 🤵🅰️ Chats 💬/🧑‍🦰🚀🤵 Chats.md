...
> The [Broker 🤵 domain](<../../🤵🤲 Broker helper.md>) lists the [Chats 💬](<../../../../35 Chats/12 💬 Chats/$ 💬 Chat.md>) of a [Wallet 🧑‍🦰 app](<../../../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>).
...
| Chat      | `ChatID`        | uuid  | [Chat 💬](<../../../../35 Chats/12 💬 Chats/$ 💬 Chat.md>) ID
