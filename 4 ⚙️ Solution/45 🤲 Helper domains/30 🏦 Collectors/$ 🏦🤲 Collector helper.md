...
1. **How do Collectors work?**
    ...
    |2| The [Payer 💳 domain](<../../50 🫥 Agents/60 💳 Payers/03 💳🎭 Payer role.md>) then performs a traditional payment to a [Collector 🏦 helper domain](<$ 🏦🤲 Collector helper.md>).
    |3| The [Collector 🏦 domain](<$ 🏦🤲 Collector helper.md>)issues a traditional receipt back to the [Payer 💳 domain](<../../50 🫥 Agents/60 💳 Payers/03 💳🎭 Payer role.md>).
...
1. **Why are Collectors important?**
    ...
    - e.g. for a restaurant business in Portugal to receive a 100€ payment from a Chinese tourist, they just need to request a 100€ token from their [Collector 🏦 domain](<$ 🏦🤲 Collector helper.md>) and share it with the tourist's [Payer 💳 agent](<../../50 🫥 Agents/60 💳 Payers/03 💳🎭 Payer role.md>);
...
1. **How does a domain withdraw its money from a Collector?**
    ...
    | **Proxy** | G.Wallet | the [Payer 💳 domain](<../../50 🫥 Agents/60 💳 Payers/03 💳🎭 Payer role.md>) pays to the [Collector 🏦 domain](<$ 🏦🤲 Collector helper.md>), who then transfers to the recipients's bank account.
    | **Wallet** | PayPal | the [Payer 💳 domain](<../../50 🫥 Agents/60 💳 Payers/03 💳🎭 Payer role.md>) pays to the [Collector 🏦 domain](<$ 🏦🤲 Collector helper.md>), who holds the money until withdrawn by the recipient.
...
1. **Can a Seller implement the Collector API?**
    ...
    - A [Collector 🏦 domain](<$ 🏦🤲 Collector helper.md>) may be better suited to sign wide international agreements with multiple [Payer 💳](<../../50 🫥 Agents/60 💳 Payers/03 💳🎭 Payer role.md>) and [Biller 🤝 domains](<../20 🤝 Billers/🤝🛠️ Biller helper.md>), and support a multitude of payment options.
