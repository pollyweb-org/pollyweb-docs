...
* An [Itemizer 🛢 helper](<../🛢🤲 Itemizer helper.md>) domain 
    ...
    * after being deleted with an [`UNDO`](<../../../35 💬 Chats/😃 Talkers/😃⚙️ Talker cmds/...datasets 🪣/UNDO ↩️.md>) possibility
    * via the [`Delete@Itemizer`](<../🛢🅰️ Itemizer methods/...for Items/👥🚀🛢 Delete.md>) method.
...
|-|-|-|-
| Header    | `From`        | string    | [Itemizer 🛢](<../🛢🤲 Itemizer helper.md>) from [`Delete@Itemizer`](<../🛢🅰️ Itemizer methods/...for Items/👥🚀🛢 Delete.md>)
...
|| `Handler`     | string    | Handler from [`Build@Itemizer`](<../🛢🅰️ Itemizer methods/...for Tables/👥🐌🛢 Build.md>)
