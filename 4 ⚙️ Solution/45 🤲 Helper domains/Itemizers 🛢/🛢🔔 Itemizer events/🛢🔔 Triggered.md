...
* An [Itemizer 🛢 helper](<../🛢🤲 Itemizer helper.md>) domain 
    ...
    * via the [`Delete@Itemizer`](<../🛢🅰️ Itemizer methods/...for Items/Item Delete 👥🚀🛢/🛢 Delete 🚀 request.md>) method.
...
|-|-|-|-
| Header    | `From`        | string    | [Itemizer 🛢](<../🛢🤲 Itemizer helper.md>) from [`Delete@Itemizer`](<../🛢🅰️ Itemizer methods/...for Items/Item Delete 👥🚀🛢/🛢 Delete 🚀 request.md>)
|           | `To`          | string    | [Talker 😃](<../🛢🅰️ Itemizer methods/...for Items/Item Delete 👥🚀🛢/🛢 Delete 🚀 request.md>)
...
|| `Handler`     | string    | Handler from [`Build@Itemizer`](<../🛢🅰️ Itemizer methods/...for Tables/Table Build 👥🐌🛢/🛢 Build 🐌 msg.md>)
|           | `Item`        | object    | [Item 🛢](<../../../30 🧩 Data/Datasets 🪣/🪣🔣 Dataset types/Itemized 🛢 dataset.md>) from [`Delete@Itemizer`](<../🛢🅰️ Itemizer methods/...for Items/Item Delete 👥🚀🛢/🛢 Delete 🚀 request.md>)
