...
> Implements the  [`DELETE`](<../../../../35 💬 Chats/Scripts 📃/📃 for datasets 🪣/DELETE 🗑️/🗑️ DELETE ⌘ cmd.md>) commands via the [`.DELETE` 📃 script](<../../../../35 💬 Chats/Scripts 📃/📃 for datasets 🪣/DELETE 🗑️/🗑️ DELETE 📃 script.md>).
...
* Deletes items 
  ...
  * via the [`.DELETE` 📃 script](<../../../../35 💬 Chats/Scripts 📃/📃 for datasets 🪣/DELETE 🗑️/🗑️ DELETE 📃 script.md>).
...
|         | `Undo` | string  | Optional [`UNDO`](<../../../../35 💬 Chats/Scripts 📃/📃 for datasets 🪣/UNDO ↩️/↩️ UNDO ⌘ cmd.md>) time
|
