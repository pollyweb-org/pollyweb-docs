...
1. **How to know if the item was deleted on timeout?**
    ...
    [Talker 😃 domains](<../../../../../35 💬 Chats/😃 Talkers/😃 Talker role.md>) can register a `Hook` on the [`Build@Itemizer`](<../../...for Tables/Table Build 👥🐌🛢/🛢 Build 🐌 msg.md>) method to listen to delete events on the [Itemized 🪣 dataset](<../../../../../30 🧩 Data/Datasets 🪣/🪣🔣 Dataset types/Itemized 🛢 dataset.md>).
