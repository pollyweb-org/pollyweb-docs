...
|           | `Key`        | string    | Key from [`Save@Itemizer`](<../👥🚀🛢 Save/👥🚀🛢 Save.md>)
|
...
|| `.Version` | uuid   | Version for [`Save@Itemizer`](<../👥🚀🛢 Save/👥🚀🛢 Save.md>)
|| `{Item object}`        | object    | [Item 🛢](<../../../../../30 🧩 Data/Datasets 🪣/🪣🔣 Dataset types/Itemized 🛢 dataset.md>) saved on [`Save@Itemizer`](<../👥🚀🛢 Save/👥🚀🛢 Save.md>)
|