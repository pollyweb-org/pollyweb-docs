...
1. **What architectural patterns do Itemizers support?**
    ...
    | [Insert Idempotency](<../🛢♒ Itemizer patterns/Idempotency on insert ♒/🛢 Insert Idempotency ♒ pattern.md>) | Ensures that repeated [`SAVE`](<../../../37 Scripts 📃/📃 Commands ⌘/⌘ for datasets 🪣/SAVE 💾/💾 SAVE ⌘ cmd.md>) insert operations with the same data do not trigger more than one event.
    | [Update Idempotency](<../🛢♒ Itemizer patterns/Idempotency on update ♒/🛢 Update Idempotency ♒ pattern.md>) | Ensures that repeated [`READ`](<../../../37 Scripts 📃/📃 Commands ⌘/⌘ for datasets 🪣/READ 🧲/🧲 READ ⌘ cmd.md>) then [`SAVE`](<../../../37 Scripts 📃/📃 Commands ⌘/⌘ for datasets 🪣/SAVE 💾/💾 SAVE ⌘ cmd.md>) update operations with the same data do not trigger more than one event.
    | [Optimistic concurrency](<../🛢♒ Itemizer patterns/Optimistic concurrency ♒/🛢 Optimistic concurrency ♒ pattern.md>) | Allows multiple [`SAVE`](<../../../37 Scripts 📃/📃 Commands ⌘/⌘ for datasets 🪣/SAVE 💾/💾 SAVE ⌘ cmd.md>) commands to run in parallel without locking resources, assuming that conflicts are rare.
