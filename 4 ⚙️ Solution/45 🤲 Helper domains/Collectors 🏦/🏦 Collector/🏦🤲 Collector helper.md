...
1. **What is a Collector domain in NLWeb?**
    ...
    * that other [domains 👥](<../../../40 👥 Domains/👥 Domain/👥 Domain.md>) can leverage 
    * to collect payments from [Payer 💳 domains](<../../../41 🎭 Domain Roles/Payers/💳🎭 Payer role.md>);
...
1. **How do Collectors work?**
    ...
    |#|Step
    |-|-
    |1| A [Payer 💳 domain](<../../../41 🎭 Domain Roles/Payers/💳🎭 Payer role.md>) receives an order to make a payment, either from a user's [Wallet 🧑‍🦰 app](<../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>) in a business-to-consumer (B2C) transaction, or from a [domain 👥](<../../../40 👥 Domains/👥 Domain/👥 Domain.md>) in a business-to-business (B2B) transaction.
    ...
    |4| The [Collector 🏦 domain](<🏦🤲 Collector helper.md>)notifies the recipient [domain 👥](<../../../40 👥 Domains/👥 Domain/👥 Domain.md>) that the payment was successful.
...
1. **Why are Collectors important?**
    ...
    - e.g. for a restaurant business in Portugal to receive a 100€ payment from a Chinese tourist, they just need to request a 100€ token from their [Collector 🏦 domain](<🏦🤲 Collector helper.md>) and share it with the tourist's [Payer 💳 agent](<../../../41 🎭 Domain Roles/Payers/💳🎭 Payer role.md>);
...
1. **How does a domain withdraw its money from a Collector?**
    ...
    How a recipient [domain 👥](<../../../40 👥 Domains/👥 Domain/👥 Domain.md>) receives the money on their bank account depends on the [Collector 🏦 domain](<🏦🤲 Collector helper.md>) - options are as follows.

    | Option | Example | Description
    |-|-|-
    | **Direct** | Visa | the [Payer 💳 domain](<../../../41 🎭 Domain Roles/Payers/💳🎭 Payer role.md>) transfers directly to the recipient's bank account.
    | **Proxy** | G.Wallet | the [Payer 💳 domain](<../../../41 🎭 Domain Roles/Payers/💳🎭 Payer role.md>) pays to the [Collector 🏦 domain](<🏦🤲 Collector helper.md>), who then transfers to the recipients's bank account.
    | **Wallet** | PayPal | the [Payer 💳 domain](<../../../41 🎭 Domain Roles/Payers/💳🎭 Payer role.md>) pays to the [Collector 🏦 domain](<🏦🤲 Collector helper.md>), who holds the money until withdrawn by the recipient.
...
1. **What responsibilities do Collectors have with receipts?**
    ...
    - issuing receipts on behalf of the [domain 👥](<../../../40 👥 Domains/👥 Domain/👥 Domain.md>), 
    - sharing those receipts with the [Payer 💳 domains](<../../../41 🎭 Domain Roles/Payers/💳🎭 Payer role.md>),
...
1. **Can a Collector be use in boutique's cash register?**
    ...
    Yes. Here's a possible configuration for [domain 👥](<../../../40 👥 Domains/👥 Domain/👥 Domain.md>) admins:
    - add [🔆 NFC/QR Locators](<../../../25 🔆 Locators/Locators 🔆/🔆 Locator.md>) on both sides of the counter;
    - issue cashier [Tokens 🎫](<../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) from your [domain 👥](<../../../40 👥 Domains/👥 Domain/👥 Domain.md>);
    ...
    |3| customers' [Payer 💳 agent](<../../../41 🎭 Domain Roles/Payers/💳🎭 Payer role.md>) ask for the preferred payment method;
    |4| customers pay and see the receipt on their [Payer 💳 agent](<../../../41 🎭 Domain Roles/Payers/💳🎭 Payer role.md>). 
...
1. **Can a Seller implement the Collector API?**
    ...
    - A [Collector 🏦 domain](<🏦🤲 Collector helper.md>) may be better suited to sign wide international agreements with multiple [Payer 💳](<../../../41 🎭 Domain Roles/Payers/💳🎭 Payer role.md>) and [Biller 🤝 domains](<../../Billers 🤝/🤝 Biller/🤝 Biller 🤲 helper.md>), and support a multitude of payment options.
...
1. **Do Collectors accept split payments?**
    ...
    * [🚕 Split taxi ride](<../../../../3 🤝 Use Cases/03 🧳 Travel/04 🧳 Travel by taxi 🚕/2 🚕 Customer @ Car/23. Split with friends.md>).
    ...
    | 💳 [Payer](<../../../41 🎭 Domain Roles/Payers/💳🎭 Payer role.md>) | 🫥 Pay $12.95 bill? 🧾 [No]  <br/>- [ ✂️ Split bill ] <br/>- ... | > Split bill
