...
1. **What is a Collector domain in NLWeb?**
    ...
    * that other [domains 👥](<../../40 👥 Domains/👥 Domain.md>) can leverage 
...
1. **How do Collectors work?**
    ...
    |#|Step
    |-|-
    |1| A [Payer 💳 domain](<../../41 🎭 Domain Roles/Payers/💳🎭 Payer role.md>) receives an order to make a payment, either from a user's [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>) in a business-to-consumer (B2C) transaction, or from a [domain 👥](<../../40 👥 Domains/👥 Domain.md>) in a business-to-business (B2B) transaction.
...
1. **How does a domain withdraw its money from a Collector?**
    ...
    How a recipient [domain 👥](<../../40 👥 Domains/👥 Domain.md>) receives the money on their bank account depends on the [Collector 🏦 domain](<🏦🤲 Collector helper.md>) - options are as follows.
...
1. **What responsibilities do Collectors have with receipts?**
    ...
    - issuing receipts on behalf of the [domain 👥](<../../40 👥 Domains/👥 Domain.md>), 
...
1. **Can a Collector be use in boutique's cash register?**
    ...
    Yes. Here's a possible configuration for [domain 👥](<../../40 👥 Domains/👥 Domain.md>) admins:
    - add [🔆 NFC/QR Locators](<../../25 🔆 Locators/Locators 🔆/🔆 Locator.md>) on both sides of the counter;
    - issue cashier [Tokens 🎫](<../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) from your [domain 👥](<../../40 👥 Domains/👥 Domain.md>);
