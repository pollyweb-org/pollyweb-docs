...
1. **What is a Collector domain in NLWeb?**
    ...
    * to collect payments from [Payer 💳 domains](<../../50 🫥 Agent domains/Payers 💳/03 💳🎭 Payer role.md>);
...
1. **How do Collectors work?**
    ...
    |#|Step
    |-|-
    |1| A [Payer 💳 domain](<../../50 🫥 Agent domains/Payers 💳/03 💳🎭 Payer role.md>) receives an order to make a payment, either from a user's [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>) in a business-to-consumer (B2C) transaction, or from a [domain 👥](<../../40 👥 Domains/👥 Domains/👥 Domain.md>) in a business-to-business (B2B) transaction.
    |2| The [Payer 💳 domain](<../../50 🫥 Agent domains/Payers 💳/03 💳🎭 Payer role.md>) then performs a traditional payment to a [Collector 🏦 helper domain](<🏦🤲 Collector helper.md>).
    |3| The [Collector 🏦 domain](<🏦🤲 Collector helper.md>)issues a traditional receipt back to the [Payer 💳 domain](<../../50 🫥 Agent domains/Payers 💳/03 💳🎭 Payer role.md>).
...
1. **Why are Collectors important?**
    ...
    - e.g. for a restaurant business in Portugal to receive a 100€ payment from a Chinese tourist, they just need to request a 100€ token from their [Collector 🏦 domain](<🏦🤲 Collector helper.md>) and share it with the tourist's [Payer 💳 agent](<../../50 🫥 Agent domains/Payers 💳/03 💳🎭 Payer role.md>);
...
1. **How does a domain withdraw its money from a Collector?**
    ...
    |-|-|-
    | **Direct** | Visa | the [Payer 💳 domain](<../../50 🫥 Agent domains/Payers 💳/03 💳🎭 Payer role.md>) transfers directly to the recipient's bank account.
    | **Proxy** | G.Wallet | the [Payer 💳 domain](<../../50 🫥 Agent domains/Payers 💳/03 💳🎭 Payer role.md>) pays to the [Collector 🏦 domain](<🏦🤲 Collector helper.md>), who then transfers to the recipients's bank account.
    | **Wallet** | PayPal | the [Payer 💳 domain](<../../50 🫥 Agent domains/Payers 💳/03 💳🎭 Payer role.md>) pays to the [Collector 🏦 domain](<🏦🤲 Collector helper.md>), who holds the money until withdrawn by the recipient.
...
1. **What responsibilities do Collectors have with receipts?**
    ...
    - sharing those receipts with the [Payer 💳 domains](<../../50 🫥 Agent domains/Payers 💳/03 💳🎭 Payer role.md>),
...
1. **Can a Collector be use in boutique's cash register?**
    ...
    |3| customers' [Payer 💳 agent](<../../50 🫥 Agent domains/Payers 💳/03 💳🎭 Payer role.md>) ask for the preferred payment method;
    |4| customers pay and see the receipt on their [Payer 💳 agent](<../../50 🫥 Agent domains/Payers 💳/03 💳🎭 Payer role.md>). 
...
1. **Can a Seller implement the Collector API?**
    ...
    - A [Collector 🏦 domain](<🏦🤲 Collector helper.md>) may be better suited to sign wide international agreements with multiple [Payer 💳](<../../50 🫥 Agent domains/Payers 💳/03 💳🎭 Payer role.md>) and [Biller 🤝 domains](<../Billers 🤝/🤝🤲 Biller helper.md>), and support a multitude of payment options.
...
1. **Do Collectors accept split payments?**
    ...
    * [🚕 Split taxi ride](<../../../3 🤝 Use Cases/03 🧳 Travel/04 🧳 Travel by taxi 🚕/2 🚕 Customer @ Car/23. Split with friends.md>).
    ...
    | 💳 [Payer](<../../50 🫥 Agent domains/Payers 💳/03 💳🎭 Payer role.md>) | 🫥 Pay $12.95 bill? 🧾 [No]  <br/>- [ ✂️ Split bill ] <br/>- ... | > Split bill
    ...
    | 💳 [Payer](<../../50 🫥 Agent domains/Payers 💳/03 💳🎭 Payer role.md>) | 🫥 Pay $4.33 partial bill? 🧾 [No] <br/>- [ card ABC ] + $0.10 <br/>- [ card DEF ] (free) | > card ABC
    | 💳 [Payer](<../../50 🫥 Agent domains/Payers 💳/03 💳🎭 Payer role.md>) | 🫥 Add tip? [No, 10%, +] | > 10%
