...
1. **Can a Seller implement the Collector API?**
    ...
    - A [Collector 🏦 domain](<🏦🤲 Collector helper.md>) may be better suited to sign wide international agreements with multiple [Payer 💳](<../../41 🎭 Domain Roles/Payers/💳🎭 Payer role.md>) and [Biller 🤝 domains](<../Billers 🤝/🤝🤲 Biller helper.md>), and support a multitude of payment options.
