...
1. **Can a Seller implement the Collector API?**
    ...
    - A [Collector 🏦 domain](<🏦🤲 Collector helper.md>) may be better suited to sign wide international agreements with multiple [Payer 💳](<../../50 🫥 Agent domains/60 💳 Payers/03 💳🎭 Payer role.md>) and [Biller 🤝 domains](<../Billers 🤝/🤝🤲 Biller helper.md>), and support a multitude of payment options.
