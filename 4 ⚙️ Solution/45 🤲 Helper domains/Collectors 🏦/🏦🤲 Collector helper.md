...
1. **How do Collectors work?**
    ...
    |#|Step
    |-|-
    |1| A [Payer 💳 domain](<../../41 🎭 Domain Roles/Payers/💳🎭 Payer role.md>) receives an order to make a payment, either from a user's [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/1 🧑‍🦰 Wallets/🧑‍🦰🛠️ Wallet app.md>) in a business-to-consumer (B2C) transaction, or from a [domain 👥](<../../40 👥 Domains/👥 Domains/👥 Domain.md>) in a business-to-business (B2B) transaction.
