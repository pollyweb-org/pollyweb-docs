...
![](<../../40 👥 Domains/👥👍 Domain Trusts/.📎 Assets/👍 Authority.png>)
...
1. **What is an Authority domain in NLWeb?**
    ...
    - converting legal agreements into [trust 👍](<../../40 👥 Domains/👥👍 Domain Trusts/👍 Domain Trust.md>) relationships (e.g., international commerce federations);
    - converting standards to [Schema Codes 🧩](<../../30 🧩 Data/1 🧩 Schema Codes/🧩 Schema Code.md>) (e.g., electronic passports); and 
    - publishing reference [🪣 Datasets](<../../41 🎭 Domain Roles/Datasets 🪣/🪣🎭 Dataset role.md>) for automated issues (e.g., accessibility codes for international travel).
...
1. **How do other domains parse the hierarchies?**
    ...
    * Instead, domains should rely on [Graphs 🕸](<../50 🕸 Graphs/🕸🤲 Graph helper.md>) to index the [Schema Codes 🧩](<../../30 🧩 Data/1 🧩 Schema Codes/🧩 Schema Code.md>) on their behalf.
