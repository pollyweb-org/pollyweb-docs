...
![](<../../../50 🫥 Agents/60 💳 Payers/. 📎 Assets/💳 Biller User.png>)

For a user to [sign](<../../../50 🫥 Agents/45 🆔 Identities/16 🆔🔏 Verify Signatures.md>) a subscription, the following preconditions must be met:
- 1/ the user has default [Payer 💳](<../../../50 🫥 Agents/60 💳 Payers/03 💳🎭 Payer role.md>) and [Identity 🆔](<../../../50 🫥 Agents/45 🆔 Identities/$ 🆔🫥 Identity agent.md>) domains;
...
- 3/ the Seller's [Biller 🤝](<../🤝🛠️ Biller helper.md>) sends the PDF terms to the user;
- 4/ the user accepts the PDF terms;
- 5/ the user's [Identity 🆔 domain](<../../../50 🫥 Agents/45 🆔 Identities/$ 🆔🫥 Identity agent.md>) authenticates the user;
- 6/ the user's [Payer 💳](<../../../50 🫥 Agents/60 💳 Payers/03 💳🎭 Payer role.md>) asks the user for a payment method;
- 7/ the [Seller 💵](<../../../41 🎭 Domain Roles/70 💵 Sellers/💵🎭 Seller role.md>) confirms the subscription;
- 8/ the  [Biller 🤝](<../🤝🛠️ Biller helper.md>)  initiates the monthly collection.
...
| 🤵 [Broker](<../../24 🤵 Brokers/$ 🤵 Broker domain.md>) | 🫥 [Allow guest domain?](<../../../41 🎭 Domain Roles/30 🤗 Hosts/🤗⏩ Host flows/🤗⏩🧑‍🦰 Invite 🤲.md>) <br/> - Any Biller 🤝<br/>- [ Always ] for Any Helper 🤲 | > Always
| 🤝 [Biller](<../🤝🛠️ Biller helper.md>) | 😃 What plan to subscribe? <br/>- [ Simple ] pay-as-you-go  <br/>- [ Monthly ] commitment | > Simple
...
| 🛠️ [`INVITE`](<../../../../9 😃 Talkers/60 ⏩ Msg flows/46 🤲 INVITE msg.md>) | To subscribe the user to plan.
