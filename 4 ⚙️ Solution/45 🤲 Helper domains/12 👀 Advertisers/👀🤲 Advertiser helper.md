...
1. **How are ads selected?**
    ...
    3 | The [Broker 🤵 domain](<../24 🤵 Brokers/🤵🤲 Broker helper.md>) asks the Chat's 💬 [Host 🤗 domain](<../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) to share the [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) summary with the user's [Curator 🧚 agent](<../../50 🫥 Agents/30 🧚 Curators/🧚🫥 Curator agent.md>), passing the bill's [Locator 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/$ 🔆 Locator.md>).
    ...
    10 | The Advertiser 👀 asks the [Broker 🤵 domain](<../24 🤵 Brokers/🤵🤲 Broker helper.md>) to open a new [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) to the user-selected [Locator 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/$ 🔆 Locator.md>).
