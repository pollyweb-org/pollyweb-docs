...
1. **What is an Advertiser helper domain in NLWeb?**
    ...
    Advertisers 👀 are [Helper 🛠️ domains](<../$ 🤲 Helpers/🛠️👥 Helper domain.md>) that intermediate the registration, distribution, and payment flows for ads on NLWeb. 
...
1. **How are ads selected?**
    ...
    | D | And sends the corresponding part to the [Collector 🏦 helper](<../30 🏦 Collectors/$ 🏦🤲 Collector helper.md>) of the [Broker 🤵 domain](<../24 🤵 Brokers/$ 🤵 Broker domain.md>) for orchestrating the ad workflows.
...
1. **How is PII protected?**
    ...
    * [Host 🤗 domains](<../../41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) send chat summaries directly to [Curator 🧚 agents](<../../50 🫥 Agents/30 🧚 Curators/🧚🫥 Curator agent.md>), not to [Broker 🤵 domains](<../24 🤵 Brokers/$ 🤵 Broker domain.md>).
