...
1. **What domain roles do Wands typically implement?**
    ...
    | [🏭 Supplier](<../../41 🎭 Domain Roles/Suppliers 🏭/🏭🎭 Supplier role.md>) | For receiving orders to add [Chats 💬](<../../35 💬 Chats/💬 Chats/💬 Chat.md>) to [Things 💠](<../../25 🔆 Locators/2 💠 Things/💠🔆 Thing locator.md>).
...
1. **Why are Wands important?**
    ...
    * **For users**, [Wand 🪄 domains](<🪄🤲 Wand helper.md>) ensure a seamless experience when interacting with [Things 💠](<../../25 🔆 Locators/2 💠 Things/💠🔆 Thing locator.md>) from any [Brand 🍏 domains](<../../41 🎭 Domain Roles/Brands 🍏/🍏🎭 Brand role.md>), given that the [Chat 💬](<../../35 💬 Chats/💬 Chats/💬 Chat.md>) session of a [Things 💠](<../../25 🔆 Locators/2 💠 Things/💠🔆 Thing locator.md>) is controlled by the [Wand 🪄 domain](<🪄🤲 Wand helper.md>).
...
1. **Can Brands know which user registered the placeholder?**
    ...
    No.
    * The owner of a [Thing 💠](<../../25 🔆 Locators/2 💠 Things/💠🔆 Thing locator.md>) is hidden from [Brand 🍏 domains](<../../41 🎭 Domain Roles/Brands 🍏/🍏🎭 Brand role.md>) by [Custodian 🧳 vault domains](<../../50 🫥 Agent domains/35 🧳 Custodians/$ 🧳🫥 Custodian agent.md>). 
...
1. **What if a Brand ceases to exist?**
    ...
    * A [Wand 🪄 domain](<🪄🤲 Wand helper.md>) may decide to keep a [Thing 💠](<../../25 🔆 Locators/2 💠 Things/💠🔆 Thing locator.md>) working even after the [Brand 🍏 domains](<../../41 🎭 Domain Roles/Brands 🍏/🍏🎭 Brand role.md>) is inactive;
