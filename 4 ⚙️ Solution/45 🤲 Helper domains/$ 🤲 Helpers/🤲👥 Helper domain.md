...
1. **What are examples of Helper domains?**
    ...
    | [🪄 Wand](<../90 🪄 Wands/🪄🤲 Wand helper.md>) | - | Manages [Chats 💬](<../../35 Chats/12 💬 Chats/💬 Chat.md>) for [Things 💠](<../../25 Locators/71 💠 Things/💠 Thing.md>) for [Brands 🍏](<../../41 🎭 Domain Roles/20 🍏 Brands/$ 🍏🎭 Brand role.md>)
