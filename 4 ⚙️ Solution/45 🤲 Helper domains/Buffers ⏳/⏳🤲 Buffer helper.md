...
> Mentioned in [📨 Domain Message](<../../40 👥 Domains/📨 Messages/📨 Message.md>)

> Reference by [Identity@Graph 🚀 method](<../Graphs 🕸/🕸🅰️ Graph methods/👥🚀🕸 Identity.md>)
...
1. **Why are Buffers important?**
    ...
    [Buffer ⏳ domains](<⏳🤲 Buffer helper.md>) handle the difference in speed and availability between two [domains 👥](<../../40 👥 Domains/👥 Domains/👥 Domain.md>), allowing for faster [Streamer 🌬️ domains](<../../41 🎭 Domain Roles/Streamers 🌬️/🌬️🎭 Streamer role.md>) to continue without waiting for the slower receiver.
