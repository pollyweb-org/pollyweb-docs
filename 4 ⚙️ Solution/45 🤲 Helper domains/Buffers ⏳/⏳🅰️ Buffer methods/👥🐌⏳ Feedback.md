...
|-|-|-|-
|Header|`From`| uuid | [Domain 👥](<../../../40 👥 Domains/👥 Domain.md>) name of the [Message 📨](<../../../30 🧩 Data/Messages 📨/📨 Message/📨 Message.md>) receiver 
||`To`|domain| Sender's [Buffer ⏳ helper domain](<../⏳🤲 Buffer helper.md>) name
||`Subject`| string | `Feedback@Buffer`
|Body| `Sender`| string | [Domain 👥](<../../../40 👥 Domains/👥 Domain.md>) name of the [Message 📨](<../../../30 🧩 Data/Messages 📨/📨 Message/📨 Message.md>) sender
