...
|-|-|-|-
|Header|`From` | uuid | [Domain 👥](<../../../40 👥 Domains/👥 Domains/👥 Domain.md>) name of the [Message 📨](<../../../40 👥 Domains/👥📨 Domain Messages/📨 Message.md>) receiver 
||`To`| string | Sender's [Buffer ⏳ helper domain](<../⏳🤲 Buffer helper.md>) name
||`Subject`| string | `Feedback@Buffer`
|Body| `Sender`| string | [Domain 👥](<../../../40 👥 Domains/👥 Domains/👥 Domain.md>) name of the [Message 📨](<../../../40 👥 Domains/👥📨 Domain Messages/📨 Message.md>) sender
||`Correlation`| uuid | Correlation ID of the affected [Message 📨](<../../../40 👥 Domains/👥📨 Domain Messages/📨 Message.md>)
