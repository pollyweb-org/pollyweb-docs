...
1. **What does the registration Chat look like?**
    ...
    | 🤵 [Broker](<../../20 🧑‍🦰 UI/Brokers 🤵/🤵🤲 Broker helper.md>) | 🫥 [Ready to register?](<../../41 🎭 Domain Roles/Consumers 💼/💼⏩ Consumer flows/💼⏩🧑‍🦰 Inform 📝.md>) [Yes, No] <br>- Your broker binds with us 🔗 <br/>- You choose a billing plan 🤝 <br/>- Your payer adds a method 💳 <br/>- Your identity signs the terms 🆔 | > Yes
    ...
    | 🤵 [Broker](<../../20 🧑‍🦰 UI/Brokers 🤵/🤵🤲 Broker helper.md>) | 🫥 [Allow guest domain?](<../../41 🎭 Domain Roles/Hosts 🤗/🤗⏩ Host flows/🤗⏩🧑‍🦰 Invite 🤲.md>) [Yes, No]  <br/> - Any Biller 🤝<br/>- [ Always ] for Any Helper 🤲 | > Always
    ...
    |-|-
    | 📝 [`INFORM`](<../../35 💬 Chats/😃 Talkers/😃⚙️ Talker cmds/...messages/INFORM 📝 msg.md>) | To provide instructions
    | 🔗 [`BIND`](<../../35 💬 Chats/😃 Talkers/😃⚙️ Talker cmds/...messages/BIND 🔗 msg.md>) | To create a user profile
    | 🛠️ [`INVITE`](<../../35 💬 Chats/😃 Talkers/😃⚙️ Talker cmds/...messages/INVITE 🤲 msg.md>) | To subscribe the user to plan
    | ❄️ [`FREEZE`](<../../35 💬 Chats/😃 Talkers/😃⚙️ Talker cmds/...messages/FREEZE ❄️ msg.md>) | To disable past inputs
    ...
    | 👋 [`GOODBYE`](<../../35 💬 Chats/😃 Talkers/😃⚙️ Talker cmds/...messages/GOODBYE 👋 msg.md>) | To show advertising
