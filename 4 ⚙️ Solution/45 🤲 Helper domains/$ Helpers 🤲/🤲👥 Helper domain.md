...
1. **What are examples of Helper domains?**
    ...
    | [🏦 Collector](<../Collectors 🏦/🏦🤲 Collector helper.md>) | CapitalOne | Collects money from [Payers 💳](<../../50 🫥 Agent domains/60 💳 Payers/03 💳🎭 Payer role.md>) for [Sellers 💵](<../../41 🎭 Domain Roles/Sellers 💵/💵🎭 Seller role.md>)
    ...
    | [💳 Payer](<../../50 🫥 Agent domains/60 💳 Payers/03 💳🎭 Payer role.md>) | PayPal | Pays [Collectors 🏦](<../Collectors 🏦/🏦🤲 Collector helper.md>) for [domains 👥](<../../40 👥 Domains/👥 Domains/👥 Domain.md>)
...
1. **What roles do Helpers implement?**
    ...
    | [🪢 Integrator](<../../41 🎭 Domain Roles/Integrators 🪢/🪢🎭 Integrator role.md>) | To manifest its services to  [Finder 🔎 domains](<../../50 🫥 Agent domains/40 🔎 Finders/🔎🫥 Finder agent.md>)
...
1. **How can domain-admin users register with a Helper?**
    ...
    |5| `Link` | Link a [Payer 💳](<../../50 🫥 Agent domains/60 💳 Payers/03 💳🎭 Payer role.md>) with the Helper's [Biller 🤝](<../Billers 🤝/🤝🤲 Biller helper.md>)
