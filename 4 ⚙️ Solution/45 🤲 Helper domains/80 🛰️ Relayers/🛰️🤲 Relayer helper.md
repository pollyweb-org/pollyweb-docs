...
1. **How do Relayers work?**
    ...
    |3| `Brand` | The Relayer 🛰️ registers the [Pluggable's Locator 🔆](<../../30 🧩 Data/15 🔆 Locators/$ 🔆 Locator.md>) in the [Pluggable's Brand 🍏 domain](<../../41 🎭 Domain Roles/20 🍏 Brands/$ 🍏🎭 Brand role.md>).
