...
1. **What is the Inbound file?**
    ...
    * tells the [Hoster ☁️ domain](<../../../45 🤲 Helper domains/Hosters ☁️/☁️🤲 Hoster helper.md>) 
    * where to forward [Messages 📨](<../../../40 👥 Domains/📨 Messages/📨 Message.md>) to.
...
1. **How is traffic processed over HTTP?**
    ...
    * [Hosted 📦 domains](<../📦👥 Hosted domain.md>) decrypt the messages received from [Hoster ☁️ domains](<../../../45 🤲 Helper domains/Hosters ☁️/☁️🤲 Hoster helper.md>), 
