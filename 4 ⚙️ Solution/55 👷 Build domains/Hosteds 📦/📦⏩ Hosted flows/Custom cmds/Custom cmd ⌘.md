...
1. **How to create custom commands?**
    ...
    |2| `Parse` | Parse it at the [`Parse@Hosted` 🅰️ method](<../../📦🅰️ Hosted methods/Parse 😃🚀📦/📦 Parse 🚀 request.md>)
...
1. **How to build a custom `ECHO` command?**
    ...
    Here's the [Script 📃](<../../../../35 💬 Chats/Scripts 📃/Script 📃.md>) for the [`Hello@Host` 🅰️ method](<../../../../41 🎭 Domain Roles/Hosts 🤗/🤗⏩ Host flows/Goodbye 🤗⏩👋/🤗 Goodbye ⏩ flow.md>) 
    ...
    Here's the python handler for the [`Parse@Hosted` 🅰️ method](<../../📦🅰️ Hosted methods/Parse 😃🚀📦/📦 Parse 🚀 request.md>)
    ...
    ```
    Commands: [`RUN`](<../../../../37 Scripts 📃/📃 Commands ⌘/⌘ for control ▶️/RUN ▶️/▶️ RUN ⌘ cmd.md>)
