...
1. **What is contained in a Schema Code?**
    ...
    * of the [Authority 🏛️ domain](<../../45 Helpers/14 🏛️ Authorities/$ 🏛️🛠️ Authority helper.md>) called `nlweb.com`. 
...
1. **How do define a Schema in a Manifest?**
    ...
    | [`.MANIFEST/DELEGATE` 🧩](<../../40 👥 Domains/44 📜 Manifests/30 🧩 DELEGATE code.md>) | Delegation to other [Authorities 🏛️](<../../45 Helpers/14 🏛️ Authorities/$ 🏛️🛠️ Authority helper.md>)
