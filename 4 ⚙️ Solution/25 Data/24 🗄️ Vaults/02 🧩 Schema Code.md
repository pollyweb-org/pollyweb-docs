...
1. **Are versions mandatory?**
    ...
    | [🕸 Graph](<../../42 Backbone/20 🕸 Graphs/$ 🕸🛠️ Graph helper.md>) | When a version is omitted when calling [`Schema@Graph`](<../../../6 🅰️ APIs/45 🕸🅰️ Graph/08 👥🚀🕸 Schema.md>), then the [🕸 Graph](<../../42 Backbone/20 🕸 Graphs/$ 🕸🛠️ Graph helper.md>) returns the latest version.
...
1. **How are Schema Codes used in data sharing between domains?**
    ...
    When a [Consumer 💼 domain](<../../41 🎭 Domain Roles/27 💼 Consumers/04 💼🎭 Consumer role.md>) needs information stored in a [user's Vault 🗄️ domains](<../../41 🎭 Domain Roles/80 🗄️ Vault/03 🗄️🎭 Vault role.md>), 
...
1. **How can domains read Schemas in domain Manifests?**
    ...
    * Instead, [domains 👥](<../../40 👥 Domains/41 📨 Messages/00 👥 Domain.md>) need to query [Graph 🕸 domains](<../../42 Backbone/20 🕸 Graphs/$ 🕸🛠️ Graph helper.md>) for a schema definition, by passing the [Schema Code 🧩](<02 🧩 Schema Code.md>) to the [`Schema@Graph`](<../../../6 🅰️ APIs/45 🕸🅰️ Graph/08 👥🚀🕸 Schema.md>).
...
1. **Is the NLWeb Manifest a single point of failure?**
    ...
    - Instead, [domains 👥](<../../40 👥 Domains/41 📨 Messages/00 👥 Domain.md>) should rely on [Graph 🕸 helper domains](<../../42 Backbone/20 🕸 Graphs/$ 🕸🛠️ Graph helper.md>) to look up schema definitions.
...
1. **Wouldn't JSON be faster than YAML?**
    ...
    - But, because of [Graph 🕸 helper domains](<../../42 Backbone/20 🕸 Graphs/$ 🕸🛠️ Graph helper.md>), the performance of either protocol is irrelevant in this context. 
