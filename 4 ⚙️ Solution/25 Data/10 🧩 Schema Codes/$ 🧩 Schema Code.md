...
1. **What is contained in a Schema Code?**
    ...
    The string of a [Schema Code 🧩](<$ 🧩 Schema Code.md>) is composed of the following parts.

    |#| Part |  Description
    |-|-|-
    |1| `domain` |  The [domain 👥](<../../40 👥 Domains/41 📨 Messages/00 👥 Domain.md>) that published the [Schema Code 🧩](<$ 🧩 Schema Code.md>) in their [domain Manifest 📜](<../../40 👥 Domains/44 📜 Manifests/$ 📜 Domain Manifest.md>).
...
1. **How are Schema Codes used in data sharing between domains?**
    ...
    * it invokes the [`Query@Broker`](<../../../6 🅰️ APIs/15 🤵🅰️ Broker/60 🤵🅰️ Share/61 💼🐌🤵 Query.md>) from the [user's Broker 🤵 domain](<../../20 🧑‍🦰 UI/03 🤵 Brokers/$ 🤵 Broker domain.md>), asking for datasets that comply with a given [Schema Code 🧩](<$ 🧩 Schema Code.md>).
...
1. **How can domains read Schemas in domain Manifests?**
    ...
    * Instead, [domains 👥](<../../40 👥 Domains/41 📨 Messages/00 👥 Domain.md>) need to query [Graph 🕸 domains](<../../45 🛠️ Helper domains/40 🕸 Graphs/$ 🕸🛠️ Graph helper.md>) for a schema definition, by passing the [Schema Code 🧩](<$ 🧩 Schema Code.md>) to the [`Schema@Graph`](<../../../6 🅰️ APIs/45 🕸🅰️ Graph/08 👥🚀🕸 Schema.md>).
...
1. **How do define a Schema in a Manifest?**
    ...
    The instructions on how to add a [Schema Code 🧩](<$ 🧩 Schema Code.md>) to a [domain Manifest 📜](<../../40 👥 Domains/44 📜 Manifests/$ 📜 Domain Manifest.md>) are themselves published as special [Schema Codes 🧩](<$ 🧩 Schema Code.md>):
...
1. **Does nlweb.org define Schema Codes?**
    ...
    Yes. 
    - The NLWeb protocol is supported by a set of [Schema Codes 🧩](<$ 🧩 Schema Code.md>) defined in the `nlweb.org` [domain Manifest 📜](<../../40 👥 Domains/44 📜 Manifests/$ 📜 Domain Manifest.md>). 
