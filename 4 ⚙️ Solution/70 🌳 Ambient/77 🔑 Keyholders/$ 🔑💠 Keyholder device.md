...
1. **What is a Keyholder?**
    ...
    * 🧑‍🦰 [Wallet apps](<../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰🛠️ Wallet app.md>) - Wallets support the Keyholder protocol natively.
    * ⌚ [Tapbands](<../../25 🔆 Locators/Tapbands ⌚/⌚💠 Tapband thing.md>) - these are smart bands with the ability to connect to the internet (e.g., Bluetooth, eSim);
...
1. **What does a Keyholder store?**
    ...
    - the domain of the [🔐 KeyMaker](<../../45 🤲 Helper domains/Keymakers 🔐/05  🔐🏭 Keymaker supplier.md>) (e.g., `any-keymaker.dom`) 
