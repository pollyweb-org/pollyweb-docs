...
1. **How does it work?**
    ...
    |6| `Owner?` | The [Consumer 💼 domain](<../../20 🧑‍🦰 UI/27 💼 Consumers/04 💼🎭 Consumer role.md>) asks the [Identity 🆔 vaults](<../../30 🫥 Agents/05 🆔 Identities/03 🆔🫥 Identity agent.md>) of the received [identity-bound Tokens 🎫](<../../20 🧑‍🦰 UI/25 🎫 Tokens/01 🎫 Token.md>) if the person on the images is the owner of the [Tokens 🎫](<../../20 🧑‍🦰 UI/25 🎫 Tokens/01 🎫 Token.md>).
    |7| `Match` | The [Identity 🆔 vaults](<../../30 🫥 Agents/05 🆔 Identities/03 🆔🫥 Identity agent.md>) perform a comparison between the images sent by the [Consumer 💼 domain](<../../20 🧑‍🦰 UI/27 💼 Consumers/04 💼🎭 Consumer role.md>) and the user's face biometrics stored on the [Identity 🆔 vault](<../../30 🫥 Agents/05 🆔 Identities/03 🆔🫥 Identity agent.md>).
