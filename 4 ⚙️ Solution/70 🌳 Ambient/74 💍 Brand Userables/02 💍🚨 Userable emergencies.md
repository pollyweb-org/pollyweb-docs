...
1. **What does the Chat look like?**
    ...
    | 🧢 [Persona](<../../30 🫥 Agents/02 🧢 Personas/$ 🧢🫥 Persona agent.md>) | 🫥 Share contacts ? [Yes, No] | > Yes
