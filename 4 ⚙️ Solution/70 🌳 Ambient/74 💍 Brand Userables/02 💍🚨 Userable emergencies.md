...
1. **What does the Chat look like?**
    ...
    | 🪄 [Wand](<../../45 🛠️ Helper domains/90 🪄 Wands/09 🪄🛠️ Wand helper.md>) | ℹ️ Userable: wedding ring [+]
    | 🪄 [Wand](<../../45 🛠️ Helper domains/90 🪄 Wands/09 🪄🛠️ Wand helper.md>) | 😃 Hi! What do you need? <br/>- [ Emergency ] trigger <br/>- [ Something else ] | > Emergency
    | 🤵 [Broker](<../../20 🧑‍🦰 UI/03 🤵 Brokers/03 🤵 Broker domain.md>) | ⓘ Flow: emergency [+]
    | 🪄 [Wand](<../../45 🛠️ Helper domains/90 🪄 Wands/09 🪄🛠️ Wand helper.md>)| 😐 Are you the owner? [Yes, No] | > No
    | 🪄 [Wand](<../../45 🛠️ Helper domains/90 🪄 Wands/09 🪄🛠️ Wand helper.md>)| ℹ️ Public notes:<br/>- suffers from epilepsy <br/> - allergic to penicillin
    | 🪄 [Wand](<../../45 🛠️ Helper domains/90 🪄 Wands/09 🪄🛠️ Wand helper.md>)| 😐 Activate emergency? [Yes, No] <br/> - I'll need your location <br/> - your contact details <br/>- and an identity check | > Yes
    | 🪄 [Wand](<../../45 🛠️ Helper domains/90 🪄 Wands/09 🪄🛠️ Wand helper.md>) | [📍 Share location?](<../../../9 😃 Talkers/20 🤔 Prompts/7 ✏️ Input prompts/91 📍 LOCATION prompt.md>) [Yes, No] | > Yes
    | 🧢 [Persona](<../../30 🫥 Agents/70 🧢 Personas/$ 🧢🫥 Persona agent.md>) | 🫥 Share contacts ? [Yes, No] | > Yes
    | 🆔 [Identity](<../../30 🫥 Agents/45 🆔 Identities/01 🆔🫥 Identity agent.md>) | 🫥 Share identity? [Yes, No] | > Yes
    ...
    | 🪄 [Wand](<../../45 🛠️ Helper domains/90 🪄 Wands/09 🪄🛠️ Wand helper.md>) | ✅ Emergency activated [+]
...
1. **How does it work?**
    ...
    |2| `Interact`| A [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) opens with the [Userable's Wand 🪄 domain](<../../45 🛠️ Helper domains/90 🪄 Wands/09 🪄🛠️ Wand helper.md>) (i.e., the helper defined by the [Userable's Brand 🍏 domain](<../71 💠 Brand Things/07 🍏🎭 Brand role.md>)) - this allows the guest user to read the landing notes that the owner user left, and allowing the guest to active the emergency script defined by the owner user.
    |3| `Identify` | The [Userable's Wand 🪄 domain](<../../45 🛠️ Helper domains/90 🪄 Wands/09 🪄🛠️ Wand helper.md>) asks the [guest user's Identity 🆔 agent](<../../30 🫥 Agents/45 🆔 Identities/01 🆔🫥 Identity agent.md>) to authenticate the guest - this allows emergency services to impose legal actions on harassment frauds if necessary.
    |4| `Activate`| The guest activates the emergency workflow - this triggers the [Userable's Wand 🪄 domain](<../../45 🛠️ Helper domains/90 🪄 Wands/09 🪄🛠️ Wand helper.md>) to ask the [guest's Broker 🤵 domain](<../../20 🧑‍🦰 UI/03 🤵 Brokers/03 🤵 Broker domain.md>) for the guest's location, ask the [guest's Persona 🧢 agent](<../../30 🫥 Agents/70 🧢 Personas/$ 🧢🫥 Persona agent.md>) for the guest's contact details, and pass that information to the [owner's Custodian 🧳 vault](<../71 💠 Brand Things/05 🧳🗄️ Custodian vault.md>).
...
1. **How are Userable owners protected from harassment frauds?**
    ...
    * by a [trusted 👍](<../../40 👥 Domains/43 👍 Trusts/$ 👍 Domain Trust.md>) [Identity 🆔 domain](<../../30 🫥 Agents/45 🆔 Identities/01 🆔🫥 Identity agent.md>).
