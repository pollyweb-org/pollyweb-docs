...
1. **What are Userable Things in NLWeb?**
    ...
    [Userables 💍](<01 💍 Userable thing.md>) are [Things 💠](<../71 💠 Brand Things/$ 💠 Thing.md>) 
...
1. **What can users do with their Userables?**
    ...
    Users can do with their [Userable 💍 things](<01 💍 Userable thing.md>) everything they do with standard [Things 💠](<../71 💠 Brand Things/$ 💠 Thing.md>). 
...
1. **Are Userables protected from spoofing?**
    ...
    - When a [Userable 💍 thing](<01 💍 Userable thing.md>) is [tapped 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/04 🧑‍🦰🔆 Wallet NFC tap.md>), the user's [Custodian 🧳 agent](<../../50 🫥 Agents/35 🧳 Custodians/$ 🧳🫥 Custodian agent.md>) checks the validity of the unique dynamic code sent by domain that scanned the [Userable 💍 thing](<01 💍 Userable thing.md>), verifying if 
...
1. **How is the dynamic code generation enforced?**
    ...
    When a user registers a [Userable 💍 thing](<01 💍 Userable thing.md>) on the user's [Custodian 🧳 agent](<../../50 🫥 Agents/35 🧳 Custodians/$ 🧳🫥 Custodian agent.md>),
