...
4. **Are Userables protected from spoofing?**
    ...
    - When a [Userable 💍 thing](<01 💍 Userable thing.md>) is [tapped 🔆](<../../20 🧑‍🦰 UI/22 🔆 Locators/04 🧑‍🦰🔆 Wallet NFC tap.md>), the user's [Custodian 🧳 agent](<../71 💠 Brand Things/05 🧳🗄️ Custodian vault.md>) checks the validity of the unique dynamic code sent by domain that scanned the [Userable 💍 thing](<01 💍 Userable thing.md>), verifying if 
