...
1. **What can users do with their Userables?**
    ...
    * Additionally, users can also leverage their [Userable 💍 things](<01 💍 Userable thing.md>) in the following situations.
    ...
    | 💳 [Pay a salesperson](<21 💍💳 Userable pay salesperson.md>) | Pay a [Seller 💵 domain](<../../41 🎭 Domain Roles/70 💵 Sellers/01 💵🎭 Seller role.md>) using the [Seller's Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>).
    | [💳 Pay seller at a kiosk](<22 💍💳 Userable pay kiosk.md>) | Pay a [Seller 💵 domain](<../../41 🎭 Domain Roles/70 💵 Sellers/01 💵🎭 Seller role.md>) using the [Seller's Kiosk 🖥️](<../../60 🧰 Edge/68 🏪 Terminals/01 🖥️ Info kiosk.md>).
