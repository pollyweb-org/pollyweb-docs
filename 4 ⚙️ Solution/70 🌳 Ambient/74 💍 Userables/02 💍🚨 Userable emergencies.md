...
1. **What does the Chat look like?**
    ...
    | 🤵 [Broker](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) | ⓘ Flow: emergency [+]
...
1. **How does it work?**
    ...
    |4| `Activate`| The guest activates the emergency workflow - this triggers the [Userable's Wand 🪄 domain](<../../45 🤲 Helper domains/90 🪄 Wands/🪄🤲 Wand helper.md>) to ask the [guest's Broker 🤵 domain](<../../20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) for the guest's location, ask the [guest's Persona 🧢 agent](<../../50 🫥 Agent domains/70 🧢 Personas/🧢🫥 Persona agent.md>) for the guest's contact details, and pass that information to the [owner's Custodian 🧳 vault](<../../50 🫥 Agent domains/35 🧳 Custodians/$ 🧳🫥 Custodian agent.md>).
