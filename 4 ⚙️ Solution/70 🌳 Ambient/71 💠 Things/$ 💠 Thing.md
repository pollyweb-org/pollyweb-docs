...
1. **What is a Thing?**
    ...
    A Thing 💠 
    * is an [🔆 NFC/QR Locator](<../../30 Data/15 🔆 Locators/$ 🔆 Locator.md>) 
...
1. **How cans Things make a vintage book smarter?**
    ...
    |2| `Create` | The [Wand 🪄 domain](<../../45 🤲 Helper domains/90 🪄 Wands/🪄🤲 Wand helper.md>) creates a [Thing 💠](<$ 💠 Thing.md>) and shares its [digital Locator 🔆](<../../30 Data/15 🔆 Locators/$ 🔆 Locator.md>). |
    |3| `Print` | The [Printer 🖨️](<../../45 🤲 Helper domains/75 🖨️ Printers/🖨️🤲 Printer helper.md>) prints the [Locator 🔆](<../../30 Data/15 🔆 Locators/$ 🔆 Locator.md>) of the [Thing 💠](<$ 💠 Thing.md>) into a QR/NFC  smart sticker.
...
1. **How can Things make a dog collar smarter?**
    ...
    |2| `Print` | The [Brand 🍏 domain](<../../41 🎭 Domain Roles/20 🍏 Brands/$ 🍏🎭 Brand role.md>) orders the physical [Locator 🔆](<../../30 Data/15 🔆 Locators/$ 🔆 Locator.md>) from a [Printer 🖨️ helper domain](<../../45 🤲 Helper domains/75 🖨️ Printers/🖨️🤲 Printer helper.md>).
    |3| `Sell` | The [Brand 🍏 domain](<../../41 🎭 Domain Roles/20 🍏 Brands/$ 🍏🎭 Brand role.md>) sells the physical [Locator 🔆](<../../30 Data/15 🔆 Locators/$ 🔆 Locator.md>) on a smart collar product bundle.
