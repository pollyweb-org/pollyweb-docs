...
1. **What is a Tapband?**
    ...
    - 💍 **Userable**: emulates a passive NFC [Locator 🔆](<../../20 🧑‍🦰 UI/04 🔆 Locators/01 🔆 Locator.md>) representing a [Userable 💍](<../74 💍 Brand Userables/01 💍 Userable thing.md>) [Thing 💠](<../71 💠 Brand Things/01 💠 Thing.md>);
