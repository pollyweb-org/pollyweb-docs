...
1. **How can owners register a Thing?**
    ...
    |2| The [Wand 🪄 domain](<../../45 🛠️ Helper domains/90 🪄 Wands/$ 🪄🛠️ Wand helper.md>) creates the Things' [Locators 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/01 🔆 Locator.md>) and informs the [Brand 🍏 domain](<07 🍏🎭 Brand role.md>).
    |3| The [Brand 🍏](<07 🍏🎭 Brand role.md>) embeds the Things' [Locators 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/01 🔆 Locator.md>) into the products that it sells. 
