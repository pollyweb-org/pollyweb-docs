...
1. **What is a Wand domain in NLWeb?**
    ...
    * that creates and manages [Chats 💬](<../../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>) 
...
1. **How do Wands work?**
    ...
    |-|-|-
    |A| `Tap/Scan` | Guest users use their [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) to [tap 🔆](<../../20 🧑‍🦰 UI/04 🔆 Locators/04 🧑‍🦰🔆 Wallet NFC tap.md>) or [scan ✨](<../../20 🧑‍🦰 UI/04 🔆 Locators/03 🧑‍🦰✨ Wallet QR scan.md>) the [Locator 🔆](<../../20 🧑‍🦰 UI/04 🔆 Locators/01 🔆 Locator.md>) of a [Thing 💠](<01 💠 Thing.md>) from a given [Brand 🍏 domain](<07 🍏🎭 Brand role.md>).
    |B| `Open`| That opens a [Chat 💬](<../../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>) with the [Wand 🪄 domain](<09 🪄🛠️ Wand helper.md>), acting on behalf of the [Thing's Brand 🍏 domain](<07 🍏🎭 Brand role.md>).
    ...
    |-|-|-
    |1| `Tap/Scan` | Owners use their [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) to [tap 🔆](<../../20 🧑‍🦰 UI/04 🔆 Locators/04 🧑‍🦰🔆 Wallet NFC tap.md>) or [scan ✨](<../../20 🧑‍🦰 UI/04 🔆 Locators/03 🧑‍🦰✨ Wallet QR scan.md>) the [Locator 🔆](<../../20 🧑‍🦰 UI/04 🔆 Locators/01 🔆 Locator.md>) of a [Thing 💠](<01 💠 Thing.md>) with a given [Brand 🍏 domain](<07 🍏🎭 Brand role.md>).
    |2| `Open` | That opens a [Chat 💬](<../../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>) with the [Wand 🪄 domain](<09 🪄🛠️ Wand helper.md>), acting on behalf of the [Brand 🍏](<07 🍏🎭 Brand role.md>). Owners can then do everything that guests can.
...
3. **What domain roles do Wands typically implement?**
    ...
    | [🏭 Supplier](<../../30 🫥 Agents/06 🛎️ Concierges/02 🏭🎭 Supplier role.md>) | For receiving orders to add [Chats 💬](<../../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>) to [Things 💠](<01 💠 Thing.md>).
...
4. **Why are Wands important?**
    ...
    * **For users**, [Wand 🪄 domains](<09 🪄🛠️ Wand helper.md>) ensure a seamless experience when interacting with [Things 💠](<01 💠 Thing.md>) from any [Brand 🍏 domains](<07 🍏🎭 Brand role.md>), given that the [Chat 💬](<../../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>) session of a [Things 💠](<01 💠 Thing.md>) is controlled by the [Wand 🪄 domain](<09 🪄🛠️ Wand helper.md>).
...
9. **How can Wands monetize?**
    ...
    - introduce [advertising 👀](<../../../2 🏔️ Landscape/1 💼 Business landscape/04 👀 Advertising landscape>) in the user [Chats 💬](<../../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>), by leveraging an [Advertiser 👀 helper domain](<../../30 🫥 Agents/10 🔎 Finders/03 👀👥 Advertiser helper.md>).
