...
1. **How do Wands work?**
    ...
    |-|-|-
    |A| `Tap/Scan` | Guest users use their [Wallet 🧑‍🦰 app](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) to [tap 🔆](<../../20 🧑‍🦰 UI/22 🔆 Locators/04 🧑‍🦰🔆 Wallet NFC tap.md>) or [scan ✨](<../../20 🧑‍🦰 UI/22 🔆 Locators/03 🧑‍🦰✨ Wallet QR scan.md>) the [Locator 🔆](<../../20 🧑‍🦰 UI/22 🔆 Locators/01 🔆 Locator.md>) of a [Thing 💠](<01 💠 Thing.md>) from a given [Brand 🍏 domain](<07 🍏🎭 Brand role.md>).
    |B| `Open`| That opens a [Chat 💬](<../../20 🧑‍🦰 UI/23 💬 Chats/01 💬 Chat.md>) with the Wand 🪄 domain, acting on behalf of the [Thing's Brand 🍏 domain](<07 🍏🎭 Brand role.md>).
    |C| `Interact` | Guests can then chat with the Wand 🪄 to search instructions, add private notes, join groups, contact the owner, call emergency, or return the item when found; all notes added by the guest are saved on the [guest's Storage 📦 agent](<../../30 🫥 Agents/01 📦 Storage/01 📦🫥 Storage agent.md>).
    ...
    |2| `Open` | That opens a [Chat 💬](<../../20 🧑‍🦰 UI/23 💬 Chats/01 💬 Chat.md>) with the Wand 🪄, acting on behalf of the [Brand 🍏](<07 🍏🎭 Brand role.md>). Owners can then do everything that guests can.
    |3| `Identify` | The Wand 🪄 will detect the user's ownership by its registration on the [owner's Custodian 🧳 agent](<05 🧳🗄️ Custodian vault.md>), and will will provide the owner with admin access after authenticating the owner via the [owner's Identity 🆔 agent](<../../30 🫥 Agents/05 🆔 Identities/03 🆔🫥 Identity agent.md>).
...
5. **Do Wands know which user registered the Locator?**
    ...
    No. 
    * [Thing 💠](<01 💠 Thing.md>) owners are hidden from Wands 🪄 by [Custodian 🧳 vault domains](<05 🧳🗄️ Custodian vault.md>).
...
6. **Can Brands know which user registered the placeholder?**
    ...
    No.
    * [Thing 💠](<01 💠 Thing.md>) owners are hidden from [Brand 🍏 domains](<07 🍏🎭 Brand role.md>) by [Custodian 🧳 vault domains](<05 🧳🗄️ Custodian vault.md>). 
...
7. **Can a user contact the Brand?**
    ...
    * [Brand 🍏 domains](<07 🍏🎭 Brand role.md>) may provide their contact details when placing an order to Wand 🪄 domains;
        * in that case, Wands 🪄 can leverage the [Brand 🍏 domain](<07 🍏🎭 Brand role.md>) on behalf of users.
...
8. **What if a Brand ceases to exist?**
    ...
    Wand 🪄 domains verify if the [Brand 🍏 domains](<07 🍏🎭 Brand role.md>) is still active upon user interaction. 
    * A Wand 🪄 may decide to keep a [Thing 💠](<01 💠 Thing.md>) working even after the [Brand 🍏 domains](<07 🍏🎭 Brand role.md>) is inactive (e.g., if the user pays a subscription to the Wand 🪄).
...
9. **How can Wands monetize?**
    ...
    - introduce [advertising 👀](<../../../2 🏔️ Landscape/1 💼 Business landscape/04 👀 Advertising landscape>) in the user [Chats 💬](<../../20 🧑‍🦰 UI/23 💬 Chats/01 💬 Chat.md>), by leveraging an [Advertiser 👀 helper domain](<../../30 🫥 Agents/10 🔎 Finders/03 👀👥 Advertiser helper.md>).
