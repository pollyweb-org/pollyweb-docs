...
1. **What Helper domains does a Brand typically uses?**
    ...
    | [Buffer ⏳](<../../40 👥 Domains/42 🌬️ Streams/03 ⏳🛠️ Buffer helper.md>) | To receive order updates from the [Wand 🪄](<09 🪄🛠️ Wand helper.md>) and the [Printer 🖨️](<08 🖨️🏭 Printer helper.md>) domains.
