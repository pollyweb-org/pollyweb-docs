...
2. **How does it work?**
    ...
    |Category|Step
    |-|-
    | `Orchestrate` | A [Brand 🍏 domains](<07 🍏🎭 Brand role.md>) ask a [Wand 🪄 helper domain](<09 🪄🛠️ Wand helper.md>) to create a digital [Locator 🔆](<../../20 🧑‍🦰 UI/04 🔆 Locators/01 🔆 Locator.md>) for the embedded [Chat 💬](<../../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>) of their physical product (i.e., a [Thing 💠 extension](<01 💠 Thing.md>)).
    | `Supply` | The [Brand 🍏 domain](<07 🍏🎭 Brand role.md>) then asks a [Printer 🖨️ helper domain](<08 🖨️🏭 Printer helper.md>) to print that [Locator 🔆](<../../20 🧑‍🦰 UI/04 🔆 Locators/01 🔆 Locator.md>) into physical NFQ/QR tag (i.e., a [Thing 💠 tag](<01 💠 Thing.md>)).
    | `Assembly` | The [Brand 🍏 domain](<07 🍏🎭 Brand role.md>) then bundles the product with the tag, and sells it.
    | `Tap/Scan`| Users then pick up the product (e.g., a shirt in a fashion store) and tap/scan the [Locator 🔆](<../../20 🧑‍🦰 UI/04 🔆 Locators/01 🔆 Locator.md>) to initiate a [Chat 💬](<../../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>) with the [Wand 🪄 domain](<09 🪄🛠️ Wand helper.md>).
...
3. **What Helper domains does a Brand typically uses?**
    ...
    |-|-
    | [Printer 🖨️](<08 🖨️🏭 Printer helper.md>) | To print the [NFC/QR Locators 🔆](<../../20 🧑‍🦰 UI/04 🔆 Locators/01 🔆 Locator.md>) for the Brand's [Things 💠](<01 💠 Thing.md>).
    | [Wand 🪄](<09 🪄🛠️ Wand helper.md>) | To order and manage the lifecycle of [Chats 💬](<../../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>) for the Brand's [Things 💠](<01 💠 Thing.md>).
...
4. **What can a Brand configure for a Thing?**
    ...
    | `Knowledge` | Body of knowledge for [Chat 💬](<../../20 🧑‍🦰 UI/05 💬 Chats/01 💬 Chat.md>) interactions with guest users - e.g., instruction manuals and frequently asked questions;
...
5. **How can Brands print NFC/QR tags for their Things?**
    ...
    Brands 🍏 can either:
    * print the [Locators 🔆](<../../20 🧑‍🦰 UI/04 🔆 Locators/01 🔆 Locator.md>) of the [Wand 🪄 helper domains](<09 🪄🛠️ Wand helper.md>) by themselves, 
    * or they can order [Locators 🔆](<../../20 🧑‍🦰 UI/04 🔆 Locators/01 🔆 Locator.md>) from [Printer 🖨️ helper domains](<08 🖨️🏭 Printer helper.md>).
