...
1. **What Helper domains does a Brand typically uses?**
    ...
    | [Buffer ⏳](<../../45 🛠️ Helper domains/15 ⏳ Buffers/$ ⏳🛠️ Buffer helper.md>) | To receive order updates from the [Wand 🪄](<09 🪄🛠️ Wand helper.md>) and the [Printer 🖨️](<../../45 🛠️ Helper domains/60 🖨️ Printers/$ 🖨️🏭 Printer helper.md>) domains.
