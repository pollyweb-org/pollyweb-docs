...
1. **What is a Thing?**
    ...
    * brought to life by a [Wand 🪄 domain](<../../45 🛠️ Helper domains/90 🪄 Wands/09 🪄🛠️ Wand helper.md>)
...
1. **How cans Things make a vintage book smarter?**
    ...
    |#|Category|Step
    |-|-|-
    |1| `Order` | A [Printer 🖨️ domain](<../../45 🛠️ Helper domains/60 🖨️ Printers/$ 🖨️🏭 Printer helper.md>) orders a [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) interaction from a [Wand 🪄 helper domain](<../../45 🛠️ Helper domains/90 🪄 Wands/09 🪄🛠️ Wand helper.md>). 
    |2| `Create` | The [Wand 🪄 domain](<../../45 🛠️ Helper domains/90 🪄 Wands/09 🪄🛠️ Wand helper.md>) creates a [Thing 💠](<01 💠 Thing.md>) and shares its [digital Locator 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/01 🔆 Locator.md>). |
...
1. **How can Things make a dog collar smarter?**
    ...
    |#|Category|Step
    |-|-|-
    |1| `Create` | A [Brand 🍏 domain](<07 🍏🎭 Brand role.md>) orders a [Thing 💠](<01 💠 Thing.md>) from a [Wand 🪄 helper domain](<../../45 🛠️ Helper domains/90 🪄 Wands/09 🪄🛠️ Wand helper.md>). 
