...
1. **How cans Things make a vintage book smarter?**
    ...
    |#|Category|Step
    |-|-|-
    |1| `Order` | A [Printer 🖨️ domain](<../../45 Helpers/10 Printers/08 🖨️🏭 Printer helper.md>) orders a [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) interaction from a [Wand 🪄 helper domain](<09 🪄🛠️ Wand helper.md>). 
    ...
    |3| `Print` | The [Printer 🖨️](<../../45 Helpers/10 Printers/08 🖨️🏭 Printer helper.md>) prints the [Locator 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/01 🔆 Locator.md>) of the [Thing 💠](<01 💠 Thing.md>) into a QR/NFC  smart sticker.
    |4| `Sell` | The [Printer 🖨️](<../../45 Helpers/10 Printers/08 🖨️🏭 Printer helper.md>) distributes the smart sticker to commercial end-users.
...
1. **How can Things make a dog collar smarter?**
    ...
    |2| `Print` | The [Brand 🍏 domain](<07 🍏🎭 Brand role.md>) orders the physical [Locator 🔆](<../../20 🧑‍🦰 UI/11 🔆 Locators/01 🔆 Locator.md>) from a [Printer 🖨️ helper domain](<../../45 Helpers/10 Printers/08 🖨️🏭 Printer helper.md>).
