...
1. **How cans Things make a vintage book smarter?**
    ...
    |#|Category|Step
    |-|-|-
    |1| `Order` | A [Printer 🖨️ domain](<../../45 🛠️ Helper domains/60 🖨️ Printers/$ 🖨️🏭 Printer helper.md>) orders a [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) interaction from a [Wand 🪄 helper domain](<../../45 🛠️ Helper domains/90 🪄 Wands/$ 🪄🛠️ Wand helper.md>). 
