...
1. **How can Robots answer questions about their features?**
    ...
    [Wands 🪄](<../../45 🤲 Helper domains/90 🪄 Wands/🪄🤲 Wand helper.md>) managing Robots use the [Schema Code 🧩](<../../30 Data/🧩 Schema Codes/🧩 Schema Code.md>) provided by the [Brand 🍏](<../../41 🎭 Domain Roles/20 🍏 Brands/$ 🍏🎭 Brand role.md>) to get the user manuals of the Robot 🤖, then typically feed it to a GenAI algorithm.
    
    ---

1. **How can Robots execute commands?**

    Additionally to answering questions, [Wands 🪄](<../../45 🤲 Helper domains/90 🪄 Wands/🪄🤲 Wand helper.md>) use the [Schema Code 🧩](<../../30 Data/🧩 Schema Codes/🧩 Schema Code.md>) provided by the [Brand 🍏](<../../41 🎭 Domain Roles/20 🍏 Brands/$ 🍏🎭 Brand role.md>) to get the API definition of the Robot's [Pluggable 🔌](<../../60 🧰 Edge/61 🔌 Pluggables/01 🔌 Pluggable device.md>) controller, then typically run it through a GenAI agent.
