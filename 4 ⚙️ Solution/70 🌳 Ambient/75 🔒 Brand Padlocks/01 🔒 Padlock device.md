...
1. **How does a Padlock decide when to open a lock?**
    ...
    - a fixed Padlock [Schema Code 🧩](<../../25 Data/Schema Codes/02 🧩 Schema Code.md>) identifier 
...
1. **Can Padlocks be unlocked against a Token?**
    ...
    - These scenarios require a [Token 🎫](<../../25 Data/25 🎫 Tokens/$ 🎫 Token.md>) and are not supported because Padlocks have no access to the internet, so they cannot verify Tokens.
