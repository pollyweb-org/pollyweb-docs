...
1. **Can Padlocks be unlocked against a Token?**
    ...
    - These scenarios require a [Token 🎫](<../../20 🧑‍🦰 UI/25 🎫 Tokens/$ 🎫 Token.md>) and are not supported because Padlocks have no access to the internet, so they cannot verify Tokens.
