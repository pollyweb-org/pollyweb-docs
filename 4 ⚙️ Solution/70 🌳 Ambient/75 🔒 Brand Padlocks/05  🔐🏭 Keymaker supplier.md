...
1. **What is a Keymaker domain helper?**
    ...
    Keymakers 🔐 are [Suppliers 🏭](<../../41 🎭 Domain Roles/78 🏭 Suppliers/$ 🏭🎭 Supplier role.md>) that supply and manage the lifecycle of [Padlocks 🔒](<01 🔒 Padlock device.md>) on behalf of [Brands 🍏](<../../41 🎭 Domain Roles/20 🍏 Brands/$ 🍏🎭 Brand role.md>).

    ---

1. **What is the commitment of Keymakers to Brands?**

    When supplying [Padlocks 🔒](<01 🔒 Padlock device.md>) to [Brands 🍏](<../../41 🎭 Domain Roles/20 🍏 Brands/$ 🍏🎭 Brand role.md>), Keymakers 🔐 commit to manage the following features for an agreed time period (e.g., 10 years, forever):
...
1. **What happens when a Keymaker's commitment ends?**
    ...
    The [Padlock 🔒](<01 🔒 Padlock device.md>) won't unlock anymore, unless the a physical backup key is used.
