...
1. **What is a Buffer domain in NLWeb?**
    ...
    * is a point-to-point [Helper 🛠️ domain](<../../25 Data/24 🗄️ Vaults/05 🛠️👥 Helper domain.md>)
...
1. **How can Buffers improve network latency?**
    ...
    * Instead of using the public Internet to transfer the events, use instead a private global network from a single cloud provider (e.g., AWS Network) to reduce the number of network hoops between the [Streamer 🌬️ domain](<../../40 👥 Domains/42 🌬️ Streams/02 🌬️🎭 Streamer role.md>) and the [Subscriber 🔔 domain](<../../40 👥 Domains/42 🌬️ Streams/04 🔔🎭 Subscriber role.md>).
...
1. **What API methods do Buffers expose?**
    ...
    | [🔔 Subscriber](<../../40 👥 Domains/42 🌬️ Streams/04 🔔🎭 Subscriber role.md>) | [🚀 Queue](<../../../6 🅰️ APIs/20 ⏳🅰️ Buffer/12 🔔🐌⏳ Queue.md>) | Create or change a queue.
    | [🔔 Subscriber](<../../40 👥 Domains/42 🌬️ Streams/04 🔔🎭 Subscriber role.md>) |[🚀 Unqueue](<../../../6 🅰️ APIs/20 ⏳🅰️ Buffer/13 🔔🐌⏳ Unqueue.md>) | Delete a queue.
    | [🔔 Subscriber](<../../40 👥 Domains/42 🌬️ Streams/04 🔔🎭 Subscriber role.md>) |[🚀 Purge](<../../../6 🅰️ APIs/20 ⏳🅰️ Buffer/14 🔔🚀⏳ Purge.md>) | Clean up a queue.
    |[🌬️ Streamer](<../../40 👥 Domains/42 🌬️ Streams/02 🌬️🎭 Streamer role.md>)|[🐌 Push](<../../../6 🅰️ APIs/20 ⏳🅰️ Buffer/21 🌬️🐌⏳ Push.md>) | Add a message to a queue.
    | [🔔 Subscriber](<../../40 👥 Domains/42 🌬️ Streams/04 🔔🎭 Subscriber role.md>) |[🚀 Poll](<../../../6 🅰️ APIs/20 ⏳🅰️ Buffer/22 🔔🚀⏳ Poll.md>) | Poll messages from a queue.
    | [🔔 Subscriber](<../../40 👥 Domains/42 🌬️ Streams/04 🔔🎭 Subscriber role.md>) |[🚀 Confirm](<../../../6 🅰️ APIs/20 ⏳🅰️ Buffer/23 🔔🚀⏳ Confirm.md>) | Remove a handled message.
    | [🔔 Subscriber](<../../40 👥 Domains/42 🌬️ Streams/04 🔔🎭 Subscriber role.md>)  | [🐌 Replay](<../../../6 🅰️ APIs/20 ⏳🅰️ Buffer/31 🔔🐌⏳ Replay.md>) | Replay confirmed messages.
    | [🔔 Subscriber](<../../40 👥 Domains/42 🌬️ Streams/04 🔔🎭 Subscriber role.md>)  | [🐌 Redrive](<../../../6 🅰️ APIs/20 ⏳🅰️ Buffer/32 🔔🐌⏳ Redrive.md>) | Replay messages in the DLQ.
    |