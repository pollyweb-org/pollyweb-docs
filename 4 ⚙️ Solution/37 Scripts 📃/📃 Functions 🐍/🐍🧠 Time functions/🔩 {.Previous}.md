...
1. **What is the .Previous function?**
    ...
    * representing the previous period relative to [`.Now`](<../../📃 Holders 🧠/🧠 Input holders/Time/🧠🔩 .Now.md>).
...
1. **What are examples of .Previous for times?**
    ...
    Consider [`.Now`](<../../📃 Holders 🧠/🧠 Input holders/Time/🧠🔩 .Now.md>) as `2025-11-03 13:36`
...
1. **How to use .Previous in Scripts?**
    ...
    ```
    Uses: [`.IsIn`](<../🐍 System 🔩 functions/🔩 {.IsIn}.md>)
