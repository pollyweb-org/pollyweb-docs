...
> Used by [`.Add`](<../../📃 Functions 🐍/🐍 System 🔩 functions/Add ⓕ any.md>) [`.Plus`](<../../📃 Functions 🐍/🐍 System 🔩 functions/Plus ⓕ any.md>)
...
1. **What is the .Advance function?**
    ...
    * that advances a period from a given [Time 🧠 holder](<../../📃 Holders 🧠/Time 📚 holders/🧠 Time holders.md>)
...
1. **What's the syntax?**
    ...
    || or as a [Time 🧠 holder](<../../📃 Holders 🧠/Time 📚 holders/🧠 Time holders.md>) | [`$time`](<../../📃 Holders 🧠/Time 📚 holders/🧠 Time holders.md>) 
    | `period` | Textual period to advance, | `3 hours` 
    || or timestamp-like period, | `3:29:47` |
    || or an exact [Time 🧠 holder](<../../📃 Holders 🧠/Time 📚 holders/🧠 Time holders.md>) | [`$time2`](<../../📃 Holders 🧠/Time 📚 holders/🧠 Time holders.md>) 
...
1. **What happens when passing a time holder to the period?**
    ...
    A [Time 🧠 holder](<../../📃 Holders 🧠/Time 📚 holders/🧠 Time holders.md>) passed in the `period` input 
    * always outputs that holder,
    * allowing to use `.Advance($time, $any)` 
    * where `$any` is either an absolute [Time 🧠](<../../📃 Holders 🧠/Time 📚 holders/🧠 Time holders.md>) 
