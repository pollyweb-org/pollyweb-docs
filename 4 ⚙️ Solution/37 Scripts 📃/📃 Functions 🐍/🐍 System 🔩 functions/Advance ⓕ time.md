...
1. **What's the syntax?**
    ...
    || or an exact [Time 🧠 holder](<../../📃 Holders 🧠/🧠 Input holders/🧠 Time holders.md>) | [`$time2`](<../../📃 Holders 🧠/🧠 Input holders/🧠 Time holders.md>) 
...
1. **What happens when passing a time holder to the period?**
    ...
    A [Time 🧠 holder](<../../📃 Holders 🧠/🧠 Input holders/🧠 Time holders.md>) passed in the `period` input 
    * always outputs that holder,
    * allowing to use `.Advance($time, $any)` 
    * where `$any` is either an absolute [Time 🧠](<../../📃 Holders 🧠/🧠 Input holders/🧠 Time holders.md>) 
