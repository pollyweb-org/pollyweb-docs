...
1. **What is the .Contains function?**
    ...
    * that checks if a [Text 🧠 holder](<../../📃 Holders 🧠/🧠 Input holders/Text holders.md>) contains a char or substring
    * or if a [List 🧠 holder](<../../📃 Holders 🧠/🧠 Input holders/List holders.md>) contains a value, 
    * similar to [`.IsIn`](<🔩 {.IsIn}.md>) but from the [List 🧠 holder](<../../📃 Holders 🧠/🧠 Input holders/List holders.md>) perspective.
...
1. **What's the behavior of .Contains?**
    ...
    |[Map 🧠](<../../📃 Holders 🧠/🧠 Input holders/Map holders.md>)    |bool| Is the given key in the [`.Keys`](<../../📃 Holders 🧠/🧠🔩 Map functions/Map.Keys 🔩 ext.md>) list?
    |[Set 🧠](<../../📃 Holders 🧠/🧠🔩 Set holders/Set holders.md>)    |bool| Is the given [Map 🧠](<../../📃 Holders 🧠/🧠 Input holders/Map holders.md>) in the [Set 🧠](<../../📃 Holders 🧠/🧠🔩 Set holders/Set holders.md>)?
