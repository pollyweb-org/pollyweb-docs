...
1. **What is the .Contains function?**
    ...
    * that checks if a [Text 🧠 holder](<../../📃 Holders 🧠/Text 🧠/🧠 Text holders.md>) contains a char or substring
...
1. **What's the behavior of .Contains?**
    ...
    |-|-|-
    |[Text 🧠](<../../📃 Holders 🧠/Text 🧠/🧠 Text holders.md>)   |bool| Is the given [Text 🧠](<../../📃 Holders 🧠/Text 🧠/🧠 Text holders.md>) a subs string?
    |[Period 🧠](<../../📃 Holders 🧠/🧠 Output holders/Period holders.md>) |bool| Is the given [Time 🧠](<../../📃 Holders 🧠/Time 🧠/🧠 Time holders.md>) in the date interval?
...
1. **What are examples of .Contains for strings?**
    ...
    [Text 🧠](<../../📃 Holders 🧠/Text 🧠/🧠 Text holders.md>) | Value |Result
    |-|-|-
    | `{empty}` | ... | ❌ False
    | `AB` | `ABC`| ✅ True
    | `BA` | `ABC`| ❌ False
