...
1. **What's an example of .Diff for [Time 🧠 holders](<../../📃 Holders 🧠/🧠 Input holders/🧠 Time holders.md>)?**
    ...
    ```
    Uses: [`.Today`](<../../📃 Holders 🧠/🧠 Input holders/Time 🧠 functions/🔩 .Today.md>) [`.Now`](<../../📃 Holders 🧠/🧠 Input holders/Time 🧠 functions/🔩 .Now.md>) [`INFO`](<../../📃 Prompts 🤔/🤔 Status ⚠️ prompts/INFO ℹ️/INFO ℹ️ prompt.md>)
