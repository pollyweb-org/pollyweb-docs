...
1. **What's the behavior of .Diff by type?**
    ...
    |Type| Behavior
    |-|-
    | [Texts 🧠](<../../📃 Holders 🧠/Text 🧠/🧠 Text holders.md>) | Same as [`.Remove`](<🔩 {.Remove}.md>) 
    ...
    | [Time 🧠](<../../📃 Holders 🧠/Time 🧠/🧠 Time holders.md>) | Returns the [Period 🧠](<../../📃 Holders 🧠/🧠 Output holders/Period holders.md>) between timestamps
...
1. **What's an example of .Diff for [Time 🧠 holders](<../../📃 Holders 🧠/Time 🧠/🧠 Time holders.md>)?**
