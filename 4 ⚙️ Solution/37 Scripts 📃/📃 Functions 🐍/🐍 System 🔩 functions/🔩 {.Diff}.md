...
1. **What's the behavior of .Diff by type?**
    ...
    | [Time 🧠](<../../📃 Holders 🧠/🧠 Input holders/Time/🧠 Time holders.md>) | Returns the [Period 🧠](<../../📃 Holders 🧠/🧠 Output holders/Period holders.md>) between timestamps
...
1. **What's an example of .Diff for [Time 🧠 holders](<../../📃 Holders 🧠/🧠 Input holders/Time/🧠 Time holders.md>)?**
    ...
    ```
    Uses: [`.Today`](<../../📃 Holders 🧠/🧠 Input holders/Time/🔩 {.Today}.md>) [`.Now`](<../../📃 Holders 🧠/🧠 Input holders/Time/🧠🔩 .Now.md>) [`INFO`](<../../📃 Prompts 🤔/🤔 Status ⚠️ prompts/INFO ℹ️/INFO ℹ️ prompt.md>)
