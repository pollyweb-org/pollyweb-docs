...
1. **What is the .First function?**
    ...
    * that returns the start of a [Text 🧠](<../../📃 Holders 🧠/Text 🧠/🧠 Text holders.md>) or [List 🧠](<../../📃 Holders 🧠/🧠🔩 List holders/List holders.md>).
...
1. **What's the behavior of .First?**
    ...
    |Input|Behavior
    |-|-
    |[`$txt`](<../../📃 Holders 🧠/Text 🧠/🧠 Text holders.md>)`.First(n)`| Returns the first `n` characters of a [Text 🧠 holder](<../../📃 Holders 🧠/Text 🧠/🧠 Text holders.md>)
    |               |If `n` exceeds [`.Length`](<🔩 {.Length}.md>), returns the [Text 🧠 holder](<../../📃 Holders 🧠/Text 🧠/🧠 Text holders.md>)
    |[`$txt`](<../../📃 Holders 🧠/Text 🧠/🧠 Text holders.md>)`.First` | Equals `$txt.First(1)`
