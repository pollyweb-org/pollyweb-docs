...
1. **What is the .First function?**
    ...
    * that returns the start of a [Text 🧠](<../../📃 Holders 🧠/🧠 Input holders/Text holders.md>) or [List 🧠](<../../📃 Holders 🧠/🧠 Input holders/List holders.md>).
...
1. **What's the behavior of .First?**
    ...
    |[`$mapList`](<../../📃 Holders 🧠/🧠 Input holders/Map holders.md>)`.First({A:1},n)`| Applies [`.Filter`](<🔩 {.Filter}.md>) then `.First(n)`
    |[`$mapList`](<../../📃 Holders 🧠/🧠 Input holders/Map holders.md>)`.First({A:1})` | Equals `$mapList.First({A:1},1)`
    ---
    <br/>
