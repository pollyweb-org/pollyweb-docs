...
1. **What are examples of .IsIn for times?**
    ...
    Value  | List |Result
    |-|-|-
    [`.Now`](<../../📃 Holders 🧠/🧠 Input holders/Time/🧠🔩 .Now.md>) | [`.This`](<../🐍🧠 Time functions/🔩 {.This}.md>)`(year)` | ✅ True
    [`.Now`](<../../📃 Holders 🧠/🧠 Input holders/Time/🧠🔩 .Now.md>)| [`.Last`](<🔩 {.Last}.md>)`(year)` | ✅ True
    [`.Now`](<../../📃 Holders 🧠/🧠 Input holders/Time/🧠🔩 .Now.md>)| [`.Previous`](<../🐍🧠 Time functions/🔩 {.Previous}.md>)`(day)`| ❌ False
