...
1. **What are examples of .IsIn for times?**
    ...
    Value  | List |Result
    |-|-|-
    [`.Now`](<../🐍🧠 Time functions/🔩 {.Now}.md>) | [`.This`](<../🐍🧠 Time functions/🔩 {.This}.md>)`(year)` | ✅ True
    [`.Now`](<../🐍🧠 Time functions/🔩 {.Now}.md>)| [`.Last`](<🔩 {.Last}.md>)`(year)` | ✅ True
    [`.Now`](<../🐍🧠 Time functions/🔩 {.Now}.md>)| [`.Previous`](<../🐍🧠 Time functions/🔩 {.Previous}.md>)`(day)`| ❌ False
