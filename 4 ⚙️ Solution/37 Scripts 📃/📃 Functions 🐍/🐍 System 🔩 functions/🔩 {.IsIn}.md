...
1. **What are examples of .IsIn for times?**
    ...
    Value  | List |Result
    |-|-|-
    [`.Now`](<../../📃 Holders 🧠/🧠 Input holders/Time 🧠 functions/🔩 .Now.md>) | [`.This`](<time/🔩 {.This}.md>)`(year)` | ✅ True
    [`.Now`](<../../📃 Holders 🧠/🧠 Input holders/Time 🧠 functions/🔩 .Now.md>)| [`.Last`](<🔩 {.Last}.md>)`(year)` | ✅ True
    [`.Now`](<../../📃 Holders 🧠/🧠 Input holders/Time 🧠 functions/🔩 .Now.md>)| [`.Previous`](<🔩 {.Previous}.md>)`(day)`| ❌ False
