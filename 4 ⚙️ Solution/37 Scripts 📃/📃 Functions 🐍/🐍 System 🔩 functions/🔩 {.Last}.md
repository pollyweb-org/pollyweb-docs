...
1. **What are examples of .Last for times?**
    ...
    For time related strings, [`.Last`](<🔩 {.Last}.md>) returns a [Period 🧠 holder](<../../📃 Holders 🧠/🧠 Output holders/Period holders.md>) for [`.IsIn`](<../../📃 Holders 🧠/🧠🔩 Any holders/🔩 {.IsIn}.md>) and [`.IsBetween`](<../../📃 Holders 🧠/🧠🔩 Any holders/.IsBetween 🔩 any.md>).
