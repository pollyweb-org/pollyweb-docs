...
1. **What's the behavior of .Last?**
    ...
    |[`$mapList`](<../../📃 Holders 🧠/🧠🔩 Map holders/Map holders.md>)`.Last({A:1},n)`| Applies [`.Filter`](<../../📃 Holders 🧠/🧠🔩 Set holders/🔩 {.Filter}.md>) then `.Last(n)`
...
1. **What are examples of .Last for times?**
    ...
    For time related strings, [`.Last`](<🔩 {.Last}.md>) returns a [Period 🧠 holder](<../../📃 Holders 🧠/🧠 Output holders/Period holders.md>) for [`.IsIn`](<../../📃 Holders 🧠/🧠🔩 Any holders/🔩 {.IsIn}.md>) and [`.IsBetween`](<../../📃 Holders 🧠/🧠🔩 Any holders/🔩 {.IsBetween}.md>).

    | Example | Returns
    |-|-
    | `.Last(60 minutes)` | From [`.Now`](<time/🔩 Now.md>)[`.Minus`](<../../📃 Holders 🧠/🧠🔩 Any holders/any.Minus 🔩 ext.md>)`(60 minutes)` to [`.Now`](<time/🔩 Now.md>)
    | `.Last(hour)` | `.Last(60 minutes)`
    | `.Last(2 hours)` | `.Last(120 minutes)`
    | `.Last(day)` | `.Last(24 hours)`
    | `.Last(2 days)` | `.Last(48 hours)`
    | `.Last(1 month)` | From [`.Now`](<time/🔩 Now.md>)[`.Minus`](<../../📃 Holders 🧠/🧠🔩 Any holders/any.Minus 🔩 ext.md>)`(1 month)` to [`.Now`](<time/🔩 Now.md>)
