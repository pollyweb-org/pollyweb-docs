...
* For [Period 🧠 holders](<../../📃 Holders 🧠/🧠 Output holders/Period holders.md>), it's similar but not the same as [`.This`](<../../📃 Holders 🧠/🧠🔩 Time extensions/🔩 {.This}.md>) and [`.Previous`](<../../📃 Holders 🧠/🧠🔩 Time extensions/🔩 {.Previous}.md>)
...
1. **What are examples of .Last for times?**
    ...
    | Example | Returns
    |-|-
    | `.Last(60 minutes)` | From [`.Now`](<../../📃 Holders 🧠/🧠 Input holders/Time 🧠 functions/🔩 .Now.md>)[`.Minus`](<🔩 {.Minus}.md>)`(60 minutes)` to [`.Now`](<../../📃 Holders 🧠/🧠 Input holders/Time 🧠 functions/🔩 .Now.md>)
    | `.Last(hour)` | `.Last(60 minutes)`
    | `.Last(2 hours)` | `.Last(120 minutes)`
    | `.Last(day)` | `.Last(24 hours)`
    | `.Last(2 days)` | `.Last(48 hours)`
    | `.Last(1 month)` | From [`.Now`](<../../📃 Holders 🧠/🧠 Input holders/Time 🧠 functions/🔩 .Now.md>)[`.Minus`](<🔩 {.Minus}.md>)`(1 month)` to [`.Now`](<../../📃 Holders 🧠/🧠 Input holders/Time 🧠 functions/🔩 .Now.md>)
