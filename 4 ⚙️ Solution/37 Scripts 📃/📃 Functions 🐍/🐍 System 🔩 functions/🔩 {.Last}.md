...
1. **What are examples of .Last for times?**
    ...
    | Example | Returns
    |-|-
    | `.Last(60 minutes)` | From [`.Now`](<time/🔩 Now.md>)[`.Minus`](<../../📃 Holders 🧠/🧠🔩 Any holders/🔩 {.Minus}.md>)`(60 minutes)` to [`.Now`](<time/🔩 Now.md>)
    | `.Last(hour)` | `.Last(60 minutes)`
    | `.Last(2 hours)` | `.Last(120 minutes)`
    | `.Last(day)` | `.Last(24 hours)`
    | `.Last(2 days)` | `.Last(48 hours)`
    | `.Last(1 month)` | From [`.Now`](<time/🔩 Now.md>)[`.Minus`](<../../📃 Holders 🧠/🧠🔩 Any holders/🔩 {.Minus}.md>)`(1 month)` to [`.Now`](<time/🔩 Now.md>)
