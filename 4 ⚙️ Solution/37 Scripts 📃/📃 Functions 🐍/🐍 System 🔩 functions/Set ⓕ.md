...
* Used by [`.Add`](<Add ⓕ.md>) and [`SET`](<../../📃 Commands ⌘/⌘ for holders 🧠/SET ↘️/↘️ SET ⌘ cmd.md>)
...
1. **What are examples of .Set for [List 🧠 holders](<../../📃 Holders 🧠/Input holders 📥/🧠 List holders.md>)?**
    ...
    Uses: [`CALL`](<../../📃 Commands ⌘/⌘ for async/CALL 🧮/🧮 CALL ⌘ cmd.md>) [`SET`](<../../📃 Commands ⌘/⌘ for holders 🧠/SET ↘️/↘️ SET ⌘ cmd.md>)
