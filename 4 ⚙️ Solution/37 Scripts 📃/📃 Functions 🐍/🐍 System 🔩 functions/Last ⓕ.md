...
1. **What's the behavior of .Last?**
    ...
    |[`$txt`](<../../📃 Holders 🧠/Input holders 📥/🧠 Text holders.md>)`.Last(n)`| Returns the last `n` characters of a [Text 🧠 holder](<../../📃 Holders 🧠/Input holders 📥/🧠 Text holders.md>)
    |               |If `n` exceeds [`.Length`](<Length ⓕ.md>), returns the [Text 🧠 holder](<../../📃 Holders 🧠/Input holders 📥/🧠 Text holders.md>)
    |[`$txt`](<../../📃 Holders 🧠/Input holders 📥/🧠 Text holders.md>)`.Last` | Equals `$txt.Last(1)`
...
1. **What are examples of .Last for times?**
    ...
    For time related strings, [`.Last`](<Last ⓕ.md>) returns a [Period 🧠 holder](<../../📃 Holders 🧠/Output holders 📤/Period holders.md>) for [`.IsIn`](<IsIn ⓕ any.md>) and [`.IsBetween`](<IsBetween ⓕ any.md>).
