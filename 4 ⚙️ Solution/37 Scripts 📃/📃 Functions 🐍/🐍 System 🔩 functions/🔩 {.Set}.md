...
1. **What's the syntax for .Set?**
    ...
    |-|-|-
    | `original` | Original [Map 🧠 holder](<../../📃 Holders 🧠/🧠 Holder types/Map holders.md>) | `{A:1,B:2}`
...
1. **What are examples of .Set for [Map 🧠 holders](<../../📃 Holders 🧠/🧠 Holder types/Map holders.md>)?**
