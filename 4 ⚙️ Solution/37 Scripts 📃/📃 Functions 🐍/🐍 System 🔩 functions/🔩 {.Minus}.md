...
1. **What's the behavior of .Minus by type?**
    ...
    | [Time 🧠](<../../📃 Holders 🧠/🧠 Input holders/Time holders.md>) | Same as [`.GoBack`](<../🐍🧠 Time functions/🔩 {$time.GoBack}.md>)
...
1. **What are examples of .Minus?**
    ...
    | [`.Today`](<../🐍🧠 Time functions/🔩 {.Today}.md>)`.Minus(1 month)` | A month ago | [`.Today`](<../🐍🧠 Time functions/🔩 {.Today}.md>)[`.GoBack`](<../🐍🧠 Time functions/🔩 {$time.GoBack}.md>)`(1 month ago)`
    | [`.Now`](<../🐍🧠 Time functions/🔩 {.Now}.md>)`.Minus(1 hour)` | An hour ago | [`.Now`](<../🐍🧠 Time functions/🔩 {.Now}.md>)[`.GoBack`](<../🐍🧠 Time functions/🔩 {$time.GoBack}.md>)`(1 hour ago)`
    |