...
1. **What's an example of a `ONE` prompt?**
    ...
    [🫥 Agent](<../../../../50 🫥 Agent domains/$/🫥🗄️ Agent vault.md>) | 🫥 Which one?<br/>- Option [A] <br/>- Option [B] | > A
    | [🤲 Helper](<../../../../41 🎭 Domain Roles/Helpers 🤲/🤲 Helper/🤲🎭 Helper role.md>) | 🫥 Which one?<br/>- Option [A] <br/>- Option [B] | > A
    |
