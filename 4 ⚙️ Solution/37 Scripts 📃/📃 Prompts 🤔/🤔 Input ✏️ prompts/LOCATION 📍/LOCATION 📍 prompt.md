...
1. **What's a LOCATION prompt?**
    ...
    It's a [Prompt 🤔](<../../../../35 💬 Chats/Chats 💬/🤔 Prompt.md>) that asks for the user's current location.
...
1. **How is that example in a [Prompted@Host](<../../../../41 🎭 Domain Roles/Hosts 🤗/🤗📨 Host msgs/Prompted 🧑‍🦰🚀🤗/🤗 Prompted 🚀 call.md>) response?**
