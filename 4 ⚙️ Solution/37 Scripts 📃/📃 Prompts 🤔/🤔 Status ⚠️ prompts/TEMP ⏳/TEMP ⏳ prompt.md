...
1. **What is a non-blocking TEMP?**
    ...
    * but it is automatically removed when a new [Prompt 🤔](<../../../../35 💬 Chats/Prompts 🤔/🤔 Prompt.md>) arrives;
...
1. **What's the TEMP format for a [Script 📃](<../../../../35 💬 Chats/Scripts 📃/Script 📃.md>)?**
...
1. **What do TEMP prompts look like in a [Chat 💬](<../../../../35 💬 Chats/Chats 💬/💬 Chat.md>)?**
    ...
    |  [🗄️ Vault](<../../../../41 🎭 Domain Roles/Vaults 🗄️/🗄️🎭 Vault role.md>) | ⏳ Simple temp.
    |
