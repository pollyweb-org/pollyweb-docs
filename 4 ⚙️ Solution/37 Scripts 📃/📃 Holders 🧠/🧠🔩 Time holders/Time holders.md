...
1. **What are the built-in functions for time?**
    ...
    |Compare| [`.IsBetween`](<../🧠🔩 Any holders/🔩 {.IsBetween}.md>)  |bool| Is it between two given times?
    ...
    |       | [`.Add`](<../🧠🔩 Any holders/any.Add 🔩 ext.md>) |[time](<Time holders.md>)| Same as [`.Advance`](<time.Advance 🔩 ext.md>)Time 🧠 functions/🔩 .Advance.md
