...
1. **What is the .This function?**
    ...
    * to be used with the [`.IsIn` function](<../../📃 Functions 🐍/🐍 System 🔩 functions/🔩 {.IsIn}.md>).
...
1. **How to use .This in a Script?**
    ...
    - ASSERT:
        $date.IsIn(.This(year))
    ```
    Uses: [`ASSERT`](<../../📃 Commands ⌘/⌘ for holders 🧠/ASSERT 🚦/🚦 ASSERT ⌘ cmd.md>)  [`.IsIn`](<../../📃 Functions 🐍/🐍 System 🔩 functions/🔩 {.IsIn}.md>)
