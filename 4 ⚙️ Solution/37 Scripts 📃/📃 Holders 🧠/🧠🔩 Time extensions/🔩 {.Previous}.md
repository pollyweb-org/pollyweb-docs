...
1. **What is the .Previous function?**
    ...
    * representing the previous period relative to [`.Now`](<../../📃 Holders 🧠/🧠 Input holders/Time 🧠 functions/🔩 .Now.md>).
...
1. **What are examples of .Previous for times?**
    ...
    Consider [`.Now`](<../../📃 Holders 🧠/🧠 Input holders/Time 🧠 functions/🔩 .Now.md>) as `2025-11-03 13:36`
...
1. **How to use .Previous in Scripts?**
    ...
    ```
    Uses: [`.IsIn`](<../../📃 Functions 🐍/🐍 System 🔩 functions/🔩 {.IsIn}.md>)
