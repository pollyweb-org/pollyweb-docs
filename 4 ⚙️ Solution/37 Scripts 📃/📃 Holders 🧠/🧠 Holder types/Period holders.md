...
1. **What are Period holders?**
    ...
    * i.e., the interval between two [Time 🧠 holders](<Time holders.md>).
...
1. **What functions return periods?**
    ...
    |-|-
    |[`.Diff`](<../../📃 Functions 🐍/🐍 System 🔩 functions/🔩 {.Diff}.md>)   | Returns the period between 2 [Time 🧠 holders](<Time holders.md>)
