...
1. **How to append into lists?**
    ...
    Using the [`.Append`](<../../📃 Functions 🐍/🐍 System 🔩 functions/🔩 {.Append}.md>) or [`.Add` functions](<../../📃 Functions 🐍/🐍 System 🔩 functions/🔩 {.Add}.md>) with [`EVAL`](<../../📃 Commands ⌘/⌘ for holders 🧠/EVAL 🧮/🧮 EVAL ⌘ cmd.md>).
    
    ```yaml   
    ┌────────────────────────┬─────────────┐
    │ Explicit               │ Implicit    │ 
    ├────────────────────────┼─────────────┤
    │ EVAL|$lst.Add >> $lst: │ PUT +> $lst │ 
    │   A: 1                 │   A: 1      │
    │   B: 2                 │   B: 2      │
    └────────────────────────┴─────────────┘    
    ```
...
1. **How to format a list of objects?**
    ...
    │ Explicit                  │ Implicit          │ 
    ├───────────────────────────┼───────────────────┤
    │ EVAL|$lst.Format >> $out: │ PUT|$lst >> $out: │ 
    │   Alpha: A                │   Alpha: A        │      
    │   Beta: B                 │   Beta: B         │  
    └───────────────────────────┴───────────────────┘    
    ```
...
1. **How to take some properties from a [List 🧠](<List holders.md>) of [Pair 🧠](<Pair holders.md>)?**
    ...
    * with the [`EVAL` commands](<../../📃 Commands ⌘/⌘ for holders 🧠/EVAL 🧮/🧮 EVAL ⌘ cmd.md>),
