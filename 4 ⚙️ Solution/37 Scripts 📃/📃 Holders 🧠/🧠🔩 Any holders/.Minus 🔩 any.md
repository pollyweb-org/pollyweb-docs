...
1. **What's the behavior of .Minus by type?**
    ...
    |Type| Behavior
    |-|-
    | [Texts 🧠](<../Text 🧠/🧠 Text holders.md>) | Same as [`.Remove`](<../../📃 Functions 🐍/🐍 System 🔩 functions/🔩 {.Remove}.md>) 
    ...
    | [Time 🧠](<../Time 🧠/🧠 Time holders.md>) | Same as [`.GoBack`](<../Time 🧠/GoBack ⓕ time.md>)
...
1. **What are examples of .Minus?**
    ...
    | [`.Today`](<../../📃 Functions 🐍/🐍 System 🔩 functions/time/🔩 Today.md>)`.Minus(1 month)` | A month ago | [`.Today`](<../../📃 Functions 🐍/🐍 System 🔩 functions/time/🔩 Today.md>)[`.GoBack`](<../Time 🧠/GoBack ⓕ time.md>)`(1 month ago)`
    | [`.Now`](<../../📃 Functions 🐍/🐍 System 🔩 functions/time/🔩 Now.md>)`.Minus(1 hour)` | An hour ago | [`.Now`](<../../📃 Functions 🐍/🐍 System 🔩 functions/time/🔩 Now.md>)[`.GoBack`](<../Time 🧠/GoBack ⓕ time.md>)`(1 hour ago)`
    |