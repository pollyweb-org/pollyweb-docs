...
1. **What are the built-in functions for bools?**
    ...
    |-|-|-|-
    |Assess| [`.IsEmpty`](<../🧠🔩 Any holders/any.IsEmpty2 🔩 ext.md>) |bool| Is it unset or missing?
    ...
    |Default| [`.Default`](<../🧠🔩 Any holders/any.Default2 🔩 ext.md>) |bool| Substitute a fallback when empty
