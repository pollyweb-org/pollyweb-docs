...
1. **What are the built-in functions for text strings?**
    ...
    |Chars| [`.Length`](<../Any 📚 holders/Length ⓕ.md>) |[num][num]| How many chars does it contain?
    |       | [`.Size`](<../Any 📚 holders/Size ⓕ.md>) |[num][num]| Same as [`.Length`](<../Any 📚 holders/Length ⓕ.md>)
    |       | [`.First`](<../Any 📚 holders/First ⓕ.md>) |[text][text]| What's the first char?
    |       | [`.Last`](<../Any 📚 holders/Last ⓕ.md>) |[text][text]| What's the last char?
    ...
    |       | [`.Remove`](<../Any 📚 holders/Remove ⓕ.md>) |[text][text]| What if we remove the given string?
    |       | [`.Minus`](<../Any 📚 holders/Minus ⓕ any.md>) |[text][text]| Same as [`.Remove`](<../Any 📚 holders/Remove ⓕ.md>)
    |       | [`.Diff`](<../Any 📚 holders/Diff ⓕ.md>) |[text][text]| Same as [`.Remove`](<../Any 📚 holders/Remove ⓕ.md>)
    |       | [`.Translate`](<Translate ⓕ.md>) |[text][text]| Translates between languages
    |Create | [`.UUID`](<../../📃 Functions 🐍/🐍 System 🔩 functions/generators/UUID ⓕ.md>) |[text][text]| Returns a new unique ID
