...
1. **What are the built-in functions for Sets?**
    ...
    ||[`.Where`](<../../📃 Functions 🐍/🐍🧠 Set functions/{$set.Where}.md>) | [set][set] | Equals [`.Filter`][.Filter]
    ...
    || [`.Format`](<../../📃 Functions 🐍/🐍🧠 Set functions/{$set.Format}.md>) | [set][set] | Select and rename [Map 🧠][map] keys
