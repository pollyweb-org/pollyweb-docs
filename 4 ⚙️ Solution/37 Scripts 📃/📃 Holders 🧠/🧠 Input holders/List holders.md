...
1. **How to format a list of objects?**
    ...
    Using the [`.Format` function](<../🧠🔩 Set extensions/{$set.Format}.md>) or the [`PUT`](<../../📃 Commands ⌘/⌘ for holders 🧠/PUT ⬇️/⬇️ PUT ⌘ cmd.md>) command.
...
1. **How to take some properties from a [List 🧠][list] of [Map 🧠](<Map holders.md>)?**
    ...
    Using the [`.Format` function](<../🧠🔩 Set extensions/{$set.Format}.md>) in one of 3 forms:
