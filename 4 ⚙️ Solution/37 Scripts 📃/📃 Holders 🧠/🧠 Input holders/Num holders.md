...
1. **What are the built-in functions for numbers?**
    ...
    |Change | [`.Sum`](<../🧠🔩 Num holders/Num.Sum 🔩 ext.md>) |[num][num]| Adds numbers
    |       | [`.Add`](<../../📃 Functions 🐍/🐍 System 🔩 functions/🔩 {.Add}.md>) |[num][num]| Same as [`.Sum`](<../🧠🔩 Num holders/Num.Sum 🔩 ext.md>)
    |       | [`.Plus`](<../../📃 Functions 🐍/🐍 System 🔩 functions/🔩 {.Plus}.md>) |[num][num]| Same as [`.Sum`](<../🧠🔩 Num holders/Num.Sum 🔩 ext.md>) | What if we add numbers?
    |       | [`.Minus`](<../../📃 Functions 🐍/🐍 System 🔩 functions/🔩 {.Minus}.md>) |[num][num]| Subtracts numbers
    |       | [`.Times`](<../🧠🔩 Num holders/Num.Times 🔩 ext.md>) |[num][num]| Multiplies numbers
    |       | [`.Calculate`](<../🧠🔩 Num holders/Num.Calculate 🔩 ext.md>) |[num][num]| Calculates formulas
