...
1. **What does a Talker look like for static codes?**
   ...
   Commands: [`BIND`](<🔗 BIND ⌘ cmd.md>) [`IF`](<../../⌘ for control ▶️/IF ⤵️/⤵️ IF ⌘ cmd.md>)
...
1. **What does a Talker look like for holder codes?**
   ...
   Commands: [`BIND`](<🔗 BIND ⌘ cmd.md>) [`EVAL`](<../../⌘ for holders 🧠/EVAL ⬇️/⬇️ EVAL ⌘ cmd.md>) [`IF`](<../../⌘ for control ▶️/IF ⤵️/⤵️ IF ⌘ cmd.md>)
