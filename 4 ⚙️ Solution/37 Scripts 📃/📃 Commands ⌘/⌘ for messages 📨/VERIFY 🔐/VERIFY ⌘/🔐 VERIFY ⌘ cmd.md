...
1. **What type of content can be verified?**
    ...
    |-|-|-
    | [`SCHEMA`](<../VERIFY Schema 🧩/🔐 Schema ⌘ cmd.md>)|| Does it comply with the [Schema Code 🧩](<../../../../../30 🧩 Data/Codes 🧩/🧩 Schema Code.md>)
    | [`MESSAGE`](<../VERIFY Message 📨/🔐 Message ⌘ cmd.md>) | [Domain 👥](<../../../../../40 👥 Domains/👥 Domain/👥 Domain.md>) | Was a [Message 📨](<../../../../../30 🧩 Data/Messages 📨/📨 Message/📨 Message.md>) signed by the [domain 👥](<../../../../../40 👥 Domains/👥 Domain/👥 Domain.md>)?
    ...
    | [`TOKEN`](<../VERIFY Token 🎫/🔐 Token ⌘ cmd.md>) | [Wallet 🧑‍🦰](<../../../../../20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰 Wallet app/🧑‍🦰 Wallet 🛠️ app.md>) | Was a [Token 🎫](<../../../../../30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) signed by the [Issuer 🎴](<../../../../../41 🎭 Domain Roles/Issuers 🎴/🎴 Issuer/🎴🎭 Issuer role.md>)?
