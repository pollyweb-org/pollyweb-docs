...
1. **What's the SELECT syntax?**
    ...
    |Input|Purpose||
    |-|-|-
    | `All` | Uses [`.Format`](<../../../📃 Functions 🐍/🐍🧠 Set functions/{$set.Format}.md>) to format item properties
    | `First` | Uses [`.First`](<../../../📃 Functions 🐍/🐍 System 🔩 functions/🔩 {.First}.md>) and [`.Format`](<../../../📃 Functions 🐍/🐍🧠 Set functions/{$set.Format}.md>) on the 1st item
    | `Last` | Uses [`.Last`](<../../../📃 Functions 🐍/🐍 System 🔩 functions/🔩 {.Last}.md>) and [`.Format`](<../../../📃 Functions 🐍/🐍🧠 Set functions/{$set.Format}.md>) on the last item
