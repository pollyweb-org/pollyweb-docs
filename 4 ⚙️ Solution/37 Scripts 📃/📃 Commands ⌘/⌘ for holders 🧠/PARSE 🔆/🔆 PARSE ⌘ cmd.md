...
1. **What's the PARSE command?**
   ...
   * that parses a [Locator 🔆](<../../../../25 🔆 Locators/Locators 🔆/🔆 Locator.md>) with the [`.Locator`](<../../../📃 Functions 🐍/🐍 System 🔩 functions/parsers/Locator ⓕ.md>) function
   * or a [Schema Code 🧩](<../../../../30 🧩 Data/Codes 🧩/🧩 Schema Code.md>) with the [`.Schema`](<../../../📃 Functions 🐍/🐍 System 🔩 functions/parsers/Schema ⓕ.md>) function.
...
1. **What's the PARSE syntax?**
    ...
    |        | Upon multiple inputs, returns a [map](<../../../📃 Holders 🧠/Map 📚 holders/🧠 Map holders.md>) of outputs
