...
1. **What's the syntax for boolean assertions?**
    ...
    | `<key>` | Input to [`.Assert`](<../../../📃 Holders 🧠/List 📚 holders/Assert ⓕ.md>) a [Holder 🧠](<../../../../35 💬 Chats/Scripts 📃/Holder 🧠.md>) | `From` `$A` [`$lst.A`](<../../../📃 Holders 🧠/List 📚 holders/🧠 List holders.md>)
    | `.f(?)`| Input to [`.Assert`](<../../../📃 Holders 🧠/List 📚 holders/Assert ⓕ.md>) a [{Function} 🐍](<../../../../35 💬 Chats/Scripts 📃/Function 🐍.md>)  | [`.IsIn`](<../../../📃 Holders 🧠/Any 📚 holders/IsIn ⓕ any.md>)`(A,B)`
    | `:<val>` | Input to [`.Assert`](<../../../📃 Holders 🧠/List 📚 holders/Assert ⓕ.md>) with  [`.Is`](<../../../📃 Holders 🧠/Any 📚 holders/Is ⓕ any.md>) | `:any-domain.dom`
    

    > **Note** 
    * If `AllOf`, `AnyOf`, or `OneOf` are set, 
    * then [`.Assert`](<../../../📃 Holders 🧠/List 📚 holders/Assert ⓕ.md>) will only be called if [`.IsNotEmpty`](<../../../📃 Holders 🧠/Any 📚 holders/IsNotEmpty ⓕ any.md>), 
...
1. **What's the simplest syntax?**
    ...
    | Input| Purpose | Examples
    |-|-|-
    | `assertion` | Input to [`.Assert`](<../../../📃 Holders 🧠/List 📚 holders/Assert ⓕ.md>) | `aA.Is(7)`
...
1. **How to assert a [List 🧠](<../../../📃 Holders 🧠/List 📚 holders/🧠 List holders.md>) of [Maps 🧠](<../../../📃 Holders 🧠/Map 📚 holders/🧠 Map holders.md>)?**
    ...
    > Note
    * The [`.Assert`](<../../../📃 Holders 🧠/List 📚 holders/Assert ⓕ.md>) of `C.IsIn(X,Y)` returns `False` because the property `C` doesn't event exist in the third list item.
