...
1. **What are examples of ASSERT usage?**
    ...
    | Scenario | Purpose
    |-|-
    | [`$.Inputs` 🧠 holder](<../../../📃 Holders 🧠/System holders 🔩/$.Inputs 🏃/🏃 $.Inputs 🧠 holder.md>)      | Assert inputs from [`RUN`](<../../⌘ for control ▶️/RUN 🏃/🏃 RUN ⌘ cmd.md>) commands
...
1. **What's the syntax for Multi-field assertions?**
    ...
    | `UUIDs` | Must be a UUID fields| `A,B` `[A,B]` | [`.IsUUID`](<../../../📃 Functions 🐍/🐍 System 🔩 functions/IsUUID ⓕ.md>)
    | `Texts` | Must be [Text 🧠](<../../../📃 Holders 🧠/Input holders 📥/🧠 Text holders.md>) fields | `A,B` `[A,B]` | [`.IsText`](<../../../📃 Functions 🐍/🐍 System 🔩 functions/IsText ⓕ.md>)
