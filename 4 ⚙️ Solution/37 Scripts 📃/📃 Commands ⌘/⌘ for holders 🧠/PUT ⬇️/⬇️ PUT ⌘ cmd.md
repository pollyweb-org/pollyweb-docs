...
1. **What's the [`PUT`](<⬇️ PUT ⌘ cmd.md>) syntax?**
    ...
    | `PUT\|$lst >> $out: *` | Formats a [List 🧠 holder](<../../../📃 Holders 🧠/🧠 Input holders/List holders.md>) with [`.Format`](<../../../📃 Holders 🧠/🧠🔩 Set extensions/Set.Format 🔩 ext.md>)
    || Equals [`CALL`](<../CALL 🧮/🧮 CALL ⌘ cmd.md>)`\|`[`.Format`](<../../../📃 Holders 🧠/🧠🔩 Set extensions/Set.Format 🔩 ext.md>)` >> $out: $lst,*`
