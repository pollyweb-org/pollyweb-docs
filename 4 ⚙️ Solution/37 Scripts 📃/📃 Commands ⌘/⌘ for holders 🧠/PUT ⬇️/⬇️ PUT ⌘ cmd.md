...
1. **What's the [`PUT`](<⬇️ PUT ⌘ cmd.md>) syntax?**
    ...
    | `PUT\|$lst >> $out: *` | Formats a [List 🧠 holder](<../../../📃 Holders 🧠/🧠🔩 List holders/List holders.md>) with [`.Format`](<../../../📃 Holders 🧠/🧠🔩 Set holders/set.Format2 🔩 ext.md>)
    || Equals [`CALL`](<../CALL 🧮/🧮 CALL ⌘ cmd.md>)`\|`[`.Format`](<../../../📃 Holders 🧠/🧠🔩 Set holders/set.Format2 🔩 ext.md>)` >> $out: $lst,*`
