...
1. **What's the WAIT syntax?**
    ...
    | Input| Purpose
    |-|-
    | `Timeout`  | Time to wait, evaluated by the [`.Add`](<../../../📃 Functions 🐍/🐍 System 🔩 functions/Add ⓕ any.md>) function
...
1. **How to build a clock?**
    ...
    Uses: [`.Now`](<../../../📃 Functions 🐍/🐍 System 🔩 functions/Now ⓕ.md>) [`REPEAT`](<../../⌘ for control ▶️/REPEAT 🔁/🔁 REPEAT ⌘ cmd.md>) [`TEMP`](<../../../📃 Prompts 🤔/🤔 Status ⚠️ prompts/TEMP ⏳/TEMP ⏳ prompt.md>) [`WAIT`](<🧘 WAIT ⌘ cmd.md>)
