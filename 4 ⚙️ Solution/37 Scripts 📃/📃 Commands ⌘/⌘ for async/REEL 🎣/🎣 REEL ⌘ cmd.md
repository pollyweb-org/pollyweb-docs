...
1. **What's the syntax of REEL for Async Messages?**
    ...
    | Input| Purpose |
    |-|-
    | `$hook`| [Hooks 🪣 item](<../../../../35 💬 Chats/Talkers 😃/😃🪣 Talker tables/Wait 🧘 » Race 🏁/😃 Talker.Waits 🪣 table.md>) saved by the [Command ⌘](<../../../../35 💬 Chats/Scripts 📃/Command ⌘.md>) | -
...
1. **What's an example of REEL?**
    ...
    Consider the [`BIND` flow command](<../../../../41 🎭 Domain Roles/Vaults 🗄️/🗄️⌘ Vault cmds/BIND 🔗/🔗 BIND ⌘ cmd.md>).
    ...
    Here's the handler of [`Bound@Broker`](<../../../../41 🎭 Domain Roles/Vaults 🗄️/🗄️📨 Vault msgs/Bound 🤵🐌🗄️/🗄️ Bound 🐌 msg.md>)
    ...
    |-|-
    | 🧲 [`READ`](<../../⌘ for datasets 🪣/READ 🧲/🧲 READ ⌘ cmd.md>) | Get the [`Hook` 🪣](<../../../../35 💬 Chats/Talkers 😃/😃🪣 Talker tables/Wait 🧘 » Race 🏁/😃 Talker.Waits 🪣 table.md>) from [`Bind@Broker`](<../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵📨 Broker msgs/Binds 🔗 Bind 🗄️🐌🤵/🤵 Bind 🐌 msg.md>)  
