...
1. **How to use an UNDO?**
    ...
    Uses: [`CASE`](<../../⌘ for control ▶️/CASE ⏯️/⏯️ CASE ⌘ cmd.md>) [`DELETE`](<../DELETE 🗑️/🗑️ DELETE ⌘ cmd.md>) [`DONE`](<../../../📃 Prompts 🤔/🤔 Status ⚠️ prompts/DONE ✅/DONE ✅ prompt.md>)
...
1. **What's a use case for soft deletes?**
    ...
    See [Pop Token 🔆](<../../../../20 🧑‍🦰 UI/Brokers 🤵/🤵😃 Broker talkers/PopToken 🎫 talker/Token/🤵 PopToken 😃 handler.md>).
