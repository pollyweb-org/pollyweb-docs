...
1. **What is a Graph domain in NLWeb?**
    ...
    * that subscribes to [domain Manifest 📜](<../../40 👥 Domains/44 📜 Manifests/01 📜 Domain Manifest.md>) change events from [Listener 👂 domains](<../10 👂 Listeners/$ 👂🛠️ Listener helper.md>)
