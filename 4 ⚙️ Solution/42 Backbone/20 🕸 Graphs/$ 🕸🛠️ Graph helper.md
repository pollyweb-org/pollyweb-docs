...
1. **What can domains use Graphs for?**
    ...
    | [🏭 Supplies](<../../41 🎭 Domain Roles/78 🏭 Suppliers/02 🏭🎭 Supplier role.md>) | What are the asynchronous [Supplies 🏭](<../../41 🎭 Domain Roles/78 🏭 Suppliers/02 🏭🎭 Supplier role.md>) of [domain 👥](<../../40 👥 Domains/41 📨 Messages/00 👥 Domain.md>) `D`?
...
1. **How are NLWeb Graphs updated?**
    ...
    - To allow any graph to subscribe to changes in any [domain Manifests 📜](<../../40 👥 Domains/44 📜 Manifests/$ 📜 Domain Manifest.md>), NLWeb provides a cluster of [Listener 👂 nodes](<../10 👂 Listeners/$ 👂🛠️ Listener helper.md>) for [domains 👥](<../../40 👥 Domains/41 📨 Messages/00 👥 Domain.md>) to publish change notifications to, and for [Graph 🕸 domains](<$ 🕸🛠️ Graph helper.md>) to receive notifications from. 
...
1. **How can domains reset their Manifest representation on Graphs?**
    ...
    * a [domain 👥](<../../40 👥 Domains/41 📨 Messages/00 👥 Domain.md>) can send a RESET event to their [Listener 👂 helper domain](<../10 👂 Listeners/$ 👂🛠️ Listener helper.md>);
...
1. **How is a new NLWeb trust graph populated?**
    ...
    * it can ask a [Listener 👂 domain](<../10 👂 Listeners/$ 👂🛠️ Listener helper.md>) 
