...
1. **What is a Graph domain in NLWeb?**
    ...
    * that subscribes to [domain Manifest 📜](<../../40 👥 Domains/44 📜 Manifests/01 📜 Domain Manifest.md>) change events from [Listener 👂 domains](<../../40 👥 Domains/45 👂 Backbone/02 👂🛠️ Listener helper.md>)
...
1. **How are NLWeb Graphs updated?**
    ...
    - To allow any graph to subscribe to changes in any [domain Manifests 📜](<../../40 👥 Domains/44 📜 Manifests/01 📜 Domain Manifest.md>), NLWeb provides a cluster of [Listener 👂 nodes](<../../40 👥 Domains/45 👂 Backbone/02 👂🛠️ Listener helper.md>) for [domains 👥](<../../40 👥 Domains/41 📨 Messages/00 👥 Domain.md>) to publish change notifications to, and for [Graph 🕸 domains](<03 🕸🛠️ Graph helper.md>) to receive notifications from. 
...
1. **How can domains reset their Manifest representation on Graphs?**
    ...
    * a [domain 👥](<../../40 👥 Domains/41 📨 Messages/00 👥 Domain.md>) can send a RESET event to their [Listener 👂 helper domain](<../../40 👥 Domains/45 👂 Backbone/02 👂🛠️ Listener helper.md>);
...
1. **How is a new NLWeb trust graph populated?**
    ...
    * it can ask a [Listener 👂 domain](<../../40 👥 Domains/45 👂 Backbone/02 👂🛠️ Listener helper.md>) 
