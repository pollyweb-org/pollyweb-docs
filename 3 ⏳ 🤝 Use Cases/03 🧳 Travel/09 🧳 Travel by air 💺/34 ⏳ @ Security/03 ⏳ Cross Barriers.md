...
1. **How to pass a terminal gate at an airport with a token?**
    ...
    Airport terminal gates typically require users to scan their flight tickets to pass 
    - the airport verifies:
        - if the user is in right terminal, 
        - if the ticket is for the day, 
...
1. **How to pass gates at an airport?**

    When interacting in closed environments where authentication is required in every interaction point (e.g., gates and stores at an airport), users can opt to use their biometrics as tokens.
