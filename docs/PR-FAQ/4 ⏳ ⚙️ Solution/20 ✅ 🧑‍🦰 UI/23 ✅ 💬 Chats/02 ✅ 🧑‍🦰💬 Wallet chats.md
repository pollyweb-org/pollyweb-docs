🧑‍🦰💬 Chat user experience (UX) FAQ
===

1. **How does a user open a new chat window with a domain?**

    To open a new chat window with a domain, a user needs the domain's NLWeb [Locator 🔆](<../22 ✅ 🔆 Locators/01 ✅ 🔆 Locator.md>) contained in a QR code, NFC tag, web link, or chat option: 
...
1. **What if the user doesn't have the domain's Locator?**
    ...
    If a user doesn't know exactly where to find a [Locator 🔆](<../22 ✅ 🔆 Locators/01 ✅ 🔆 Locator.md>), they can use the [Finder 🔎](<../../30 ⏳ 🫥 Agents/10 ⏳ 🔎 Finders/02 ⏳ 🔎🫥 Finder vault.md>) domain to search for it;
...
1. **How can users contribute to a domain's reputation?**
    ...
    * Wallets share this feedback collaboratively with other Wallets via [Reviewer ⭐](<../../30 ⏳ 🫥 Agents/10 ⏳ 🔎 Finders/01 ✅ ⭐🫥 Reviewer vault.md>) domains. 
