...
1. **What's an IF flow?**
    ...
    * based on the evaluation of a placeholder or [{Function}](<../Data/12 🐍 {Function}.md>).
...
1. **How are values evaluated to booleans?**
    ...
    [Confirm 👍](<../Prompts/30 Input prompts/31 👍 CONFIRM prompt.md>) |  no | `No` | yes | `Yes`|
    [Share 💼](<../Messages/45 💼 SHARE msg.md>) | empty | `{}`| non-empty | `{A:1}`
...
1. **What's the `IF` syntax?**
    ...
    || Defaults to the last [input prompt ✏️](<../Prompts/10 Prompt definitions/09 ✏️ as Input.md>) | `TEXT\|Id?`
