...
1. **What are Flow commands?**
    ...
    | 🫥 [`EMOJI`](<../16 😶 EMOJI flow.md>) | Changes the [default emoji 😃](<../Prompts/25 Input defintions/14 ✏️😶 Input emojis.md>) for [input prompts ✏️](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/31 🤔 Prompts/11 ✏️ Input behavior.md>).
