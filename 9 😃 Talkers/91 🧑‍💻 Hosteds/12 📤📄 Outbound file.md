...
1. **How does the Outbound proxy work?**
    ...
    * receives unsigned [Messages 📨](<../../4 ⚙️ Solution/40 👥 Domains/41 📨 Messages/$ 📨 Domain Message.md>) from the [domain 👥](<../../4 ⚙️ Solution/40 👥 Domains/$ 👥 Domains/👥 Domain.md>), 
    * signs them with the [DKIM 📨](<../../4 ⚙️ Solution/40 👥 Domains/41 📨 Messages/$ 📨 Domain Message.md>) private key, 
