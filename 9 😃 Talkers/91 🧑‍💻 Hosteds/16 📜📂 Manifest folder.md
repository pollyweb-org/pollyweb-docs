...
1. **What is the structure of a Manifest?**
    ...
    * `📜 Manifest/` 
        * [`👥 Identity.yaml`](<../../4 ⚙️ Solution/45 🛠️ Helper domains/50 🕸 Graphs/🕸🅰️ Graph methods/04 👥🚀🕸 Identity.md>) 
        * `📝 Forms/`   
            * [`📝 FORM-1.yaml`](<../../4 ⚙️ Solution/45 🛠️ Helper domains/50 🕸 Graphs/🕸🅰️ Graph methods/01 👥🚀🕸 Form.md>)
        * `🧩 Codes/` 
            * [`🧩 CODE-1.yaml`](<../../4 ⚙️ Solution/45 🛠️ Helper domains/50 🕸 Graphs/🕸🅰️ Graph methods/08 👥🚀🕸 Schema.md>)
            * `GROUP-A/`
                * [`🧩 CODE-A2.yaml`](<../../4 ⚙️ Solution/45 🛠️ Helper domains/50 🕸 Graphs/🕸🅰️ Graph methods/08 👥🚀🕸 Schema.md>)
        * `👍 Trusts/` 
