...
1. **What is required from domain owners?**
    ...
    | [🆔 Identity](<../../4 ⚙️ Solution/50 🫥 Agents/45 🆔 Identities/01 🆔🫥 Identity agent.md>) | To authenticate the domain user.
    | [🗂️ Folder](<../../4 ⚙️ Solution/45 🛠️ Helper domains/45 🗂️ Folders/$ 🗂️ Folder editor.md>) | To manage the settings of the hosted [domain 👥](<../../4 ⚙️ Solution/40 👥 Domains/$ 👥 Domains/00 👥 Domain.md>).
