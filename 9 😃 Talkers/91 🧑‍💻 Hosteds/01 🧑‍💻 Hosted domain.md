...
1. **How to set up a Hosted domain?**
    ...
    |#|Step
    |-|-
    |1| [Bind 🔗](<../../4 ⚙️ Solution/25 Data/24 🗄️ Vaults/01 🔗 Bind.md>) to a [Hoster ☁️ domain](<../90 ☁️ Hosters/05 ☁️🛠️ Hoster helper.md>)
...
1. **What domain files are cloned locally?**
    ...
    | [🛠️ Helpers](<13 🛠️📄 Helpers file.md>)  | YAML | Required [Helper 🛠️ domains](<../../4 ⚙️ Solution/45 Helpers/$ 🛠️ Helpers/05 🛠️👥 Helper domain.md>)
...
1. **What is required from domain owners?**
    ...
    | [🗂️ Folder](<../../4 ⚙️ Solution/45 Helpers/26 🗂️ Folders/01 🗂️ Folder editor.md>) | To manage the settings of the hosted [domain 👥](<../../4 ⚙️ Solution/40 👥 Domains/41 📨 Messages/00 👥 Domain.md>).
