...
1. **What is a Resourcer role?**
    ...
    A [domain 👥](<../../4 ⚙️ Solution/40 👥 Domains/44 📜 Manifests/00 👥 Domain.md>) with a [Resourcer 🗃️ role](<02 🗃️🎭 Resourcer role.md>)
    * is any [domain 👥](<../../4 ⚙️ Solution/40 👥 Domains/44 📜 Manifests/00 👥 Domain.md>) that stores files
...
1. **What API messages do Resources expose?**
    ...
    |-|-|-
    |[⏩ Clone](<../../5 ⏩ Flows/77 🔃⏩ Syncer/10 🔃⏩🗃️ Clone.md>)|[`Clone`](<../../6 🅰️ APIs/78 🗃️🅰️ Resourcer/10 🔃🚀🗃️ Clone.md>) | Registers [Syncers 🔃 ](<../../9 😃 Talkers/90 ☁️ Hosters/01 🔃🛠️ Syncer tool.md>) on [Resourcers 🗃️](<../../9 😃 Talkers/90 ☁️ Hosters/02 🗃️🎭 Resourcer role.md>)
