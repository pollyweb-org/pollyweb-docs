...
1. **What is a Resourcer role?**
    ...
    A [domain 👥](<../../4 ⚙️ Solution/40 👥 Domains/41 📨 Messages/00 👥 Domain.md>) with a [Resourcer 🗃️ role](<02 🗃️🎭 Resourcer role.md>)
    * is any [domain 👥](<../../4 ⚙️ Solution/40 👥 Domains/41 📨 Messages/00 👥 Domain.md>) that stores files
