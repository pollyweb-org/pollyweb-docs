...
1. **What domains roles does a Hoster implement?**
    ...
    | `And also` | [`Issuer 🎴`](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/25 🎫 Tokens/02 🎴🎭 Issuer role.md>) [`Vault 🗄️`](<../../4 ⚙️ Solution/41 🎭 Domain Roles/80 🗄️ Vault/03 🗄️🎭 Vault role.md>) [`Consumer 💼`](<../../4 ⚙️ Solution/41 🎭 Domain Roles/27 💼 Consumers/04 💼🎭 Consumer role.md>)
