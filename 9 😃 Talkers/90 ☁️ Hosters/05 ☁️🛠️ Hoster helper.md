...
1. **What domains roles does a Hoster implement?**
    ...
    | [😃 Talker](<../10 📘 Talker specs/10 😃 Talker.md>) | To manage [Chat 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) workflows
    | [🤗 Host](<../../20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) | For interacting with [Wallet 🧑‍🦰](<../../20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) in [Chats 💬](<../../20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>)
    ...
    |  | [`Seller 💵`](<../../4 ⚙️ Solution/30 🫥 Agents/04 💳 Payers/01 💵🎭 Seller role.md>) [`Subscriber 🔔`](<../../../4 ⚙️ Solution/40 👥 Domains/41 📨 Comms/04 🔔🎭 Subscriber role.md>)
...
1. **How to bootstrap?**
    ...
    | [🤵 Broker](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/03 🤵 Brokers/03 🤵 Broker domain.md>) | 🫥 Bind [Yes, No, +]<br/>- [ Host Personalize 🧩 ](<../../7 🧩 Codes/HOST/🧩 HostPersonalize.md>) | > Yes 
