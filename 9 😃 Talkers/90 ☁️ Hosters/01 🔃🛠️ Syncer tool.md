...
1. **What commands are supported on the terminal?**
    ...
    |[⏩ `chat`](<../../4 ⚙️ Solution/41 🎭 Domain Roles/60 🗃️ Resourcers/🗃️🅰️ Resourcer methods/🔃🐌🗃️ Chat.md>)| Opens [Chats 💬](<../../4 ⚙️ Solution/35 Chats/12 💬 Chats/$ 💬 Chat.md>) with [Resourcer 🗃️ domains](<../../4 ⚙️ Solution/41 🎭 Domain Roles/60 🗃️ Resourcers/🗃️🎭 Resourcer role.md>)
