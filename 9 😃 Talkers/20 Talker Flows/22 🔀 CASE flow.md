...
1. **What's a CASE flow?**
    ...
    * that runs a matching [Procedure ⚙️](<../../33 😃 Talkers/11 ⚙️ Procedure.md>) or [Command ⌘](<../../33 😃 Talkers/10 ⌘ Command.md>) 
    * based on the evaluation of a [{Function}](<../../33 😃 Talkers/12 🐍 {Function}.md>).
...
1. **What's the syntax?**
    ...
    |-|-|-
    | `{function}` | Optional [{Function}](<../../33 😃 Talkers/12 🐍 {Function}.md>) to evaluate | `{f}` `{$p}`
    ...
    | `<action>`| Run a [Procedure ⚙️](<../../33 😃 Talkers/11 ⚙️ Procedure.md>) | `MyProc`
    || or a one-line [Command ⌘](<../../33 😃 Talkers/10 ⌘ Command.md>). | `INFO\|OK`
    ...
    | Argument| Purpose
    |-|-
    | `<cmd-n>`| Run a multi-line [Command ⌘](<../../33 😃 Talkers/10 ⌘ Command.md>) list.
...
1. **What's an example with inputs?**
    ...
    | [Domain](<../../4 ⚙️ Solution/40 👥 Domains/44 📜 Manifests/00 👥 Domain.md>) | [Prompt](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/31 🤔 Prompts/01 🤔 Prompt.md>) | [User](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>)
    | - | - | - |
    | [🤗 Host](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) | 😃 [Select an option.](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/31 🤔 Prompts/53 1️⃣ ONE prompt.md>) <br/> - [ A ] <br/> - [ B ] <br/> - [ C ] | > B
