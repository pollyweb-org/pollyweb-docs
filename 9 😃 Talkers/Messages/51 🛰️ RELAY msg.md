...
1. **What's the syntax?**
    ...
    | `<failure>` | [Procedure ⚙️](<../Flow/11 ⚙️ Procedure.md>) or [Command ⌘](<../Flow/10 ⌘ Command.md>) to run on failure
    | `<success>` | [Procedure ⚙️](<../Flow/11 ⚙️ Procedure.md>) or [Command ⌘](<../Flow/10 ⌘ Command.md>) to run on success
