...
1. **What is a BIND message command?**
    ...
    A `BIND`
    * is a message [Command ⌘](<../Flow/10 ⌘ Command.md>) 
...
1. **What does a [Chat 💬](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) look like for optional binds?**
    ...
    | 🗄️ [Vault](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) | ✅ [Done! Your wallet is bound.](<../Prompts/20 Status prompts/23 ✅ SUCCESS prompt.md>)
