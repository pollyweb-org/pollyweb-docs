...
1. **What's the syntax?**
    ...
    | Argument| Purpose
    |-|-
    | `<message>`| Optional message for a [CONFIRM 👍 prompt](<../50 🤔 Prompts/7 ✏️ Input prompts/31 👍 CONFIRM prompt.md>)
...
1. **What's an example of a repeat without a message?**
    ...
    |-|-
    | 🔄 [`QUANTITY`](<../50 🤔 Prompts/7 ✏️ Input prompts/42 🔄 QUANTITY prompt.md>) | To wait for user input.
