...
1. **What are Flow commands?**
    ...
    | 🫥 [`EMOJI`](<../50 🤔 Prompts/2 ✏️ Input specs/16 😶⌘ EMOJI cmd.md>) | Changes the [default emoji 😃](<../50 🤔 Prompts/2 ✏️ Input specs/14 ✏️😶 Input emojis.md>) for [input prompts ✏️](<../50 🤔 Prompts/1 📘 Prompt specs/09 ✏️ Input behavior.md>).
