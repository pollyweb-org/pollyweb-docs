...
1. **How to set up a Hosted domain?**
    ...
    |#|Step
    |-|-
    |1| [Bind 🔗](<../../4 ⚙️ Solution/30 🧩 Data/20 🔗 Binds/🔗 Bind.md>) to a [Hoster ☁️ domain](<../../4 ⚙️ Solution/45 🛠️ Helper domains/55 ☁️ Hosters/05 ☁️🛠️ Hoster helper.md>)
...
1. **What domain files are cloned locally?**
    ...
    | [🛠️ Helpers](<📦📄 Hosted files/🛠️📄 Helpers file.md>)  | YAML | Required [Helper 🛠️ domains](<../../4 ⚙️ Solution/45 🛠️ Helper domains/$ 🛠️ Helpers/🛠️👥 Helper domain.md>)
...
1. **What is required from domain owners?**
    ...
    | [🗂️ Folder](<../../4 ⚙️ Solution/45 🛠️ Helper domains/35 🧑‍💻 Editors/🧑‍💻 Editor.md>) | To manage the settings of the hosted [domain 👥](<../../4 ⚙️ Solution/40 👥 Domains/$ 👥 Domains/👥 Domain.md>).
