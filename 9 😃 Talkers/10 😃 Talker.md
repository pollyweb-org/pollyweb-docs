...
1. **What is a Talker?**
    ...
    * referencing [{Functions} 🐍](<😃🗃️ Talker data/12 🐍 {Function}.md>) evaluated by [Hosted 📦 domains](<../4 ⚙️ Solution/90 👷 Build/91 📦 Hosteds/📦👥 Hosted domain.md>)
...
1. **What flows are initiated by Talkers?**
    ...
    |Flow|Details
    |-|-
    | [😃⏩🧑‍💻 Handle 🐍](<../5 ⏩ Flows/79 😃⏩ Talkers/20 😃⏩🧑‍💻 Handle 🐍.md>) | Ask [Hosteds 📦](<../4 ⚙️ Solution/90 👷 Build/91 📦 Hosteds/📦👥 Hosted domain.md>) to handle [{Functions} 🐍](<😃🗃️ Talker data/12 🐍 {Function}.md>)
