...
1. **What are blocking inputs?**
    ...
    * e.g., date, number, radio, checklist;
    ...
    ||Section | Details
    |-|- | -
    ||[⏭️ Input nullability](<../2 ✏️ Input specs/12 ✏️⏭️ Input nullability.md>) | Allow inputs to be optional.
    ||[📋 Input validation](<../2 ✏️ Input specs/13 ✏️📋 Input validation.md>) | Client versus Server side validation.
    ||[😶 Input emojis](<../2 ✏️ Input specs/14 ✏️😶 Input emojis.md>) | Changing the default emojis.
...
1. **What are the blocking formats available?**
    ...
    | [🔄&nbsp;QUANTITY](<../7 ✏️ Input prompts/42 🔄 QUANTITY prompt.md>) | Shows up/down arrows.
    ...
    | [🔆&nbsp;SCAN](<../7 ✏️ Input prompts/72 🔆 SCAN prompt.md>) | Asks to touch/scan a [QR/NFC Locator 🔆](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/11 🔆 Locators/01 🔆 Locator.md>)
    ...
    | [👤&nbsp;IDENTIFY](<../7 ✏️ Input prompts/71 👤 IDENTIFY prompt.md>) | Asks the user's [Identity 🆔 agent](<../../../4 ⚙️ Solution/30 🫥 Agents/05 🆔 Identities/01 🆔🫥 Identity agent.md>) to verify the user
