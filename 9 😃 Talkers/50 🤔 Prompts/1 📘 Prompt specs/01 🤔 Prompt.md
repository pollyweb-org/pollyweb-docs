...
1. **What input formats can Hosts ask Wallets to render?**
    ...
    * The supported [Prompt 🤔](<01 🤔 Prompt.md>) formats are as follow.
    ...
    |[`Inputs`](<09 ✏️ Input behavior.md>)| [`🔢 DIGITS`](<../7 ✏️ Input prompts/44 🔢 DIGITS prompt.md>) [`🔄 QUANTITY`](<../7 ✏️ Input prompts/42 🔄 QUANTITY prompt.md>) [`💰 AMOUNT`](<../7 ✏️ Input prompts/43 💰 AMOUNT prompt.md>) [`🔑 OTP`](<../7 ✏️ Input prompts/57 🔑 OTP prompt.md>) [`⭐ RATE`](<../7 ✏️ Input prompts/46 ⭐ RATE prompt.md>) 
...
1. **What are features of Prompts?**
    ...
    | ✏️ [ ✏️ `Input`](<09 ✏️ Input behavior.md>) | Waits for an answer from users.
