...
1. **What are expandable details?**
    ...
    Expandible details
    * are additional notes of any [Prompt 🤔](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/31 🤔 Prompts/01 🤔 Prompt.md>)
...
1. **What's the format for a [Talker 😃](<../../01 😃 Talker.md>)?**
    ...
    |-|-|-
    | `<PROMPT>` | A [Prompt 🤔](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/31 🤔 Prompts/01 🤔 Prompt.md>) format. | `INFO` `TEMP`
...
1. **What's an example in a [Chat 💬](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>)?**
    ...
    |-|-
    | ℹ️ [`INFO`](<../20 Status prompts/21 ℹ️ INFO prompt.md>) | To show the messages and details.
