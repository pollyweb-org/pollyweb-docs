...
1. **Can prompt options be deferred?**
    ...
    * [Prompt options](<04 🤔🔘 with Options.md>) can be differed with [non-blocking status Prompts 🤔](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/31 🤔 Prompts/08 ⚠️ Status behavior.md>);../../../4 ⚙️ Solution/20 🧑‍🦰 UI/31 🤔 Prompts/08 ⚠️ Status behavior.md
        ...
        * [Host 🤗 domains](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) speed-up [Chats 💬](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) by taking unilateral two-way-door decisions that can be reverted by users even after other [Prompts 🤔](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/31 🤔 Prompts/01 🤔 Prompt.md>)../../../4 ⚙️ Solution/20 🧑‍🦰 UI/31 🤔 Prompts/01 🤔 Prompt.md.
...
1. **What are the prompts with options?**
    ...
    |Behavior| [Prompt 🤔](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/31 🤔 Prompts/01 🤔 Prompt.md>) 
    |-|-
    |[`Status`](<../20 Status prompts/23 ✅ SUCCESS prompt.md>) [`❌ FAILURE`](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/31 🤔 Prompts/24 ❌ FAILURE prompt.md>)
    |[`Inputs`](<../30 Input prompts/32 🔠 TEXT prompt.md>) 
...
1. **What's the format for a [Talker 😃](<../../01 😃 Talker.md>)?**
    ...
    |-|-|-
    | `<PROMPT>` | A [Prompt 🤔](<../20 Status prompts/25 ⏳ TEMP prompt.md>)
    ...
    || and uses `§` for [Locators 🔆](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/11 🔆 Locators/01 🔆 Locator.md>). | `Open § {$url}`
...
1. **What's an example in a [Chat 💬](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>)?**
    ...
    > Note: [non-blocking status prompts ⚠️](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/31 🤔 Prompts/08 ⚠️ Status behavior.md>) behave slightly differently.
    ...
    |-|-
    | 1️⃣ [`ONE`](<../30 Input prompts/53 1️⃣ ONE prompt.md>) | To show the options.
