...
1. **What's the syntax?**
    ...
    | Argument| Purpose
    |-|-
    | `<message>`| Optional message for a [CONFIRM 👍 prompt](<../3 Prompts/30 Input prompts/31 👍 CONFIRM prompt.md>)
...
1. **What's an example of a repeat without a message?**
    ...
    |-|-
    | 🔄 [`QUANTITY`](<../3 Prompts/30 Input prompts/42 🔄 QUANTITY prompt.md>) | To wait for user input.
...
1. **How to build a simple shopping basket?**
    ...
    | [Command ⌘](<10 ⌘ Command.md>) | Purpose
    |-|-
    | 👍 [`CONFIRM`](<../3 Prompts/30 Input prompts/31 👍 CONFIRM prompt.md>) | To wait for user confirmation.
    | ⬇️ [`EVAL`](<../2 Data/20 ⬇️ EVAL flow.md>) | To add an item to the database.
...
1. **How to build a simple game?**
    ...
    | [🤗 Host](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) | 😃 Say a number from 1 to 9. | 🔄 3
    | [🤗 Host](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) | ❌ You have 2 more tries.
    | [🤗 Host](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) | 😃 Say a number from 1 to 9. | 🔄 1
    | [🤗 Host](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) | ❌ It's your last try.
    | [🤗 Host](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) | 😃 Say a number from 1 to 9. | 🔄 7
    ...
    | [Command ⌘](<10 ⌘ Command.md>) | Purpose
    |-|-
    | ⬇️ [`EVAL`](<../2 Data/20 ⬇️ EVAL flow.md>) | To generate a random number a subtract tries.
