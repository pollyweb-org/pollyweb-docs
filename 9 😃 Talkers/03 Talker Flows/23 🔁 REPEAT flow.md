...
1. **What's the syntax?**
    ...
    | Argument| Purpose
    |-|-
    | `<message>`| Optional message for a [CONFIRM 👍 prompt](<../3 Prompts/30 ✏️🤔 Input prompts/31 👍 CONFIRM prompt.md>)
...
1. **What's an example of a repeat without a message?**
    ...
    |-|-
    | 🔄 [`QUANTITY`](<../3 Prompts/30 ✏️🤔 Input prompts/42 🔄 QUANTITY prompt.md>) | To wait for user input.
...
1. **How to build a simple shopping basket?**
    ...
    | [Command ⌘](<10 ⌘ Command.md>) | Purpose
    |-|-
    | 👍 [`CONFIRM`](<../3 Prompts/30 ✏️🤔 Input prompts/31 👍 CONFIRM prompt.md>) | To wait for user confirmation.
    | ⬇️ [`EVAL`](<../03 Talker Data/20 ⬇️ EVAL flow.md>) | To add an item to the database.
...
1. **How to build a simple game?**
    ...
    | [Command ⌘](<10 ⌘ Command.md>) | Purpose
    |-|-
    | ⬇️ [`EVAL`](<../03 Talker Data/20 ⬇️ EVAL flow.md>) | To generate a random number a subtract tries.
