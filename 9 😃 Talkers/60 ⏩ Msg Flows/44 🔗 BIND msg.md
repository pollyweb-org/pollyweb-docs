...
1. **What is a BIND message command?**
    ...
    A `BIND`
    * is a message [Command ⌘](<../../../../../../9 😃 Talkers/40 🌊 Talker flows/10 ⌘ Command.md>) 
...
1. **What's the BIND syntax?**
   ...
   ```
    ...
    | Argument| Purpose
    |-|-
    | `{bindable}` | [{Function}](<../30 🗃️ Talker data/12 🐍 {Function}.md>) to get the [Codes 🧩](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/24 🗄️ Vaults/02 🧩 Schema Code.md>) for [Bindable @ Broker](<../../6 🅰️ APIs/15 🤵🅰️ Broker/40 🤵🅰️ Binds 🔗/42 🗄️🐌🤵 Bindable.md>).
...
1. **What does a Talker look like for static codes?**
   ...
   |-|-
   | ⤵️ [IF](<../../../../../../9 😃 Talkers/40 🌊 Talker flows/21 ⤵️ IF flow.md>) | To verify the result.  
