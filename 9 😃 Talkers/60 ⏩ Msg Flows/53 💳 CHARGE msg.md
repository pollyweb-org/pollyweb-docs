...
1. **What's the syntax?**
   ...
   * May have a [Biller 🤝](<../../4 ⚙️ Solution/30 🫥 Agents/04 💳 Payers/06 🤝🛠️ Biller helper.md>) ID for multiple [Collectors 🏦](<../../4 ⚙️ Solution/45 Helpers/18 🏦 Collectors/$ 🏦🛠️ Collector helper.md>).
