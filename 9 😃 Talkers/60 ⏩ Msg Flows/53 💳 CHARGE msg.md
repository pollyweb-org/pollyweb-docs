...
1. **What's the syntax?**
   ...
   * May have a [Biller 🤝](<../../4 ⚙️ Solution/45 🛠️ Helper domains/15 🤝 Billers/$ 🤝🛠️ Biller helper.md>) ID for multiple [Collectors 🏦](<../../4 ⚙️ Solution/45 🛠️ Helper domains/18 🏦 Collectors/$ 🏦🛠️ Collector helper.md>).
