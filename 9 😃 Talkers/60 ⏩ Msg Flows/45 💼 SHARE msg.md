...
1. **What is a SHARE message command?**
    ...
    * that asks for user data in [Schema Codes 🧩](<../../4 ⚙️ Solution/25 Data/24 🗄️ Vaults/02 🧩 Schema Code.md>)
...
1. **What's the SHARE syntax?**
    ...
    | Argument| Purpose
    |-|-
    | `<code-n>`  | [Schema Codes 🧩](<../../4 ⚙️ Solution/25 Data/24 🗄️ Vaults/02 🧩 Schema Code.md>) for [`Query@Broker`](<../../6 🅰️ APIs/15 🤵🅰️ Broker/60 🤵🅰️ Share/61 💼🐌🤵 Query.md>) <br/>For readability, a dot replaces `nlweb.org/`
...
1. **What does the dot mean in a code?**
    ...
    Given that the [Schema Codes 🧩](<../../4 ⚙️ Solution/25 Data/24 🗄️ Vaults/02 🧩 Schema Code.md>) defined by `nlweb.org` will be widely used, 
...
1. **What does a [Chat 💬](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) look like?**
    ...
    | Data | [Schema Code 🧩](<../../4 ⚙️ Solution/25 Data/24 🗄️ Vaults/02 🧩 Schema Code.md>)
    |-|-
...
1. **What are use cases of SHARE?**
    ...
    | [🗓️ Scheduler](<../../4 ⚙️ Solution/30 🫥 Agents/75 🗓️ Schedulers/04 🗓️🗄️ Scheduler agent.md>) | [Date and time for a table reservation 🍽️](<../../3 🤝 Use Cases/02 🍲 Eat & Drink/60 🍽️ Restaurants/31 🌐 Web: Book table 🗓️.md>)
