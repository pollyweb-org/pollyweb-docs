...
1. **What's the SHARE syntax?**
    ...
    | `$shared`| An object returned by [`Collect@Vault`](<../../4 ⚙️ Solution/41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🅰️ Vault API/💼🚀🗄️ Collect.md>).<br/> Or a Token list from [`Receive@Consumer`](<../../6 🅰️ APIs/30 💼🅰️ Consumer/03 🧑‍🦰🐌💼 Receive.md>).
