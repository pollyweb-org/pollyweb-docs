...
1. **What is an INFORM message command?**
    ...
    * and passing the form key in the Host's [Manifest 📜](<../../4 ⚙️ Solution/40 👥 Domains/44 📜 Manifests/📜 Manifest.md>).
...
1. **What's the INFORM syntax?**
    ...
    | Argument| Purpose
    |-|-
    | `<key>` | Form key for [`Form@Graph`](<../../4 ⚙️ Solution/45 🤲 Helper domains/50 🕸 Graphs/🕸🅰️ Graph methods/👥🚀🕸 Form.md>)
...
1. **What's an example of INFORM?**
    ...
    | - | - | - |
    | 🤵 [Broker](<../../4 ⚙️ Solution/45 🤲 Helper domains/24 🤵 Brokers/🤵🤲 Broker helper.md>) | 🫥 Ready to order? [Yes, No] <br/> - your curator orders 🧚<br/>  - your payer pays the bill 💳  | > Yes
    |
    ...
    Here's the [Manifest 📜](<../../4 ⚙️ Solution/40 👥 Domains/44 📜 Manifests/📜 Manifest.md>).
    ```yaml
    Forms:
      TableOrder:
        Verb: order
