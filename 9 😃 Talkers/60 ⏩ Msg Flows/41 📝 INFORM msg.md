...
1. **What's the INFORM syntax?**
    ...
    | Argument| Purpose
    |-|-
    | `<key>` | Form key for [`Form@Graph`](<../../6 🅰️ APIs/45 🕸🅰️ Graph/01 👥🚀🕸 Form.md>)
...
1. **What's an example of INFORM?**
    ...
    | - | - | - |
    | 🤵 [Broker](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/03 🤵 Brokers/$ 🤵 Broker domain.md>) | 🫥 Ready to order? [Yes, No] <br/> - your curator orders 🧚<br/>  - your payer pays the bill 💳  | > Yes
    |
