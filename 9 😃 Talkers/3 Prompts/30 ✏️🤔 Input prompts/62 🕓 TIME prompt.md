...
1. **What's an example of a [Chat 💬](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>)?**
    ...
    | Domain | [Prompt 🤔](<../10 🤔📘 Prompt definitions/01 🤔 Prompt.md>) | User
    | - | - | - |
...
1. **How to provide default time options in a [Chat 💬](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>)?**
    ...
    Mix with [ONE 1️⃣ prompts](<53 1️⃣ ONE prompt.md>), like in the following [Chat 💬](<../../4 ⚙️ Solution/../../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.mdon/20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md

    | Domain | [Prompt 🤔](<../10 🤔📘 Prompt definitions/01 🤔 Prompt.md>) | User
    | - | - | - |
    | [🤗 Host](<53 1️⃣ ONE prompt.md>) <br/> - [ 10:00 ] <br/> - [ 10:30 ] <br/> - [ Another ] time | > Another
    ...
    The associated [Talker 😃](<../../01 😃 Talker.md>) would be the following.
