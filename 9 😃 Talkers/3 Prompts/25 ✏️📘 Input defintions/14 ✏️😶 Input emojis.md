...
> Part of [✏️ Input prompts](<../10 🤔📘 Prompt definitions/09 ✏️ as Input.md>)
...
1. **Are emojis mandatory in inputs?**
    ...
    * Emojis are not specified in the [`Prompted@Host`](<../../../6 🅰️ APIs/50 🤗🅰️ Host/04 🧑‍🦰🚀🤗 Prompted.md>) method.
        * Thus, [Host 🤗 domains](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) can send simple strings to [Wallet 🧑‍🦰 apps](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>).
    ...
    * To help [Host 🤗 domain](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) developers, 
        * [Talkers 😃](<../../01 😃 Talker.md>) add emojis to [`Prompted@Host`](<../../../6 🅰️ APIs/50 🤗🅰️ Host/04 🧑‍🦰🚀🤗 Prompted.md>) messages. 
...
1. **How do emojis work on Talkers?**
    ...
    Most (but not all) [Talker input commands ✏️](<../10 🤔📘 Prompt definitions/09 ✏️ as Input.md>) work with the following emojis.

    Emoji | Behavior
    |-|-
    😃 | The happy emoji 😃 represent the chat's [Host 🤗 domain](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>).
    🫥 | The faded emoji 🫥 represents other domains that have been pulled into the chat. These can be either a user's [Agent 🫥 vault](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/24 🗄️ Vaults/04 🫥🗄️ Agent vault.md>) or a [Helper 🛠️ domain](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/24 🗄️ Vaults/05 🛠️👥 Helper domain.md>) that was [invited ⏩](<../../../5 ⏩ Flows/50 🤗⏩ Hosts/03 🤗⏩🧑‍🦰 Invite 🛠️.md>) by a [Host 🤗 domain](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>).
...
1. **Can Talker prompts use alternative emojis?**
    ...
    The default [Talker 😃](<../../01 😃 Talker.md>) emoji `😃` can be replaced with one of the following.
...
1. **How to replace emojis in Talkers?**
    ...
    * per [Prompt 🤔](<../10 🤔📘 Prompt definitions/01 🤔 Prompt.md>) by setting the `Emoji` parameter,
    * or by default for upcoming [Prompts 🤔](<../../../4 ⚙️ Solution../../16 😶 EMOJI flow.mdd>) with the [`EMOJI`](<../../../9 😃 Talkers/16 😶 EMOJI flow.md>) command.
