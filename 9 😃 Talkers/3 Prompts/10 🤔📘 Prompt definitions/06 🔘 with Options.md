...
1. **Can prompt options be deferred?**
    ...
    * [Prompt options](<06 🔘 with Options.md>) can be differed with [non-blocking status Prompts 🤔](<08 ⚠️ as Status.md>);../../../4 ⚙️ Solution/20 🧑‍🦰 UI/31 🤔 Prompts/08 ⚠️ Status behavior.md
        ...
        * e.g., [`INFO`](<../40 ⚠️🤔 Status prompts/21 ℹ️ INFO prompt.md>), [`TEMP`](<../40 ⚠️🤔 Status prompts/25 ⏳ TEMP prompt.md>), [`SUCCESS`](<../40 ⚠️🤔 Status prompts/23 ✅ SUCCESS prompt.md>), and [`FAILURE`](<../40 ⚠️🤔 Status prompts/24 ❌ FAILURE prompt.md>).../../../4 ⚙️ Solution/20 🧑‍🦰 UI/31 🤔 Prompts/24 ❌ FAILURE prompt.md
...
1. **What are the prompts with options?**
    ...
    |-|-
    |[`Status`](<../40 ⚠️🤔 Status prompts/23 ✅ SUCCESS prompt.md>) [`❌ FAILURE`](<../40 ⚠️🤔 Status prompts/24 ❌ FAILURE prompt.md>)
...
1. **What's the format for a [Talker 😃](<../../01 😃 Talker.md>)?**
    ...
    |-|-|-
    | `<PROMPT>` | A [Prompt 🤔](<../40 ⚠️🤔 Status prompts/25 ⏳ TEMP prompt.md>)
