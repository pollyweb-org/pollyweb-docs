...
1. **What input formats can Hosts ask Wallets to render?**
    ...
    * The supported [Prompt 🤔](<01 🤔 Prompt.md>) formats are as follow.
    ...
    |Behavior| Format 
    |-|-
    |[`Status`](<08 ⚠️ as Status.md>)| [`ℹ️ INFO`](<../40 ⚠️🤔 Status prompts/21 ℹ️ INFO prompt.md>) [`⏳ TEMP`](<../40 ⚠️🤔 Status prompts/25 ⏳ TEMP prompt.md>) [`✅ SUCCESS`](<../40 ⚠️🤔 Status prompts/23 ✅ SUCCESS prompt.md>) [`❌ FAILURE`](<../40 ⚠️🤔 Status prompts/24 ❌ FAILURE prompt.md>)
