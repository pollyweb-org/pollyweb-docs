...
1. **What's the syntax of AMOUNT in a [Talker 😃](<../../01 😃 Talker.md>)?**
    ...
    | `MinValue` | Optional [minimum value 📋](<../25 Input defintions/13 ✏️📋 Input validation.md>) | `-100`
    | `MaxValue` | Optional [maximum value 📋](<../25 Input defintions/13 ✏️📋 Input validation.md>) | `100`
...
1. **What's contained in the AMOUNT placeholder?**
    ...
    | [`$p.$`](<../../2 Data/12 🐍 {Function}.md>) | The value of `$p.Pretty` | `$1,234.57`
    | `$p` | The [default value](<../../2 Data/12 🐍 {Function}.md>) `$p.$` | `$1,234.57`
...
1. **How does AMOUNT process money signs?**
    ...
    When collecting an [`AMOUNT`](<43 💰 AMOUNT prompt.md>) in../01 😃 Talker.mders/01 😃 Talker.md>) 
