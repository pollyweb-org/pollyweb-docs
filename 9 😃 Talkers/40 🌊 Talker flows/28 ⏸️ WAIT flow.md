...
1. **How to build a clock?**
    ...
    | ⏳ [`TEMP`](<../../4 ⚙️ Solution/35 Chats/20 🤔 Prompts/4 ⚠️ Status prompts/25 ⏳ TEMP prompt.md>) | Show the temporary message.
...
1. **How to wait for a task to complete?**
    ...
    | ✅ [`SUCCESS`](<../../4 ⚙️ Solution/35 Chats/20 🤔 Prompts/4 ⚠️ Status prompts/23 ✅ SUCCESS prompt.md>) | To say that it's ready.
    | ⏳ [`TEMP`](<../../4 ⚙️ Solution/35 Chats/20 🤔 Prompts/4 ⚠️ Status prompts/25 ⏳ TEMP prompt.md>) | To show work in progress.
