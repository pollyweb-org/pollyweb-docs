...
1. **What is a Talker?**
    ...
    * referencing [{Functions} 🐍](<../30 🗃️ Talker data/12 🐍 {Function}.md>) evaluated by [Hosted 📦 domains](<../../4 ⚙️ Solution/90 👷 Build/91 📦 Hosteds/📦👥 Hosted domain.md>)
...
1. **What flows are initiated by Talkers?**
    ...
    |Flow|Details
    |-|-
    | [😃⏩🧑‍💻 Handle 🐍](<../../5 ⏩ Flows/79 😃⏩ Talkers/20 😃⏩🧑‍💻 Handle 🐍.md>) | Ask [Hosteds 📦](<../../4 ⚙️ Solution/90 👷 Build/91 📦 Hosteds/📦👥 Hosted domain.md>) to handle [{Functions} 🐍](<../../9 😃 Talkers/30 🗃️ Talker data/12 🐍 {Function}.md>)
    | [😃⏩🧑‍💻 Wait ⏸️](<../../5 ⏩ Flows/79 😃⏩ Talkers/30 😃⏩🧑‍💻 Wait ⏸️.md>) | Allow [Hosted 📦](<../../4 ⚙️ Solution/90 👷 Build/91 📦 Hosteds/📦👥 Hosted domain.md>)  long-running tasks
