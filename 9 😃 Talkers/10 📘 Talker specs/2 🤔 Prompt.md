...
1. **What input formats can Hosts ask Wallets to render?**
    ...
    Similar to HTTP, on NLWeb the [Host 🤗 domain](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) servers request the [Wallet 🧑‍🦰 apps](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) to render the requested [Prompts 🤔](<2 🤔 Prompt.md>).

    * The supported [Prompt 🤔](<2 🤔 Prompt.md>) formats are as follow.
    ...
    || [`🔠 TEXT`](<../20 🤔 Prompts/7 ✏️ Input prompts/32 🔠 TEXT prompt.md>) 
    || [`👤 IDENTIFY`](<../20 🤔 Prompts/7 ✏️ Input prompts/71 👤 IDENTIFY prompt.md>) [`🛒 EAN`](<../20 🤔 Prompts/7 ✏️ Input prompts/74 🛒 EAN prompt.md>) [`🔆 SCAN`](<../20 🤔 Prompts/7 ✏️ Input prompts/72 🔆 SCAN prompt.md>) [`🦋 TOUCH`](<../20 🤔 Prompts/7 ✏️ Input prompts/73 🦋 TOUCH prompt.md>) 
    |`Special`| [`📍 LOCATION`](<../20 🤔 Prompts/7 ✏️ Input prompts/91 📍 LOCATION prompt.md>) [`🗺️ TRACK`](<../20 🤔 Prompts/7 ✏️ Input prompts/92 🗺️ TRACK prompt.md>)
...
1. **Can Hosts replace sent prompts?**
    ...
    Yes, but only temporary [Prompts 🤔](<2 🤔 Prompt.md>). 
    - If a [Host 🤗 domain](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) sends  two consecutive blocking [Prompts 🤔](<2 🤔 Prompt.md>) while the user has not answered the first, then the first becomes readonly and the second becomes the active input.
    - If the [Host 🤗 domain](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) wants a [Prompts 🤔](<2 🤔 Prompt.md>) to be visually replaced, then they need to use a temporary [Prompts 🤔](<2 🤔 Prompt.md>), visually represented by an hourglass ⏳ emoji. 
...
1. **Can users change an answer to an answered prompt?**
    ...
    * [Chats 💬](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) are designed to be forward-only workloads managed by a [Host 🤗 domain](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) (and not by the user). 
        ...
        * Just like in ChatGPT, users to change answers to old [Prompts 🤔](<2 🤔 Prompt.md>).
    ...
    * However, [Host 🤗 domains](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) can [Freeze ❄️](<../../5 ⏩ Flows/50 🤗⏩ Hosts/06 🤗⏩🧑‍🦰 Freeze ❄️.md>) a [Chat 💬](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) until a certain checkpoint.
        * This blocks the user from changing any [Prompts 🤔](<2 🤔 Prompt.md>) up to that point.
    ...
    * ⚠️ Note: [`Options`](<../20 🤔 Prompts/1 📘 Prompt specs/04 🔘 with Options.md>) with a `§` open a new [Chat 💬](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>)  and are never frozen.
