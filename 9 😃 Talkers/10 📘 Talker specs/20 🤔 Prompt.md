...
1. **What input formats can Hosts ask Wallets to render?**
    ...
    Similar to HTTP, on NLWeb the [Host 🤗 domain](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) servers request the [Wallet 🧑‍🦰 apps](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/$ 🧑‍🦰 Wallet app.md>) to render the requested [Prompts 🤔](<20 🤔 Prompt.md>).
