...
1. **What input formats can Hosts ask Wallets to render?**
    ...
    Similar to HTTP, on NLWeb the [Host 🤗 domain](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) servers request the [Wallet 🧑‍🦰 apps](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) to render the requested [Prompts 🤔](<20 🤔 Prompt.md>).

    * The supported [Prompt 🤔](<20 🤔 Prompt.md>) formats are as follow.
...
1. **Can Hosts replace sent prompts?**
    ...
    Yes, but only temporary [Prompts 🤔](<20 🤔 Prompt.md>). 
    - If a [Host 🤗 domain](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) sends  two consecutive blocking [Prompts 🤔](<20 🤔 Prompt.md>) while the user has not answered the first, then the first becomes readonly and the second becomes the active input.
    - If the [Host 🤗 domain](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) wants a [Prompts 🤔](<20 🤔 Prompt.md>) to be visually replaced, then they need to use a temporary [Prompts 🤔](<20 🤔 Prompt.md>), visually represented by an hourglass ⏳ emoji. 
