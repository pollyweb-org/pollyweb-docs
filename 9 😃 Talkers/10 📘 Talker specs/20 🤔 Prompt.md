...
1. **What is a Prompt?**
    ...
    * via the [Prompt 🤗⏩🧑‍🦰](<../../4 ⚙️ Solution/41 🎭 Domain Roles/30 🤗 Hosts/01 🤗⏩🧑‍🦰 Prompt 🤔.md>) flow.
...
1. **Can users change an answer to an answered prompt?**
    ...
    * For example:
        ...
        * as long as there was no [Freeze ❄️](<../../4 ⚙️ Solution/41 🎭 Domain Roles/30 🤗 Hosts/06 🤗⏩🧑‍🦰 Freeze ❄️.md>) between B and E.
    
    * However, [Host 🤗 domains](<../../4 ⚙️ Solution/41 🎭 Domain Roles/30 🤗 Hosts/$ 🤗🎭 Host role.md>) can [Freeze ❄️](<../../4 ⚙️ Solution/41 🎭 Domain Roles/30 🤗 Hosts/06 🤗⏩🧑‍🦰 Freeze ❄️.md>) a [Chat 💬](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) until a certain checkpoint.
