...
1. **What's an example for FREEZE?**
    ...
    | 1️⃣ [`ONE`](<../3 Prompts/30 Input prompts/53 1️⃣ ONE prompt.md>) | Select an option, the day in this case.
    | 💼 [`SHARE`](<45 💼 SHARE msg.md>) | Get the user's booking contacts.
    | 👍 [`CONFIRM`](<../3 Prompts/30 Input prompts/31 👍 CONFIRM prompt.md>) | Pause to allow changing previous inputs.
