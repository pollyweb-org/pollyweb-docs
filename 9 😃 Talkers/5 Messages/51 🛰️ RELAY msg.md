...
1. **What's the syntax?**
    ...
    | `<failure>` | [Procedure ⚙️](<../03 Talker Flows/11 ⚙️ Procedure.md>) or [Command ⌘](<../03 Talker Flows/10 ⌘ Command.md>) to run on failure
    | `<success>` | [Procedure ⚙️](<../03 Talker Flows/11 ⚙️ Procedure.md>) or [Command ⌘](<../03 Talker Flows/10 ⌘ Command.md>) to run on success
...
1. **How to open a locker door remotely?**
    ...
    |-|-
    | 🪵 [`LOG`](<../03 Talker Data/15 🪵 LOG flow.md>) | To log the result.
