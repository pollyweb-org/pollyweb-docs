...
1. **What is a non-blocking TEMP?**
    ...
    * but it is automatically removed when a new [Prompt 🤔](<../../10 📘 Talker specs/2 🤔 Prompt.md>) arrives;
...
1. **What's the TEMP format for a [Talker 😃](<../../10 📘 Talker specs/1 😃 Talker.md>)?**
