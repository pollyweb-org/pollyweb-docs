...
1. **What's an AMOUNT example of a [Chat 💬](<../../../4 ⚙️ Solution/35 Chats/12 💬 Chats/$ 💬 Chat.md>)?**
    ...
    [🫥 Agent](<../../../4 ⚙️ Solution/50 🫥 Agent domains/$ 🫥 Agent Vaults/$ 🫥🗄️ Agent vault.md>) | 🫥 How much? | 💰 12345.6
    | [🤲 Helper](<../../../4 ⚙️ Solution/45 🤲 Helper domains/$ 🤲 Helpers/🤲👥 Helper domain.md>) | 🫥 How much? | 💰 -54.456
    |
...
1. **How does AMOUNT process money signs?**
    ...
    * while storing the currencies in their original currency.
    ...
    Consider the following conversion table in a [Chat 💬](<../../../4 ⚙️ Solution/35 Chats/12 💬 Chats/$ 💬 Chat.md>) with locale `en-US`.
