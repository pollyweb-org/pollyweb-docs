...
1. **What's a LOCATION prompt?**
    ...
    It's a [Prompt 🤔](<../../10 📘 Talker specs/20 🤔 Prompt.md>) that asks for the user's current location.
...
1. **What's the format for a [Talker 😃](<../../10 📘 Talker specs/10 😃 Talker.md>)?**
    ...
    |Parameter|Details
    |-|-
    | `$placeholder` | Stores the answer in this [$placeholder 💾](<../../30 🗃️ Talker data/10 💾 $Placeholder.md>)
    
    ---
    <br/>

1. **What's an example of a [Talker 😃](<../../10 📘 Talker specs/10 😃 Talker.md>)?**
...
1. **How is that example in a [Prompted@Host](<../../../4 ⚙️ Solution/41 🎭 Domain Roles/30 🤗 Hosts/🅰️ Host methods/54 🧑‍🦰🚀🤗 Prompted@Host.md>) response?**
...
1. **What's the Answer in the [Reply@Host](<../../../4 ⚙️ Solution/41 🎭 Domain Roles/30 🤗 Hosts/🅰️ Host methods/55 🧑‍🦰🐌🤗 Reply@Host.md>) message?**
