...
1. **What's the syntax of a `CONFIRM`?**
    ...
    | Argument| Purpose | Example
    |-|-|-
    | `Then` | [Procedure ⚙️](<../../30 🌊 Talker flows/11 ⚙️ Procedure.md>) or [Command ⌘](<../../30 🌊 Talker flows/10 ⌘ Command.md>) on `True` | `INFO\|OK`
    | `Else` | [Procedure ⚙️](<../../30 🌊 Talker flows/11 ⚙️ Procedure.md>) or [Command ⌘](<../../30 🌊 Talker flows/10 ⌘ Command.md>) on `False` | `INFO\|NOK`
