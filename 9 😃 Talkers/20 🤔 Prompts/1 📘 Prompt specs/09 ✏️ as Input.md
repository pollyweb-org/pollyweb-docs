...
1. **What are the blocking formats available?**
    ...
    | [👤&nbsp;IDENTIFY](<../7 ✏️ Input prompts/71 👤 IDENTIFY prompt.md>) | Asks the user's [Identity 🆔 agent](<../../../4 ⚙️ Solution/50 🫥 Agents/45 🆔 Identities/$ 🆔🫥 Identity agent.md>) to verify the user
