...
1. **How do non-blocking options work?**
    ...
    - If it contains [`Options`](<04 🔘 with Options.md>), then the user may click an option any time before or after the [Host 🤗 domain](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) sends other subsequent [Prompts 🤔](<../../10 📘 Talker specs/20 🤔 Prompt.md>).
