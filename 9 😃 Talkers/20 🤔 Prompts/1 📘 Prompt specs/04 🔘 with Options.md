...
1. **Do all prompt options behave the same way?**
    ...
    * [`Options`](<04 🔘 with Options.md>) with a `§` sign 
        ...
        * even after a [Freeze ❄️](<../../../4 ⚙️ Solution/41 🎭 Domain Roles/30 🤗 Hosts/06 🤗⏩🧑‍🦰 Freeze ❄️ flow.md>) command.
    * All others [`Options`](<04 🔘 with Options.md>)
        * continue the [Chat 💬](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>)
        * and are disabled with a [Freeze ❄️](<../../../4 ⚙️ Solution/41 🎭 Domain Roles/30 🤗 Hosts/06 🤗⏩🧑‍🦰 Freeze ❄️ flow.md>) command.
