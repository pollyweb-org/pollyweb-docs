...
1. **Can prompt options be deferred?**
    ...
    * [Prompt options](<04 🔘 with Options.md>) can be differed with [non-blocking status Prompts 🤔](<08 ⚠️ as Status.md>);
        ...
        * [Host 🤗 domains](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) speed-up [Chats 💬](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>) by taking unilateral two-way-door decisions that can be reverted by users even after other [Prompts 🤔](<../../10 📘 Talker specs/02 🤔 Prompt.md>) have been sent.
...
1. **What are the prompts with options?**
    ...
    |Behavior| [Prompt 🤔](<../../10 📘 Talker specs/02 🤔 Prompt.md>) 
    |-|-
...
1. **What's the format for a [Talker 😃](<../../10 📘 Talker specs/01 😃 Talker.md>)?**
    ...
    |-|-|-
    | `<PROMPT>` | A [Prompt 🤔](<../../10 📘 Talker specs/02 🤔 Prompt.md>) format. | [`INFO`](<../4 ⚠️ Status prompts/21 ℹ️ INFO prompt.md>) [`TEMP`](<../4 ⚠️ Status prompts/25 ⏳ TEMP prompt.md>)
...
1. **What's an example in a [Chat 💬](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>)?**
    ...
    | 🔀 [`CASE`](<../../30 🌊 Talker flows/22 🔀 CASE flow.md>) | To check the selected option.
