...
1. **What's the syntax?**
    ...
    | `<failure>` | [Procedure ⚙️](<11 ⚙️ Procedure.md>) or [Command ⌘](<../9 😃 Talkers/20 Talker Flows/10 ⌘ Command.md>) to run on failure
    | `<success>` | [Procedure ⚙️](<11 ⚙️ Procedure.md>) or [Command ⌘](<../9 😃 Talkers/20 Talker Flows/10 ⌘ Command.md>) to run on success
