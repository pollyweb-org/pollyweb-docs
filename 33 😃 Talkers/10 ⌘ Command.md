...
1. **What are Flow commands?**
    ...
    Command | Purpose
    |-|-
    | 🔀 [`CASE`](<../9 😃 Talkers/20 Talker Flows/22 🔀 CASE flow.md>) | Runs a [Command ⌘](<10 ⌘ Command.md>) or [Procedure ⚙️](<11 ⚙️ Procedure.md>) matching a [{Function}](<12 🐍 {Function}.md>).
    ...
    | ⤵️ [`IF`](<../9 😃 Talkers/20 Talker Flows/21 ⤵️ IF flow.md>) | Runs a [Command ⌘](<10 ⌘ Command.md>) or [Procedure ⚙️](<11 ⚙️ Procedure.md>) based on a [{Function}](<12 🐍 {Function}.md>).
    | 🪵 [`LOG`](<15 🪵 LOG flow.md>) | Logs messages into the system handler.
    | 🔁 [`REPEAT`](<../9 😃 Talkers/20 Talker Flows/23 🔁 REPEAT flow.md>) | Repeats the current [Procedure ⚙️](<11 ⚙️ Procedure.md>) with a confirmation.
    | ↩️ [`RETURN`](<../9 😃 Talkers/20 Talker Flows/25 ↩️ RETURN flow.md>) | Returns from a [Procedure ⚙️](<11 ⚙️ Procedure.md>) with a result.
    | ▶️ [`RUN`](<../9 😃 Talkers/20 Talker Flows/24 ▶️ RUN flow.md>) | Runs a [Procedure ⚙️](<11 ⚙️ Procedure.md>) and puts the result in a placeholder.
    | ⏸️ [`WAIT`](<../9 😃 Talkers/20 Talker Flows/28 ⏸️ WAIT flow.md>) | Waits for a period of time or until signaled.
