...
1. **What's a code EVAL example?**
    ...
    |-|-
    | 👍 [`CONFIRM`](<../4 ⚙️ Solution/20 🧑‍🦰 UI/31 🤔 Prompts/31 👍 CONFIRM prompt.md>) | To pause for user confirmation.
    | 🔁 [`REPEAT`](<../9 😃 Talkers/20 Talker Flows/23 🔁 REPEAT flow.md>) | To add more rows.
