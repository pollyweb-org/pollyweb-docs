...
> <br/>• [💼⏩🧑‍🦰 Token Status @ Consumer](<../../../4 ⚙️ Solution/41 🎭 Domain Roles/27 💼 Consumers/35 💼⏩🤵 Token status 🎫 flow.md>) flow
...
| |`TokenID`|string|[Token 🎫](<../../../4 ⚙️ Solution/30 🧩 Data/30 🎫 Tokens/🎫 Token.md>) ID
