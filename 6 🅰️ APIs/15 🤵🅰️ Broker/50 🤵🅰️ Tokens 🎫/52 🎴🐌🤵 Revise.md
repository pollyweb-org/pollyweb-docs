...
> Updates the status of a [Token 🎫](<../../../4 ⚙️ Solution/25 Data/30 🎫 Tokens/$ 🎫 Token.md>).

> Used by:
> <br/>• [🎴⏩🧑‍🦰 Revise Token @ Issuer](<../../../5 ⏩ Flows/60 🎴⏩ Issuers/02 🎴⏩🧑‍🦰 Revise token.md>) flow
> <br/>• [💼⏩🧑‍🦰 Token Status @ Consumer](<../../../4 ⚙️ Solution/41 🎭 Domain Roles/27 💼 Consumers/05 💼⏩🤵 Token status.md>) flow
...
| |`TokenID`|string|[Token 🎫](<../../../4 ⚙️ Solution/25 Data/30 🎫 Tokens/$ 🎫 Token.md>) ID
...
| |`Locator`| string | [Locator 🔆](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/11 🔆 Locators/$ 🔆 Locator.md>) for a [Chat 💬](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>) about it.
|