...
* In a [Chat 💬](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/$ 💬 Chat.md>), 
    ...
    * in one or more [Schema Codes 🧩](<../../../4 ⚙️ Solution/25 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>).
...
| | `Codes` | string[] | List of [Schema Codes 🧩](<../../../4 ⚙️ Solution/25 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>)
|
...
1. **Why a list of Codes instead of a single one?**
    ...
    Although many [Schema Codes 🧩](<../../../4 ⚙️ Solution/25 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>) may be requested, 
...
1. **How are SELF Tokens are shared?**
    ...
    For the [Schema Codes 🧩](<../../../4 ⚙️ Solution/25 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>) marked with SELF, 
