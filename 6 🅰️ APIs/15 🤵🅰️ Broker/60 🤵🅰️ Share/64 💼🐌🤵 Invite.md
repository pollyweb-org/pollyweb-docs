...
> <br/>• followed by [`Invited@Helper`](<../../../4 ⚙️ Solution/45 🤲 Helper domains/$ 🤲 Helpers/🛠️🅰️ Helper methods/🤵🐌🛠️ Invited.md>) message
...
||`Helper`  | string  | Invitee [Helper 🛠️ domain](<../../../4 ⚙️ Solution/45 🤲 Helper domains/$ 🤲 Helpers/🛠️👥 Helper domain.md>) name
