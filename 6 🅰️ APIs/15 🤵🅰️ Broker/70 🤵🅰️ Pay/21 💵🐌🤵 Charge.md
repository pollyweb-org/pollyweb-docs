...
# 💵🐌🤵 Charge @ [Broker](<../../../4 ⚙️ Solution/45 🛠️ Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>)
...
- Next: [Charge@Notifier 🤵💵🐌📣](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/02 📣 Notifiers/📣🅰️ Notifier methods/05 📣💳🅰️ Payments/61 🤵🐌📣 Charge.md>)
...
- Body:
    ...
    - Charge:
        ...
        - Currency: `EUR`
        - Operation: `DEBIT`
        - [Collectors 🏦](<../../../4 ⚙️ Solution/45 🛠️ Helper domains/30 🏦 Collectors/$ 🏦🛠️ Collector helper.md>): [ `revolut.com`, `paypal.com` ]
