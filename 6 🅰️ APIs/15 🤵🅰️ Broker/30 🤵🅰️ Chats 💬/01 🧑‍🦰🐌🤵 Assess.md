...
|Body  |`Locator` |string| [Locator 🔆](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/04 🔆 Locators/01 🔆 Locator.md>) of types: <br/>- [`nlweb.org/HOST` 🧩](<../../../8 📜 Manifests/👥 nlweb.org/{codes}/HOST/🧩 Host.md>) <br/>- [`nlweb.org/ALIAS` 🧩](<../../../8 📜 Manifests/👥 nlweb.org/🧩 Alias.md>)
|
