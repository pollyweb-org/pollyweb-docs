...
|           | `To`          | string    | [Resourcer 🗃️ domain](<../../4 ⚙️ Solution/41 🎭 Domain Roles/60 🗃️ Resourcers/02 🗃️🎭 Resourcer role.md>) name
...
|-|-|-|-
|| `Resourcer`   | string    | [Resourcer 🗃️](<../../4 ⚙️ Solution/41 🎭 Domain Roles/60 🗃️ Resourcers/02 🗃️🎭 Resourcer role.md>) for parameter-less [Sync ⏩](<../../5 ⏩ Flows/77 🔃⏩ Syncer/20 🔃⏩🗃️ Sync.md>)
