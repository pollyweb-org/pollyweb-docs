...
# 🧑‍🦰🐌💳 Endorse @ [Payer](<../../4 ⚙️ Solution/30 🫥 Agents/04 💳 Payers/02 💳🫥 Payer agent.md>)
...
- Header:
   ...
   - [To 💳](<../../4 ⚙️ Solution/30 🫥 Agents/04 💳 Payers/02 💳🫥 Payer agent.md>): `any-payer.org`
...
- Body:
   ...
   - [Collector 🏦](<../../4 ⚙️ Solution/30 🫥 Agents/01 📦 Storage/03 🏦🛠️ Collector helper.md>): `any-collector.org`
   - Session: 
