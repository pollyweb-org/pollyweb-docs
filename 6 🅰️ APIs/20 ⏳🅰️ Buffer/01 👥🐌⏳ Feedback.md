...
> The feedback is sent via a [Buffer ⏳ helper domain](<../../4 ⚙️ Solution/45 Helpers/10 ⏳ Buffers/$ ⏳🛠️ Buffer helper.md>) defined by the sender's domain. 
...
||`To`| string | Sender's [Buffer ⏳ helper domain](<../../4 ⚙️ Solution/45 Helpers/10 ⏳ Buffers/$ ⏳🛠️ Buffer helper.md>) name
