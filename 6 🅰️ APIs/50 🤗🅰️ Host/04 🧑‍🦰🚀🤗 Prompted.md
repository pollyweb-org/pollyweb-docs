...
> Downloads the content of a [Prompt 🤔](<../../9 😃 Talkers/3 Prompts/10 Prompt definitions/01 🤔 Prompt.md>).
...
|| `PromptID`    | uuid      | [Prompt 🤔](<../../9 😃 Talkers/3 Prompts/10 Prompt definitions/01 🤔 Prompt.md>) ID from [`Prompt@Broker`](<../15 🤵🅰️ Broker/30 🤵🅰️ Chats 💬/03 🤗🐌🤵 Prompt.md>)
|
...
|| [`MinValue`](<../../9 😃 Talkers/3 Prompts/25 Input defintions/13 ✏️📋 Input validation.md>) | int | Optional minimum value
|| [`MaxValue`](<../../9 😃 Talkers/3 Prompts/25 Input defintions/13 ✏️📋 Input validation.md>) | int | Optional maximum value
...
|Option | `ID`          | string  | ID of the [option](<../../9 😃 Talkers/3 Prompts/10 Prompt definitions/06 🔘 with Options.md>) for [`Reply@Host`](<05 🧑‍🦰🐌🤗 Reply.md>)
|       | `Translation` | string  | Text of the [option](<../../9 😃 Talkers/3 Prompts/10 Prompt definitions/06 🔘 with Options.md>) to display in the [Chat 💬](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/01 💬 Chat.md>)
|
