...
> Downloads the content of a [Prompt 🤔](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/02 🤔 Prompt.md>).
...
|| `PromptID`    | uuid      | [Prompt 🤔](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/02 🤔 Prompt.md>) ID from [Prompt@Broker](<../15 🤵🅰️ Broker/30 🤵🅰️ Chats 💬/03 🤗🐌🤵 Prompt.md>)
|
...
|Object |Property|Type|Description
|-|-|-|-
|Top| `Format`  | string | One format supported by [Prompts 🤔](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/02 🤔 Prompt.md>)
