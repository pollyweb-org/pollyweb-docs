...
|       |`To`       | string | [Supplier 🏭 domain](<../../4 ⚙️ Solution/41 🎭 Domain Roles/78 🏭 Suppliers/02 🏭🎭 Supplier role.md>)
...
|       | `ItemCode`| string | [Schema Code 🧩](<../../4 ⚙️ Solution/25 Data/24 🗄️ Vaults/02 🧩 Schema Code.md>) of the items
||
