...
|Body   |`OrderID`  | uuid   | ID of the order on the  Caller [domain 👥](<../../4 ⚙️ Solution/40 👥 Domains/$ 👥 Domains/00 👥 Domain.md>)
|       | `ItemCode`| string | [Schema Code 🧩](<../../4 ⚙️ Solution/30 🧩 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>) of the items
||
