...
|-|-|-|-
|Header| `From`| string | Caller [domain 👥](<../../40 👥 Domains/44 📜 Manifests/00 👥 Domain.md>) name
...
|Object|Property|Type|Description
|-|-|-|-
|Top    | `Code`    | enum | One of the [Schema Codes 🧩](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/24 🗄️ Vaults/02 🧩 Schema Code.md>)<br/>• [nlweb.org/HOST 🧩](<../../8 📜 Manifests/👥 nlweb.org/{codes}/HOST/🧩 Host.md>)
