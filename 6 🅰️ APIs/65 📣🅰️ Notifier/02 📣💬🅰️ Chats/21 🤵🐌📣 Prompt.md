...
> [Brokers 🤵 domain](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/03 🤵 Brokers/03 🤵 Broker domain.md>) forward   [Prompts 🤔](<../../../9 😃 Talkers/10 📘 Talker specs/2 🤔 Prompt.md>) from [Host 🤗 domains](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/12 💬 Chats/04 🤗🎭 Host role.md>) to [Notifier 📣 domains](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/02 📣 Notifiers/02 📣 Notifier domain.md>).
...
|      |`ChatID`  |uuid  | Chat ID 
|      |`PromptID`|uuid  | [Prompt 🤔](<../../../9 😃 Talkers/10 📘 Talker specs/2 🤔 Prompt.md>) callback on the Host domain
