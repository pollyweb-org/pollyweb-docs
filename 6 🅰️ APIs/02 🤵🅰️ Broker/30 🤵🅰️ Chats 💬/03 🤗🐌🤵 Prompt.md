...
> Used by [🤗⏩🧑‍🦰 Prompt @ Host](<../../../5 ⏩ Flows/03 🤗⏩ Hosts/01 🤗⏩🧑‍🦰 Prompt.md>).
...
||`PromptID` | UUID    | Callback to download the [Prompt 🤔](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/23 💬 Chats/02 🤔 Prompt.md>) from the [Host 🤗 domain](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/23 💬 Chats/04 🤗🎭 Host role.md>) via [Prompted@Host](<../../09 🤗🅰️ Host/04 🧑‍🦰🚀🤗 Prompted.md>)
|