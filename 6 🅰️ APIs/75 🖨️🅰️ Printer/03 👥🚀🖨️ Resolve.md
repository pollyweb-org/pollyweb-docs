...
> A [Printer 🖨️ domain](<../../4 ⚙️ Solution/45 Helpers/10 Printers/08 🖨️🏭 Printer helper.md>) returns the [Locator 🔆](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/11 🔆 Locators/01 🔆 Locator.md>) of an alias, if any.
...
|Body|`Alias`| string | Unique [Locator 🔆](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/11 🔆 Locators/01 🔆 Locator.md>) ID on the [Printer 🖨️ ](<../../4 ⚙️ Solution/45 Helpers/10 Printers/08 🖨️🏭 Printer helper.md>)
|
