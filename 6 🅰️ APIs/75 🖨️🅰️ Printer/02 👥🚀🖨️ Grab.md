...
> A [Printer 🖨️ domain](<../../4 ⚙️ Solution/45 Helpers/60 🖨️ Printers/08 🖨️🏭 Printer helper.md>) grabs an available alias. 
...
|Body|`Alias`| string | Unique alias on the [Printer 🖨️](<../../4 ⚙️ Solution/45 Helpers/60 🖨️ Printers/08 🖨️🏭 Printer helper.md>)
