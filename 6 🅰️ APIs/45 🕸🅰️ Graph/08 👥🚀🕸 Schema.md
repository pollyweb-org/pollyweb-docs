...
* Gets the schema of a [Schema Code 🧩](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/24 🗄️ Vaults/02 🧩 Schema Code.md>) 
    * as defined in [`.MANIFEST/CODE` 🧩](<../../4 ⚙️ Solution/40 👥 Domains/44 📜 Manifests/11 🧩 CODE code.md>) 
    * and [`.MANIFEST/CODE/SCHEMA` 🧩](<../../4 ⚙️ Solution/40 👥 Domains/44 📜 Manifests/12 🧩 SCHEMA code.md>) parts
