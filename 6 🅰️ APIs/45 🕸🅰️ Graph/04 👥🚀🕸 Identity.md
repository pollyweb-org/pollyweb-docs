...
* Given a domain, 
    * returns the content of [`.MANIFEST/IDENTITY 🧩`](<../../4 ⚙️ Solution/40 👥 Domains/44 📜 Manifests/🧩 ManifestIdentity.md>)
* Used by:
...
|-|-|-|-
| Header| `From`    | string | The name of the [domain 👥](<../../4 ⚙️ Solution/40 👥 Domains/41 📨 Msgs/00 👥 Domain.md>) querying
|       | `To`      | string | [Graph 🕸 domain](<../../4 ⚙️ Solution/40 👥 Domains/45 👂 Backbone/03 🕸🛠️ Graph helper.md>) name
|       | `Subject` | string | `Identity@Graph`
| Body  | `Domain`  | string | The name of another [domain 👥](<../../4 ⚙️ Solution/40 👥 Domains/41 📨 Msgs/00 👥 Domain.md>) to look up
|
...
|Object|Property|Type|Description
|-|-|-|-
|Top        |`Domain`       | string | URL name of the [domain 👥](<../../4 ⚙️ Solution/40 👥 Domains/41 📨 Msgs/00 👥 Domain.md>)
|           |`Feedback`     | string | [Buffer ⏳ helper domain](<../../4 ⚙️ Solution/40 👥 Domains/42 🌬️ Streams/03 ⏳🛠️ Buffer helper.md>) name
|           |`Name`         | string | Friendly name of the [domain 👥](<../../4 ⚙️ Solution/40 👥 Domains/41 📨 Msgs/00 👥 Domain.md>)
