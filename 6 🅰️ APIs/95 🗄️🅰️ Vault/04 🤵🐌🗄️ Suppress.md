...
> Suppress [🖐️ Palm scans](<../../4 ⚙️ Solution/30 🫥 Agents/05 🆔 Identities/11 🆔🖐️ Palm scan.md>) on Palmist devices.
...
* If the session is tracked, stop it - e.g.: 
    ...
    * AND stop sending findings to the [Host 🤗 domain](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/23 💬 Chats/04 🤗🎭 Host role.md>).
