...
> Suppress [🖐️ Palm scans](<../../4 ⚙️ Solution/50 🫥 Agents/45 🆔 Identities/22 🆔🖐️ Palm scan.md>) on Palmist devices.
...
* If the session is tracked, stop it - e.g.: 
    ...
    * AND stop sending findings to the [Host 🤗 domain](<../../4 ⚙️ Solution/41 🎭 Domain Roles/30 🤗 Hosts/$ 🤗🎭 Host role.md>).
