...
# 📜 [Manifest](<../../4 ⚙️ Solution/30 🧩 Data/Manifests 📜/📜 Manifest/📜 Manifest.md>): standards.any-igo.dom
...
Schemas:
  ...
  # --------------------------------------------------
  # [🧩](<../../4 ⚙️ Solution/30 🧩 Data/Codes 🧩/🧩 Schema Code.md>) /3166-1 (ISO 3166 Country Codes)
  # --------------------------------------------------
