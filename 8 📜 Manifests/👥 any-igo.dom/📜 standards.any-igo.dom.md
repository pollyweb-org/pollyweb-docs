...
# 📜 [Manifest](<../../4 ⚙️ Solution/30 🧩 Data/Manifests 📜/📜 Manifest.md>): standards.any-igo.dom
...
Codes:
  ...
  # --------------------------------------------------
  # [🧩](<../../4 ⚙️ Solution/30 🧩 Data/Schema Codes 🧩/🧩 Schema Code.md>) /639-1 (Language codes)
  # --------------------------------------------------
  ...
  # --------------------------------------------------
  # [🧩](<../../4 ⚙️ Solution/30 🧩 Data/Schema Codes 🧩/🧩 Schema Code.md>) /3166-1 (ISO 3166 Country Codes)
  # --------------------------------------------------
