...
# 📜 [Manifest](<../../4 ⚙️ Solution/40 👥 Domains/44 📜 Manifests/01 📜 Domain Manifest.md>): standards.any-igo.org
...
Codes:
  ...
  # --------------------------------------------------
  # [🧩](<../../4 ⚙️ Solution/25 Data/24 🗄️ Vaults/02 🧩 Schema Code.md>) /639-1 (Language codes)
  # --------------------------------------------------
  ...
  # --------------------------------------------------
  # [🧩](<../../4 ⚙️ Solution/25 Data/24 🗄️ Vaults/02 🧩 Schema Code.md>) /3166-1 (ISO 3166 Country Codes)
  # --------------------------------------------------
