...
# 📜 [Manifest](<../../4 ⚙️ Solution/40 👥 Domains/44 📜 Manifests/📜 Manifest.md>): standards.any-igo.org
...
Codes:
  ...
  # --------------------------------------------------
  # [🧩](<../../4 ⚙️ Solution/30 🧩 Data/10 🧩 Schema Codes/🧩 Schema Code.md>) /639-1 (Language codes)
  # --------------------------------------------------
  ...
  # --------------------------------------------------
  # [🧩](<../../4 ⚙️ Solution/30 🧩 Data/10 🧩 Schema Codes/🧩 Schema Code.md>) /3166-1 (ISO 3166 Country Codes)
  # --------------------------------------------------
