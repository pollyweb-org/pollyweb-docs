...
# 📜 [Manifest](<../../4 ⚙️ Solution/40 👥 Domains/44 📜 Manifests/01 📜 Domain Manifest.md>): locale.any-igo.org
...
Datasets:
  ...
  # [🧩](<../../4 ⚙️ Solution/25 Data/24 🗄️ Vaults/02 🧩 Schema Code.md>) //COUNTRY list.
  - Dataset: nlweb.org/LOCALE/COUNTRY:1.0
    Requires: 
      Language: Code@standards.any-igo.org/639-1
    
  # [🧩](<../../4 ⚙️ Solution/25 Data/24 🗄️ Vaults/02 🧩 Schema Code.md>) //DIALCODE list.
