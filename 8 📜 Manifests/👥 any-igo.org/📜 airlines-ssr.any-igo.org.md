...
# 📜 [Manifest](<../../4 ⚙️ Solution/40 👥 Domains/44 📜 Manifests/$ 📜 Domain Manifest.md>): airlines-ssr.any-igo.org
...
```yaml
  # [🧩](<../../4 ⚙️ Solution/25 Data/10 🧩 Schema Codes/02 🧩 Schema Code.md>) //MEALS list.
...
```yaml
  # --------------------------------------------------
  # [🧩](<../../4 ⚙️ Solution/25 Data/10 🧩 Schema Codes/02 🧩 Schema Code.md>) /SSR
...
```yaml
  # --------------------------------------------------
  # [🧩](<../../4 ⚙️ Solution/25 Data/10 🧩 Schema Codes/02 🧩 Schema Code.md>) //WCHR/CRED
...
```yaml
  # --------------------------------------------------
  # [🧩](<../../4 ⚙️ Solution/25 Data/10 🧩 Schema Codes/02 🧩 Schema Code.md>) //MEAL
  # --------------------------------------------------
