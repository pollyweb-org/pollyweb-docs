...
```yaml
  # [🧩](<../../4 ⚙️ Solution/25 Data/Schema Codes/02 🧩 Schema Code.md>) //MEALS list.
...
```yaml
  # --------------------------------------------------
  # [🧩](<../../4 ⚙️ Solution/25 Data/Schema Codes/02 🧩 Schema Code.md>) /SSR
...
```yaml
  # --------------------------------------------------
  # [🧩](<../../4 ⚙️ Solution/25 Data/Schema Codes/02 🧩 Schema Code.md>) //WCHR/CRED
...
```yaml
  # --------------------------------------------------
  # [🧩](<../../4 ⚙️ Solution/25 Data/Schema Codes/02 🧩 Schema Code.md>) //MEAL
  # --------------------------------------------------
