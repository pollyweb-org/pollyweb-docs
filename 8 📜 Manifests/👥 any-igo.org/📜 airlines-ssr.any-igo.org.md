...
```yaml
  # [🧩](<../../4 ⚙️ Solution/25 🧩 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>) //MEALS list.
...
```yaml
  # --------------------------------------------------
  # [🧩](<../../4 ⚙️ Solution/25 🧩 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>) /SSR
...
```yaml
  # --------------------------------------------------
  # [🧩](<../../4 ⚙️ Solution/25 🧩 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>) //WCHR/CRED
...
```yaml
  # --------------------------------------------------
  # [🧩](<../../4 ⚙️ Solution/25 🧩 Data/10 🧩 Schema Codes/$ 🧩 Schema Code.md>) //MEAL
  # --------------------------------------------------
