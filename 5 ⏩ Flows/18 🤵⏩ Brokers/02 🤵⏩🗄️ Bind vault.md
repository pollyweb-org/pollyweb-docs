...
| 2 | [🤗⏩🧑‍🦰 Prompt @ Host](<../39 🤗⏩ Hosts/01 🤗⏩🧑‍🦰 Prompt.md>) | The [Broker 🤵](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/03 🤵 Brokers/03 🤵 Broker domain.md>) informs the user about the [Bind 🔗](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/24 🗄️ Vaults/01 🔗 Bind.md>)
