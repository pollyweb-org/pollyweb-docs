...
| 2 | [🤵🐌📣 Prompt @ Notifier](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/Notifiers 📣/📣🅰️ Notifier methods/2 💬 Chats/🤵🐌📣 Prompt.md>) | [Brokers 🤵](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/Brokers 🤵/🤵🤲 Broker helper.md>) push it to the [Wallet 🧑‍🦰](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/Wallets 🧑‍🦰/🧑‍🦰🛠️ Wallet app.md>) via the [Notifier 📣](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/Notifiers 📣/📣👥 Notifier domain.md>)
