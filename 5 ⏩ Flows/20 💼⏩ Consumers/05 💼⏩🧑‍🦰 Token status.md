...
|#| Step | Purpose
|-|-|-
|1| [🎴⏩🧑‍🦰 Offer @ Issuer](<../60 🎴⏩ Issuers/01 🎴⏩🧑‍🦰 Offer token.md>) | [Issuer 🎴 domains](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/25 🎫 Tokens/02 🎴🎭 Issuer role.md>) offer [Tokens 🎫](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/25 🎫 Tokens/01 🎫 Token.md>)
