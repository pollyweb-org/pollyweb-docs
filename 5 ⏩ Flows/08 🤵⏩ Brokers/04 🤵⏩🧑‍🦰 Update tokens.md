...
| Caller | Notes
|-|-
| [🧑‍🦰👉🎴 Accept @ Wallet](<../06 🎴⏩ Issuers/01 🎴⏩🧑‍🦰 Offer token.md>) | Adds a [Token 🎫](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/25 🎫 Tokens/01 🎫 Token.md>) to the list.
...
| 2 | [🧑‍🦰🚀🤵 Tokens @ Broker](<../../6 🅰️ APIs/02 🤵🅰️ Broker/50 🤵🅰️ Tokens 🎫/54 🧑‍🦰🚀🤵 Tokens.md>) | The [Wallet 🧑‍🦰](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>) gets the [Tokens 🎫](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/25 🎫 Tokens/01 🎫 Token.md>) from the [Broker 🤵](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/03 🤵 Brokers/03 🤵 Broker domain.md>)
||
