...
| # | Call | Notes
|-|-|-|
|1|[🤵🚀🖨️ `Resolve@Printer`](<../../6 🅰️ APIs/75 🖨️🅰️ Printer/03 👥🚀🖨️ Resolve.md>) | Ask [Printers 🖨️](<../../4 ⚙️ Solution/45 Helpers/10 🖨️ Printers/08 🖨️🏭 Printer helper.md>) to resolve [`.ALIAS` 🧩](<../../7 🧩 Codes/$/🧩 ALIAS code.md>)
