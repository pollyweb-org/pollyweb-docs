...
| # | API | Description |
|-|-|-
| 1 | [👥🚀🕸 `Translate@Graph`](<../../4 ⚙️ Solution/45 🛠️ Helper domains/50 🕸 Graphs/45 🕸🅰️ Graph methods/06 👥🚀🕸 Translate.md>) | The [Broker 🤵](<../../4 ⚙️ Solution/45 🛠️ Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) translates into the user's language
| 2 | [🤗⏩🧑‍🦰 Prompt 🤔](<../../4 ⚙️ Solution/41 🎭 Domain Roles/30 🤗 Hosts/31 🤗⏩🧑‍🦰 Prompt 🤔 flow.md>) | The [Broker 🤵](<../../4 ⚙️ Solution/45 🛠️ Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) informs the user about the [Bind 🔗](<../../4 ⚙️ Solution/30 🧩 Data/20 🔗 Binds/$ 🔗 Bind.md>)
