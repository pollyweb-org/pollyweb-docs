...
| # | API | Description |
|-|-|-
| 1 | [👥🚀🕸 `Translate@Graph`](<../../4 ⚙️ Solution/45 🛠️ Helper domains/50 🕸 Graphs/🕸🅰️ Graph methods/06 👥🚀🕸 Translate.md>) | The [Broker 🤵](<../../4 ⚙️ Solution/45 🛠️ Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) translates into the user's language
