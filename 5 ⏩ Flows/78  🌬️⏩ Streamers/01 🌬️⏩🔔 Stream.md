...
| 1 | [🌬️🐌⏳ Push @ Buffer](<../../6 🅰️ APIs/20 ⏳🅰️ Buffer/11 🌬️🐌⏳ Push.md>) | The [Streamer 🌬️](<../../4 ⚙️ Solution/40 👥 Domains/41 📨 Comms/02 🌬️🎭 Streamer role.md>) pushes to the [Buffer ⏳](<../../4 ⚙️ Solution/40 👥 Domains/41 📨 Comms/03 ⏳🛠️ Buffer helper.md>).
...
| 3 | [🔔🚀⏳ Poll @ Buffer](<../../6 🅰️ APIs/20 ⏳🅰️ Buffer/12 🔔🚀⏳ Poll.md>) | The [Subscriber 🔔](<../../4 ⚙️ Solution/40 👥 Domains/41 📨 Comms/04 🔔🎭 Subscriber role.md>) polls all buffered messages.
|4| [🔔🚀⏳ Confirm @ Buffer](<../../6 🅰️ APIs/20 ⏳🅰️ Buffer/13 🔔🚀⏳ Confirm.md>) | The [Subscriber 🔔](<../../4 ⚙️ Solution/40 👥 Domains/41 📨 Comms/04 🔔🎭 Subscriber role.md>) confirms the processed ones.
||
