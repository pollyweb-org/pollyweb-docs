...
| # | Call | Notes
|-|-|-
|1| [🔔🚀⏳ `Queue@Buffer`](<../../6 🅰️ APIs/20 ⏳🅰️ Buffer/12 🔔🐌⏳ Queue.md>) | [Subscribers 🔔](<../../4 ⚙️ Solution/40 👥 Domains/42 🌬️ Streams/04 🔔🎭 Subscriber role.md>) create a [Buffer ⏳](<../../4 ⚙️ Solution/45 Helpers/10 ⏳ Buffers/$ ⏳🛠️ Buffer helper.md>) queue
...
| 3 | [🌬️🐌⏳ `Push@Buffer`](<../../6 🅰️ APIs/20 ⏳🅰️ Buffer/21 🌬️🐌⏳ Push.md>) | [Streamers 🌬️](<../../4 ⚙️ Solution/40 👥 Domains/42 🌬️ Streams/02 🌬️🎭 Streamer role.md>) push to [Buffers ⏳](<../../4 ⚙️ Solution/45 Helpers/10 ⏳ Buffers/$ ⏳🛠️ Buffer helper.md>)
| 4 | [⏳🐌🔔 `Wake-up@Subscriber`](<../../6 🅰️ APIs/87 🔔🅰️ Subscriber/04 ⏳🐌🔔 Wake-up.md>) | [Buffers ⏳](<../../4 ⚙️ Solution/45 Helpers/10 ⏳ Buffers/$ ⏳🛠️ Buffer helper.md>) wake up [Subscribers 🔔](<../../4 ⚙️ Solution/40 👥 Domains/42 🌬️ Streams/04 🔔🎭 Subscriber role.md>)
...
1. **Why an async request for [`Queue@Buffer`](<../../6 🅰️ APIs/20 ⏳🅰️ Buffer/12 🔔🐌⏳ Queue.md>) ?**
    ...
    [Buffer ⏳ domains](<../../4 ⚙️ Solution/45 Helpers/10 ⏳ Buffers/$ ⏳🛠️ Buffer helper.md>) may require additional time to resource the compute and store to handle the queue. 
    * [Buffer ⏳ domains](<../../4 ⚙️ Solution/45 Helpers/10 ⏳ Buffers/$ ⏳🛠️ Buffer helper.md>) should not be pressured to speed up under a synchronous request.
...
1. **How is privacy the Subscriber protected on [`Push@Buffer`](<../../6 🅰️ APIs/20 ⏳🅰️ Buffer/21 🌬️🐌⏳ Push.md>)?**
    ...
    When [Streamer 🌬️ domains](<../../4 ⚙️ Solution/40 👥 Domains/42 🌬️ Streams/02 🌬️🎭 Streamer role.md>) send messages to [Buffer ⏳ domains](<../../4 ⚙️ Solution/45 Helpers/10 ⏳ Buffers/$ ⏳🛠️ Buffer helper.md>), 
