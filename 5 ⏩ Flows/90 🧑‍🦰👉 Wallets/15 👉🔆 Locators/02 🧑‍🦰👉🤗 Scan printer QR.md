...
| 3 | [👥🚀🖨️ `Resolve@Printer`](<../../../4 ⚙️ Solution/45 🛠️ Helper domains/75 🖨️ Printers/🖨️🅰️ Printer methods/👥🚀🖨️ Resolve.md>) | Get the host's locator from the [Printer 🖨️](<../../../4 ⚙️ Solution/45 🛠️ Helper domains/75 🖨️ Printers/🖨️🛠️ Printer helper.md>)
