...
* Scenario where the [Locator 🔆](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/11 🔆 Locators/01 🔆 Locator.md>) is managed by a [Printer 🖨️](<../../../4 ⚙️ Solution/45 Helpers/60 🖨️ Printers/08 🖨️🏭 Printer helper.md>) domain.
...
| 3 | [👥🚀🖨️ `Resolve@Printer`](<../../../6 🅰️ APIs/75 🖨️🅰️ Printer/03 👥🚀🖨️ Resolve.md>) | Get the host's locator from the [Printer 🖨️](<../../../4 ⚙️ Solution/45 Helpers/60 🖨️ Printers/08 🖨️🏭 Printer helper.md>)
