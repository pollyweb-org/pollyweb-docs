...
| 3 | [👥🚀🖨️ `Alias@Printer`](<../../../6 🅰️ APIs/75 🖨️🅰️ Printer/01 👥🚀🖨️ Alias.md>) | Get the host's locator from the [Printer 🖨️](<../../../4 ⚙️ Solution/70 🌳 Ambient/71 💠 Brand Things/08 🖨️🏭 Printer helper.md>)
| 4 | [🤵⏩🧑‍🦰 Assessed 🔆](<../../10 🤵⏩ Brokers/01 🤵⏩🧑‍🦰 Assessed 🔆.md>) | Ask the [Wallet 🧑‍🦰](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/01 🧑‍🦰 Wallet app.md>)  to open a chat window
