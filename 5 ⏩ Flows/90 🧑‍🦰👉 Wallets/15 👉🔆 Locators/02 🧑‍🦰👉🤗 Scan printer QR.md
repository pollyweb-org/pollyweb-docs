...
* The user scans a [Locator 🔆](<../../../4 ⚙️ Solution/30 🧩 Data/15 🔆 Locators/$ 🔆 Locator.md>) with their [Wallet 🧑‍🦰 app](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/01 🧑‍🦰 Wallets/🧑‍🦰 Wallet app.md>).
* Scenario where the [Locator 🔆](<../../../4 ⚙️ Solution/30 🧩 Data/15 🔆 Locators/$ 🔆 Locator.md>) is managed by a [Printer 🖨️](<../../../4 ⚙️ Solution/45 🤲 Helper domains/75 🖨️ Printers/🖨️🤲 Printer helper.md>) domain.
...
| # | Call | Notes
|-|-|-
| 1 | [👥🐌🏭 `Order@Supplier`](<../../../6 🅰️ APIs/90 🏭🅰️ Supplier/01 👥🐌🏭 Order.md>) | Order dynamic [Locators 🔆](<../../../4 ⚙️ Solution/30 🧩 Data/15 🔆 Locators/$ 🔆 Locator.md>)
