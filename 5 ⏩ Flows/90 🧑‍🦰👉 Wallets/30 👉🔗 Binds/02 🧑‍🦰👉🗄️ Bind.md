...
| 🤵 [Broker](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/03 🤵 Brokers/03 🤵 Broker domain.md>) | 🫥 [Bind to Any Vault?](<../../../9 😃 Talkers/44 🔗 BIND msg.md>) [All, No] <br/> - [ ] Some schema code 🧩 <br/> - [ ] Some other schema code 🧩 | > All
...
The associated [Talker 😃](<../../../9 😃 Talkers/01 😃 Talker.md>) uses the [`BIND` 🔗 ](<../../../9 😃 Talkers/44 🔗 BIND msg.md>) command.
