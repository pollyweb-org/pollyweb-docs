...
| 🤵 [Broker](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/03 🤵 Brokers/03 🤵 Broker domain.md>) | 🫥 [Bind to Any Vault?](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/33 😃 Talkers/42 🔗 BIND msg.md>) [All, No] <br/> - [ ] Some schema code 🧩 <br/> - [ ] Some other schema code 🧩 | > All
...
The associated [Talker 😃](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/33 😃 Talkers/01 😃 Talker.md>) uses the [`BIND` 🔗 ](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/33 😃 Talkers/42 🔗 BIND msg.md>) command.
