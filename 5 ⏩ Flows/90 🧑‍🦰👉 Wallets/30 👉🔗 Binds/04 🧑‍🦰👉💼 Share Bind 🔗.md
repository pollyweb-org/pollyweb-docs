...
|5|[🤵🐌🗄️ `Disclose@Broker`](<../../../4 ⚙️ Solution/41 🎭 Domain Roles/80 🗄️ Vaults/95 🗄️🅰️ Vault/53 🤵🐌🗄️ Disclose@Vault.md>) | [Brokers 🤵](<../../../4 ⚙️ Solution/45 🛠️ Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) ask the [Vault 🗄️](<../../../4 ⚙️ Solution/41 🎭 Domain Roles/80 🗄️ Vaults/$ 🗄️🎭 Vault role.md>) to disclose
...
|8|[🗄️⏩💼 Consume 🧩](<../../../4 ⚙️ Solution/41 🎭 Domain Roles/80 🗄️ Vaults/32 🗄️⏩💼 Consume 🔗.md>) | [Vaults 🗄️](<../../../4 ⚙️ Solution/41 🎭 Domain Roles/80 🗄️ Vaults/$ 🗄️🎭 Vault role.md>) share the user's data
|
