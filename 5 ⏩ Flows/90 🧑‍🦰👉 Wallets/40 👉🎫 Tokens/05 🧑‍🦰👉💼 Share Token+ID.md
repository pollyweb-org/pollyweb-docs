...
1. **Why do we need to get the user's approval?**
    ...
    * The later is the case when a user is trying to interact with a [Userable 💍](<../../../4 ⚙️ Solution/25 Locators/4 💍 Userables/💍💠 Userable thing.md>) from another person in the [Confused senior user 👴🏻](<../../../4 ⚙️ Solution/25 Locators/4 💍 Userables/💍⏩ Userable flows/💍📱 Senior user.md>) scenario.
