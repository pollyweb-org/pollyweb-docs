...
|3|[💼🐌🤵 `Invite@Broker`](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/03 🤵 Brokers/🤵🅰️ Broker methods/6 🤵🅰️ Share/💼🐌🤵 Invite.md>)|Invite the [Identity 🆔](<../../../4 ⚙️ Solution/50 🫥 Agent domains/45 🆔 Identities/$ 🆔🫥 Identity agent.md>) to the [Chat 💬](<../../../4 ⚙️ Solution/35 Chats/💬 Chats/💬 Chat.md>)
...
|6|[🗄️⏩💼 Consume 🧩](<../../../4 ⚙️ Solution/41 🎭 Domain Roles/80 🗄️ Vaults/🗄️⏩ Vault flows/🗄️⏩💼 Consume 🔗.md>) | Confirm the [Token 🎫](<../../../4 ⚙️ Solution/30 Data/🎫 Tokens/🎫 Token.md>) ownership
|
...
1. **Why do we need to get the user's approval?**
    ...
    Users expect to have only their own [Vaults 🗄️ domains](<../../../4 ⚙️ Solution/41 🎭 Domain Roles/80 🗄️ Vaults/🗄️🎭 Vault role.md>) on the [Chat 💬](<../../../4 ⚙️ Solution/35 Chats/💬 Chats/💬 Chat.md>), apart from the [Host 🤗 domain](<../../../4 ⚙️ Solution/41 🎭 Domain Roles/30 🤗 Hosts/🤗🎭 Host role.md>) and the [Broker 🤵 domain](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>).
    * If the [Identity 🆔 vault](<../../../4 ⚙️ Solution/50 🫥 Agent domains/45 🆔 Identities/$ 🆔🫥 Identity agent.md>) referenced by the [Token 🎫](<../../../4 ⚙️ Solution/30 Data/🎫 Tokens/🎫 Token.md>) is listed as a user [Bind 🔗](<../../../4 ⚙️ Solution/30 Data/🔗 Binds/🔗 Bind.md>), then no approval is required.
...
1. **What does the Invite@Broker call look like?**
    ...
    Consider the following example payload to  [`Invite@Broker`](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/03 🤵 Brokers/🤵🅰️ Broker methods/6 🤵🅰️ Share/💼🐌🤵 Invite.md>).
