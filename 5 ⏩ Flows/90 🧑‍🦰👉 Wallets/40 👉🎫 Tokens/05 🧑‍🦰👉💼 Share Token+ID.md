...
1. **Why do we need to get the user's approval?**
    ...
    * If the [Identity 🆔 vault](<../../../4 ⚙️ Solution/30 🫥 Agents/45 🆔 Identities/01 🆔🫥 Identity agent.md>) referenced by the [Token 🎫](<../../../4 ⚙️ Solution/25 Data/30 🎫 Tokens/$ 🎫 Token.md>) is listed as a user [Bind 🔗](<../../../4 ⚙️ Solution/25 Data/20 🔗 Binds/$ 🔗 Bind.md>), then no approval is required.
