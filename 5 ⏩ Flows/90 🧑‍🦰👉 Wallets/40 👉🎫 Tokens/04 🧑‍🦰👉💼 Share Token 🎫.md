...
|#| Step | Purpose
|-|-|-
|1| [💼🐌🤵 `Query@Broker`](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/03 🤵 Brokers/🤵🅰️ Broker methods/6 🤵🅰️ Share/💼🐌🤵 Query.md>) | Ask for user data in specific [Schema Codes 🧩](<../../../4 ⚙️ Solution/30 Data/10 🧩 Schema Codes/🧩 Schema Code.md>)
