...
![alt text](<../../20 💼⏩ Consumers/.📎 Assets/⚙️ Query Token.png>)
...
|6| [🤵🐌💼 Receive @ Consumer](<../../../6 🅰️ APIs/30 💼🅰️ Consumer/02 🧑‍🦰🐌💼 Receive.md>) | Send the shared offline [Tokens 🎫](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/25 🎫 Tokens/01 🎫 Token.md>)
...
|8| [👥🚀🕸 Public Key @ Graph](<../../../6 🅰️ APIs/45 🕸🅰️ Graph/07 👥🚀🕸 Public Key.md>) | Get the DKIM public key of each [Token 🎫](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/25 🎫 Tokens/01 🎫 Token.md>)
|
