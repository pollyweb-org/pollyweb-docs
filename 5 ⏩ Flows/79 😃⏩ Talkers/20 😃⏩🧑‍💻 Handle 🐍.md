...
1. **Why isn't the [Talker 😃 API](<../../9 😃 Talkers/10 📘 Talker specs/10 😃 Talker.md>) a separate domain?**
    ...
    [Talkers 😃](<../../9 😃 Talkers/10 📘 Talker specs/10 😃 Talker.md>) manage a wide number of messages for multiple [domain roles 🎭](<../../4 ⚙️ Solution/40 👥 Domains/$ 👥 Domains/00 👥 Domain.md>);
