...
| 2 | [🤵🐌🤗 Summarize @ Host](<../../6 🅰️ APIs/09 🤗🅰️ Host/10 🤵🐌🤗 Summarize.md>) | Then ask [Hosts 🤗](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/23 💬 Chats/04 🤗🎭 Host role.md>) to summarize the [Chat 💬](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/23 💬 Chats/01 💬 Chat.md>)
| 3 | [🤗🐌👀 Summarized @ Advertiser](<../../6 🅰️ APIs/01 👀🅰️ Advertiser/02 🤗🐌👀 Summarized.md>) | [Hosts 🤗](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/23 💬 Chats/04 🤗🎭 Host role.md>) notify [Advertisers 👀](<../../4 ⚙️ Solution/30 🫥 Agents/10 🔎 Finders/03 👀👥 Advertiser helper.md>) when summarized
