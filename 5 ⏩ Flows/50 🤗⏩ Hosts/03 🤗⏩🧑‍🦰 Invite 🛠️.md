...
|-|-
| ℹ️ [`INFO`](<../../9 😃 Talkers/Prompts/20 Status prompts/21 ℹ️ INFO prompt.md>) | To show the messages to the user.
| 🛠️ [`INVITE`](<../../9 😃 Talkers/Messages/46 🛠️ INVITE msg.md>) | To collect a random number.
|
