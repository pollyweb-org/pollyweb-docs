...
The associated [Talker 😃](<../../9 😃 Talkers/10 📘 Talker specs/01 😃 Talker.md>) is as follows.
...
|-|-
| ℹ️ [`INFO`](<../../9 😃 Talkers/50 🤔 Prompts/40 ⚠️🤔 Status prompts/21 ℹ️ INFO prompt.md>) | To show the messages to the user.
