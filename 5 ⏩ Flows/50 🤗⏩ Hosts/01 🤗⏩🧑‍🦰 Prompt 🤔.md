...
The associated [Talker 😃](<../../9 😃 Talkers/10 📘 Talker specs/01 😃 Talker.md>), with one line per [Prompt 🤔](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/31 🤔 Prompts/01 🤔 Prompt.md>), would be the following.
