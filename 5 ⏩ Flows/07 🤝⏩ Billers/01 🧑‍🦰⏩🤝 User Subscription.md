...
- 1/ the user has default [Payer 💳](<../../4 ⚙️ Solution/50 🫥 Agents/60 💳 Payers/03 💳🎭 Payer role.md>) and [Identity 🆔](<../../4 ⚙️ Solution/50 🫥 Agents/45 🆔 Identities/01 🆔🫥 Identity agent.md>) domains;
...
- 5/ the user's [Identity 🆔 domain](<../../4 ⚙️ Solution/50 🫥 Agents/45 🆔 Identities/01 🆔🫥 Identity agent.md>) authenticates the user;
