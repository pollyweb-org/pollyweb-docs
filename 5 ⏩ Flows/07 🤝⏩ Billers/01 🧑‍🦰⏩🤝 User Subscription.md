...
| 🤵 [Broker](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/03 🤵 Brokers/03 🤵 Broker domain.md>) | 🫥 [Bind?](<../../7 🧩 Schemas/HOST/🧩 HostPersonalize.md>) | > Yes 
...
|-|-
| 📝 [`FORM`](<../../9 😃 Talkers/5 Messages/41 📝 FORM msg.md>) | To provide instructions.
| 🔗 [`BIND`](<../../9 😃 Talkers/5 Messages/44 🔗 BIND msg.md>) | To create a user profile.
...
| ⬇️ [`EVAL`](<../../9 😃 Talkers/03 Talker Data/20 ⬇️ EVAL flow.md>) | To register on the database.
| ✅ [`SUCCESS`](<../../9 😃 Talkers/3 Prompts/40 ⚠️🤔 Status prompts/23 ✅ SUCCESS prompt.md>) | To say that it was successful.
