...
| 🤵 [Broker](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/03 🤵 Brokers/03 🤵 Broker domain.md>) | 🫥 [Bind?](<../../7 🧩 Codes/HOST/🧩 HostPersonalize.md>) | > Yes 
...
| ✅ [`SUCCESS`](<../../9 😃 Talkers/50 🤔 Prompts/4 ⚠️ Status prompts/23 ✅ SUCCESS prompt.md>) | To say that it was successful.
