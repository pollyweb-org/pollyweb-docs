...
- 2/ the [Seller 💵 domain](<../../4 ⚙️ Solution/41 🎭 Domain Roles/70 💵 Sellers/01 💵🎭 Seller role.md>) has a default [Collector 🏦 domain](<../../4 ⚙️ Solution/45 🛠️ Helper domains/18 🏦 Collectors/$ 🏦🛠️ Collector helper.md>).

The following steps describe a subscription workflow:
- 1/ the user initiates a chat with a [Seller 💵](<../../4 ⚙️ Solution/41 🎭 Domain Roles/70 💵 Sellers/01 💵🎭 Seller role.md>);
- 2/ the user selects a subscription in the chat;
- 3/ the Seller's [Biller 🤝](<../../4 ⚙️ Solution/45 🛠️ Helper domains/15 🤝 Billers/06 🤝🛠️ Biller helper.md>) sends the PDF terms to the user;
...
- 7/ the [Seller 💵](<../../4 ⚙️ Solution/41 🎭 Domain Roles/70 💵 Sellers/01 💵🎭 Seller role.md>) confirms the subscription;
- 8/ the  [Biller 🤝](<../../4 ⚙️ Solution/45 🛠️ Helper domains/15 🤝 Billers/06 🤝🛠️ Biller helper.md>)  initiates the monthly collection.
...
| 🤝 [Biller](<../../4 ⚙️ Solution/45 🛠️ Helper domains/15 🤝 Billers/06 🤝🛠️ Biller helper.md>) | 😃 What plan to subscribe? <br/>- [ Simple ] pay-as-you-go  <br/>- [ Monthly ] commitment | > Simple
