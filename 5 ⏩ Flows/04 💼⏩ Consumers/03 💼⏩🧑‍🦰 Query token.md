...
|#| Step | Purpose
|-|-|-
|0| [🎴⏩🧑‍🦰 Offer @ Issuer](<../06 🎴⏩ Issuers/01 🎴⏩🧑‍🦰 Offer token.md>) | The [Issuer 🎴 domain](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/25 🎫 Tokens/02 🎴🎭 Issuer role.md>) offers a [Token 🎫](<../../4 ⚙️ Solution/20 🧑‍🦰 UI/25 🎫 Tokens/01 🎫 Token.md>).
