...
| 🧭 [Navigator](<../../../../4 ⚙️ Solution/50 🫥 Agent domains/Navigators 🧭/$ 🧭🫥 Navigator agent.md>) | ⓘ Direction to your seat [+] <br/> - move one row forward to row B <br/> - go towards the right side of the row <br/> - find seats 10 and 12 <br/> - and tap them to re-confirm.
