...
| 🆔 [Identity](<../../../../4 ⚙️ Solution/50 🫥 Agents/45 🆔 Identities/$ 🆔🫥 Identity agent.md>) | 🫥 Share identity? [Yes, No] | > Yes
...
| 🧢 [Persona](<../../../../4 ⚙️ Solution/50 🫥 Agents/70 🧢 Personas/$ 🧢🫥 Persona agent.md>) | 🫥 Share current job titles? [Yes, No] | > Yes
...
| 📇 [Mingler](<../../../../4 ⚙️ Solution/50 🫥 Agents/50 📇 Minglers/$ 📇🫥 Mingler agent.md>) | 🫥 Forward request? [No] <br/> - to selected contacts 📇 <br/> - to share identity 🆔 <br/> - with Any Council 🏛️  | > Yes
| 📇 [Mingler](<../../../../4 ⚙️ Solution/50 🫥 Agents/50 📇 Minglers/$ 📇🫥 Mingler agent.md>) | 🫥 Select contacts [+] <br/> - [ ] 🐭 mouse <br/> - [ ] 🧑‍🦱 Deb <br/> - [ ] 🧕 sissy <br/> - ...| [X] 🐭 mouse <br/> [X] 🧕 sissy 
| 📇 [Mingler](<../../../../4 ⚙️ Solution/50 🫥 Agents/50 📇 Minglers/$ 📇🫥 Mingler agent.md>) | ⏳ Waiting 2/2 items, 48 hrs left... <br/>- [ change request ]
| 📇 [Mingler](<../../../../4 ⚙️ Solution/50 🫥 Agents/50 📇 Minglers/$ 📇🫥 Mingler agent.md>) | ⏳ Waiting 1/2 items, 17 mins left... <br/>- [ change request ] <br/>- [ list received ] 
