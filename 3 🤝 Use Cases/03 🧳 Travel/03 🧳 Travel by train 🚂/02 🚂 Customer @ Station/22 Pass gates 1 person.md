...
| 🧭 [Navigator](<../../../../4 ⚙️ Solution/50 🫥 Agent domains/55 🧭 Navigators/$ 🧭🫥 Navigator agent.md>) | ⓘ Go to platform A (3 min): [+] <br>- turn left to SP 🐿️<br>- down to JP via stairs 🐆<br/>- platform A is on the left 🐜
||
