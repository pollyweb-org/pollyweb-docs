...
| 🧭 [Navigator](<../../../../4 ⚙️ Solution/30 🫥 Agents/55 🧭 Navigators/01 🧭🫥 Navigator agent.md>) | ⓘ Go to platform A (3 min): [+] <br>- turn left to SP 🐿️<br>- down via stairs to JP 🐆<br/>- platform A is on the left 🐜
||