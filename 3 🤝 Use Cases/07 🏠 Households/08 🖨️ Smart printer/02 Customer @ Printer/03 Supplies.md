...
| 🧢 [Persona](<../../../../4 ⚙️ Solution/50 🫥 Agent domains/70 🧢 Personas/🧢🫥 Persona agent.md>) | 🫥 Share delivery address? [No] <br/>- [ office ] <br/>- [ Alice's ] | > Alice's
| 🖨️ Seller   | 🙏 Confirm: [OK, Cancel] <br>- arrival: Friday<br/>- total cost: 20 dollars | > OK
| 💳 [Payer](<../../../../4 ⚙️ Solution/50 🫥 Agent domains/60 💳 Payers/03 💳🎭 Payer role.md>) | 🫥 Pay $20.00 bill? 🧾 [No] <br/>- [ card ABC ] + $0.10<br/>- [ card DEF ] (free) | > card ABC
| 🤵 [Broker](<../../../../4 ⚙️ Solution/45 🤲 Helper domains/24 🤵 Brokers/🤵🤲 Broker helper.md>) | 🫥 Save parcel delivery? [Yes, No] <br/> | > Yes
