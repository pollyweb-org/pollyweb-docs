...
1. **How to request immediate home assistance?**
    ...
    | 🧢 [Persona](<../../../4 ⚙️ Solution/30 🫥 Agents/02 🧢 Personas/$ 🧢🫥 Persona agent.md>) | 🫥 Share delivery address? [No]  <br/>- [ home ] <br/>- [ Alice's ] | > Alice's
    ...
    | 🆔 [Identity](<../../../4 ⚙️ Solution/30 🫥 Agents/05 🆔 Identities/01 🆔🫥 Identity agent.md>) | 🫥 Sign report? 📄 [Yes, No] | > Yes
