...
1. **How to request immediate home assistance?**
    ...
    | 🧢 [Persona](<../../../4 ⚙️ Solution/50 🫥 Agents/70 🧢 Personas/$ 🧢🫥 Persona agent.md>) | 🫥 Share delivery address? [No]  <br/>- [ home ] <br/>- [ Alice's ] | > Alice's
    | [🗓️ Scheduler](<../../../4 ⚙️ Solution/50 🫥 Agents/75 🗓️ Schedulers/$ 🗓️🗄️ Scheduler agent.md>) | 🫥 Confirm plumber? [Yes, No] <br/>📍 43, Soho, W1D 3QX  <br/> 🕑 today, 11:30 am <br/> - you have a work meeting at 12pm. | > Yes
    ...
    | 🆔 [Identity](<../../../4 ⚙️ Solution/50 🫥 Agents/45 🆔 Identities/01 🆔🫥 Identity agent.md>) | 🫥 Sign report? 📄 [Yes, No] | > Yes
