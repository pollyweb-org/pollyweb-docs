...
| 🧚 [Curator](<../../../4 ⚙️ Solution/30 🫥 Agents/03 🧚 Curators/$ 🧚🫥 Curator agent.md>) | 💭 [Some suggestions:](<../../../9 😃 Talkers/20 🤔 Prompts/7 ✏️ Input prompts/54 🔠 MANY prompt.md>) [All, No] <br/>- [ ] house burger 🍔 (£3.00) <br/> - [ ] still water (25 cl) 💧 (£1.00) <br/> |  > All
| 🧚 [Curator](<../../../4 ⚙️ Solution/30 🫥 Agents/03 🧚 Curators/$ 🧚🫥 Curator agent.md>) | 💭 [Anything else?](<../../../9 😃 Talkers/20 🤔 Prompts/7 ✏️ Input prompts/54 🔠 MANY prompt.md>) [No] <br/> - [ ] coffee ☕ (£0.90) | > No
