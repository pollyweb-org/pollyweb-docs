...
1. **What [Agent 🫥 vault domains](<../../../4 ⚙️ Solution/50 🫥 Agents/$ 🫥 Agent Vaults/$ 🫥🗄️ Agent vault.md>) do customers need?**
    ...
    | 🧳 [Custodian](<../../../4 ⚙️ Solution/50 🫥 Agents/35 🧳 Custodians/$ 🧳🫥 Custodian agent.md>) | To pay with a [💍 Userable](<../../../4 ⚙️ Solution/70 🌳 Ambient/74 💍 Userables/$ 💍 Userable thing.md>).
    |
...
1. **What [Agent 🫥 vault domains](<../../../4 ⚙️ Solution/50 🫥 Agents/$ 🫥 Agent Vaults/$ 🫥🗄️ Agent vault.md>) does staff need?**
    ...
    |  Agent| Purpose
    |-|-
    [🆔 Identity](<../../../4 ⚙️ Solution/50 🫥 Agents/45 🆔 Identities/$ 🆔🫥 Identity agent.md>) | To verify the [staff Token 🎫](<../../../4 ⚙️ Solution/30 🧩 Data/30 🎫 Tokens/🎫 Token.md>).
    |
...
1. **What are the [domain helpers 🛠️](<../../../4 ⚙️ Solution/45 🤲 Helper domains/$ 🤲 Helpers/🤲👥 Helper domain.md>) required?**
   
    | [Helper 🛠️](<../../../4 ⚙️ Solution/45 🤲 Helper domains/$ 🤲 Helpers/🤲👥 Helper domain.md>) | Purpose
    |-|-
...
1. **What does the [domain Manifest 📜](<../../../4 ⚙️ Solution/40 👥 Domains/44 📜 Manifests/📜 Manifest.md>) look like?**
