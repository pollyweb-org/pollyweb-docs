...
* [Talker 😃](<../../../9 😃 Talkers/10 😃 Talker.md>) for:
...
| [🪣 `Items`](<94 🪣 Owner: Items.md>) | List of items to [`MAP`](<../../../9 😃 Talkers/😃🗃️ Talker data/61 🪣 MAP item.md>)
| [🪣 `Locators`](<95 🪣 Owner: Locators.md>) | List of machines to [`MAP`](<../../../9 😃 Talkers/😃🗃️ Talker data/61 🪣 MAP item.md>)
| 💬 [`$.Chat.Key`](<../../../9 😃 Talkers/😃🗃️ Talker data/11 💬 $.Chat holder.md>) | Get the machine's [Locator 🔆](<../../../4 ⚙️ Solution/25 Locators/15 🔆 Locators/🔆 Locator.md>) key
|
...
[Functions](<../../../9 😃 Talkers/😃🗃️ Talker data/12 🐍 {Function}.md>)| Type | Purpose
|-|-|-
...
|Type|[Command ⌘](<../../../9 😃 Talkers/😃🌊 Talker flow/10 ⌘ Command.md>)|Purpose
|-|-|-
|Data| 🪣 [`MAP`](<../../../9 😃 Talkers/😃🗃️ Talker data/61 🪣 MAP item.md>) | Look up items and machines
...
|Flow| ⤵️ [`IF`](<../../../9 😃 Talkers/😃🌊 Talker flow/21 ⤵️ IF flow.md>) | To see if 21+ check is needed
||⬇️ [`EVAL`](<../../../9 😃 Talkers/😃🗃️ Talker data/20 ⬇️ EVAL flow.md>) | To deduct the value on errors
||🪵 [`LOG`](<../../../9 😃 Talkers/😃🗃️ Talker data/15 🪵 LOG flow.md>) | To log eventual errors
|Message| 💼 [`SHARE`](<../../../9 😃 Talkers/😃📨 Talker msgs/45 💼 SHARE msg.md>) | Ask for proof of over 21
|| 💳 [`CHARGE`](<../../../9 😃 Talkers/😃📨 Talker msgs/53 💳 CHARGE msg.md>) | Charge the item price
|| 🏦 [`REFUND`](<../../../9 😃 Talkers/😃📨 Talker msgs/55 🏦 REFUND.md>) | Refund the payment on failure
|| 👋 [`GOODBYE`](<../../../9 😃 Talkers/😃📨 Talker msgs/50 👋 GOODBYE.md>) | Show ads on success
|| 🛰️ [`RELAY`](<../../../9 😃 Talkers/😃📨 Talker msgs/51 🛰️ RELAY msg.md>) | Relay messages to  machines
|
