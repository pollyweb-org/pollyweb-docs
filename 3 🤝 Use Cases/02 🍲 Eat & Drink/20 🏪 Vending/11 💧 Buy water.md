...
| 🍫 Vending | 😃 [A water bottle?](<../../../9 😃 Talkers/50 🤔 Prompts/7 ✏️ Input prompts/31 👍 CONFIRM prompt.md>) [Yes, No]        | > Yes
| 💳 [Payer](<../../../4 ⚙️ Solution/30 🫥 Agents/04 💳 Payers/03 💳🎭 Payer role.md>) | 🫥 Pay $1.50 bill? 🧾 [No] <br/>- [ card ABC ] + $0.10<br/>- [ card DEF ] (free) | > card ABC
| 🍫 Vending | [⏳ Delivering...](<../../../9 😃 Talkers/50 🤔 Prompts/4 ⚠️ Status prompts/25 ⏳ TEMP prompt.md>)
| 🍫 Vending | [✅ Pick up the item. ](<../../../9 😃 Talkers/50 🤔 Prompts/4 ⚠️ Status prompts/23 ✅ SUCCESS prompt.md>)
