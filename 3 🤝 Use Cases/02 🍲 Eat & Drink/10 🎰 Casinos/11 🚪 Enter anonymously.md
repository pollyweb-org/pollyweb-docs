...
Users can ask their [Identity 🆔 vault](<../../../4 ⚙️ Solution/50 🫥 Agent domains/45 🆔 Identities/$ 🆔🫥 Identity agent.md>) for an age-related [Token 🎫](<../../../4 ⚙️ Solution/30 Data/3 🎫 Tokens/🎫 Token.md>)
