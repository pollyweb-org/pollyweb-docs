...
| 🤵 [Broker](<../../../4 ⚙️ Solution/45 🛠️ Helper domains/24 🤵 Brokers/$ 🤵 Broker domain.md>) | 🫥 [Allow guest domain?](<../../../4 ⚙️ Solution/41 🎭 Domain Roles/30 🤗 Hosts/⏩ Host flows/33 🤗⏩🧑‍🦰 Invite 🛠️ flow.md>) [Yes, No]  <br/> - Any Collector 🏦<br/>- [ Always ] for Any Restaurant 🍽️ | > Yes
