...
|-|-
| 
| 🪣 [`MAP`](<../../../9 😃 Talkers/61 🪣 MAP item.md>) | Map the locator to a restaurant info.
| 📝 [`FORM`](<../../../9 😃 Talkers/41 📝 FORM msg.md>) | Show user instructions and allow inputs.
| 1️⃣ [`ONE`](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/31 🤔 Prompts/53 1️⃣ ONE prompt.md>) | Select an option, the day in this case.
| 💼 [`SHARE`](<../../../9 😃 Talkers/45 💼 SHARE msg.md>) | Get the user's booking contacts.
| 👍 [`CONFIRM`](<../../../4 ⚙️ Solution/20 🧑‍🦰 UI/31 🤔 Prompts/31 👍 CONFIRM prompt.md>) | Pause to allow changing previous inputs.
| ❄️ [`FREEZE`](<../../../9 😃 Talkers/42 ❄️ FREEZE msg.md>) | Freeze all previous inputs from changes.
