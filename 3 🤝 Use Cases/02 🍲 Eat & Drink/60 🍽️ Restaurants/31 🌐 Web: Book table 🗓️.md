...
| 1️⃣ [`ONE`](<../../../4 ⚙️ Solution/35 Chats/🤔 Prompts/7 ✏️ Input prompts/53 1️⃣ ONE prompt.md>) | Select an option, the day in this case.
| 💼 [`SHARE`](<../../../4 ⚙️ Solution/35 Chats/😃 Talkers/😃📨 Talker msgs/45 💼 SHARE msg.md>) | Get the user's booking contacts.
| 👍 [`CONFIRM`](<../../../4 ⚙️ Solution/35 Chats/🤔 Prompts/7 ✏️ Input prompts/31 👍 CONFIRM prompt.md>) | Pause to allow changing previous inputs.
