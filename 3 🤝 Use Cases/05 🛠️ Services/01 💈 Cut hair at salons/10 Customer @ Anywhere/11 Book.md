...
| - | - | - |
||| > Book 🔗
| 🔎 [Finder](<../../../../4 ⚙️ Solution/50 🫥 Agent domains/40 🔎 Finders/🔎🫥 Finder agent.md>) | ⓘ Any Salon (4.4 ⭐) [+]
...
| 🧚 [Curator](<../../../../4 ⚙️ Solution/50 🫥 Agent domains/30 🧚 Curators/🧚🫥 Curator agent.md>) | 💭 Suggested services: <br/>- [  ] Haircut 💇<br/>- [  ]  Manicure 💅<br/>- [  ] Pedicure 🦶 | [X] Haircut 💇 <br/> [X] Manicure 💅
| 🧚 [Curator](<../../../../4 ⚙️ Solution/50 🫥 Agent domains/30 🧚 Curators/🧚🫥 Curator agent.md>) | 💭 Anything else? [Yes, No] | > No
| [🗓️ Scheduler](<../../../../4 ⚙️ Solution/50 🫥 Agent domains/75 🗓️ Schedulers/$ 🗓️🫥 Scheduler agent.md>) | ⏳ Verifying availability...
| [🗓️ Scheduler](<../../../../4 ⚙️ Solution/50 🫥 Agent domains/75 🗓️ Schedulers/$ 🗓️🫥 Scheduler agent.md>) | 🫥 Which day? <br/> - [ Today ] <br/> - [ Tomorrow ] <br/> - ... | > Tomorrow
...
| 🤵 [Broker](<../../../../4 ⚙️ Solution/20 🧑‍🦰 UI/03 🤵 Brokers/🤵🤲 Broker helper.md>) | 🫥 Save booking? [Yes, No] | > Yes    
| 💈 Salon   | ✅ Booked!
