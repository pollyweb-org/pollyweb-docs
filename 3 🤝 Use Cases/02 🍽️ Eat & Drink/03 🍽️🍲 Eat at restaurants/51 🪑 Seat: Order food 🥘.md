...
| 🍲 Restaurant | 😃 Hi! What do you need? <br/>- [ Order ] <br/>- [ Something else ] | > Order
...
| 🍲 Restaurant  | ℹ️ Order ($15): [Change] <br/> - 1 tap water 🚰 (free) <br/> - 1 dark paella 🥘 ($15) 
...
| 🍲 Restaurant | 😃 Food will take ~10 min: <br/> - [ OK ] no problem <br/> - [ Change ] order | > OK
