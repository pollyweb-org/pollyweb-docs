...
1. [access](<../4 ⚙️ Solution/20 🧑‍🦰 UI/11 🔆 Locators/$ 🔆 Locator.md>) services anytime, from anywhere, or from any product; 
...
1. own their multi-persona [digital twins](<../4 ⚙️ Solution/50 🫥 Agents/70 🧢 Personas/$ 🧢🫥 Persona agent.md>), and decide when to share them;
...
1. manage all only debits and credits from a [central user experience](<../4 ⚙️ Solution/45 🛠️ Helper domains/20 🤝 Billers/🤝🛠️ Biller helper.md>).
...
1. publicly [manifest](<../4 ⚙️ Solution/40 👥 Domains/44 📜 Manifests/📜 Manifest.md>) their products and services to the world;
...
1. keep their citizens' data within [sovereign](<../4 ⚙️ Solution/50 🫥 Agents/80 📦 Storage/$ 📦🫥 Storage agent.md>) borders;
1. proxy and obfuscate their citizens' [biometric verification](<../4 ⚙️ Solution/50 🫥 Agents/45 🆔 Identities/$ 🆔🫥 Identity agent.md>);
