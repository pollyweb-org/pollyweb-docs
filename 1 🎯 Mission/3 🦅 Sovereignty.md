...
1. [keep](<../4 ⚙️ Solution/25 Data/24 🗄️ Vaults/03 🗄️🎭 Vault role.md>) the data output of services, and [share](<../4 ⚙️ Solution/25 Data/27 💼 Consumers/04 💼🎭 Consumer role.md>) it with other businesses;
...
1. use domain certificates for [authentication](<../4 ⚙️ Solution/40 👥 Domains/41 📨 Messages/01 📨 Domain Message.md>), not API keys;
