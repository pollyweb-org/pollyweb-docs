...
1. **What are the message types supported in chats?**
    ...
    - 💼 *Share*: [Consumer 💼](<../25 ✅ 💼 Consumers/04 ✅ 💼🎭 Consumer role.md>) domains request users to share data from a specific [schema](<../24 ✅ 🗄️ Vaults/02 ✅ 🧩 Schema Code.md>) or to share a [Token 🎫](<../27 ✅ 🎫 Tokens/01 ✅ 🎫 Token.md>).
    - 💳 *Pay*: [Seller 💵](<../../30 ⏳ 🫥 Agents/04 ✅ 💳 Payers/02 ✅ 💵🎭 Seller role.md>) domains request the user's [Payer 💳](<../../30 ⏳ 🫥 Agents/04 ✅ 💳 Payers/01 ✅ 💳🫥 Payer agent.md>) vault to pay an amount.
...
1. **Can Hosts replace sent prompts?**
    ...
    - This is particularly useful when [preparing food](<../../../3 ⏳ 🤝 Use Cases/02 ⏳ 🍽️ Eat & Drink/03 ✅ 🍲 Eat at restaurants/03 ✅ Order @ Seat 🪑/33. ✅ Change order 🌀.md>), when [waiting food orders](<../../../3 ⏳ 🤝 Use Cases/02 ⏳ 🍽️ Eat & Drink/03 ✅ 🍲 Eat at restaurants/06 ✅ Staff @ Back 🧑‍🍳/62. ✅ Prepare food 🥘.md>), and when reminding users of [upcoming bookings](<../../../3 ⏳ 🤝 Use Cases/03 ⏳ 🧳 Travel/05 ✅ Travel by hailing 🙋/1 ✅ Customer @ Home/12. ✅ Book.md>).
