🗂️ Data gathering landscape FAQ
===
...
- implementing national scoring systems for finance, insurance, drivers licenses, and social credit.

---
🤔 However, data misuse is a concern to society.
- News on the amount and unauthorized usage of data abound (e.g., NSA, Cambridge Analytica).
- Governments worldwide responded with regulation to protect their citizens privacy (e.g., GDPR).
