...
|Domain | Purpose
|-|-
|[💳 Payer](<../../../4 ⚙️ Solution/41 🎭 Domain Roles/Payers/💳🎭 Payer role.md>) | Pays money on behalf of users.
|[🏦 Collector](<../../../4 ⚙️ Solution/45 🤲 Helper domains/Collectors 🏦/🏦 Collector/🏦🤲 Collector helper.md>) | Collects money on behalf of businesses.
...
|-|-|-
|1|`Bill`| A Businesses issues a bill via their [Collector 🏦 helper domain](<../../../4 ⚙️ Solution/45 🤲 Helper domains/Collectors 🏦/🏦 Collector/🏦🤲 Collector helper.md>).
|2|`Collect`| The [business' Collector 🏦 helper](<../../../4 ⚙️ Solution/45 🤲 Helper domains/Collectors 🏦/🏦 Collector/🏦🤲 Collector helper.md>) asks the money in the business currency to [user's 💳 Payer agent domain](<../../../4 ⚙️ Solution/41 🎭 Domain Roles/Payers/💳🎭 Payer role.md>).
|3|`Negotiate`| The [user's Payer 💳 domain](<../../../4 ⚙️ Solution/41 🎭 Domain Roles/Payers/💳🎭 Payer role.md>) and the [business' Collector 🏦 domain](<../../../4 ⚙️ Solution/45 🤲 Helper domains/Collectors 🏦/🏦 Collector/🏦🤲 Collector helper.md>) agree on the transfer channel (e.g. Wise).
|4|`Pay`| Users pay in their preferred currency and methods (e.g., AMEX).
|5|`Fees`| The [user's Payer 💳 domain](<../../../4 ⚙️ Solution/41 🎭 Domain Roles/Payers/💳🎭 Payer role.md>) collects and distributes additional payment fees (e.g., AMEX fee).
