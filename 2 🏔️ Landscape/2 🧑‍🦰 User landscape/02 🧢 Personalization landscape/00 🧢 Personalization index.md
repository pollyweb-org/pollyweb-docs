...
- To protect user PII, brands are leveraging public trust to serve as proxies for their customers, e.g.:
    ...
    - and [PayPal 📺](<13 📺 PayPal Fastlane.md>) with FastLane, allowing users to remain anonymous on checkouts.
...
- **[personal vaults 🗄️](<../../../4 ⚙️ Solution/41 🎭 Domain Roles/Vaults 🗄️/🗄️🎭 Vault role.md>)**, implemented by the same organizations that already own PII; 
- **[zero knowledge proof 🆔](<../../../4 ⚙️ Solution/50 🫥 Agent domains/Identities 🆔/🆔⏩ Identity flows/3 🆔⏩🎫 Verify Tokens.md>)**, where proof is delegated to [vaults 🗄️](<../../../4 ⚙️ Solution/41 🎭 Domain Roles/Vaults 🗄️/🗄️🎭 Vault role.md>) in [online 🔗](<../../../4 ⚙️ Solution/30 🧩 Data/Binds 🔗/🔗 Bind.md>) and [offline 🎫](<../../../4 ⚙️ Solution/30 🧩 Data/Tokens 🎫/🎫 Token/🎫 Token.md>) fashion;
...
- How self-sovereign identity (SSI) aims to protect PII, namely:
    - what are [Solid Vaults 📺](<./05 📺 Berners-Lee vaults.md>), according to Sir Tim Berners-Lee (inventor of the web);
