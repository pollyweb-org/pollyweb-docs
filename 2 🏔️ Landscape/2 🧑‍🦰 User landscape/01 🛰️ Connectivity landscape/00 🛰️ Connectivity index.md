...
- when mid-air in intercontinental flights;
- when using mobile data in roaming abroad;
- when verify identity in airports, between countries;
- when in underground subways where there is no mobile signal;
...
- Starlink and Project Kuiper promise to make internet available anywhere above the ground.
